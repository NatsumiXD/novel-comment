const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CiKXl0r0.js","assets/chunks/framework.DHtr43LW.js"])))=>i.map(i=>d[i]);
import{d as P,c as o,r as _,n as I,o as s,a as z,t as C,b as A,w as b,T as ln,e as k,_ as f,u as yn,i as ne,f as pe,g as An,h as y,j as i,k as d,l as X,m as jn,p as J,q as ee,s as Nn,v as te,x as B,y as cn,z as U,A as On,B as dn,C as en,D as un,E as Dn,F as Hn,G as L,H as R,I as H,J as S,K,L as Fn,M as ae,N as se,O as W,P as _n,Q as Kn,R as re,S as bn,U as rn,V as Gn,W as oe,X as ie,Y as le,Z as Wn,$ as qn,a0 as ce,a1 as de,a2 as Z,a3 as ue,a4 as _e,a5 as fe,a6 as Bn,a7 as me,a8 as he,a9 as O}from"./chunks/framework.DHtr43LW.js";const ve=P({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(p){return(n,e)=>(s(),o("span",{class:I(["VPBadge",p.type])},[_(n.$slots,"default",{},()=>[z(C(p.text),1)])],2))}}),be={key:0,class:"VPBackdrop"},ge=P({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(p){return(n,e)=>(s(),A(ln,{name:"fade"},{default:b(()=>[p.show?(s(),o("div",be)):k("",!0)]),_:1}))}}),$e=f(ge,[["__scopeId","data-v-c79a1216"]]),V=yn;function ke(p,n){let e,t=!1;return()=>{e&&clearTimeout(e),t?e=setTimeout(p,n):(p(),(t=!0)&&setTimeout(()=>t=!1,n))}}function gn(p){return p.startsWith("/")?p:`/${p}`}function xn(p){const{pathname:n,search:e,hash:t,protocol:a}=new URL(p,"http://a.com");if(ne(p)||p.startsWith("#")||!a.startsWith("http")||!pe(n))return p;const{site:r}=V(),l=n.endsWith("/")||n.endsWith(".html")?p:p.replace(/(?:(^\.+)\/)?.*$/,`$1${n.replace(/(\.md)?$/,r.value.cleanUrls?"":".html")}${e}${t}`);return An(l)}function tn({correspondingLink:p=!1}={}){const{site:n,localeIndex:e,page:t,theme:a,hash:r}=V(),l=y(()=>({label:n.value.locales[e.value]?.label,link:n.value.locales[e.value]?.link||(e.value==="root"?"/":`/${e.value}/`)}));return{localeLinks:y(()=>Object.entries(n.value.locales).flatMap(([u,v])=>l.value.label===v.label?[]:{text:v.label,link:Pe(v.link||(u==="root"?"/":`/${u}/`),a.value.i18nRouting!==!1&&p,t.value.relativePath.slice(l.value.link.length-1),!n.value.cleanUrls)+r.value,lang:v.lang,dir:v.dir})),currentLang:l}}function Pe(p,n,e,t){return n?p.replace(/\/$/,"")+gn(e.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,t?".html":"")):p}const Te={class:"NotFound"},Se={class:"code"},ye={class:"title"},Ae={class:"quote"},Ne={class:"action"},Oe=["href","aria-label"],Be=P({__name:"NotFound",setup(p){const{theme:n}=V(),{currentLang:e}=tn();return(t,a)=>(s(),o("div",Te,[i("p",Se,C(d(n).notFound?.code??"404"),1),i("h1",ye,C(d(n).notFound?.title??"PAGE NOT FOUND"),1),a[0]||(a[0]=i("div",{class:"divider"},null,-1)),i("blockquote",Ae,C(d(n).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),i("div",Ne,[i("a",{class:"link",href:d(An)(d(n).notFound?.link??d(e).link),"aria-label":d(n).notFound?.linkLabel??"go to home"},C(d(n).notFound?.linkText??"Take me home"),9,Oe)])]))}}),xe=f(Be,[["__scopeId","data-v-829df670"]]);function Yn(p,n){if(Array.isArray(p))return sn(p);if(p==null)return[];n=gn(n);const e=Object.keys(p).sort((a,r)=>r.split("/").length-a.split("/").length).find(a=>n.startsWith(gn(a))),t=e?p[e]:[];return Array.isArray(t)?sn(t):sn(t.items,t.base)}function Ve(p){const n=[];let e=0;for(const t in p){const a=p[t];if(a.items){e=n.push(a);continue}n[e]||n.push({items:[]}),n[e].items.push(a)}return n}function Ce(p){const n=[];function e(t){for(const a of t)a.text&&a.link&&n.push({text:a.text,link:a.link,docFooterText:a.docFooterText}),a.items&&e(a.items)}return e(p),n}function $n(p,n){return Array.isArray(n)?n.some(e=>$n(p,e)):X(p,n.link)?!0:n.items?$n(p,n.items):!1}function sn(p,n){return[...p].map(e=>{const t={...e},a=t.base||n;return a&&t.link&&(t.link=a+t.link.replace(/^\//,a.endsWith("/")?"":"/")),t.items&&(t.items=sn(t.items,a)),t})}function Ie(){const{hasSidebar:p}=q(),n=jn("(min-width: 960px)"),e=jn("(min-width: 1280px)");return{isAsideEnabled:y(()=>!e.value&&!n.value?!1:p.value?e.value:n.value)}}const Le=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,kn=[];function Xn(p){return typeof p.outline=="object"&&!Array.isArray(p.outline)&&p.outline.label||p.outlineTitle||"On this page"}function we(p){const n=[...document.querySelectorAll(".VPDoc h1, .VPDoc h2, .VPDoc h3, .VPDoc h4, .VPDoc h5, .VPDoc h6")].filter(e=>e.id&&e.hasChildNodes()).map(e=>{const t=Number(e.tagName[1]);return{element:e,title:je(e),link:"#"+e.id,level:t}});return De(n,p)}function je(p){let n="";for(const e of p.childNodes)if(e.nodeType===1){if(Le.test(e.className))continue;n+=e.textContent}else e.nodeType===3&&(n+=e.textContent);return n.trim()}function De(p,n){if(n===!1)return[];const e=(typeof n=="object"&&!Array.isArray(n)?n.level:n)||2,[t,a]=typeof e=="number"?[e,e]:e==="deep"?[2,6]:e;return ze(p,t,a)}function Me(p,n){const{isAsideEnabled:e}=Ie(),t=ke(r,100);let a=null;J(()=>{requestAnimationFrame(r),window.addEventListener("scroll",t)}),ee(()=>{l(location.hash)}),Nn(()=>{window.removeEventListener("scroll",t)});function r(){if(!e.value)return;const c=window.scrollY,u=window.innerHeight,v=document.body.offsetHeight,h=Math.abs(c+u-v)<1,m=kn.map(({element:$,link:N})=>({link:N,top:Ee($)})).filter(({top:$})=>!Number.isNaN($)).sort(($,N)=>$.top-N.top);if(!m.length){l(null);return}if(c<1){l(null);return}if(h){l(m[m.length-1].link);return}let g=null;for(const{link:$,top:N}of m){if(N>c+te()+4)break;g=$}l(g)}function l(c){a&&a.classList.remove("active"),c==null?a=null:a=p.value.querySelector(`a[href="${decodeURIComponent(c)}"]`);const u=a;u?(u.classList.add("active"),n.value.style.top=u.offsetTop+39+"px",n.value.style.opacity="1"):(n.value.style.top="33px",n.value.style.opacity="0")}}function Ee(p){let n=0;for(;p!==document.body;){if(p===null)return NaN;n+=p.offsetTop,p=p.offsetParent}return n}function ze(p,n,e){kn.length=0;const t=[],a=[];return p.forEach(r=>{const l={...r,children:[]};let c=a[a.length-1];for(;c&&c.level>=l.level;)a.pop(),c=a[a.length-1];if(l.element.classList.contains("ignore-header")||c&&"shouldIgnore"in c){a.push({level:l.level,shouldIgnore:!0});return}l.level>e||l.level<n||(kn.push({element:l.element,link:l.link}),c?c.children.push(l):t.push(l),a.push(l))}),t}const Q=B(!1);function Re(p){let n;cn(()=>{n=Q.value?document.activeElement:void 0}),J(()=>{window.addEventListener("keyup",e)}),Nn(()=>{window.removeEventListener("keyup",e)});function e(t){t.key==="Escape"&&Q.value&&(p(),n?.focus())}}function Je(){function p(){Q.value=!0}function n(){Q.value=!1}function e(){Q.value?n():p()}return{isOpen:Q,open:p,close:n,toggle:e}}function Ue(p){const{page:n,hash:e}=V(),t=B(!1),a=y(()=>p.value.collapsed!=null),r=y(()=>!!p.value.link),l=B(!1),c=()=>{l.value=X(n.value.relativePath,p.value.link)};U([n,p,e],c),J(c);const u=y(()=>l.value?!0:p.value.items?$n(n.value.relativePath,p.value.items):!1),v=y(()=>!!(p.value.items&&p.value.items.length));cn(()=>{t.value=!!(a.value&&p.value.collapsed)}),On(()=>{(l.value||u.value)&&(t.value=!1)});function h(){a.value&&(t.value=!t.value)}return{collapsed:t,collapsible:a,isLink:r,isActiveLink:l,hasActiveLink:u,hasChildren:v,toggle:h}}const Pn=dn([]),pn=dn([]),Tn=dn(!1);function q(){const{frontmatter:p,theme:n}=V(),e=y(()=>!!(p.value.isHome??p.value.layout==="home")),t=y(()=>p.value.sidebar!==!1&&pn.value.length>0&&!e.value),a=y(()=>t.value&&Tn.value),r=y(()=>t.value?Ve(pn.value):[]),l=y(()=>e.value?!1:p.value.aside!=null?!!p.value.aside:n.value.aside!==!1),c=y(()=>l.value?p.value.aside==null?n.value.aside==="left":p.value.aside==="left":!1),u=y(()=>Pn.value.length>0);return{isHome:e,sidebar:Dn(pn),sidebarGroups:r,hasSidebar:t,isSidebarEnabled:a,hasAside:l,leftAside:c,headers:Dn(Pn),hasLocalNav:u}}function He({closeSidebar:p}){const{frontmatter:n,page:e,theme:t}=V();U(()=>[e.value.relativePath,t.value.sidebar],([r,l])=>{const c=l?Yn(l,r):[];JSON.stringify(c)!==JSON.stringify(pn.value)&&(pn.value=c)},{immediate:!0,deep:!0,flush:"sync"}),Hn(()=>{Pn.value=we(n.value.outline??t.value.outline)}),en&&(Tn.value=window.innerWidth>=960,window.addEventListener("resize",()=>{Tn.value=window.innerWidth>=960},{passive:!0}));const a=un();U(()=>a.path,p),Re(p)}const Qn=Symbol("layout-info"),Fe=["href","title"],Ke=P({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(p){return(n,e)=>{const t=H("VPDocOutlineItem",!0);return s(),o("ul",{class:I(["VPDocOutlineItem",p.root?"root":"nested"])},[(s(!0),o(L,null,R(p.headers,({children:a,link:r,title:l})=>(s(),o("li",null,[i("a",{class:"outline-link",href:r,title:l},C(l),9,Fe),a?.length?(s(),A(t,{key:0,headers:a},null,8,["headers"])):k("",!0)]))),256))],2)}}}),Zn=f(Ke,[["__scopeId","data-v-1ce71065"]]),Ge={class:"content"},We={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},qe=P({__name:"VPDocAsideOutline",setup(p){const{theme:n}=V(),e=B(),t=B(),{headers:a,hasLocalNav:r}=q();return Me(e,t),(l,c)=>(s(),o("nav",{"aria-labelledby":"doc-outline-aria-label",class:I(["VPDocAsideOutline",{"has-outline":d(r)}]),ref_key:"container",ref:e},[i("div",Ge,[i("div",{class:"outline-marker",ref_key:"marker",ref:t},null,512),i("div",We,C(d(Xn)(d(n))),1),S(Zn,{headers:d(a),root:!0},null,8,["headers"])])],2))}}),Ye=f(qe,[["__scopeId","data-v-60d5052e"]]),Xe={class:"VPDocAsideCarbonAds"},Qe=P({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(p){const n=()=>null;return(e,t)=>(s(),o("div",Xe,[S(d(n),{"carbon-ads":p.carbonAds},null,8,["carbon-ads"])]))}}),Ze={class:"VPDocAside"},nt=P({__name:"VPDocAside",setup(p){const{theme:n}=V();return(e,t)=>(s(),o("div",Ze,[_(e.$slots,"aside-top",{},void 0,!0),_(e.$slots,"aside-outline-before",{},void 0,!0),S(Ye),_(e.$slots,"aside-outline-after",{},void 0,!0),t[0]||(t[0]=i("div",{class:"spacer"},null,-1)),_(e.$slots,"aside-ads-before",{},void 0,!0),d(n).carbonAds?(s(),A(Qe,{key:0,"carbon-ads":d(n).carbonAds},null,8,["carbon-ads"])):k("",!0),_(e.$slots,"aside-ads-after",{},void 0,!0),_(e.$slots,"aside-bottom",{},void 0,!0)]))}}),pt=f(nt,[["__scopeId","data-v-3f215769"]]);function et(){const{theme:p,page:n}=V();return y(()=>{const{text:e="Edit this page",pattern:t=""}=p.value.editLink||{};let a;return typeof t=="function"?a=t(n.value):a=t.replace(/:path/g,n.value.filePath),{url:a,text:e}})}function tt(){const{page:p,theme:n,frontmatter:e}=V();return y(()=>{const t=Yn(n.value.sidebar,p.value.relativePath),a=Ce(t),r=at(a,v=>v.link.replace(/[?#].*$/,"")),l=r.findIndex(v=>X(p.value.relativePath,v.link)),c=n.value.docFooter?.prev===!1&&!e.value.prev||e.value.prev===!1,u=n.value.docFooter?.next===!1&&!e.value.next||e.value.next===!1;return{prev:c?void 0:{text:(typeof e.value.prev=="string"?e.value.prev:typeof e.value.prev=="object"?e.value.prev.text:void 0)??r[l-1]?.docFooterText??r[l-1]?.text,link:(typeof e.value.prev=="object"?e.value.prev.link:void 0)??r[l-1]?.link},next:u?void 0:{text:(typeof e.value.next=="string"?e.value.next:typeof e.value.next=="object"?e.value.next.text:void 0)??r[l+1]?.docFooterText??r[l+1]?.text,link:(typeof e.value.next=="object"?e.value.next.link:void 0)??r[l+1]?.link}}})}function at(p,n){const e=new Set;return p.filter(t=>{const a=n(t);return e.has(a)?!1:e.add(a)})}const G=P({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(p){const n=p,e=y(()=>n.tag??(n.href?"a":"span")),t=y(()=>n.href&&Fn.test(n.href)||n.target==="_blank");return(a,r)=>(s(),A(K(e.value),{class:I(["VPLink",{link:p.href,"vp-external-link-icon":t.value,"no-icon":p.noIcon}]),href:p.href?d(xn)(p.href):void 0,target:p.target??(t.value?"_blank":void 0),rel:p.rel??(t.value?"noreferrer":void 0)},{default:b(()=>[_(a.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),st={class:"VPLastUpdated"},rt=["datetime"],ot=P({__name:"VPDocFooterLastUpdated",setup(p){const{theme:n,page:e,lang:t}=V(),{language:a}=se(),r=ae("timeRef"),l=y(()=>new Date(e.value.lastUpdated)),c=y(()=>l.value.toISOString()),u=dn("");return J(()=>{cn(()=>{const v=n.value.lastUpdated?.formatOptions?.forceLocale?t.value:a.value;u.value=new Intl.DateTimeFormat(v,n.value.lastUpdated?.formatOptions??{dateStyle:"medium",timeStyle:"medium"}).format(l.value),v&&t.value!==v?r.value?.setAttribute("lang",v):r.value?.removeAttribute("lang")})}),(v,h)=>(s(),o("p",st,[z(C(d(n).lastUpdated?.text||d(n).lastUpdatedText||"Last updated")+": ",1),i("time",{ref_key:"timeRef",ref:r,datetime:c.value},C(u.value),9,rt)]))}}),it=f(ot,[["__scopeId","data-v-3c637f39"]]),lt={key:0,class:"VPDocFooter"},ct={key:0,class:"edit-info"},dt={key:0,class:"edit-link"},ut={key:1,class:"last-updated"},_t={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},ft={class:"pager"},mt=["innerHTML"],ht=["innerHTML"],vt={class:"pager"},bt=["innerHTML"],gt=["innerHTML"],$t=P({__name:"VPDocFooter",setup(p){const{theme:n,page:e,frontmatter:t}=V(),a=et(),r=tt(),l=y(()=>n.value.editLink&&t.value.editLink!==!1),c=y(()=>e.value.lastUpdated),u=y(()=>l.value||c.value||r.value.prev||r.value.next);return(v,h)=>u.value?(s(),o("footer",lt,[_(v.$slots,"doc-footer-before",{},void 0,!0),l.value||c.value?(s(),o("div",ct,[l.value?(s(),o("div",dt,[S(G,{class:"edit-link-button",href:d(a).url,"no-icon":!0},{default:b(()=>[h[0]||(h[0]=i("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),z(" "+C(d(a).text),1)]),_:1},8,["href"])])):k("",!0),c.value?(s(),o("div",ut,[S(it)])):k("",!0)])):k("",!0),d(r).prev?.link||d(r).next?.link?(s(),o("nav",_t,[h[1]||(h[1]=i("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),i("div",ft,[d(r).prev?.link?(s(),A(G,{key:0,class:"pager-link prev",href:d(r).prev.link},{default:b(()=>[i("span",{class:"desc",innerHTML:d(n).docFooter?.prev||"Previous page"},null,8,mt),i("span",{class:"title",innerHTML:d(r).prev.text},null,8,ht)]),_:1},8,["href"])):k("",!0)]),i("div",vt,[d(r).next?.link?(s(),A(G,{key:0,class:"pager-link next",href:d(r).next.link},{default:b(()=>[i("span",{class:"desc",innerHTML:d(n).docFooter?.next||"Next page"},null,8,bt),i("span",{class:"title",innerHTML:d(r).next.text},null,8,gt)]),_:1},8,["href"])):k("",!0)])])):k("",!0)])):k("",!0)}}),kt=f($t,[["__scopeId","data-v-e257564d"]]),Pt={class:"container"},Tt={class:"aside-container"},St={class:"aside-content"},yt={class:"content"},At={class:"content-container"},Nt={class:"main"},Ot=P({__name:"VPDoc",setup(p){const{theme:n}=V(),e=un(),{hasSidebar:t,hasAside:a,leftAside:r}=q(),l=y(()=>e.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(c,u)=>{const v=H("Content");return s(),o("div",{class:I(["VPDoc",{"has-sidebar":d(t),"has-aside":d(a)}])},[_(c.$slots,"doc-top",{},void 0,!0),i("div",Pt,[d(a)?(s(),o("div",{key:0,class:I(["aside",{"left-aside":d(r)}])},[u[0]||(u[0]=i("div",{class:"aside-curtain"},null,-1)),i("div",Tt,[i("div",St,[S(pt,null,{"aside-top":b(()=>[_(c.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":b(()=>[_(c.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":b(()=>[_(c.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":b(()=>[_(c.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":b(()=>[_(c.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":b(()=>[_(c.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):k("",!0),i("div",yt,[i("div",At,[_(c.$slots,"doc-before",{},void 0,!0),i("main",Nt,[S(v,{class:I(["vp-doc",[l.value,d(n).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),S(kt,null,{"doc-footer-before":b(()=>[_(c.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),_(c.$slots,"doc-after",{},void 0,!0)])])]),_(c.$slots,"doc-bottom",{},void 0,!0)],2)}}}),Bt=f(Ot,[["__scopeId","data-v-7011f0d8"]]),xt=P({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(p){const n=p,e=y(()=>n.href&&Fn.test(n.href)),t=y(()=>n.tag||(n.href?"a":"button"));return(a,r)=>(s(),A(K(t.value),{class:I(["VPButton",[p.size,p.theme]]),href:p.href?d(xn)(p.href):void 0,target:n.target??(e.value?"_blank":void 0),rel:n.rel??(e.value?"noreferrer":void 0)},{default:b(()=>[_(a.$slots,"default",{},()=>[z(C(p.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),Vt=f(xt,[["__scopeId","data-v-01bff58b"]]),Ct=["src","alt"],It=P({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(p){return(n,e)=>{const t=H("VPImage",!0);return p.image?(s(),o(L,{key:0},[typeof p.image=="string"||"src"in p.image?(s(),o("img",W({key:0,class:"VPImage"},typeof p.image=="string"?n.$attrs:{...p.image,...n.$attrs},{src:d(An)(typeof p.image=="string"?p.image:p.image.src),alt:p.alt??(typeof p.image=="string"?"":p.image.alt||"")}),null,16,Ct)):(s(),o(L,{key:1},[S(t,W({class:"dark",image:p.image.dark,alt:p.image.alt},n.$attrs),null,16,["image","alt"]),S(t,W({class:"light",image:p.image.light,alt:p.image.alt},n.$attrs),null,16,["image","alt"])],64))],64)):k("",!0)}}}),on=f(It,[["__scopeId","data-v-8426fc1a"]]),Lt={class:"container"},wt={class:"main"},jt={class:"heading"},Dt=["innerHTML"],Mt=["innerHTML"],Et=["innerHTML"],zt={key:0,class:"actions"},Rt={key:0,class:"image"},Jt={class:"image-container"},Ut=P({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(p){const{heroImageSlotExists:n}=_n(Qn);return(e,t)=>(s(),o("div",{class:I(["VPHero",{"has-image":p.image||d(n)}])},[i("div",Lt,[i("div",wt,[_(e.$slots,"home-hero-info-before",{},void 0,!0),_(e.$slots,"home-hero-info",{},()=>[i("h1",jt,[p.name?(s(),o("span",{key:0,innerHTML:p.name,class:"name clip"},null,8,Dt)):k("",!0),p.text?(s(),o("span",{key:1,innerHTML:p.text,class:"text"},null,8,Mt)):k("",!0)]),p.tagline?(s(),o("p",{key:0,innerHTML:p.tagline,class:"tagline"},null,8,Et)):k("",!0)],!0),_(e.$slots,"home-hero-info-after",{},void 0,!0),p.actions?(s(),o("div",zt,[(s(!0),o(L,null,R(p.actions,a=>(s(),o("div",{key:a.link,class:"action"},[S(Vt,{tag:"a",size:"medium",theme:a.theme,text:a.text,href:a.link,target:a.target,rel:a.rel},null,8,["theme","text","href","target","rel"])]))),128))])):k("",!0),_(e.$slots,"home-hero-actions-after",{},void 0,!0)]),p.image||d(n)?(s(),o("div",Rt,[i("div",Jt,[t[0]||(t[0]=i("div",{class:"image-bg"},null,-1)),_(e.$slots,"home-hero-image",{},()=>[p.image?(s(),A(on,{key:0,class:"image-src",image:p.image},null,8,["image"])):k("",!0)],!0)])])):k("",!0)])],2))}}),Ht=f(Ut,[["__scopeId","data-v-1e96e9e8"]]),Ft=P({__name:"VPHomeHero",setup(p){const{frontmatter:n}=V();return(e,t)=>d(n).hero?(s(),A(Ht,{key:0,class:"VPHomeHero",name:d(n).hero.name,text:d(n).hero.text,tagline:d(n).hero.tagline,image:d(n).hero.image,actions:d(n).hero.actions},{"home-hero-info-before":b(()=>[_(e.$slots,"home-hero-info-before")]),"home-hero-info":b(()=>[_(e.$slots,"home-hero-info")]),"home-hero-info-after":b(()=>[_(e.$slots,"home-hero-info-after")]),"home-hero-actions-after":b(()=>[_(e.$slots,"home-hero-actions-after")]),"home-hero-image":b(()=>[_(e.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):k("",!0)}}),Kt={class:"box"},Gt={key:0,class:"icon"},Wt=["innerHTML"],qt=["innerHTML"],Yt=["innerHTML"],Xt={key:4,class:"link-text"},Qt={class:"link-text-value"},Zt=P({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(p){return(n,e)=>(s(),A(G,{class:"VPFeature",href:p.link,rel:p.rel,target:p.target,"no-icon":!0,tag:p.link?"a":"div"},{default:b(()=>[i("article",Kt,[typeof p.icon=="object"&&p.icon.wrap?(s(),o("div",Gt,[S(on,{image:p.icon,alt:p.icon.alt,height:p.icon.height||48,width:p.icon.width||48},null,8,["image","alt","height","width"])])):typeof p.icon=="object"?(s(),A(on,{key:1,image:p.icon,alt:p.icon.alt,height:p.icon.height||48,width:p.icon.width||48},null,8,["image","alt","height","width"])):p.icon?(s(),o("div",{key:2,class:"icon",innerHTML:p.icon},null,8,Wt)):k("",!0),i("h2",{class:"title",innerHTML:p.title},null,8,qt),p.details?(s(),o("p",{key:3,class:"details",innerHTML:p.details},null,8,Yt)):k("",!0),p.linkText?(s(),o("div",Xt,[i("p",Qt,[z(C(p.linkText)+" ",1),e[0]||(e[0]=i("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):k("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),na=f(Zt,[["__scopeId","data-v-5219619b"]]),pa={key:0,class:"VPFeatures"},ea={class:"container"},ta={class:"items"},aa=P({__name:"VPFeatures",props:{features:{}},setup(p){const n=p,e=y(()=>{const t=n.features.length;if(t){if(t===2)return"grid-2";if(t===3)return"grid-3";if(t%3===0)return"grid-6";if(t>3)return"grid-4"}else return});return(t,a)=>p.features?(s(),o("div",pa,[i("div",ea,[i("div",ta,[(s(!0),o(L,null,R(p.features,r=>(s(),o("div",{key:r.title,class:I(["item",[e.value]])},[S(na,{icon:r.icon,title:r.title,details:r.details,link:r.link,"link-text":r.linkText,rel:r.rel,target:r.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):k("",!0)}}),sa=f(aa,[["__scopeId","data-v-a6181336"]]),ra=P({__name:"VPHomeFeatures",setup(p){const{frontmatter:n}=V();return(e,t)=>d(n).features?(s(),A(sa,{key:0,class:"VPHomeFeatures",features:d(n).features},null,8,["features"])):k("",!0)}}),oa=P({__name:"VPHomeContent",setup(p){const{width:n}=re({initialWidth:0,includeScrollbar:!1});return(e,t)=>(s(),o("div",{class:"vp-doc container",style:Kn(d(n)?{"--vp-offset":`calc(50% - ${d(n)/2}px)`}:{})},[_(e.$slots,"default",{},void 0,!0)],4))}}),ia=f(oa,[["__scopeId","data-v-8e2d4988"]]),la=P({__name:"VPHome",setup(p){const{frontmatter:n,theme:e}=V();return(t,a)=>{const r=H("Content");return s(),o("div",{class:I(["VPHome",{"external-link-icon-enabled":d(e).externalLinkIcon}])},[_(t.$slots,"home-hero-before",{},void 0,!0),S(Ft,null,{"home-hero-info-before":b(()=>[_(t.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":b(()=>[_(t.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":b(()=>[_(t.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":b(()=>[_(t.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":b(()=>[_(t.$slots,"home-hero-image",{},void 0,!0)]),_:3}),_(t.$slots,"home-hero-after",{},void 0,!0),_(t.$slots,"home-features-before",{},void 0,!0),S(ra),_(t.$slots,"home-features-after",{},void 0,!0),d(n).markdownStyles!==!1?(s(),A(ia,{key:0},{default:b(()=>[S(r)]),_:1})):(s(),A(r,{key:1}))],2)}}}),ca=f(la,[["__scopeId","data-v-8b561e3d"]]),da={},ua={class:"VPPage"};function _a(p,n){const e=H("Content");return s(),o("div",ua,[_(p.$slots,"page-top"),S(e),_(p.$slots,"page-bottom")])}const fa=f(da,[["render",_a]]),ma=P({__name:"VPContent",setup(p){const{page:n,frontmatter:e}=V(),{isHome:t,hasSidebar:a}=q();return(r,l)=>(s(),o("div",{class:I(["VPContent",{"has-sidebar":d(a),"is-home":d(t)}]),id:"VPContent"},[d(n).isNotFound?_(r.$slots,"not-found",{key:0},()=>[S(xe)],!0):d(e).layout==="page"?(s(),A(fa,{key:1},{"page-top":b(()=>[_(r.$slots,"page-top",{},void 0,!0)]),"page-bottom":b(()=>[_(r.$slots,"page-bottom",{},void 0,!0)]),_:3})):d(e).layout==="home"?(s(),A(ca,{key:2},{"home-hero-before":b(()=>[_(r.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":b(()=>[_(r.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":b(()=>[_(r.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":b(()=>[_(r.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":b(()=>[_(r.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":b(()=>[_(r.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":b(()=>[_(r.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":b(()=>[_(r.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":b(()=>[_(r.$slots,"home-features-after",{},void 0,!0)]),_:3})):d(e).layout&&d(e).layout!=="doc"?(s(),A(K(d(e).layout),{key:3})):(s(),A(Bt,{key:4},{"doc-top":b(()=>[_(r.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":b(()=>[_(r.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":b(()=>[_(r.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":b(()=>[_(r.$slots,"doc-before",{},void 0,!0)]),"doc-after":b(()=>[_(r.$slots,"doc-after",{},void 0,!0)]),"aside-top":b(()=>[_(r.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":b(()=>[_(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":b(()=>[_(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":b(()=>[_(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":b(()=>[_(r.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":b(()=>[_(r.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),ha=f(ma,[["__scopeId","data-v-c87f25bf"]]),va={class:"container"},ba=["innerHTML"],ga=["innerHTML"],$a=P({__name:"VPFooter",setup(p){const{theme:n,frontmatter:e}=V(),{hasSidebar:t}=q();return(a,r)=>d(n).footer&&d(e).footer!==!1?(s(),o("footer",{key:0,class:I(["VPFooter",{"has-sidebar":d(t)}])},[i("div",va,[d(n).footer.message?(s(),o("p",{key:0,class:"message",innerHTML:d(n).footer.message},null,8,ba)):k("",!0),d(n).footer.copyright?(s(),o("p",{key:1,class:"copyright",innerHTML:d(n).footer.copyright},null,8,ga)):k("",!0)])],2)):k("",!0)}}),ka=f($a,[["__scopeId","data-v-c3855bb3"]]),Pa={class:"menu-text"},Ta={class:"header"},Sa={class:"outline"},ya=P({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(p){const n=p,{theme:e}=V(),t=B(!1),a=B(0),r=B(),l=B();function c(m){r.value?.contains(m.target)||(t.value=!1)}U(t,m=>{if(m){document.addEventListener("click",c);return}document.removeEventListener("click",c)}),bn("Escape",()=>{t.value=!1}),Hn(()=>{t.value=!1});function u(){t.value=!t.value,a.value=window.innerHeight+Math.min(window.scrollY-n.navHeight,0)}function v(m){m.target.classList.contains("outline-link")&&(l.value&&(l.value.style.transition="none"),rn(()=>{t.value=!1}))}function h(){t.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(m,g)=>(s(),o("div",{class:"VPLocalNavOutlineDropdown",style:Kn({"--vp-vh":a.value+"px"}),ref_key:"main",ref:r},[p.headers.length>0?(s(),o("button",{key:0,onClick:u,class:I({open:t.value})},[i("span",Pa,C(d(Xn)(d(e))),1),g[0]||(g[0]=i("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(s(),o("button",{key:1,onClick:h},C(d(e).returnToTopLabel||"Return to top"),1)),S(ln,{name:"flyout"},{default:b(()=>[t.value?(s(),o("div",{key:0,ref_key:"items",ref:l,class:"items",onClick:v},[i("div",Ta,[i("a",{class:"top-link",href:"#",onClick:h},C(d(e).returnToTopLabel||"Return to top"),1)]),i("div",Sa,[S(Zn,{headers:p.headers},null,8,["headers"])])],512)):k("",!0)]),_:1})],4))}}),Aa=f(ya,[["__scopeId","data-v-0bf0e06f"]]),Na={class:"container"},Oa=["aria-expanded"],Ba={class:"menu-text"},xa=P({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(p){const{theme:n}=V(),{isHome:e,hasSidebar:t,headers:a,hasLocalNav:r}=q(),{y:l}=Gn(),c=B(0);J(()=>{c.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const u=y(()=>({VPLocalNav:!0,"has-sidebar":t.value,empty:!r.value,fixed:!r.value&&!t.value}));return(v,h)=>!d(e)&&(d(r)||d(t)||d(l)>=c.value)?(s(),o("div",{key:0,class:I(u.value)},[i("div",Na,[d(t)?(s(),o("button",{key:0,class:"menu","aria-expanded":p.open,"aria-controls":"VPSidebarNav",onClick:h[0]||(h[0]=m=>v.$emit("open-menu"))},[h[1]||(h[1]=i("span",{class:"vpi-align-left menu-icon"},null,-1)),i("span",Ba,C(d(n).sidebarMenuLabel||"Menu"),1)],8,Oa)):k("",!0),S(Aa,{headers:d(a),navHeight:c.value},null,8,["headers","navHeight"])])],2)):k("",!0)}}),Va=f(xa,[["__scopeId","data-v-db738f89"]]);function Ca(){const p=B(!1);function n(){p.value=!0,window.addEventListener("resize",a)}function e(){p.value=!1,window.removeEventListener("resize",a)}function t(){p.value?e():n()}function a(){window.outerWidth>=768&&e()}const r=un();return U(()=>r.path,e),{isScreenOpen:p,openScreen:n,closeScreen:e,toggleScreen:t}}const Vn=Symbol("nav"),Ia={},La={class:"VPSwitch",type:"button",role:"switch"},wa={class:"check"},ja={key:0,class:"icon"};function Da(p,n){return s(),o("button",La,[i("span",wa,[p.$slots.default?(s(),o("span",ja,[_(p.$slots,"default",{},void 0,!0)])):k("",!0)])])}const Ma=f(Ia,[["render",Da],["__scopeId","data-v-1d5665e3"]]),Ea=P({__name:"VPSwitchAppearance",setup(p){const{isDark:n,theme:e}=V(),t=_n("toggle-appearance",()=>{n.value=!n.value}),a=B("");return On(()=>{a.value=n.value?e.value.lightModeSwitchTitle||"Switch to light theme":e.value.darkModeSwitchTitle||"Switch to dark theme"}),(r,l)=>(s(),A(Ma,{title:a.value,class:"VPSwitchAppearance","aria-checked":d(n),onClick:d(t)},{default:b(()=>[...l[0]||(l[0]=[i("span",{class:"vpi-sun sun"},null,-1),i("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Cn=f(Ea,[["__scopeId","data-v-5337faa4"]]),za={key:0,class:"VPNavBarAppearance"},Ra=P({__name:"VPNavBarAppearance",setup(p){const{site:n}=V();return(e,t)=>d(n).appearance&&d(n).appearance!=="force-dark"&&d(n).appearance!=="force-auto"?(s(),o("div",za,[S(Cn)])):k("",!0)}}),Ja=f(Ra,[["__scopeId","data-v-6c893767"]]),In=B();let np=!1,hn=0;function Ua(p){const n=B(!1);if(en){!np&&Ha(),hn++;const e=U(In,t=>{t===p.el.value||p.el.value?.contains(t)?(n.value=!0,p.onFocus?.()):(n.value=!1,p.onBlur?.())});Nn(()=>{e(),hn--,hn||Fa()})}return oe(n)}function Ha(){document.addEventListener("focusin",pp),np=!0,In.value=document.activeElement}function Fa(){document.removeEventListener("focusin",pp)}function pp(){In.value=document.activeElement}const Ka={class:"VPMenuLink"},Ga=["innerHTML"],Wa=P({inheritAttrs:!1,__name:"VPMenuLink",props:{item:{}},setup(p){const n=p,{page:e}=V(),t=y(()=>typeof n.item.link=="function"?n.item.link(e.value):n.item.link);return(a,r)=>(s(),o("div",Ka,[S(G,W(a.$attrs,{class:{active:d(X)(d(e).relativePath,p.item.activeMatch||t.value,!!p.item.activeMatch)},href:t.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon}),{default:b(()=>[i("span",{innerHTML:p.item.text},null,8,Ga)]),_:1},16,["class","href","target","rel","no-icon"])]))}}),fn=f(Wa,[["__scopeId","data-v-faf5b206"]]),qa={class:"VPMenuGroup"},Ya={key:0,class:"title"},Xa=P({__name:"VPMenuGroup",props:{text:{},items:{}},setup(p){return(n,e)=>(s(),o("div",qa,[p.text?(s(),o("p",Ya,C(p.text),1)):k("",!0),(s(!0),o(L,null,R(p.items,t=>(s(),o(L,{key:JSON.stringify(t)},["link"in t?(s(),A(fn,{key:0,item:t},null,8,["item"])):k("",!0)],64))),128))]))}}),Qa=f(Xa,[["__scopeId","data-v-1963e1bb"]]),Za={class:"VPMenu"},ns={key:0,class:"items"},ps=P({__name:"VPMenu",props:{items:{}},setup(p){return(n,e)=>(s(),o("div",Za,[p.items?(s(),o("div",ns,[(s(!0),o(L,null,R(p.items,t=>(s(),o(L,{key:JSON.stringify(t)},["link"in t?(s(),A(fn,{key:0,item:t},null,8,["item"])):"component"in t?(s(),A(K(t.component),W({key:1,ref_for:!0},t.props),null,16)):(s(),A(Qa,{key:2,text:t.text,items:t.items},null,8,["text","items"]))],64))),128))])):k("",!0),_(n.$slots,"default",{},void 0,!0)]))}}),es=f(ps,[["__scopeId","data-v-25a6cce8"]]),ts=["aria-expanded","aria-label"],as={key:0,class:"text"},ss=["innerHTML"],rs={key:1,class:"vpi-more-horizontal icon"},os={class:"menu"},is=P({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(p){const n=B(!1),e=B();Ua({el:e,onBlur:t});function t(){n.value=!1}return(a,r)=>(s(),o("div",{class:"VPFlyout",ref_key:"el",ref:e,onMouseenter:r[1]||(r[1]=l=>n.value=!0),onMouseleave:r[2]||(r[2]=l=>n.value=!1)},[i("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":n.value,"aria-label":p.label,onClick:r[0]||(r[0]=l=>n.value=!n.value)},[p.button||p.icon?(s(),o("span",as,[p.icon?(s(),o("span",{key:0,class:I([p.icon,"option-icon"])},null,2)):k("",!0),p.button?(s(),o("span",{key:1,innerHTML:p.button},null,8,ss)):k("",!0),r[3]||(r[3]=i("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(s(),o("span",rs))],8,ts),i("div",os,[S(es,{items:p.items},{default:b(()=>[_(a.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Ln=f(is,[["__scopeId","data-v-42cb505d"]]),ls=["href","aria-label","rel","innerHTML"],cs=P({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(p){const n=p,e=B();J(async()=>{await rn();const a=e.value?.children[0];a instanceof HTMLElement&&a.className.startsWith("vpi-social-")&&(getComputedStyle(a).maskImage||getComputedStyle(a).webkitMaskImage)==="none"&&a.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${n.icon}.svg')`)});const t=y(()=>typeof n.icon=="object"?n.icon.svg:`<span class="vpi-social-${n.icon}"></span>`);return(a,r)=>(s(),o("a",{ref_key:"el",ref:e,class:"VPSocialLink no-icon",href:p.link,"aria-label":p.ariaLabel??(typeof p.icon=="string"?p.icon:""),target:"_blank",rel:p.me?"me noopener":"noopener",innerHTML:t.value},null,8,ls))}}),ds=f(cs,[["__scopeId","data-v-591a6b30"]]),us={class:"VPSocialLinks"},_s=P({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(p){return(n,e)=>(s(),o("div",us,[(s(!0),o(L,null,R(p.links,({link:t,icon:a,ariaLabel:r})=>(s(),A(ds,{key:t,icon:a,link:t,ariaLabel:r,me:p.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),wn=f(_s,[["__scopeId","data-v-d07f11e6"]]),fs={key:0,class:"group translations"},ms={class:"trans-title"},hs={key:1,class:"group"},vs={class:"item appearance"},bs={class:"label"},gs={class:"appearance-action"},$s={key:2,class:"group"},ks={class:"item social-links"},Ps=P({__name:"VPNavBarExtra",setup(p){const{site:n,theme:e}=V(),{localeLinks:t,currentLang:a}=tn({correspondingLink:!0}),r=y(()=>t.value.length&&a.value.label||n.value.appearance||e.value.socialLinks);return(l,c)=>r.value?(s(),A(Ln,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:b(()=>[d(t).length&&d(a).label?(s(),o("div",fs,[i("p",ms,C(d(a).label),1),(s(!0),o(L,null,R(d(t),u=>(s(),A(fn,{key:u.link,item:u,lang:u.lang,dir:u.dir},null,8,["item","lang","dir"]))),128))])):k("",!0),d(n).appearance&&d(n).appearance!=="force-dark"&&d(n).appearance!=="force-auto"?(s(),o("div",hs,[i("div",vs,[i("p",bs,C(d(e).darkModeSwitchLabel||"Appearance"),1),i("div",gs,[S(Cn)])])])):k("",!0),d(e).socialLinks?(s(),o("div",$s,[i("div",ks,[S(wn,{class:"social-links-list",links:d(e).socialLinks},null,8,["links"])])])):k("",!0)]),_:1})):k("",!0)}}),Ts=f(Ps,[["__scopeId","data-v-bf2fac68"]]),Ss=["aria-expanded"],ys=P({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(p){return(n,e)=>(s(),o("button",{type:"button",class:I(["VPNavBarHamburger",{active:p.active}]),"aria-label":"mobile navigation","aria-expanded":p.active,"aria-controls":"VPNavScreen",onClick:e[0]||(e[0]=t=>n.$emit("click"))},[...e[1]||(e[1]=[i("span",{class:"container"},[i("span",{class:"top"}),i("span",{class:"middle"}),i("span",{class:"bottom"})],-1)])],10,Ss))}}),As=f(ys,[["__scopeId","data-v-e5dd9c1c"]]),Ns=["innerHTML"],Os=P({__name:"VPNavBarMenuLink",props:{item:{}},setup(p){const n=p,{page:e}=V(),t=y(()=>typeof n.item.link=="function"?n.item.link(e.value):n.item.link);return(a,r)=>(s(),A(G,{class:I({VPNavBarMenuLink:!0,active:d(X)(d(e).relativePath,p.item.activeMatch||t.value,!!p.item.activeMatch)}),href:t.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,tabindex:"0"},{default:b(()=>[i("span",{innerHTML:p.item.text},null,8,Ns)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Bs=f(Os,[["__scopeId","data-v-52a1d768"]]),xs=P({__name:"VPNavBarMenuGroup",props:{item:{}},setup(p){const n=p,{page:e}=V(),t=r=>"component"in r?!1:"link"in r?X(e.value.relativePath,typeof r.link=="function"?r.link(e.value):r.link,!!n.item.activeMatch):r.items.some(t),a=y(()=>t(n.item));return(r,l)=>(s(),A(Ln,{class:I({VPNavBarMenuGroup:!0,active:d(X)(d(e).relativePath,p.item.activeMatch,!!p.item.activeMatch)||a.value}),button:p.item.text,items:p.item.items},null,8,["class","button","items"]))}}),Vs={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Cs=P({__name:"VPNavBarMenu",setup(p){const{theme:n}=V();return(e,t)=>d(n).nav?(s(),o("nav",Vs,[t[0]||(t[0]=i("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(s(!0),o(L,null,R(d(n).nav,a=>(s(),o(L,{key:JSON.stringify(a)},["link"in a?(s(),A(Bs,{key:0,item:a},null,8,["item"])):"component"in a?(s(),A(K(a.component),W({key:1,ref_for:!0},a.props),null,16)):(s(),A(xs,{key:2,item:a},null,8,["item"]))],64))),128))])):k("",!0)}}),Is=f(Cs,[["__scopeId","data-v-39714824"]]);function Ls(p){const{localeIndex:n,theme:e}=V();function t(a){const r=a.split("."),l=e.value.search?.options,c=l&&typeof l=="object",u=c&&l.locales?.[n.value]?.translations||null,v=c&&l.translations||null;let h=u,m=v,g=p;const $=r.pop();for(const N of r){let T=null;const x=g?.[N];x&&(T=g=x);const j=m?.[N];j&&(T=m=j);const w=h?.[N];w&&(T=h=w),x||(g=T),j||(m=T),w||(h=T)}return h?.[$]??m?.[$]??g?.[$]??""}return t}const ws=["aria-label"],js={class:"DocSearch-Button-Container"},Ds={class:"DocSearch-Button-Placeholder"},Mn=P({__name:"VPNavBarSearchButton",setup(p){const e=Ls({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(t,a)=>(s(),o("button",{type:"button","aria-label":d(e)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[i("span",js,[a[0]||(a[0]=i("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),i("span",Ds,C(d(e)("button.buttonText")),1)]),a[1]||(a[1]=i("span",{class:"DocSearch-Button-Keys"},[i("kbd",{class:"DocSearch-Button-Key"}),i("kbd",{class:"DocSearch-Button-Key"})],-1))],8,ws))}}),Ms={class:"VPNavBarSearch"},Es={id:"local-search"},zs={key:1,id:"docsearch"},Rs=P({__name:"VPNavBarSearch",setup(p){const n=ie(()=>le(()=>import("./chunks/VPLocalSearchBox.CiKXl0r0.js"),__vite__mapDeps([0,1]))),e=()=>null,{theme:t}=V(),a=B(!1),r=B(!1);J(()=>{});function l(){a.value||(a.value=!0,setTimeout(c,16))}function c(){const m=new Event("keydown");m.key="k",m.metaKey=!0,window.dispatchEvent(m),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||c()},16)}function u(m){const g=m.target,$=g.tagName;return g.isContentEditable||$==="INPUT"||$==="SELECT"||$==="TEXTAREA"}const v=B(!1);bn("k",m=>{(m.ctrlKey||m.metaKey)&&(m.preventDefault(),v.value=!0)}),bn("/",m=>{u(m)||(m.preventDefault(),v.value=!0)});const h="local";return(m,g)=>(s(),o("div",Ms,[d(h)==="local"?(s(),o(L,{key:0},[v.value?(s(),A(d(n),{key:0,onClose:g[0]||(g[0]=$=>v.value=!1)})):k("",!0),i("div",Es,[S(Mn,{onClick:g[1]||(g[1]=$=>v.value=!0)})])],64)):d(h)==="algolia"?(s(),o(L,{key:1},[a.value?(s(),A(d(e),{key:0,algolia:d(t).search?.options??d(t).algolia,onVnodeBeforeMount:g[2]||(g[2]=$=>r.value=!0)},null,8,["algolia"])):k("",!0),r.value?k("",!0):(s(),o("div",zs,[S(Mn,{onClick:l})]))],64)):k("",!0)]))}}),Js=P({__name:"VPNavBarSocialLinks",setup(p){const{theme:n}=V();return(e,t)=>d(n).socialLinks?(s(),A(wn,{key:0,class:"VPNavBarSocialLinks",links:d(n).socialLinks},null,8,["links"])):k("",!0)}}),Us=f(Js,[["__scopeId","data-v-0394ad82"]]),Hs=["href","rel","target"],Fs=["innerHTML"],Ks={key:2},Gs=P({__name:"VPNavBarTitle",setup(p){const{site:n,theme:e}=V(),{hasSidebar:t}=q(),{currentLang:a}=tn(),r=y(()=>typeof e.value.logoLink=="string"?e.value.logoLink:e.value.logoLink?.link),l=y(()=>typeof e.value.logoLink=="string"?void 0:e.value.logoLink?.rel),c=y(()=>typeof e.value.logoLink=="string"?void 0:e.value.logoLink?.target);return(u,v)=>(s(),o("div",{class:I(["VPNavBarTitle",{"has-sidebar":d(t)}])},[i("a",{class:"title",href:r.value??d(xn)(d(a).link),rel:l.value,target:c.value},[_(u.$slots,"nav-bar-title-before",{},void 0,!0),d(e).logo?(s(),A(on,{key:0,class:"logo",image:d(e).logo},null,8,["image"])):k("",!0),d(e).siteTitle?(s(),o("span",{key:1,innerHTML:d(e).siteTitle},null,8,Fs)):d(e).siteTitle===void 0?(s(),o("span",Ks,C(d(n).title),1)):k("",!0),_(u.$slots,"nav-bar-title-after",{},void 0,!0)],8,Hs)],2))}}),Ws=f(Gs,[["__scopeId","data-v-1e38c6bc"]]),qs={class:"items"},Ys={class:"title"},Xs=P({__name:"VPNavBarTranslations",setup(p){const{theme:n}=V(),{localeLinks:e,currentLang:t}=tn({correspondingLink:!0});return(a,r)=>d(e).length&&d(t).label?(s(),A(Ln,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:d(n).langMenuLabel||"Change language"},{default:b(()=>[i("div",qs,[i("p",Ys,C(d(t).label),1),(s(!0),o(L,null,R(d(e),l=>(s(),A(fn,{key:l.link,item:l,lang:l.lang,dir:l.dir},null,8,["item","lang","dir"]))),128))])]),_:1},8,["label"])):k("",!0)}}),Qs=f(Xs,[["__scopeId","data-v-4c1766e2"]]),Zs={class:"wrapper"},nr={class:"container"},pr={class:"title"},er={class:"content"},tr={class:"content-body"},ar=P({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(p){const n=p,{y:e}=Gn(),{isHome:t,hasSidebar:a}=q(),r=B({});return On(()=>{r.value={"has-sidebar":a.value,home:t.value,top:e.value===0,"screen-open":n.isScreenOpen}}),(l,c)=>(s(),o("div",{class:I(["VPNavBar",r.value])},[i("div",Zs,[i("div",nr,[i("div",pr,[S(Ws,null,{"nav-bar-title-before":b(()=>[_(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":b(()=>[_(l.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),i("div",er,[i("div",tr,[_(l.$slots,"nav-bar-content-before",{},void 0,!0),S(Rs,{class:"search"}),S(Is,{class:"menu"}),S(Qs,{class:"translations"}),S(Ja,{class:"appearance"}),S(Us,{class:"social-links"}),S(Ts,{class:"extra"}),_(l.$slots,"nav-bar-content-after",{},void 0,!0),S(As,{class:"hamburger",active:p.isScreenOpen,onClick:c[0]||(c[0]=u=>l.$emit("toggle-screen"))},null,8,["active"])])])])]),c[1]||(c[1]=i("div",{class:"divider"},[i("div",{class:"divider-line"})],-1))],2))}}),sr=f(ar,[["__scopeId","data-v-70946a35"]]),rr={key:0,class:"VPNavScreenAppearance"},or={class:"text"},ir=P({__name:"VPNavScreenAppearance",setup(p){const{site:n,theme:e}=V();return(t,a)=>d(n).appearance&&d(n).appearance!=="force-dark"&&d(n).appearance!=="force-auto"?(s(),o("div",rr,[i("p",or,C(d(e).darkModeSwitchLabel||"Appearance"),1),S(Cn)])):k("",!0)}}),lr=f(ir,[["__scopeId","data-v-b44890b2"]]),cr=["innerHTML"],dr=P({__name:"VPNavScreenMenuLink",props:{item:{}},setup(p){const n=p,{page:e}=V(),t=y(()=>typeof n.item.link=="function"?n.item.link(e.value):n.item.link),{closeScreen:a}=_n(Vn);return(r,l)=>(s(),A(G,{class:"VPNavScreenMenuLink",href:t.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,onClick:d(a)},{default:b(()=>[i("span",{innerHTML:p.item.text},null,8,cr)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),ur=f(dr,[["__scopeId","data-v-7d55a1c1"]]),_r=["innerHTML"],fr=P({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(p){const n=p,{page:e}=V(),t=y(()=>typeof n.item.link=="function"?n.item.link(e.value):n.item.link),{closeScreen:a}=_n(Vn);return(r,l)=>(s(),A(G,{class:"VPNavScreenMenuGroupLink",href:t.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,onClick:d(a)},{default:b(()=>[i("span",{innerHTML:p.item.text},null,8,_r)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),ep=f(fr,[["__scopeId","data-v-49e5ec9f"]]),mr={class:"VPNavScreenMenuGroupSection"},hr={key:0,class:"title"},vr=P({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(p){return(n,e)=>(s(),o("div",mr,[p.text?(s(),o("p",hr,C(p.text),1)):k("",!0),(s(!0),o(L,null,R(p.items,t=>(s(),A(ep,{key:t.text,item:t},null,8,["item"]))),128))]))}}),br=f(vr,[["__scopeId","data-v-4b7a798b"]]),gr=["aria-controls","aria-expanded"],$r=["innerHTML"],kr=["id"],Pr={key:0,class:"item"},Tr={key:1,class:"item"},Sr={key:2,class:"group"},yr=P({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(p){const n=p,e=B(!1),t=y(()=>`NavScreenGroup-${n.text.replace(" ","-").toLowerCase()}`);function a(){e.value=!e.value}return(r,l)=>(s(),o("div",{class:I(["VPNavScreenMenuGroup",{open:e.value}])},[i("button",{class:"button","aria-controls":t.value,"aria-expanded":e.value,onClick:a},[i("span",{class:"button-text",innerHTML:p.text},null,8,$r),l[0]||(l[0]=i("span",{class:"vpi-plus button-icon"},null,-1))],8,gr),i("div",{id:t.value,class:"items"},[(s(!0),o(L,null,R(p.items,c=>(s(),o(L,{key:JSON.stringify(c)},["link"in c?(s(),o("div",Pr,[S(ep,{item:c},null,8,["item"])])):"component"in c?(s(),o("div",Tr,[(s(),A(K(c.component),W({ref_for:!0},c.props,{"screen-menu":""}),null,16))])):(s(),o("div",Sr,[S(br,{text:c.text,items:c.items},null,8,["text","items"])]))],64))),128))],8,kr)],2))}}),Ar=f(yr,[["__scopeId","data-v-956364f9"]]),Nr={key:0,class:"VPNavScreenMenu"},Or=P({__name:"VPNavScreenMenu",setup(p){const{theme:n}=V();return(e,t)=>d(n).nav?(s(),o("nav",Nr,[(s(!0),o(L,null,R(d(n).nav,a=>(s(),o(L,{key:JSON.stringify(a)},["link"in a?(s(),A(ur,{key:0,item:a},null,8,["item"])):"component"in a?(s(),A(K(a.component),W({key:1,ref_for:!0},a.props,{"screen-menu":""}),null,16)):(s(),A(Ar,{key:2,text:a.text||"",items:a.items},null,8,["text","items"]))],64))),128))])):k("",!0)}}),Br=P({__name:"VPNavScreenSocialLinks",setup(p){const{theme:n}=V();return(e,t)=>d(n).socialLinks?(s(),A(wn,{key:0,class:"VPNavScreenSocialLinks",links:d(n).socialLinks},null,8,["links"])):k("",!0)}}),xr={class:"list"},Vr=P({__name:"VPNavScreenTranslations",setup(p){const{localeLinks:n,currentLang:e}=tn({correspondingLink:!0}),t=B(!1);function a(){t.value=!t.value}return(r,l)=>d(n).length&&d(e).label?(s(),o("div",{key:0,class:I(["VPNavScreenTranslations",{open:t.value}])},[i("button",{class:"title",onClick:a},[l[0]||(l[0]=i("span",{class:"vpi-languages icon lang"},null,-1)),z(" "+C(d(e).label)+" ",1),l[1]||(l[1]=i("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),i("ul",xr,[(s(!0),o(L,null,R(d(n),c=>(s(),o("li",{key:c.link,class:"item"},[S(G,{class:"link",href:c.link,lang:c.lang,dir:c.dir},{default:b(()=>[z(C(c.text),1)]),_:2},1032,["href","lang","dir"])]))),128))])],2)):k("",!0)}}),Cr=f(Vr,[["__scopeId","data-v-a4d9b172"]]),Ir={class:"container"},Lr=P({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(p){const n=B(null),e=Wn(en?document.body:null);return(t,a)=>(s(),A(ln,{name:"fade",onEnter:a[0]||(a[0]=r=>e.value=!0),onAfterLeave:a[1]||(a[1]=r=>e.value=!1)},{default:b(()=>[p.open?(s(),o("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:n,id:"VPNavScreen"},[i("div",Ir,[_(t.$slots,"nav-screen-content-before",{},void 0,!0),S(Or,{class:"menu"}),S(Cr,{class:"translations"}),S(lr,{class:"appearance"}),S(Br,{class:"social-links"}),_(t.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):k("",!0)]),_:3}))}}),wr=f(Lr,[["__scopeId","data-v-f2779853"]]),jr={key:0,class:"VPNav"},Dr=P({__name:"VPNav",setup(p){const{isScreenOpen:n,closeScreen:e,toggleScreen:t}=Ca(),{frontmatter:a}=V(),r=y(()=>a.value.navbar!==!1);return qn(Vn,{closeScreen:e}),cn(()=>{en&&document.documentElement.classList.toggle("hide-nav",!r.value)}),(l,c)=>r.value?(s(),o("header",jr,[S(sr,{"is-screen-open":d(n),onToggleScreen:d(t)},{"nav-bar-title-before":b(()=>[_(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":b(()=>[_(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":b(()=>[_(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":b(()=>[_(l.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),S(wr,{open:d(n)},{"nav-screen-content-before":b(()=>[_(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":b(()=>[_(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):k("",!0)}}),Mr=f(Dr,[["__scopeId","data-v-da52a441"]]),Er=["role","tabindex"],zr={key:1,class:"items"},Rr=P({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(p){const n=p,{collapsed:e,collapsible:t,isLink:a,isActiveLink:r,hasActiveLink:l,hasChildren:c,toggle:u}=Ue(y(()=>n.item)),v=y(()=>c.value?"section":"div"),h=y(()=>a.value?"a":"div"),m=y(()=>c.value?n.depth+2===7?"p":`h${n.depth+2}`:"p"),g=y(()=>a.value?void 0:"button"),$=y(()=>[[`level-${n.depth}`],{collapsible:t.value},{collapsed:e.value},{"is-link":a.value},{"is-active":r.value},{"has-active":l.value}]);function N(x){"key"in x&&x.key!=="Enter"||!n.item.link&&u()}function T(){n.item.link&&u()}return(x,j)=>{const w=H("VPSidebarItem",!0);return s(),A(K(v.value),{class:I(["VPSidebarItem",$.value])},{default:b(()=>[p.item.text?(s(),o("div",W({key:0,class:"item",role:g.value},ce(p.item.items?{click:N,keydown:N}:{},!0),{tabindex:p.item.items&&0}),[j[1]||(j[1]=i("div",{class:"indicator"},null,-1)),p.item.link?(s(),A(G,{key:0,tag:h.value,class:"link",href:p.item.link,rel:p.item.rel,target:p.item.target},{default:b(()=>[(s(),A(K(m.value),{class:"text",innerHTML:p.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(s(),A(K(m.value),{key:1,class:"text",innerHTML:p.item.text},null,8,["innerHTML"])),p.item.collapsed!=null&&p.item.items&&p.item.items.length?(s(),o("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:T,onKeydown:de(T,["enter"]),tabindex:"0"},[...j[0]||(j[0]=[i("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):k("",!0)],16,Er)):k("",!0),p.item.items&&p.item.items.length?(s(),o("div",zr,[p.depth<5?(s(!0),o(L,{key:0},R(p.item.items,D=>(s(),A(w,{key:D.text,item:D,depth:p.depth+1},null,8,["item","depth"]))),128)):k("",!0)])):k("",!0)]),_:1},8,["class"])}}}),Jr=f(Rr,[["__scopeId","data-v-d81de50c"]]),Ur=P({__name:"VPSidebarGroup",props:{items:{}},setup(p){const n=B(!0);let e=null;return J(()=>{e=setTimeout(()=>{e=null,n.value=!1},300)}),Z(()=>{e!=null&&(clearTimeout(e),e=null)}),(t,a)=>(s(!0),o(L,null,R(p.items,r=>(s(),o("div",{key:r.text,class:I(["group",{"no-transition":n.value}])},[S(Jr,{item:r,depth:0},null,8,["item"])],2))),128))}}),Hr=f(Ur,[["__scopeId","data-v-8d50c081"]]),Fr={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Kr=P({__name:"VPSidebar",props:{open:{type:Boolean}},setup(p){const{sidebarGroups:n,hasSidebar:e}=q(),t=p,a=B(null),r=Wn(en?document.body:null);U([t,a],()=>{t.open?(r.value=!0,a.value?.focus()):r.value=!1},{immediate:!0,flush:"post"});const l=B(0);return U(n,()=>{l.value+=1},{deep:!0}),(c,u)=>d(e)?(s(),o("aside",{key:0,class:I(["VPSidebar",{open:p.open}]),ref_key:"navEl",ref:a,onClick:u[0]||(u[0]=ue(()=>{},["stop"]))},[u[2]||(u[2]=i("div",{class:"curtain"},null,-1)),i("nav",Fr,[u[1]||(u[1]=i("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),_(c.$slots,"sidebar-nav-before",{},void 0,!0),(s(),A(Hr,{items:d(n),key:l.value},null,8,["items"])),_(c.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):k("",!0)}}),Gr=f(Kr,[["__scopeId","data-v-af661f50"]]),Wr={href:"#VPContent",class:"VPSkipLink visually-hidden"},qr=P({__name:"VPSkipLink",setup(p){const{theme:n}=V(),e=un(),t=B();return U(()=>e.path,()=>t.value.focus()),(a,r)=>(s(),o(L,null,[i("span",{ref_key:"backToTop",ref:t,tabindex:"-1"},null,512),i("a",Wr,C(d(n).skipToContentLabel||"Skip to content"),1)],64))}}),Yr=f(qr,[["__scopeId","data-v-331ec75c"]]),Xr=P({__name:"Layout",setup(p){const{isOpen:n,open:e,close:t}=Je();He({closeSidebar:t});const{frontmatter:a}=V(),r=_e(),l=y(()=>!!r["home-hero-image"]);return qn(Qn,{heroImageSlotExists:l}),(c,u)=>{const v=H("Content");return d(a).layout!==!1?(s(),o("div",{key:0,class:I(["Layout",d(a).pageClass])},[_(c.$slots,"layout-top",{},void 0,!0),S(Yr),S($e,{class:"backdrop",show:d(n),onClick:d(t)},null,8,["show","onClick"]),S(Mr,null,{"nav-bar-title-before":b(()=>[_(c.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":b(()=>[_(c.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":b(()=>[_(c.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":b(()=>[_(c.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":b(()=>[_(c.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":b(()=>[_(c.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),S(Va,{open:d(n),onOpenMenu:d(e)},null,8,["open","onOpenMenu"]),S(Gr,{open:d(n)},{"sidebar-nav-before":b(()=>[_(c.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":b(()=>[_(c.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),S(ha,null,{"page-top":b(()=>[_(c.$slots,"page-top",{},void 0,!0)]),"page-bottom":b(()=>[_(c.$slots,"page-bottom",{},void 0,!0)]),"not-found":b(()=>[_(c.$slots,"not-found",{},void 0,!0)]),"home-hero-before":b(()=>[_(c.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":b(()=>[_(c.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":b(()=>[_(c.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":b(()=>[_(c.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":b(()=>[_(c.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":b(()=>[_(c.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":b(()=>[_(c.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":b(()=>[_(c.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":b(()=>[_(c.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":b(()=>[_(c.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":b(()=>[_(c.$slots,"doc-before",{},void 0,!0)]),"doc-after":b(()=>[_(c.$slots,"doc-after",{},void 0,!0)]),"doc-top":b(()=>[_(c.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":b(()=>[_(c.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":b(()=>[_(c.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":b(()=>[_(c.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":b(()=>[_(c.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":b(()=>[_(c.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":b(()=>[_(c.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":b(()=>[_(c.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),S(ka),_(c.$slots,"layout-bottom",{},void 0,!0)],2)):(s(),A(v,{key:1}))}}}),Qr=f(Xr,[["__scopeId","data-v-1df9f90f"]]),tp={Layout:Qr,enhanceApp:({app:p})=>{p.component("Badge",ve)}},En="age_verified",Zr=365,no=P({__name:"AgeWarning",setup(p){const n=B(!1),e=B(!1);function t(c,u,v){const h=new Date;h.setTime(h.getTime()+v*24*60*60*1e3);const m=`expires=${h.toUTCString()}`;document.cookie=`${c}=${u};${m};path=/;SameSite=Strict`}function a(c){const u=c+"=",v=document.cookie.split(";");for(let h=0;h<v.length;h++){let m=v[h];for(;m.charAt(0)===" ";)m=m.substring(1,m.length);if(m.indexOf(u)===0)return m.substring(u.length,m.length)}return null}function r(){e.value=!0,setTimeout(()=>{n.value=!1,e.value=!1},300),t(En,"true",Zr)}function l(){window.location.href="https://tv.cctv.com/2013/09/02/VIDE1378113141436780.shtml"}return J(()=>{a(En)||(n.value=!0)}),(c,u)=>(s(),A(fe,{to:"body"},[n.value?(s(),o("div",{key:0,class:I(["age-warning-overlay",{"fade-out":e.value}])},[i("div",{class:"age-warning-modal"},[u[0]||(u[0]=i("div",{class:"warning-icon"},"🔞",-1)),u[1]||(u[1]=i("h2",null,"未成年人禁止入内",-1)),u[2]||(u[2]=i("p",null,"本站包含成人内容，仅限18岁及以上人士访问。",-1)),u[3]||(u[3]=i("p",{class:"warning-detail"}," 继续访问即表示您已年满18周岁，并同意浏览成人内容。 ",-1)),i("div",{class:"warning-buttons"},[i("button",{onClick:r,class:"btn-confirm"}," 是，我已年满18岁 "),i("button",{onClick:l,class:"btn-reject"}," 否，我未满18岁 ")])])],2)):k("",!0)]))}}),po=f(no,[["__scopeId","data-v-20130149"]]),eo={key:0},to={class:"moon-icon"},ao=P({__name:"ThemeTransition",setup(p){const{isDark:n}=yn(),e=B(!1),t=B(!1),a=B(!1),r=B(!1),l=B(!1);let c,u,v;const h=()=>{c&&(clearTimeout(c),c=void 0),u&&(clearTimeout(u),u=void 0),v&&(clearTimeout(v),v=void 0)},m=()=>{l.value=!0,r.value=!1,a.value=!1,u=setTimeout(()=>{e.value=!1,l.value=!1},260)},g=N=>{const T=document.documentElement;N?T.classList.add("dark"):T.classList.remove("dark")},$=N=>{h(),t.value=N,document.documentElement.classList.add("theme-switching"),a.value=!0,e.value=!0,r.value=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{r.value=!0})}),v=setTimeout(()=>{g(N)},200),c=setTimeout(()=>{r.value=!1,a.value=!1,document.documentElement.classList.remove("theme-switching"),u=setTimeout(()=>{e.value=!1},400)},500)};return U(n,(N,T)=>{if(!(typeof window>"u")&&T!==void 0){if(e.value||r.value||a.value){h(),m(),setTimeout(()=>$(N),130);return}$(N)}}),(N,T)=>e.value?(s(),o("div",eo,[i("div",{class:I(["theme-backdrop",{"backdrop-dark":t.value,show:a.value,fast:l.value}])},null,2),i("div",{class:I(["theme-transition-mask",{"mask-dark":t.value,animating:r.value,fast:l.value}])},[i("div",to,C(t.value?"🌙":"☀️"),1)],2)])):k("",!0)}}),so=f(ao,[["__scopeId","data-v-06473298"]]),ro=280,oo=P({__name:"BackToTop",setup(p){const n=B(!1),e=()=>{n.value=window.scrollY>ro},t=()=>{window.scrollTo({top:0,behavior:"smooth"})};return J(()=>{window.addEventListener("scroll",e,{passive:!0}),e()}),Z(()=>{window.removeEventListener("scroll",e)}),(a,r)=>n.value?(s(),o("button",{key:0,class:"back-top",type:"button",onClick:t,"aria-label":"返回顶部"}," ↑ ")):k("",!0)}}),io=f(oo,[["__scopeId","data-v-df795d79"]]),vn={allowedPrefixes:["/","/articles","/license","/settings"],excludedPrefixes:["/404"],excludedIncludes:[]},Sn=p=>{for(const n of vn.excludedPrefixes)if(p.startsWith(n))return!1;for(const n of vn.excludedIncludes)if(p.includes(n))return!1;for(const n of vn.allowedPrefixes)if(p.startsWith(n))return!0;return!1},nn="last_read",lo="reading_prompt_enabled",co=15e3,uo=900*1e3,_o=6e4,fo=P({__name:"ReadingReminder",setup(p){const n=Bn(),e=B(!1),t=B(!1),a=B(""),r=B(void 0),l=B(void 0),c=B(!0),u=M=>{const E=document.cookie.match(new RegExp("(?:^|; )"+M.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return E?decodeURIComponent(E[1]):""},v=(M,E,Y=365)=>{const F=new Date;F.setTime(F.getTime()+Y*24*60*60*1e3),document.cookie=`${M}=${encodeURIComponent(E)}; path=/; expires=${F.toUTCString()}`},h=()=>{r.value&&(clearTimeout(r.value),r.value=void 0)},m=()=>{l.value&&(clearTimeout(l.value),l.value=void 0)},g=()=>{const M=u(nn);if(M)try{const E=JSON.parse(M),Y=Date.now(),F={current:E.current,previous:E.current,tsCurrent:E.tsCurrent,tsPrevious:Y};v(nn,JSON.stringify(F))}catch{}},$=()=>{m(),l.value=setTimeout(()=>{c.value&&Sn(n.route.path)&&g()},_o)},N=()=>{t.value=!0,setTimeout(()=>{e.value=!1,t.value=!1},300),h()},T=()=>{h(),r.value=setTimeout(()=>N(),co)},x=M=>{if(!Sn(M))return;let E="",Y=0;try{const mn=u(nn);if(mn){const an=JSON.parse(mn);an.current&&(E=an.current),an.tsCurrent&&(Y=an.tsCurrent)}}catch{}const F=Date.now();v(nn,JSON.stringify({current:M,previous:E,tsCurrent:F,tsPrevious:Y}))},j=()=>{const M=localStorage.getItem(lo);return M===null?!0:M==="true"},w=()=>{if(!j())return;const M=u(nn);if(M)try{const E=JSON.parse(M),Y=Date.now(),F=E.tsPrevious??0;E.previous&&F&&Y-F>uo&&E.previous!==n.route.path&&(a.value=E.previous,e.value=!0,T())}catch{}},D=()=>{a.value&&(N(),n.go(a.value))};return J(()=>{U(()=>n.route.path,M=>{typeof document>"u"||(x(M),$())},{immediate:!0})}),J(()=>{w(),$(),typeof window<"u"&&(window.addEventListener("visibilitychange",w),window.addEventListener("focus",()=>{c.value=!0,$()}),window.addEventListener("blur",()=>{c.value=!1,m()}))}),Z(()=>{typeof window<"u"&&(window.removeEventListener("visibilitychange",w),window.removeEventListener("focus",()=>{}),window.removeEventListener("blur",()=>{})),h(),m()}),(M,E)=>me((s(),o("div",{class:I(["reading-reminder",{"fade-out":t.value}])},[i("div",{class:"reading-reminder__content"},[E[0]||(E[0]=i("span",null,"是否跳转到上次阅读位置？",-1)),i("div",{class:"reading-reminder__actions"},[i("button",{class:"primary",onClick:D},"跳转"),i("button",{class:"ghost",onClick:N},"关闭")])])],2)),[[he,e.value]])}}),mo=f(fo,[["__scopeId","data-v-62aa7ff8"]]),zn="cookie_consent",ho="age_verified",vo=P({__name:"CookieConsent",setup(p){const n=B(!1),e=B(!1),t=B(!1);let a;const r=()=>{e.value=!0,setTimeout(()=>{localStorage.setItem(zn,"true"),n.value=!1,e.value=!1},300)},l=()=>{window.location.href="https://www.pixiv.net/users/50811011"},c=()=>localStorage.getItem(zn)==="true",u=()=>document.cookie.includes(`${ho}=true`),v=()=>{t.value=u(),t.value&&!c()&&(n.value=!0)};return J(()=>{v(),a=window.setInterval(()=>{u()&&!t.value&&v()},500)}),Z(()=>{a&&clearInterval(a)}),(h,m)=>n.value?(s(),o("div",{key:0,class:I(["cookie-consent",{"fade-out":e.value}])},[m[3]||(m[3]=i("div",{class:"cookie-backdrop"},null,-1)),i("div",{class:"cookie-modal"},[i("div",{class:"cookie-modal__content"},[m[0]||(m[0]=i("h2",null,"Cookie 政策",-1)),m[1]||(m[1]=i("p",null,"此网站使用 Cookie 来改进用户体验，包括记录您的阅读位置和偏好设置。",-1)),m[2]||(m[2]=i("p",null,"如果您不同意使用 Cookie，请点击“拒绝”按钮离开此网站。",-1)),i("div",{class:"cookie-modal__actions"},[i("button",{class:"accept",onClick:r},"同意并继续"),i("button",{class:"decline",onClick:l},"拒绝")])])])],2)):k("",!0)}}),bo=f(vo,[["__scopeId","data-v-64f9ad39"]]),go={style:{display:"none"}},$o=P({__name:"SearchModal",setup(p){let n=null,e=!1;return J(()=>{const t=()=>{if(n=document.querySelector(".VPLocalSearchBox"),!n){setTimeout(t,50);return}const a=l=>{n&&(n.classList.add("fade-out"),setTimeout(()=>{n&&n.classList.remove("fade-out"),l()},200))},r=l=>{if(e)return;const c=l.target,u=c===n,v=c.closest("button"),h=c.closest("a"),m=l.type==="keydown"&&l.key==="Escape";(u||v||h||m)&&(l.preventDefault(),l.stopPropagation(),l.stopImmediatePropagation(),a(()=>{e=!0,m?window.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",keyCode:27,bubbles:!0,cancelable:!0})):c instanceof HTMLElement&&c.click(),setTimeout(()=>{e=!1},0)}))};n.addEventListener("click",r,!0),window.addEventListener("keydown",r,!0),Z(()=>{n&&n.removeEventListener("click",r,!0),window.removeEventListener("keydown",r,!0)})};t()}),(t,a)=>(s(),o("div",go))}}),ko=JSON.parse('{"title":"A.1 雪原与利刃的沉沦（拉普兰德1&德克萨斯0）","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/A/A.1.md","filePath":"articles/ark/A/A.1.md","lastUpdated":1766326350000}'),Po={name:"articles/ark/A/A.1.md"};function To(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",32)])])}const So=f(Po,[["render",To]]),yo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ko,default:So},Symbol.toStringTag,{value:"Module"})),Ao=JSON.parse('{"title":"阿尔图罗的特别生日礼物~#1&#2","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/B/A/B.A.1and2.md","filePath":"articles/ark/B/A/B.A.1and2.md","lastUpdated":1766326350000}'),No={name:"articles/ark/B/A/B.A.1and2.md"};function Oo(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",81)])])}const Bo=f(No,[["render",Oo]]),xo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ao,default:Bo},Symbol.toStringTag,{value:"Module"})),Vo=JSON.parse('{"title":"B.A.3&4 阿尔图罗的生日“派对”~#3&#4","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/B/A/B.A.3and4.md","filePath":"articles/ark/B/A/B.A.3and4.md","lastUpdated":1766326350000}'),Co={name:"articles/ark/B/A/B.A.3and4.md"};function Io(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",136)])])}const Lo=f(Co,[["render",Io]]),wo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Vo,default:Lo},Symbol.toStringTag,{value:"Module"})),jo=JSON.parse('{"title":"B.A.5&6 在音乐中堕落的阿尔图罗~#5&#6","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/ark/B/A/B.A.5and6.md","filePath":"articles/ark/B/A/B.A.5and6.md","lastUpdated":1766326350000}'),Do={name:"articles/ark/B/A/B.A.5and6.md"};function Mo(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",113)])])}const Eo=f(Do,[["render",Mo]]),zo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:jo,default:Eo},Symbol.toStringTag,{value:"Module"})),Ro=JSON.parse('{"title":"阿尔图罗的派对(?)","description":"","frontmatter":{"order":2,"title":"阿尔图罗的派对(?)"},"headers":[],"relativePath":"articles/ark/B/A/index.md","filePath":"articles/ark/B/A/index.md","lastUpdated":1766326350000}'),Jo={name:"articles/ark/B/A/index.md"};function Uo(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[i("h1",{id:"阿尔图罗的派对",tabindex:"-1"},[z("阿尔图罗的派对(?) "),i("a",{class:"header-anchor",href:"#阿尔图罗的派对","aria-label":"Permalink to “阿尔图罗的派对(?)”"},"​")],-1),i("p",null,"这是A系列的简介。",-1)])])}const Ho=f(Jo,[["render",Uo]]),Fo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ro,default:Ho},Symbol.toStringTag,{value:"Module"})),Ko=JSON.parse('{"title":"B.N.1 冰镇苹果汁💗~（能天使0&菲亚梅塔1）","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/B/N/B.N.1.md","filePath":"articles/ark/B/N/B.N.1.md","lastUpdated":1766326350000}'),Go={name:"articles/ark/B/N/B.N.1.md"};function Wo(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",92)])])}const qo=f(Go,[["render",Wo]]),Yo=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ko,default:qo},Symbol.toStringTag,{value:"Module"})),Xo=JSON.parse('{"title":"B.N.2 坏姐姐！💗~（安乐）","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/B/N/B.N.2.md","filePath":"articles/ark/B/N/B.N.2.md","lastUpdated":1766326350000}'),Qo={name:"articles/ark/B/N/B.N.2.md"};function Zo(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",87)])])}const ni=f(Qo,[["render",Zo]]),pi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Xo,default:ni},Symbol.toStringTag,{value:"Module"})),ei=JSON.parse('{"title":"B.N.3 泰拉的超市、可爱的能天使还有企鹅物流的各位💗~","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/ark/B/N/B.N.3.md","filePath":"articles/ark/B/N/B.N.3.md","lastUpdated":1766326350000}'),ti={name:"articles/ark/B/N/B.N.3.md"};function ai(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",123)])])}const si=f(ti,[["render",ai]]),ri=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ei,default:si},Symbol.toStringTag,{value:"Module"})),oi=JSON.parse('{"title":"B.N.4 坏掉的小苹果~（乐徳）","description":"","frontmatter":{"order":4},"headers":[],"relativePath":"articles/ark/B/N/B.N.4.md","filePath":"articles/ark/B/N/B.N.4.md","lastUpdated":1766326350000}'),ii={name:"articles/ark/B/N/B.N.4.md"};function li(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",77)])])}const ci=f(ii,[["render",li]]),di=Object.freeze(Object.defineProperty({__proto__:null,__pageData:oi,default:ci},Symbol.toStringTag,{value:"Module"})),ui=JSON.parse('{"title":"B.N.5.1苹果派装不下再多了呜呜呜~！","description":"","frontmatter":{"order":5},"headers":[],"relativePath":"articles/ark/B/N/B.N.5.1.md","filePath":"articles/ark/B/N/B.N.5.1.md","lastUpdated":1766326350000}'),_i={name:"articles/ark/B/N/B.N.5.1.md"};function fi(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",94)])])}const mi=f(_i,[["render",fi]]),hi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ui,default:mi},Symbol.toStringTag,{value:"Module"})),vi=JSON.parse('{"title":"B.N.5.2 苹果派装不下再多了呜呜呜~！2","description":"","frontmatter":{"order":6},"headers":[],"relativePath":"articles/ark/B/N/B.N.5.2.md","filePath":"articles/ark/B/N/B.N.5.2.md","lastUpdated":1766326350000}'),bi={name:"articles/ark/B/N/B.N.5.2.md"};function gi(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",64)])])}const $i=f(bi,[["render",gi]]),ki=Object.freeze(Object.defineProperty({__proto__:null,__pageData:vi,default:$i},Symbol.toStringTag,{value:"Module"})),Pi=JSON.parse('{"title":"B.N.6 触手服以及能天使~","description":"","frontmatter":{"order":7},"headers":[],"relativePath":"articles/ark/B/N/B.N.6.md","filePath":"articles/ark/B/N/B.N.6.md","lastUpdated":1766326350000}'),Ti={name:"articles/ark/B/N/B.N.6.md"};function Si(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",183)])])}const yi=f(Ti,[["render",Si]]),Ai=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Pi,default:yi},Symbol.toStringTag,{value:"Module"})),Ni=JSON.parse('{"title":"变成泡芙的能天使~","description":"","frontmatter":{"order":1,"title":"变成泡芙的能天使~"},"headers":[],"relativePath":"articles/ark/B/N/index.md","filePath":"articles/ark/B/N/index.md","lastUpdated":1766326350000}'),Oi={name:"articles/ark/B/N/index.md"};function Bi(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[i("h1",{id:"变成泡芙的能天使",tabindex:"-1"},[z("变成泡芙的能天使~ "),i("a",{class:"header-anchor",href:"#变成泡芙的能天使","aria-label":"Permalink to “变成泡芙的能天使~”"},"​")],-1),i("p",null,"这是N系列的简介。",-1)])])}const xi=f(Oi,[["render",Bi]]),Vi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ni,default:xi},Symbol.toStringTag,{value:"Module"})),Ci=JSON.parse('{"title":"淫乱的罗德岛","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/index.md","filePath":"articles/ark/index.md","lastUpdated":1771914025000}'),Ii={name:"articles/ark/index.md"};function Li(p,n,e,t,a,r){const l=H("BookWordCount"),c=H("ARKChapterList");return s(),o("div",null,[n[0]||(n[0]=O("",10)),S(l,{novel:"ark"}),n[1]||(n[1]=i("h2",{id:"章节列表",tabindex:"-1"},[z("章节列表 "),i("a",{class:"header-anchor",href:"#章节列表","aria-label":"Permalink to “章节列表”"},"​")],-1)),S(c),n[2]||(n[2]=i("hr",null,null,-1)),n[3]||(n[3]=i("p",null,[z("⚠️ "),i("strong",null,"警告"),z(": 本作品包含成人内容，仅限18岁以上读者阅读。")],-1))])}const wi=f(Ii,[["render",Li]]),ji=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ci,default:wi},Symbol.toStringTag,{value:"Module"})),Di=JSON.parse('{"title":"小说列表","description":"","frontmatter":{},"headers":[],"relativePath":"articles/index.md","filePath":"articles/index.md","lastUpdated":1766326350000}'),Mi={name:"articles/index.md"};function Ei(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[i("h1",{id:"小说列表",tabindex:"-1"},[z("小说列表 "),i("a",{class:"header-anchor",href:"#小说列表","aria-label":"Permalink to “小说列表”"},"​")],-1),i("p",null,[z("这里都是Naiii的小说！与"),i("a",{href:"https://www.pixiv.net/users/50811011",target:"_blank",rel:"noreferrer"},"Pixiv"),z("同步更新哦")],-1)])])}const zi=f(Mi,[["render",Ei]]),Ri=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Di,default:zi},Symbol.toStringTag,{value:"Module"})),Ji=JSON.parse('{"title":"#1 共犯的初响","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/tsandsis/chapter1.md","filePath":"articles/tsandsis/chapter1.md","lastUpdated":1766326350000}'),Ui={name:"articles/tsandsis/chapter1.md"};function Hi(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",95)])])}const Fi=f(Ui,[["render",Hi]]),Ki=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ji,default:Fi},Symbol.toStringTag,{value:"Module"})),Gi=JSON.parse('{"title":"#10 湿透的伪装与荆棘的印记","description":"","frontmatter":{"order":10},"headers":[],"relativePath":"articles/tsandsis/chapter10.md","filePath":"articles/tsandsis/chapter10.md","lastUpdated":1766469247000}'),Wi={name:"articles/tsandsis/chapter10.md"};function qi(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",468)])])}const Yi=f(Wi,[["render",qi]]),Xi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Gi,default:Yi},Symbol.toStringTag,{value:"Module"})),Qi=JSON.parse('{"title":"#11 同桌的指尖与白丝的秘密","description":"","frontmatter":{"order":11},"headers":[],"relativePath":"articles/tsandsis/chapter11.md","filePath":"articles/tsandsis/chapter11.md","lastUpdated":1768327787000}'),Zi={name:"articles/tsandsis/chapter11.md"};function nl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",221)])])}const pl=f(Zi,[["render",nl]]),el=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Qi,default:pl},Symbol.toStringTag,{value:"Module"})),tl=JSON.parse('{"title":"#12 口红印与不道歉的占有","description":"","frontmatter":{"order":12},"headers":[],"relativePath":"articles/tsandsis/chapter12.md","filePath":"articles/tsandsis/chapter12.md","lastUpdated":1768327787000}'),al={name:"articles/tsandsis/chapter12.md"};function sl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",171)])])}const rl=f(al,[["render",sl]]),ol=Object.freeze(Object.defineProperty({__proto__:null,__pageData:tl,default:rl},Symbol.toStringTag,{value:"Module"})),il=JSON.parse('{"title":"#13 空教室中的观众与表演","description":"","frontmatter":{"order":13},"headers":[],"relativePath":"articles/tsandsis/chapter13.md","filePath":"articles/tsandsis/chapter13.md","lastUpdated":1768327787000}'),ll={name:"articles/tsandsis/chapter13.md"};function cl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",120)])])}const dl=f(ll,[["render",cl]]),ul=Object.freeze(Object.defineProperty({__proto__:null,__pageData:il,default:dl},Symbol.toStringTag,{value:"Module"})),_l=JSON.parse('{"title":"#14 药水、校服与主动献祭","description":"","frontmatter":{"order":14},"headers":[],"relativePath":"articles/tsandsis/chapter14.md","filePath":"articles/tsandsis/chapter14.md","lastUpdated":1768327787000}'),fl={name:"articles/tsandsis/chapter14.md"};function ml(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",186)])])}const hl=f(fl,[["render",ml]]),vl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:_l,default:hl},Symbol.toStringTag,{value:"Module"})),bl=JSON.parse('{"title":"#15 囚笼、盲眼与双倍的占有","description":"","frontmatter":{"order":15},"headers":[],"relativePath":"articles/tsandsis/chapter15.md","filePath":"articles/tsandsis/chapter15.md","lastUpdated":1768327787000}'),gl={name:"articles/tsandsis/chapter15.md"};function $l(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",284)])])}const kl=f(gl,[["render",$l]]),Pl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:bl,default:kl},Symbol.toStringTag,{value:"Module"})),Tl=JSON.parse('{"title":"#16 项圈、四肢与“汪”","description":"","frontmatter":{"order":16},"headers":[],"relativePath":"articles/tsandsis/chapter16.md","filePath":"articles/tsandsis/chapter16.md","lastUpdated":1768327787000}'),Sl={name:"articles/tsandsis/chapter16.md"};function yl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",182)])])}const Al=f(Sl,[["render",yl]]),Nl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Tl,default:Al},Symbol.toStringTag,{value:"Module"})),Ol=JSON.parse('{"title":"#17 水牢、净罪与暗涌的欲望","description":"","frontmatter":{"order":17},"headers":[],"relativePath":"articles/tsandsis/chapter17.md","filePath":"articles/tsandsis/chapter17.md","lastUpdated":1768327787000}'),Bl={name:"articles/tsandsis/chapter17.md"};function xl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",131)])])}const Vl=f(Bl,[["render",xl]]),Cl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ol,default:Vl},Symbol.toStringTag,{value:"Module"})),Il=JSON.parse('{"title":"#18 晨露、项圈与并行的足迹","description":"","frontmatter":{"order":18},"headers":[],"relativePath":"articles/tsandsis/chapter18.md","filePath":"articles/tsandsis/chapter18.md","lastUpdated":1768327787000}'),Ll={name:"articles/tsandsis/chapter18.md"};function wl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",117)])])}const jl=f(Ll,[["render",wl]]),Dl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Il,default:jl},Symbol.toStringTag,{value:"Module"})),Ml=JSON.parse('{"title":"#19 制服、课堂与融化于课桌下的春潮","description":"","frontmatter":{"order":19},"headers":[],"relativePath":"articles/tsandsis/chapter19.md","filePath":"articles/tsandsis/chapter19.md","lastUpdated":1768327787000}'),El={name:"articles/tsandsis/chapter19.md"};function zl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",105)])])}const Rl=f(El,[["render",zl]]),Jl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ml,default:Rl},Symbol.toStringTag,{value:"Module"})),Ul=JSON.parse('{"title":"#2 公园的羞耻游戏","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/tsandsis/chapter2.md","filePath":"articles/tsandsis/chapter2.md","lastUpdated":1766329124000}'),Hl={name:"articles/tsandsis/chapter2.md"};function Fl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",322)])])}const Kl=f(Hl,[["render",Fl]]),Gl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ul,default:Kl},Symbol.toStringTag,{value:"Module"})),Wl=JSON.parse('{"title":"#20 正字、囚服与永夜的盛宴","description":"","frontmatter":{"order":20},"headers":[],"relativePath":"articles/tsandsis/chapter20.md","filePath":"articles/tsandsis/chapter20.md","lastUpdated":1768328362000}'),ql={name:"articles/tsandsis/chapter20.md"};function Yl(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",133)])])}const Xl=f(ql,[["render",Yl]]),Ql=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Wl,default:Xl},Symbol.toStringTag,{value:"Module"})),Zl=JSON.parse('{"title":"#21 正字烙印与永夜沉沦","description":"","frontmatter":{"order":21},"headers":[],"relativePath":"articles/tsandsis/chapter21.md","filePath":"articles/tsandsis/chapter21.md","lastUpdated":1768328362000}'),nc={name:"articles/tsandsis/chapter21.md"};function pc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",75)])])}const ec=f(nc,[["render",pc]]),tc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Zl,default:ec},Symbol.toStringTag,{value:"Module"})),ac=JSON.parse('{"title":"#22 双主轮舞与媚骨成刑","description":"","frontmatter":{"order":22},"headers":[],"relativePath":"articles/tsandsis/chapter22.md","filePath":"articles/tsandsis/chapter22.md","lastUpdated":1771696632000}'),sc={name:"articles/tsandsis/chapter22.md"};function rc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",83)])])}const oc=f(sc,[["render",rc]]),ic=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ac,default:oc},Symbol.toStringTag,{value:"Module"})),lc=JSON.parse('{"title":"#23 忤逆初萌与惩戒深犁","description":"","frontmatter":{"order":23},"headers":[],"relativePath":"articles/tsandsis/chapter23.md","filePath":"articles/tsandsis/chapter23.md","lastUpdated":1771696632000}'),cc={name:"articles/tsandsis/chapter23.md"};function dc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",139)])])}const uc=f(cc,[["render",dc]]),_c=Object.freeze(Object.defineProperty({__proto__:null,__pageData:lc,default:uc},Symbol.toStringTag,{value:"Module"})),fc=JSON.parse('{"title":"#24 双面镜城与午夜欢宴","description":"","frontmatter":{"order":24},"headers":[],"relativePath":"articles/tsandsis/chapter24.md","filePath":"articles/tsandsis/chapter24.md","lastUpdated":1771914025000}'),mc={name:"articles/tsandsis/chapter24.md"};function hc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",231)])])}const vc=f(mc,[["render",hc]]),bc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:fc,default:vc},Symbol.toStringTag,{value:"Module"})),gc=JSON.parse('{"title":"#25 银幕下的暗潮与隔间内的盛宴","description":"","frontmatter":{"order":25},"headers":[],"relativePath":"articles/tsandsis/chapter25.md","filePath":"articles/tsandsis/chapter25.md","lastUpdated":1771914025000}'),$c={name:"articles/tsandsis/chapter25.md"};function kc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",181)])])}const Pc=f($c,[["render",kc]]),Tc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:gc,default:Pc},Symbol.toStringTag,{value:"Module"})),Sc=JSON.parse('{"title":"#26 潜意识烙印与疼痛圣礼","description":"","frontmatter":{"order":26},"headers":[],"relativePath":"articles/tsandsis/chapter26.md","filePath":"articles/tsandsis/chapter26.md","lastUpdated":1771914025000}'),yc={name:"articles/tsandsis/chapter26.md"};function Ac(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",138)])])}const Nc=f(yc,[["render",Ac]]),Oc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Sc,default:Nc},Symbol.toStringTag,{value:"Module"})),Bc=JSON.parse('{"title":"#27 贱犬的渴宴","description":"","frontmatter":{"order":27},"headers":[],"relativePath":"articles/tsandsis/chapter27.md","filePath":"articles/tsandsis/chapter27.md","lastUpdated":1771914025000}'),xc={name:"articles/tsandsis/chapter27.md"};function Vc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",128)])])}const Cc=f(xc,[["render",Vc]]),Ic=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Bc,default:Cc},Symbol.toStringTag,{value:"Module"})),Lc=JSON.parse('{"title":"#28 夜啼与晨礼","description":"","frontmatter":{"order":28},"headers":[],"relativePath":"articles/tsandsis/chapter28.md","filePath":"articles/tsandsis/chapter28.md","lastUpdated":1771914025000}'),wc={name:"articles/tsandsis/chapter28.md"};function jc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",98)])])}const Dc=f(wc,[["render",jc]]),Mc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Lc,default:Dc},Symbol.toStringTag,{value:"Module"})),Ec=JSON.parse('{"title":"#29 X直播间的白丝祭品","description":"","frontmatter":{"order":29},"headers":[],"relativePath":"articles/tsandsis/chapter29.md","filePath":"articles/tsandsis/chapter29.md","lastUpdated":1771914025000}'),zc={name:"articles/tsandsis/chapter29.md"};function Rc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",100)])])}const Jc=f(zc,[["render",Rc]]),Uc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ec,default:Jc},Symbol.toStringTag,{value:"Module"})),Hc=JSON.parse('{"title":"#3 白瓷之印","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/tsandsis/chapter3.md","filePath":"articles/tsandsis/chapter3.md","lastUpdated":1766462880000}'),Fc={name:"articles/tsandsis/chapter3.md"};function Kc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",305)])])}const Gc=f(Fc,[["render",Kc]]),Wc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Hc,default:Gc},Symbol.toStringTag,{value:"Module"})),qc=JSON.parse('{"title":"#30 敏感囚笼与归巢之安","description":"","frontmatter":{"order":30},"headers":[],"relativePath":"articles/tsandsis/chapter30.md","filePath":"articles/tsandsis/chapter30.md","lastUpdated":1771914025000}'),Yc={name:"articles/tsandsis/chapter30.md"};function Xc(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",110)])])}const Qc=f(Yc,[["render",Xc]]),Zc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:qc,default:Qc},Symbol.toStringTag,{value:"Module"})),nd=JSON.parse('{"title":"#31 双主竞逐与泪雨迷途","description":"","frontmatter":{"order":31},"headers":[],"relativePath":"articles/tsandsis/chapter31.md","filePath":"articles/tsandsis/chapter31.md","lastUpdated":1771914025000}'),pd={name:"articles/tsandsis/chapter31.md"};function ed(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",107)])])}const td=f(pd,[["render",ed]]),ad=Object.freeze(Object.defineProperty({__proto__:null,__pageData:nd,default:td},Symbol.toStringTag,{value:"Module"})),sd=JSON.parse('{"title":"#32 呼吸的赋权","description":"","frontmatter":{"order":32},"headers":[],"relativePath":"articles/tsandsis/chapter32.md","filePath":"articles/tsandsis/chapter32.md","lastUpdated":1771914025000}'),rd={name:"articles/tsandsis/chapter32.md"};function od(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",227)])])}const id=f(rd,[["render",od]]),ld=Object.freeze(Object.defineProperty({__proto__:null,__pageData:sd,default:id},Symbol.toStringTag,{value:"Module"})),cd=JSON.parse('{"title":"#33催眠罂粟与黑丝献祭","description":"","frontmatter":{"order":33},"headers":[],"relativePath":"articles/tsandsis/chapter33.md","filePath":"articles/tsandsis/chapter33.md","lastUpdated":1771914025000}'),dd={name:"articles/tsandsis/chapter33.md"};function ud(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",168)])])}const _d=f(dd,[["render",ud]]),fd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:cd,default:_d},Symbol.toStringTag,{value:"Module"})),md=JSON.parse('{"title":"#34 门扉背后的无声淫宴","description":"","frontmatter":{"order":34},"headers":[],"relativePath":"articles/tsandsis/chapter34.md","filePath":"articles/tsandsis/chapter34.md","lastUpdated":1771914025000}'),hd={name:"articles/tsandsis/chapter34.md"};function vd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",155)])])}const bd=f(hd,[["render",vd]]),gd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:md,default:bd},Symbol.toStringTag,{value:"Module"})),$d=JSON.parse('{"title":"#35：月下犬饲与桥底的甘乳","description":"","frontmatter":{"order":35},"headers":[],"relativePath":"articles/tsandsis/chapter35.md","filePath":"articles/tsandsis/chapter35.md","lastUpdated":1771914025000}'),kd={name:"articles/tsandsis/chapter35.md"};function Pd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",228)])])}const Td=f(kd,[["render",Pd]]),Sd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:$d,default:Td},Symbol.toStringTag,{value:"Module"})),yd=JSON.parse('{"title":"#4 长发的白瓷铃铛","description":"","frontmatter":{"order":4},"headers":[],"relativePath":"articles/tsandsis/chapter4.md","filePath":"articles/tsandsis/chapter4.md","lastUpdated":1766462880000}'),Ad={name:"articles/tsandsis/chapter4.md"};function Nd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",214)])])}const Od=f(Ad,[["render",Nd]]),Bd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:yd,default:Od},Symbol.toStringTag,{value:"Module"})),xd=JSON.parse('{"title":"#5 黑丝、银锁与偏执的牙印","description":"","frontmatter":{"order":5},"headers":[],"relativePath":"articles/tsandsis/chapter5.md","filePath":"articles/tsandsis/chapter5.md","lastUpdated":1766462880000}'),Vd={name:"articles/tsandsis/chapter5.md"};function Cd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",197)])])}const Id=f(Vd,[["render",Cd]]),Ld=Object.freeze(Object.defineProperty({__proto__:null,__pageData:xd,default:Id},Symbol.toStringTag,{value:"Module"})),wd=JSON.parse('{"title":"#6 白丝、药丸与空教室的惩罚","description":"","frontmatter":{"order":6},"headers":[],"relativePath":"articles/tsandsis/chapter6.md","filePath":"articles/tsandsis/chapter6.md","lastUpdated":1766462880000}'),jd={name:"articles/tsandsis/chapter6.md"};function Dd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",292)])])}const Md=f(jd,[["render",Dd]]),Ed=Object.freeze(Object.defineProperty({__proto__:null,__pageData:wd,default:Md},Symbol.toStringTag,{value:"Module"})),zd=JSON.parse('{"title":"#7 铃音的小穴与温柔的引导","description":"","frontmatter":{"order":7},"headers":[],"relativePath":"articles/tsandsis/chapter7.md","filePath":"articles/tsandsis/chapter7.md","lastUpdated":1766462880000}'),Rd={name:"articles/tsandsis/chapter7.md"};function Jd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",166)])])}const Ud=f(Rd,[["render",Jd]]),Hd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:zd,default:Ud},Symbol.toStringTag,{value:"Module"})),Fd=JSON.parse('{"title":"#8 雪白的蛹与新生之穴","description":"","frontmatter":{"order":8},"headers":[],"relativePath":"articles/tsandsis/chapter8.md","filePath":"articles/tsandsis/chapter8.md","lastUpdated":1766463690000}'),Kd={name:"articles/tsandsis/chapter8.md"};function Gd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",262)])])}const Wd=f(Kd,[["render",Gd]]),qd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Fd,default:Wd},Symbol.toStringTag,{value:"Module"})),Yd=JSON.parse('{"title":"#9 谎言的茉莉香与惩罚的荆棘","description":"","frontmatter":{"order":9},"headers":[],"relativePath":"articles/tsandsis/chapter9.md","filePath":"articles/tsandsis/chapter9.md","lastUpdated":1766469247000}'),Xd={name:"articles/tsandsis/chapter9.md"};function Qd(p,n,e,t,a,r){return s(),o("div",null,[...n[0]||(n[0]=[O("",355)])])}const Zd=f(Xd,[["render",Qd]]),nu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Yd,default:Zd},Symbol.toStringTag,{value:"Module"})),pu=JSON.parse('{"title":"TS哥哥和扶她妹妹","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/tsandsis/index.md","filePath":"articles/tsandsis/index.md","lastUpdated":1771914025000}'),eu={name:"articles/tsandsis/index.md"};function tu(p,n,e,t,a,r){const l=H("BookWordCount"),c=H("ChapterList");return s(),o("div",null,[n[0]||(n[0]=i("h1",{id:"ts哥哥和扶她妹妹",tabindex:"-1"},[z("TS哥哥和扶她妹妹 "),i("a",{class:"header-anchor",href:"#ts哥哥和扶她妹妹","aria-label":"Permalink to “TS哥哥和扶她妹妹”"},"​")],-1)),n[1]||(n[1]=i("p",null,"一个关于特殊兄妹关系的故事。",-1)),n[2]||(n[2]=i("h2",{id:"简介",tabindex:"-1"},[z("简介 "),i("a",{class:"header-anchor",href:"#简介","aria-label":"Permalink to “简介”"},"​")],-1)),n[3]||(n[3]=i("p",null,"就是骨科啦~",-1)),S(l,{novel:"tsandsis"}),S(c,{novel:"tsandsis"}),n[4]||(n[4]=i("hr",null,null,-1)),n[5]||(n[5]=i("p",null,[z("⚠️ "),i("strong",null,"警告"),z(": 本作品包含成人内容，仅限18岁以上读者阅读。")],-1))])}const au=f(eu,[["render",tu]]),su=Object.freeze(Object.defineProperty({__proto__:null,__pageData:pu,default:au},Symbol.toStringTag,{value:"Module"})),ru={key:0,class:"latest-banner"},ou={class:"latest-body"},iu=["href"],lu={key:0,class:"latest-date"},cu={key:1,class:"latest-desc"},du="latest_update_banner",uu=P({__name:"LatestUpdateBanner",setup(p){const n=Object.assign({"../../../articles/ark/A/A.1.md":yo,"../../../articles/ark/B/A/B.A.1and2.md":xo,"../../../articles/ark/B/A/B.A.3and4.md":wo,"../../../articles/ark/B/A/B.A.5and6.md":zo,"../../../articles/ark/B/A/index.md":Fo,"../../../articles/ark/B/N/B.N.1.md":Yo,"../../../articles/ark/B/N/B.N.2.md":pi,"../../../articles/ark/B/N/B.N.3.md":ri,"../../../articles/ark/B/N/B.N.4.md":di,"../../../articles/ark/B/N/B.N.5.1.md":hi,"../../../articles/ark/B/N/B.N.5.2.md":ki,"../../../articles/ark/B/N/B.N.6.md":Ai,"../../../articles/ark/B/N/index.md":Vi,"../../../articles/ark/index.md":ji,"../../../articles/index.md":Ri,"../../../articles/tsandsis/chapter1.md":Ki,"../../../articles/tsandsis/chapter10.md":Xi,"../../../articles/tsandsis/chapter11.md":el,"../../../articles/tsandsis/chapter12.md":ol,"../../../articles/tsandsis/chapter13.md":ul,"../../../articles/tsandsis/chapter14.md":vl,"../../../articles/tsandsis/chapter15.md":Pl,"../../../articles/tsandsis/chapter16.md":Nl,"../../../articles/tsandsis/chapter17.md":Cl,"../../../articles/tsandsis/chapter18.md":Dl,"../../../articles/tsandsis/chapter19.md":Jl,"../../../articles/tsandsis/chapter2.md":Gl,"../../../articles/tsandsis/chapter20.md":Ql,"../../../articles/tsandsis/chapter21.md":tc,"../../../articles/tsandsis/chapter22.md":ic,"../../../articles/tsandsis/chapter23.md":_c,"../../../articles/tsandsis/chapter24.md":bc,"../../../articles/tsandsis/chapter25.md":Tc,"../../../articles/tsandsis/chapter26.md":Oc,"../../../articles/tsandsis/chapter27.md":Ic,"../../../articles/tsandsis/chapter28.md":Mc,"../../../articles/tsandsis/chapter29.md":Uc,"../../../articles/tsandsis/chapter3.md":Wc,"../../../articles/tsandsis/chapter30.md":Zc,"../../../articles/tsandsis/chapter31.md":ad,"../../../articles/tsandsis/chapter32.md":ld,"../../../articles/tsandsis/chapter33.md":fd,"../../../articles/tsandsis/chapter34.md":gd,"../../../articles/tsandsis/chapter35.md":Sd,"../../../articles/tsandsis/chapter4.md":Bd,"../../../articles/tsandsis/chapter5.md":Ld,"../../../articles/tsandsis/chapter6.md":Ed,"../../../articles/tsandsis/chapter7.md":Hd,"../../../articles/tsandsis/chapter8.md":qd,"../../../articles/tsandsis/chapter9.md":nu,"../../../articles/tsandsis/index.md":su}),e=v=>{if(v==null)return null;if(typeof v=="number")return v<1e12?v*1e3:v;const h=Date.parse(String(v));return Number.isNaN(h)?null:h},t=y(()=>Object.values(n).map(v=>{const h=v?.__pageData??{},m=v?.frontmatter??{},g=h.relativePath;if(!g)return null;const $=g.replace(/\.md$/,""),N=$.endsWith("/index")?`/${$.slice(0,-6)}/`:`/${$}`,T=e(h.lastUpdated)??e(m.updated)??e(m.date);return{title:h.title||m.title||"未命名章节",description:h.description||m.description,path:N,lastUpdated:T??h.lastUpdated}}).filter(Boolean).filter(v=>v.path.startsWith("/articles")&&Sn(v.path)).sort((v,h)=>{const m=e(v.lastUpdated)??0,g=e(h.lastUpdated)??0;return m===g?h.path.localeCompare(v.path):g-m})),a=y(()=>t.value[0]),r=v=>{if(typeof document>"u")return null;const h=document.cookie.match(new RegExp("(?:^|; )"+v.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return h?decodeURIComponent(h[1]):null},l=B(!0);J(()=>{l.value=r(du)!=="1"});const c=()=>{l.value=!1},u=y(()=>{const v=a.value?.lastUpdated;if(!v)return"";const h=typeof v=="number"?v:Date.parse(v),m=h<1e12?h*1e3:h,g=new Date(m),$=N=>String(N).padStart(2,"0");return`${g.getFullYear()}-${$(g.getMonth()+1)}-${$(g.getDate())}`});return(v,h)=>(s(),A(ln,{name:"banner-fade"},{default:b(()=>[a.value&&l.value?(s(),o("div",ru,[h[0]||(h[0]=i("div",{class:"latest-label"},"最新更新",-1)),i("div",ou,[i("a",{class:"latest-title",href:a.value.path},C(a.value.title),9,iu),u.value?(s(),o("span",lu,"更新于 "+C(u.value),1)):k("",!0),a.value.description?(s(),o("p",cu,C(a.value.description),1)):k("",!0)]),i("div",{class:"latest-actions"},[i("button",{class:"btn",onClick:c},"关闭")])])):k("",!0)]),_:1}))}}),_u=f(uu,[["__scopeId","data-v-fb77de2f"]]),fu="reader_font",mu="reader_font_size",hu=P({__name:"Layout",setup(p){const{Layout:n}=tp,{isDark:e}=yn(),t=Bn(),a="20260224_145151",r=T=>{T.preventDefault(),window.__deferredPwaPrompt=T,window.dispatchEvent(new CustomEvent("pwa-install-available"))},l=()=>{window.__deferredPwaPrompt=null,window.dispatchEvent(new CustomEvent("pwa-installed"))},c=T=>{if(typeof document>"u")return null;const x=document.cookie.match(new RegExp("(?:^|; )"+T.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return x?decodeURIComponent(x[1]):null},u=()=>{if(typeof window>"u")return;const T=c(fu);T&&(document.documentElement.dataset.font=T);const x=c(mu);x&&(document.documentElement.dataset.fontSize=x)},v=T=>{document.querySelector("iframe.giscus-frame")?.contentWindow?.postMessage({giscus:{setConfig:{theme:T}}},"https://giscus.app")},h=()=>{const T=document.querySelector(".giscus-wrapper");T&&(T.innerHTML="",typeof window<"u"&&"giscus"in window&&delete window.giscus)},m=(T=5)=>{const x=document.querySelector(".giscus-wrapper");if(!x){T>0&&setTimeout(()=>m(T-1),100);return}const j=x.querySelector("iframe.giscus-frame"),w=e.value?"dark":"light";if(j){v(w);return}const D=document.createElement("script");D.src="https://giscus.app/client.js",D.setAttribute("data-repo","NatsumiXD/novel-comment"),D.setAttribute("data-repo-id","R_kgDOQshs6w"),D.setAttribute("data-category","Announcements"),D.setAttribute("data-category-id","DIC_kwDOQshs684C0EPb"),D.setAttribute("data-mapping","pathname"),D.setAttribute("data-strict","1"),D.setAttribute("data-reactions-enabled","1"),D.setAttribute("data-emit-metadata","0"),D.setAttribute("data-input-position","bottom"),D.setAttribute("data-theme",w),D.setAttribute("data-lang","zh-CN"),D.setAttribute("crossorigin","anonymous"),D.async=!0,x.appendChild(D)};J(()=>{u(),typeof window<"u"&&(window.addEventListener("beforeinstallprompt",r),window.addEventListener("appinstalled",l)),rn(()=>{setTimeout(m,300),setTimeout(N,300)})}),Z(()=>{typeof window>"u"||(window.removeEventListener("beforeinstallprompt",r),window.removeEventListener("appinstalled",l))});const g=()=>{document.documentElement.classList.add("page-transitioning")},$=()=>{document.documentElement.classList.remove("page-transitioning")};U(e,T=>{typeof window>"u"||v(T?"dark":"light")},{flush:"post"}),U(()=>t.route.path,()=>{h(),g(),rn(()=>{setTimeout(m,100),setTimeout(N,200),setTimeout($,500)})},{flush:"post"});const N=()=>{if(typeof document>"u")return;const T=document.querySelector(".VPFooter .message");if(!T||T.querySelector(".build-time-inline"))return;const x=document.createElement("span");x.className="build-time-inline",x.textContent=` · Build time ${a} `,T.appendChild(x)};return(T,x)=>(s(),A(d(n),null,{"layout-top":b(()=>[S(bo),S(po),S(so),S($o),S(mo)]),"home-hero-before":b(()=>[S(_u)]),"doc-after":b(()=>[...x[0]||(x[0]=[i("div",{class:"giscus-wrapper"},null,-1)])]),"layout-bottom":b(()=>[S(io)]),_:1}))}}),vu=f(hu,[["__scopeId","data-v-c7d67c1f"]]),bu={},gu={class:"not-found"};function $u(p,n){return s(),o("div",gu,[...n[0]||(n[0]=[i("div",{class:"not-found__bubble"},[i("p",{class:"not-found__code"},"404"),i("h1",null,"迷路啦！"),i("p",null,"这里是次元夹缝，路标被史莱姆吃掉了。"),i("p",null,"别慌，跟着导航猫娘回去就好喵！"),i("a",{class:"not-found__button",href:"/"},"喵呜~ 带我回首页"),i("p",{class:"not-found__tip"},"一直往前会抵达未来，但换个方向更快找到想要的世界。")],-1)])])}const ku=f(bu,[["render",$u],["__scopeId","data-v-2020f3db"]]),Pu=`---
order: 1
---
...
`,ap=Object.freeze(Object.defineProperty({__proto__:null,default:Pu},Symbol.toStringTag,{value:"Module"})),Tu=`---
order: 1
---
...
而床上，两个被禁忌的欲望和温暖的体温缠绕在一起的灵魂，才刚刚开始面对他们崭新、混乱、而又无法分割的未来。`,sp=Object.freeze(Object.defineProperty({__proto__:null,default:Tu},Symbol.toStringTag,{value:"Module"})),Su=`---
order: 10
---
...
而这个牢笼，她甘愿被困在其中`,rp=Object.freeze(Object.defineProperty({__proto__:null,default:Su},Symbol.toStringTag,{value:"Module"})),yu=`---
order: 11
---
...
慢慢窒息。`,op=Object.freeze(Object.defineProperty({__proto__:null,default:yu},Symbol.toStringTag,{value:"Module"})),Au=`---
order: 12
---
...
而这个囚笼，她早已放弃了逃离的念头。`,ip=Object.freeze(Object.defineProperty({__proto__:null,default:Au},Symbol.toStringTag,{value:"Module"})),Nu=`---
order: 13
---
...
不知能否燎原。
`,lp=Object.freeze(Object.defineProperty({__proto__:null,default:Nu},Symbol.toStringTag,{value:"Module"})),Ou=`---
order: 14
---
...
`,cp=Object.freeze(Object.defineProperty({__proto__:null,default:Ou},Symbol.toStringTag,{value:"Module"})),Bu=`---
order: 15
---
...
夜还很长。
而游戏，似乎才刚刚升级。
`,dp=Object.freeze(Object.defineProperty({__proto__:null,default:Bu},Symbol.toStringTag,{value:"Module"})),xu=`---
order: 16
---
...
夜晚还很长。
而明天，新的课程即将开始。
`,up=Object.freeze(Object.defineProperty({__proto__:null,default:xu},Symbol.toStringTag,{value:"Module"})),Vu=`---
order: 17
---
...
夜还长。
水汽未散。
锁链与项圈，在月光照不到的角落，泛着冷硬的光。`,_p=Object.freeze(Object.defineProperty({__proto__:null,default:Vu},Symbol.toStringTag,{value:"Module"})),Cu=`---
order: 18
---
...
而庭院之外，天光正一寸寸变得明亮，照常升起。`,fp=Object.freeze(Object.defineProperty({__proto__:null,default:Cu},Symbol.toStringTag,{value:"Module"})),Iu=`---
order: 19
---
# #19 制服、课堂与融化于课桌下的春潮
...
而车厢内，属于“小白”的、被彻底掌控和宠爱的夜晚，才刚刚开始。`,mp=Object.freeze(Object.defineProperty({__proto__:null,default:Iu},Symbol.toStringTag,{value:"Module"})),Lu=`---
order: 2
---
...
而他们的夜晚，才刚刚开始。`,hp=Object.freeze(Object.defineProperty({__proto__:null,default:Lu},Symbol.toStringTag,{value:"Module"})),wu=`---
order: 20
---
# #20 正字、囚服与永夜的盛宴
...
而对于被囚禁在房间内、身上刻写着欲望印记的“小白”来说，时间只是用来等待下一次盛宴的、缓慢流动的沙漏。`,vp=Object.freeze(Object.defineProperty({__proto__:null,default:wu},Symbol.toStringTag,{value:"Module"})),ju=`---
order: 21
---
# #21 正字烙印与永夜沉沦
...
夜色深沉。
盐灯的光晕柔和。
腿间的黑色图腾，在昏暗光线下，宛如活物，静静诉说着永不餍足的欲望，与永无止境的沉沦。`,bp=Object.freeze(Object.defineProperty({__proto__:null,default:ju},Symbol.toStringTag,{value:"Module"})),Du=`---
order: 22
---
# #22 双主轮舞与媚骨成刑
...
只有明日的阳光（如果还能照进这间屋子），才会揭晓。`,gp=Object.freeze(Object.defineProperty({__proto__:null,default:Du},Symbol.toStringTag,{value:"Module"})),Mu=`---
order: 23
---
# #23 忤逆初萌与惩戒深犁
...
房间重归寂静。
只有熏香清冷的气息，在无声流淌。
而一场更深的沉沦，或许才刚刚揭开序幕。`,$p=Object.freeze(Object.defineProperty({__proto__:null,default:Mu},Symbol.toStringTag,{value:"Module"})),Eu=`---
order: 24
---
# #24 双面镜城与午夜欢宴
...
盐灯的光，温柔地笼罩着床上相拥的两人，仿佛在默许这一切的荒诞与必然。`,kp=Object.freeze(Object.defineProperty({__proto__:null,default:Eu},Symbol.toStringTag,{value:"Module"})),zu=`---
order: 25
---
# #25 银幕下的暗潮与隔间内的盛宴
...
窗外，城市的夜晚依旧喧嚣。
而镜城之中，那面映照出“媚骨天成”的镜子，似乎被打磨得更加光亮，也映照出更加深邃、无法回头的欲望深渊。`,Pp=Object.freeze(Object.defineProperty({__proto__:null,default:zu},Symbol.toStringTag,{value:"Module"})),Ru=`---
order: 26
---
# #26 潜意识烙印与疼痛圣礼
...
夜，如期而至。
而某些改变，已经悄然发生，并且不可逆转。`,Tp=Object.freeze(Object.defineProperty({__proto__:null,default:Ru},Symbol.toStringTag,{value:"Module"})),Ju=`---
order: 27
---
# #27 贱犬的渴宴
...
渴求被满足，欲望被填满。
贱犬的盛宴，或许每日都在上演，并且，永无餍足。`,Sp=Object.freeze(Object.defineProperty({__proto__:null,default:Ju},Symbol.toStringTag,{value:"Module"})),Uu=`---
order: 28
---
# #28 夜啼与晨礼
...
而渴求，永远不会真正止息。
它只会在一次次被填满后，蛰伏，然后孕育出下一次，更加强烈、更加贪婪的索求。`,yp=Object.freeze(Object.defineProperty({__proto__:null,default:Uu},Symbol.toStringTag,{value:"Module"})),Hu=`---
order: 29
---
# #29 X直播间的白丝祭品
...
直播结束了。
但欲望的余烬，仍在黑暗中无声地燃烧。
而这场被无数人见证的堕落，或许早已将某些东西，刻入了更深的、无法磨灭的维度。`,Ap=Object.freeze(Object.defineProperty({__proto__:null,default:Hu},Symbol.toStringTag,{value:"Module"})),Fu=`---
order: 3
---
...
而游戏，才刚刚开始。`,Np=Object.freeze(Object.defineProperty({__proto__:null,default:Fu},Symbol.toStringTag,{value:"Module"})),Ku=`---
order: 30
---
# #30 敏感囚笼与归巢之安
...
她再也无法离开。
也从未如此渴望停留。`,Op=Object.freeze(Object.defineProperty({__proto__:null,default:Ku},Symbol.toStringTag,{value:"Module"})),Gu=`---
order: 31
---
# #31 双主竞逐与泪雨迷途
...
泪雨已歇，但迷途更深。
在双主永不餍足的征服欲中，她这只可怜又可爱的小狗，除了将身心全部奉上，供其争夺、品评、享用之外，早已别无他路可走。`,Bp=Object.freeze(Object.defineProperty({__proto__:null,default:Gu},Symbol.toStringTag,{value:"Module"})),Wu=`---
order: 32
---
# #32 呼吸的赋权
...
还有什么不能给的呢？`,xp=Object.freeze(Object.defineProperty({__proto__:null,default:Wu},Symbol.toStringTag,{value:"Module"})),qu=`---
order: 33
---
# #33催眠罂粟与黑丝献祭
...
黑丝是祭品，包裹着献祭给主人的肉体。
在理性沉睡的夜晚，本能接管了一切。
而她，终于彻底地、毫无保留地，堕落成了主人最淫荡、最忠诚、最美丽的——所有物。`,Vp=Object.freeze(Object.defineProperty({__proto__:null,default:qu},Symbol.toStringTag,{value:"Module"})),Yu=`---
order: 34
---
# #34 门扉背后的无声淫宴
...
门外的世界，依旧正常运转。
门内的世界，是只属于她们的、永恒的淫宴。
而小白，终于在她的“妈妈”们怀中，找到了最扭曲、也最真实的安宁。`,Cp=Object.freeze(Object.defineProperty({__proto__:null,default:Yu},Symbol.toStringTag,{value:"Module"})),Xu=`---
order: 35
---
# #35：月下犬饲与桥底的甘乳
...
带走了部分痕迹，
却带不走那深入骨髓的、
名为“驯服”的烙印。`,Ip=Object.freeze(Object.defineProperty({__proto__:null,default:Xu},Symbol.toStringTag,{value:"Module"})),Qu=`---
order: 4
---
...
那是只属于他们的，秘密的旋律。`,Lp=Object.freeze(Object.defineProperty({__proto__:null,default:Qu},Symbol.toStringTag,{value:"Module"})),Zu=`---
order: 5
---
...
然后，他睡着了。`,wp=Object.freeze(Object.defineProperty({__proto__:null,default:Zu},Symbol.toStringTag,{value:"Module"})),n_=`---
order: 6
---
...
夜晚，还很长。`,jp=Object.freeze(Object.defineProperty({__proto__:null,default:n_},Symbol.toStringTag,{value:"Module"})),p_=`---
order: 7
---
...
窗外，阳光正好。`,Dp=Object.freeze(Object.defineProperty({__proto__:null,default:p_},Symbol.toStringTag,{value:"Module"})),e_=`---
order: 8
---
...
新生，才刚刚开始。`,Mp=Object.freeze(Object.defineProperty({__proto__:null,default:e_},Symbol.toStringTag,{value:"Module"})),t_=`---
order: 9
---
...
而明天，还会有新的风暴。`,Ep=Object.freeze(Object.defineProperty({__proto__:null,default:t_},Symbol.toStringTag,{value:"Module"})),a_=`---
order: 2
---
...
⚠️ **警告**: 本作品包含成人内容，仅限18岁以上读者阅读。
`,zp=Object.freeze(Object.defineProperty({__proto__:null,default:a_},Symbol.toStringTag,{value:"Module"})),s_={key:0,class:"chapter-list"},r_=["href"],o_=P({__name:"ChapterList",props:{novel:{},novelPath:{default:()=>""}},setup(p){const n=p;Bn();const e=y(()=>n.novelPath||n.novel),t=y(()=>{const a=Object.assign({"/articles/ark/index.md":ap,"/articles/tsandsis/chapter1.md":sp,"/articles/tsandsis/chapter10.md":rp,"/articles/tsandsis/chapter11.md":op,"/articles/tsandsis/chapter12.md":ip,"/articles/tsandsis/chapter13.md":lp,"/articles/tsandsis/chapter14.md":cp,"/articles/tsandsis/chapter15.md":dp,"/articles/tsandsis/chapter16.md":up,"/articles/tsandsis/chapter17.md":_p,"/articles/tsandsis/chapter18.md":fp,"/articles/tsandsis/chapter19.md":mp,"/articles/tsandsis/chapter2.md":hp,"/articles/tsandsis/chapter20.md":vp,"/articles/tsandsis/chapter21.md":bp,"/articles/tsandsis/chapter22.md":gp,"/articles/tsandsis/chapter23.md":$p,"/articles/tsandsis/chapter24.md":kp,"/articles/tsandsis/chapter25.md":Pp,"/articles/tsandsis/chapter26.md":Tp,"/articles/tsandsis/chapter27.md":Sp,"/articles/tsandsis/chapter28.md":yp,"/articles/tsandsis/chapter29.md":Ap,"/articles/tsandsis/chapter3.md":Np,"/articles/tsandsis/chapter30.md":Op,"/articles/tsandsis/chapter31.md":Bp,"/articles/tsandsis/chapter32.md":xp,"/articles/tsandsis/chapter33.md":Vp,"/articles/tsandsis/chapter34.md":Cp,"/articles/tsandsis/chapter35.md":Ip,"/articles/tsandsis/chapter4.md":Lp,"/articles/tsandsis/chapter5.md":wp,"/articles/tsandsis/chapter6.md":jp,"/articles/tsandsis/chapter7.md":Dp,"/articles/tsandsis/chapter8.md":Mp,"/articles/tsandsis/chapter9.md":Ep,"/articles/tsandsis/index.md":zp}),r=u=>{if(typeof u=="string")return u;if(u&&typeof u=="object"){const v=u.__content;if(typeof v=="string")return v;const h=u.default;if(typeof h=="string")return h}return""},l=[],c=e.value;return Object.entries(a).forEach(([u,v])=>{const h=u.match(new RegExp(`/articles/${c}/(.+?)\\.md$`));if(!h)return;const m=h[1];if(m==="index")return;const g=r(v),$=g.match(/^---\s*\n([\s\S]*?)\n---/);let N=999,T=m;if($){const j=$[1].match(/order:\s*(\d+)/);j&&(N=parseInt(j[1],10))}const x=g.match(/^#\s+(.+)$/m);x&&(T=x[1]),l.push({order:N,title:T,path:`/articles/${c}/${m}`})}),l.sort((u,v)=>u.order-v.order)});return(a,r)=>t.value.length>0?(s(),o("div",s_,[r[0]||(r[0]=i("h2",null,"章节列表",-1)),i("ul",null,[(s(!0),o(L,null,R(t.value,l=>(s(),o("li",{key:l.path},[i("a",{href:l.path},C(l.title),9,r_)]))),128))])])):k("",!0)}}),i_=f(o_,[["__scopeId","data-v-2681bc47"]]),l_=`---
order: 2
---
...
雪原的风裹挟着冰冷的雪花涌入洞口，试图冷却她们滚烫的肌肤和仍在分泌情动液体的隐秘地带，却徒劳无功。一前一后的身影，在苍茫雪地上投下扭曲纠缠、仿佛永生永世无法分离的影子。她们没有结合，没有亲吻，但空气中弥漫的、那混合着纯粹生殖渴望与原始情欲的、浓烈到令人窒息的张力，比任何身体的交合都更加惊心动魄，更加蚀骨销魂。这份在血与火、冰与欲、生与死的边缘淬炼出的生殖吸引，是灵魂与肉体的双重献祭，是征服与臣服的永恒悖论，是毁灭与重生的极致轮回。它如同一个未完成的、充满致命诱惑的生殖仪式，在寂静的雪原上、在她们每一次心跳的间隙里，无声地呼唤着下一次更加炽热、更加彻底的沉沦。直到她们在彼此的爱欲之火中，完成生命本能最原始、最澎湃的终极召唤——在极致的生殖结合中找到那唯一的、永恒的归宿，或在创造与毁灭的顶点化为灰烬。`,Rp=Object.freeze(Object.defineProperty({__proto__:null,default:l_},Symbol.toStringTag,{value:"Module"})),c_=`---
order: 1
---
...
`,Jp=Object.freeze(Object.defineProperty({__proto__:null,default:c_},Symbol.toStringTag,{value:"Module"})),d_=`---
order: 2
---
...
`,Up=Object.freeze(Object.defineProperty({__proto__:null,default:d_},Symbol.toStringTag,{value:"Module"})),u_=`---
order: 3
---
...
只有小屋“主人们”和能天使知道真相。羞涩优雅音乐家没病。她只是被彻底心甘情愿重塑成只为欲望存在沉迷轮奸快感时刻需要填满的——性奴。堕落的乐章已然奏响永不停歇。每个白天是在跳蛋嗡鸣中煎熬等待夜晚降临前奏。每个夜晚小屋都成为她彻底沉沦献祭自我的祭坛。直到虚脱直到意识只剩色欲直到美丽躯壳被彻底开发使用殆尽。（完）`,Hp=Object.freeze(Object.defineProperty({__proto__:null,default:u_},Symbol.toStringTag,{value:"Module"})),__=`---
order: 2
title: 阿尔图罗的派对(?)
---
...
这是A系列的简介。
`,Fp=Object.freeze(Object.defineProperty({__proto__:null,default:__},Symbol.toStringTag,{value:"Module"})),f_=`---
order: 1
---
...
`,Gp=Object.freeze(Object.defineProperty({__proto__:null,default:m_},Symbol.toStringTag,{value:"Module"})),h_=`---
order: 3
---
...
`,Wp=Object.freeze(Object.defineProperty({__proto__:null,default:h_},Symbol.toStringTag,{value:"Module"})),v_=`---
order: 4
---
# B.N.4 坏掉的小苹果~（乐徳）
...
`,qp=Object.freeze(Object.defineProperty({__proto__:null,default:v_},Symbol.toStringTag,{value:"Module"})),b_=`---
order: 5
---
# B.N.5.1苹果派装不下再多了呜呜呜~！
...
`,Yp=Object.freeze(Object.defineProperty({__proto__:null,default:b_},Symbol.toStringTag,{value:"Module"})),g_=`---
order: 6
---
...
`,Xp=Object.freeze(Object.defineProperty({__proto__:null,default:g_},Symbol.toStringTag,{value:"Module"})),$_=`---
order: 7
---
# B.N.6 触手服以及能天使~
...
`,Qp=Object.freeze(Object.defineProperty({__proto__:null,default:$_},Symbol.toStringTag,{value:"Module"})),k_=`---
order: 1
title: 变成泡芙的能天使~
---
...
这是N系列的简介。
`,Zp=Object.freeze(Object.defineProperty({__proto__:null,default:k_},Symbol.toStringTag,{value:"Module"})),P_={class:"ark-chapter-list"},T_={key:0,class:"section-a"},S_=["href"],y_={key:1,class:"section-b"},A_={key:0},N_=["href"],O_=P({__name:"ARKChapterList",setup(p){const n=y(()=>{const e=u=>typeof u=="string"?u:u&&typeof u.default=="string"?u.default:u&&typeof u.__content=="string"?u.__content:"",t=Object.assign({"/articles/ark/A/A.1.md":Rp}),a=[];Object.entries(t).forEach(([u,v])=>{const h=u.match(/\/articles\/ark\/A\/(.+?)\.md$/);if(!h)return;const m=h[1],g=e(v),$=g.match(/^---\s*\n([\s\S]*?)\n---/);let N=999,T=m;if($){const j=$[1].match(/order:\s*(\d+)/);j&&(N=parseInt(j[1],10))}const x=g.match(/^#\s+(.+)$/m);x&&(T=x[1]),a.push({order:N,title:T,path:`/articles/ark/A/${m}`})}),a.sort((u,v)=>u.order-v.order);const r=Object.assign({"/articles/ark/B/A/B.A.1and2.md":Jp,"/articles/ark/B/A/B.A.3and4.md":Up,"/articles/ark/B/A/B.A.5and6.md":Hp,"/articles/ark/B/A/index.md":Fp,"/articles/ark/B/N/B.N.1.md":Kp,"/articles/ark/B/N/B.N.2.md":Gp,"/articles/ark/B/N/B.N.3.md":Wp,"/articles/ark/B/N/B.N.4.md":qp,"/articles/ark/B/N/B.N.5.1.md":Yp,"/articles/ark/B/N/B.N.5.2.md":Xp,"/articles/ark/B/N/B.N.6.md":Qp,"/articles/ark/B/N/index.md":Zp}),l=new Map;Object.entries(r).forEach(([u,v])=>{const h=u.match(/\/articles\/ark\/B\/(\w+)\/(.+?)\.md$/);if(!h)return;const[,m,g]=h,$=e(v);if(g==="index"){const N=$.match(/^---\s*\n([\s\S]*?)\n---/);let T=999,x=m;if(N){const w=N[1].match(/order:\s*(\d+)/);w&&(T=parseInt(w[1],10))}const j=$.match(/^#\s+(.+)$/m);if(j)x=j[1];else if(N){const w=N[1].match(/title:\s*(.+)/);w&&(x=w[1].trim())}if(!l.has(m))l.set(m,{name:m,order:T,title:x,chapters:[]});else{const w=l.get(m);w.order=T,w.title=x}}else{const N=$.match(/^---\s*\n([\s\S]*?)\n---/);let T=999,x=g;if(N){const w=N[1].match(/order:\s*(\d+)/);w&&(T=parseInt(w[1],10))}const j=$.match(/^#\s+(.+)$/m);j&&(x=j[1]),l.has(m)||l.set(m,{name:m,order:999,title:m,chapters:[]}),l.get(m).chapters.push({order:T,title:x,path:`/articles/ark/B/${m}/${g}`})}});const c=Array.from(l.values());return c.forEach(u=>{u.chapters.sort((v,h)=>v.order-h.order)}),c.sort((u,v)=>u.order-v.order),{aChapters:a,series:c}});return(e,t)=>(s(),o("div",P_,[n.value.aChapters.length>0?(s(),o("section",T_,[t[0]||(t[0]=i("h3",null,"A 系列（短篇）",-1)),i("ul",null,[(s(!0),o(L,null,R(n.value.aChapters,a=>(s(),o("li",{key:a.path},[i("a",{href:a.path},C(a.title),9,S_)]))),128))])])):k("",!0),n.value.series.length>0?(s(),o("section",y_,[t[1]||(t[1]=i("h3",null,"B 系列（系列连载）",-1)),(s(!0),o(L,null,R(n.value.series,a=>(s(),o("div",{key:a.name,class:"series"},[i("h4",null,C(a.title),1),a.chapters.length>0?(s(),o("ul",A_,[(s(!0),o(L,null,R(a.chapters,r=>(s(),o("li",{key:r.path},[i("a",{href:r.path},C(r.title),9,N_)]))),128))])):k("",!0)]))),128))])):k("",!0)]))}}),B_=f(O_,[["__scopeId","data-v-e236f069"]]),x_=`# 小说列表
这里都是Naiii的小说！与[Pixiv](https://www.pixiv.net/users/50811011)同步更新哦`,V_=Object.freeze(Object.defineProperty({__proto__:null,default:x_},Symbol.toStringTag,{value:"Module"})),C_={class:"book-word-count"},I_=P({__name:"BookWordCount",props:{novel:{},novelPath:{default:()=>""}},setup(p){const n=p,e=y(()=>n.novelPath||n.novel),t=Object.assign({"/articles/ark/A/A.1.md":Rp,"/articles/ark/B/A/B.A.1and2.md":Jp,"/articles/ark/B/A/B.A.3and4.md":Up,"/articles/ark/B/A/B.A.5and6.md":Hp,"/articles/ark/B/A/index.md":Fp,"/articles/ark/B/N/B.N.1.md":Kp,"/articles/ark/B/N/B.N.2.md":Gp,"/articles/ark/B/N/B.N.3.md":Wp,"/articles/ark/B/N/B.N.4.md":qp,"/articles/ark/B/N/B.N.5.1.md":Yp,"/articles/ark/B/N/B.N.5.2.md":Xp,"/articles/ark/B/N/B.N.6.md":Qp,"/articles/ark/B/N/index.md":Zp,"/articles/ark/index.md":ap,"/articles/index.md":V_,"/articles/tsandsis/chapter1.md":sp,"/articles/tsandsis/chapter10.md":rp,"/articles/tsandsis/chapter11.md":op,"/articles/tsandsis/chapter12.md":ip,"/articles/tsandsis/chapter13.md":lp,"/articles/tsandsis/chapter14.md":cp,"/articles/tsandsis/chapter15.md":dp,"/articles/tsandsis/chapter16.md":up,"/articles/tsandsis/chapter17.md":_p,"/articles/tsandsis/chapter18.md":fp,"/articles/tsandsis/chapter19.md":mp,"/articles/tsandsis/chapter2.md":hp,"/articles/tsandsis/chapter20.md":vp,"/articles/tsandsis/chapter21.md":bp,"/articles/tsandsis/chapter22.md":gp,"/articles/tsandsis/chapter23.md":$p,"/articles/tsandsis/chapter24.md":kp,"/articles/tsandsis/chapter25.md":Pp,"/articles/tsandsis/chapter26.md":Tp,"/articles/tsandsis/chapter27.md":Sp,"/articles/tsandsis/chapter28.md":yp,"/articles/tsandsis/chapter29.md":Ap,"/articles/tsandsis/chapter3.md":Np,"/articles/tsandsis/chapter30.md":Op,"/articles/tsandsis/chapter31.md":Bp,"/articles/tsandsis/chapter32.md":xp,"/articles/tsandsis/chapter33.md":Vp,"/articles/tsandsis/chapter34.md":Cp,"/articles/tsandsis/chapter35.md":Ip,"/articles/tsandsis/chapter4.md":Lp,"/articles/tsandsis/chapter5.md":wp,"/articles/tsandsis/chapter6.md":jp,"/articles/tsandsis/chapter7.md":Dp,"/articles/tsandsis/chapter8.md":Mp,"/articles/tsandsis/chapter9.md":Ep,"/articles/tsandsis/index.md":zp});function a(h){if(typeof h=="string")return h;if(h&&typeof h=="object"){const m=h.__content;if(typeof m=="string")return m;const g=h.default;if(typeof g=="string")return g}return""}function r(h){return h.replace(/^---\s*\n[\s\S]*?\n---\s*\n?/,"")}function l(h){return r(h).replace(/```[\s\S]*?```/g,"").replace(/`[^`]*`/g,"").replace(/!\[[^\]]*\]\([^)]*\)/g,"").replace(/\[([^\]]+)\]\(([^)]+)\)/g,"$1").replace(/^#{1,6}\s+/gm,"").replace(/^>\s?/gm,"").replace(/^\s*[-*+]\s+/gm,"").replace(/^\s*\d+\.\s+/gm,"").replace(/[*_~#>-]/g,"").replace(/<[^>]*>/g,"")}function c(h){return l(h).replace(/\s+/g,"").length}const u=y(()=>Object.keys(t).filter(h=>{const m=h.match(/^\/articles\/([^/]+)\/(.+)\.md$/);if(!m)return!1;const[,g,$]=m;return g!==e.value?!1:!$.endsWith("/index")&&$!=="index"}).length),v=y(()=>Object.entries(t).reduce((h,[m,g])=>{const $=m.match(/^\/articles\/([^/]+)\/(.+)\.md$/);if(!$)return h;const[,N,T]=$;return N!==e.value||T.endsWith("/index")||T==="index"?h:h+c(a(g))},0));return(h,m)=>(s(),o("div",C_,[m[0]||(m[0]=i("strong",null,"全书字数：",-1)),z(C(v.value.toLocaleString("zh-CN"))+" 字（共 "+C(u.value)+" 章） ",1)]))}}),L_=f(I_,[["__scopeId","data-v-f4b43d41"]]),w_={class:"settings-page"},j_="reading_prompt_enabled",D_="last_read",Rn="reader_font",Jn="reader_font_size",Un="latest_update_banner",M_=P({__name:"SettingsPanel",setup(p){const n=(g,$,N=-1)=>{const T=new Date;T.setTime(T.getTime()+N*24*60*60*1e3),document.cookie=`${g}=${encodeURIComponent($)}; path=/; expires=${T.toUTCString()}`},e=g=>{const $=document.cookie.match(new RegExp("(?:^|; )"+g.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return $?decodeURIComponent($[1]):null},t=()=>document.cookie.split(";").map(g=>g.trim().split("=")[0]),a=g=>{document.documentElement.dataset.font=g,n(Rn,g,365)},r=g=>{document.documentElement.dataset.fontSize=g,n(Jn,g,365)},l=()=>{const g=e(Rn)||"sans",$=e(Jn)||"medium";document.documentElement.dataset.font=g,document.documentElement.dataset.fontSize=$;const N=document.getElementById("font-select"),T=document.getElementById("font-size-select");N&&(N.value=g),T&&(T.value=$)},c=g=>{localStorage.setItem(j_,String(g)),alert(g?"已开启提示":"已关闭提示")},u=g=>{const $=new Date;$.setTime($.getTime()+31536e6),g?(document.cookie=`${Un}=0; path=/; expires=${$.toUTCString()}`,alert("已显示最新更新横幅")):(document.cookie=`${Un}=1; path=/; expires=${$.toUTCString()}`,alert("已隐藏最新更新横幅（刷新页面生效）"))},v=()=>{n(D_,"",-1),alert("已清除上次阅读记录")},h=()=>{t().forEach($=>{n($,"",-1)}),alert("已清除所有 Cookie")};return typeof window<"u"&&setTimeout(()=>{const g=document.getElementById("enable-prompt"),$=document.getElementById("disable-prompt"),N=document.getElementById("clear-history"),T=document.getElementById("enable-banner"),x=document.getElementById("disable-banner"),j=document.getElementById("clear-all-cookies"),w=document.getElementById("font-select"),D=document.getElementById("font-size-select");g?.addEventListener("click",()=>c(!0)),$?.addEventListener("click",()=>c(!1)),N?.addEventListener("click",()=>v()),T?.addEventListener("click",()=>u(!0)),x?.addEventListener("click",()=>u(!1)),j?.addEventListener("click",()=>h()),w?.addEventListener("change",()=>{const M=w.value;a(M)}),D?.addEventListener("change",()=>{const M=D.value;r(M)}),l()},0),(g,$)=>(s(),o("div",w_,[...$[0]||($[0]=[O("",4)])]))}}),E_=f(M_,[["__scopeId","data-v-22dea74c"]]),J_={extends:tp,Layout:vu,NotFound:ku,enhanceApp({app:p}){p.component("ChapterList",i_),p.component("ARKChapterList",B_),p.component("BookWordCount",L_),p.component("SettingsPanel",E_)}};export{Ul as $,Di as A,Bo as B,zi as C,Ji as D,Fi as E,Gi as F,Yi as G,Qi as H,pl as I,tl as J,rl as K,il as L,dl as M,_l as N,hl as O,bl as P,kl as Q,J_ as R,Tl as S,Al as T,Ol as U,Vl as V,Il as W,jl as X,Ml as Y,Rl as Z,Ao as _,ko as __pageData,Vo as a,Kl as a0,Wl as a1,Xl as a2,Zl as a3,ec as a4,ac as a5,oc as a6,lc as a7,uc as a8,fc as a9,Od as aA,xd as aB,Id as aC,wd as aD,Md as aE,zd as aF,Ud as aG,Fd as aH,Wd as aI,Yd as aJ,Zd as aK,pu as aL,au as aM,vc as aa,gc as ab,Pc as ac,Sc as ad,Nc as ae,Bc as af,Cc as ag,Lc as ah,Dc as ai,Ec as aj,Jc as ak,Hc as al,Gc as am,qc as an,Qc as ao,nd as ap,td as aq,sd as ar,id as as,cd as at,_d as au,md as av,bd as aw,$d as ax,Td as ay,yd as az,Lo as b,Ls as c,jo as d,So as default,Eo as e,Ro as f,Ko as g,qo as h,Ho as i,Xo as j,ni as k,ei as l,si as m,oi as n,ci as o,ui as p,mi as q,vi as r,$i as s,Pi as t,V as u,yi as v,Ni as w,xi as x,Ci as y,wi as z};
