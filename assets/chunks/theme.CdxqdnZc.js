...
`,Ka=Object.freeze(Object.defineProperty({__proto__:null,default:Wa},Symbol.toStringTag,{value:"Module"})),qa=`---
order: 1
---
...
而床上，两个被禁忌的欲望和温暖的体温缠绕在一起的灵魂，才刚刚开始面对他们崭新、混乱、而又无法分割的未来。`,Ja=Object.freeze(Object.defineProperty({__proto__:null,default:qa},Symbol.toStringTag,{value:"Module"})),Qa=`---
order: 2
---
...
⚠️ **警告**: 本作品包含成人内容，仅限18岁以上读者阅读。
`,Ya=Object.freeze(Object.defineProperty({__proto__:null,default:Qa},Symbol.toStringTag,{value:"Module"})),Xa={key:0,class:"chapter-list"},Za=["href"],nr=_({__name:"ChapterList",props:{novel:{},novelPath:{default:()=>""}},setup(n){const e=n;xn();const t=y(()=>e.novelPath||e.novel),o=y(()=>{const s=Object.assign({"/articles/ark/index.md":Ka,"/articles/tsandsis/chapter1.md":Ja,"/articles/tsandsis/index.md":Ya}),r=h=>{if(typeof h=="string")return h;if(h&&typeof h=="object"){const m=h.__content;if(typeof m=="string")return m;const $=h.default;if(typeof $=="string")return $}return""},c=[],l=t.value;return Object.entries(s).forEach(([h,m])=>{const $=h.match(new RegExp(`/articles/${l}/(.+?)\\.md$`));if(!$)return;const P=$[1];if(P==="index")return;const B=r(m),A=B.match(/^---\s*\n([\s\S]*?)\n---/);let M=999,w=P;if(A){const I=A[1].match(/order:\s*(\d+)/);I&&(M=parseInt(I[1],10))}const x=B.match(/^#\s+(.+)$/m);x&&(w=x[1]),c.push({order:M,title:w,path:`/articles/${l}/${P}`})}),c.sort((h,m)=>h.order-m.order)});return(s,r)=>o.value.length>0?(a(),u("div",Xa,[r[0]||(r[0]=d("h2",null,"章节列表",-1)),d("ul",null,[(a(!0),u(T,null,C(o.value,c=>(a(),u("li",{key:c.path},[d("a",{href:c.path},S(c.title),9,Za)]))),128))])])):p("",!0)}}),er=k(nr,[["__scopeId","data-v-2681bc47"]]),tr=`---
order: 2
---
...
`,ar=Object.freeze(Object.defineProperty({__proto__:null,default:sr},Symbol.toStringTag,{value:"Module"})),rr=`---
order: 2
---
