import{d as _,c as u,r as v,n as N,o as a,a as z,t as S,b,w as f,T as dn,e as p,_ as k,u as Vn,i as Rn,f as zn,g as vn,h as y,j as d,k as i,l as G,m as yn,p as D,q as Gn,s as fn,v as Un,x as V,y as Z,z as H,A as hn,B as nn,C as q,D as en,E as Pn,F as Tn,G as T,H as C,I as U,J as g,K as E,L as Nn,M as Wn,N as Kn,O as F,P as tn,Q as Mn,R as qn,S as Jn,U as Y,V as Bn,W as Qn,X as An,Y as wn,Z as Yn,$ as Xn,a0 as Zn,a1 as ne,a2 as ee,a3 as te,a4 as xn}from"./framework.D9cSYwht.js";const oe=_({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(n){return(e,t)=>(a(),u("span",{class:N(["VPBadge",n.type])},[v(e.$slots,"default",{},()=>[z(S(n.text),1)])],2))}}),se={key:0,class:"VPBackdrop"},ae=_({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(n){return(e,t)=>(a(),b(dn,{name:"fade"},{default:f(()=>[n.show?(a(),u("div",se)):p("",!0)]),_:1}))}}),re=k(ae,[["__scopeId","data-v-c79a1216"]]),L=Vn;function ie(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),(o=!0)&&setTimeout(()=>o=!1,e))}}function an(n){return n.startsWith("/")?n:`/${n}`}function mn(n){const{pathname:e,search:t,hash:o,protocol:s}=new URL(n,"http://a.com");if(Rn(n)||n.startsWith("#")||!s.startsWith("http")||!zn(e))return n;const{site:r}=L(),c=e.endsWith("/")||e.endsWith(".html")?n:n.replace(/(?:(^\.+)\/)?.*$/,`$1${e.replace(/(\.md)?$/,r.value.cleanUrls?"":".html")}${t}${o}`);return vn(c)}function J({correspondingLink:n=!1}={}){const{site:e,localeIndex:t,page:o,theme:s,hash:r}=L(),c=y(()=>({label:e.value.locales[t.value]?.label,link:e.value.locales[t.value]?.link||(t.value==="root"?"/":`/${t.value}/`)}));return{localeLinks:y(()=>Object.entries(e.value.locales).flatMap(([h,m])=>c.value.label===m.label?[]:{text:m.label,link:le(m.link||(h==="root"?"/":`/${h}/`),s.value.i18nRouting!==!1&&n,o.value.relativePath.slice(c.value.link.length-1),!e.value.cleanUrls)+r.value,lang:m.lang,dir:m.dir})),currentLang:c}}function le(n,e,t,o){return e?n.replace(/\/$/,"")+an(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,o?".html":"")):n}const ce={class:"NotFound"},ue={class:"code"},de={class:"title"},ve={class:"quote"},fe={class:"action"},he=["href","aria-label"],me=_({__name:"NotFound",setup(n){const{theme:e}=L(),{currentLang:t}=J();return(o,s)=>(a(),u("div",ce,[d("p",ue,S(i(e).notFound?.code??"404"),1),d("h1",de,S(i(e).notFound?.title??"PAGE NOT FOUND"),1),s[0]||(s[0]=d("div",{class:"divider"},null,-1)),d("blockquote",ve,S(i(e).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),d("div",fe,[d("a",{class:"link",href:i(vn)(i(e).notFound?.link??i(t).link),"aria-label":i(e).notFound?.linkLabel??"go to home"},S(i(e).notFound?.linkText??"Take me home"),9,he)])]))}}),pe=k(me,[["__scopeId","data-v-829df670"]]);function In(n,e){if(Array.isArray(n))return Q(n);if(n==null)return[];e=an(e);const t=Object.keys(n).sort((s,r)=>r.split("/").length-s.split("/").length).find(s=>e.startsWith(an(s))),o=t?n[t]:[];return Array.isArray(o)?Q(o):Q(o.items,o.base)}function _e(n){const e=[];let t=0;for(const o in n){const s=n[o];if(s.items){t=e.push(s);continue}e[t]||e.push({items:[]}),e[t].items.push(s)}return e}function ge(n){const e=[];function t(o){for(const s of o)s.text&&s.link&&e.push({text:s.text,link:s.link,docFooterText:s.docFooterText}),s.items&&t(s.items)}return t(n),e}function rn(n,e){return Array.isArray(e)?e.some(t=>rn(n,t)):G(n,e.link)?!0:e.items?rn(n,e.items):!1}function Q(n,e){return[...n].map(t=>{const o={...t},s=o.base||e;return s&&o.link&&(o.link=s+o.link.replace(/^\//,s.endsWith("/")?"":"/")),o.items&&(o.items=Q(o.items,s)),o})}function be(){const{hasSidebar:n}=R(),e=yn("(min-width: 960px)"),t=yn("(min-width: 1280px)");return{isAsideEnabled:y(()=>!t.value&&!e.value?!1:n.value?t.value:e.value)}}const ke=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,ln=[];function Cn(n){return typeof n.outline=="object"&&!Array.isArray(n.outline)&&n.outline.label||n.outlineTitle||"On this page"}function $e(n){const e=[...document.querySelectorAll(".VPDoc h1, .VPDoc h2, .VPDoc h3, .VPDoc h4, .VPDoc h5, .VPDoc h6")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const o=Number(t.tagName[1]);return{element:t,title:ye(t),link:"#"+t.id,level:o}});return Pe(e,n)}function ye(n){let e="";for(const t of n.childNodes)if(t.nodeType===1){if(ke.test(t.className))continue;e+=t.textContent}else t.nodeType===3&&(e+=t.textContent);return e.trim()}function Pe(n,e){if(e===!1)return[];const t=(typeof e=="object"&&!Array.isArray(e)?e.level:e)||2,[o,s]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return Ve(n,o,s)}function Le(n,e){const{isAsideEnabled:t}=be(),o=ie(r,100);let s=null;D(()=>{requestAnimationFrame(r),window.addEventListener("scroll",o)}),Gn(()=>{c(location.hash)}),fn(()=>{window.removeEventListener("scroll",o)});function r(){if(!t.value)return;const l=window.scrollY,h=window.innerHeight,m=document.body.offsetHeight,$=Math.abs(l+h-m)<1,P=ln.map(({element:A,link:M})=>({link:M,top:Se(A)})).filter(({top:A})=>!Number.isNaN(A)).sort((A,M)=>A.top-M.top);if(!P.length){c(null);return}if(l<1){c(null);return}if($){c(P[P.length-1].link);return}let B=null;for(const{link:A,top:M}of P){if(M>l+Un()+4)break;B=A}c(B)}function c(l){s&&s.classList.remove("active"),l==null?s=null:s=n.value.querySelector(`a[href="${decodeURIComponent(l)}"]`);const h=s;h?(h.classList.add("active"),e.value.style.top=h.offsetTop+39+"px",e.value.style.opacity="1"):(e.value.style.top="33px",e.value.style.opacity="0")}}function Se(n){let e=0;for(;n!==document.body;){if(n===null)return NaN;e+=n.offsetTop,n=n.offsetParent}return e}function Ve(n,e,t){ln.length=0;const o=[],s=[];return n.forEach(r=>{const c={...r,children:[]};let l=s[s.length-1];for(;l&&l.level>=c.level;)s.pop(),l=s[s.length-1];if(c.element.classList.contains("ignore-header")||l&&"shouldIgnore"in l){s.push({level:c.level,shouldIgnore:!0});return}c.level>t||c.level<e||(ln.push({element:c.element,link:c.link}),l?l.children.push(c):o.push(c),s.push(c))}),o}const W=V(!1);function Te(n){let e;Z(()=>{e=W.value?document.activeElement:void 0}),D(()=>{window.addEventListener("keyup",t)}),fn(()=>{window.removeEventListener("keyup",t)});function t(o){o.key==="Escape"&&W.value&&(n(),e?.focus())}}function Ne(){function n(){W.value=!0}function e(){W.value=!1}function t(){W.value?e():n()}return{isOpen:W,open:n,close:e,toggle:t}}function Me(n){const{page:e,hash:t}=L(),o=V(!1),s=y(()=>n.value.collapsed!=null),r=y(()=>!!n.value.link),c=V(!1),l=()=>{c.value=G(e.value.relativePath,n.value.link)};H([e,n,t],l),D(l);const h=y(()=>c.value?!0:n.value.items?rn(e.value.relativePath,n.value.items):!1),m=y(()=>!!(n.value.items&&n.value.items.length));Z(()=>{o.value=!!(s.value&&n.value.collapsed)}),hn(()=>{(c.value||h.value)&&(o.value=!1)});function $(){s.value&&(o.value=!o.value)}return{collapsed:o,collapsible:s,isLink:r,isActiveLink:c,hasActiveLink:h,hasChildren:m,toggle:$}}const cn=nn([]),K=nn([]),un=nn(!1);function R(){const{frontmatter:n,theme:e}=L(),t=y(()=>!!(n.value.isHome??n.value.layout==="home")),o=y(()=>n.value.sidebar!==!1&&K.value.length>0&&!t.value),s=y(()=>o.value&&un.value),r=y(()=>o.value?_e(K.value):[]),c=y(()=>t.value?!1:n.value.aside!=null?!!n.value.aside:e.value.aside!==!1),l=y(()=>c.value?n.value.aside==null?e.value.aside==="left":n.value.aside==="left":!1),h=y(()=>cn.value.length>0);return{isHome:t,sidebar:Pn(K),sidebarGroups:r,hasSidebar:o,isSidebarEnabled:s,hasAside:c,leftAside:l,headers:Pn(cn),hasLocalNav:h}}function Be({closeSidebar:n}){const{frontmatter:e,page:t,theme:o}=L();H(()=>[t.value.relativePath,o.value.sidebar],([r,c])=>{const l=c?In(c,r):[];JSON.stringify(l)!==JSON.stringify(K.value)&&(K.value=l)},{immediate:!0,deep:!0,flush:"sync"}),Tn(()=>{cn.value=$e(e.value.outline??o.value.outline)}),q&&(un.value=window.innerWidth>=960,window.addEventListener("resize",()=>{un.value=window.innerWidth>=960},{passive:!0}));const s=en();H(()=>s.path,n),Te(n)}const On=Symbol("layout-info"),Ae=["href","title"],we=_({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(n){return(e,t)=>{const o=U("VPDocOutlineItem",!0);return a(),u("ul",{class:N(["VPDocOutlineItem",n.root?"root":"nested"])},[(a(!0),u(T,null,C(n.headers,({children:s,link:r,title:c})=>(a(),u("li",null,[d("a",{class:"outline-link",href:r,title:c},S(c),9,Ae),s?.length?(a(),b(o,{key:0,headers:s},null,8,["headers"])):p("",!0)]))),256))],2)}}}),Hn=k(we,[["__scopeId","data-v-1ce71065"]]),xe={class:"content"},Ie={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},Ce=_({__name:"VPDocAsideOutline",setup(n){const{theme:e}=L(),t=V(),o=V(),{headers:s,hasLocalNav:r}=R();return Le(t,o),(c,l)=>(a(),u("nav",{"aria-labelledby":"doc-outline-aria-label",class:N(["VPDocAsideOutline",{"has-outline":i(r)}]),ref_key:"container",ref:t},[d("div",xe,[d("div",{class:"outline-marker",ref_key:"marker",ref:o},null,512),d("div",Ie,S(i(Cn)(i(e))),1),g(Hn,{headers:i(s),root:!0},null,8,["headers"])])],2))}}),Oe=k(Ce,[["__scopeId","data-v-60d5052e"]]),He={class:"VPDocAsideCarbonAds"},Ee=_({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(n){const e=()=>null;return(t,o)=>(a(),u("div",He,[g(i(e),{"carbon-ads":n.carbonAds},null,8,["carbon-ads"])]))}}),je={class:"VPDocAside"},De=_({__name:"VPDocAside",setup(n){const{theme:e}=L();return(t,o)=>(a(),u("div",je,[v(t.$slots,"aside-top",{},void 0,!0),v(t.$slots,"aside-outline-before",{},void 0,!0),g(Oe),v(t.$slots,"aside-outline-after",{},void 0,!0),o[0]||(o[0]=d("div",{class:"spacer"},null,-1)),v(t.$slots,"aside-ads-before",{},void 0,!0),i(e).carbonAds?(a(),b(Ee,{key:0,"carbon-ads":i(e).carbonAds},null,8,["carbon-ads"])):p("",!0),v(t.$slots,"aside-ads-after",{},void 0,!0),v(t.$slots,"aside-bottom",{},void 0,!0)]))}}),Fe=k(De,[["__scopeId","data-v-3f215769"]]);function Re(){const{theme:n,page:e}=L();return y(()=>{const{text:t="Edit this page",pattern:o=""}=n.value.editLink||{};let s;return typeof o=="function"?s=o(e.value):s=o.replace(/:path/g,e.value.filePath),{url:s,text:t}})}function ze(){const{page:n,theme:e,frontmatter:t}=L();return y(()=>{const o=In(e.value.sidebar,n.value.relativePath),s=ge(o),r=Ge(s,m=>m.link.replace(/[?#].*$/,"")),c=r.findIndex(m=>G(n.value.relativePath,m.link)),l=e.value.docFooter?.prev===!1&&!t.value.prev||t.value.prev===!1,h=e.value.docFooter?.next===!1&&!t.value.next||t.value.next===!1;return{prev:l?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??r[c-1]?.docFooterText??r[c-1]?.text,link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??r[c-1]?.link},next:h?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??r[c+1]?.docFooterText??r[c+1]?.text,link:(typeof t.value.next=="object"?t.value.next.link:void 0)??r[c+1]?.link}}})}function Ge(n,e){const t=new Set;return n.filter(o=>{const s=e(o);return t.has(s)?!1:t.add(s)})}const j=_({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(n){const e=n,t=y(()=>e.tag??(e.href?"a":"span")),o=y(()=>e.href&&Nn.test(e.href)||e.target==="_blank");return(s,r)=>(a(),b(E(t.value),{class:N(["VPLink",{link:n.href,"vp-external-link-icon":o.value,"no-icon":n.noIcon}]),href:n.href?i(mn)(n.href):void 0,target:n.target??(o.value?"_blank":void 0),rel:n.rel??(o.value?"noreferrer":void 0)},{default:f(()=>[v(s.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),Ue={class:"VPLastUpdated"},We=["datetime"],Ke=_({__name:"VPDocFooterLastUpdated",setup(n){const{theme:e,page:t,lang:o}=L(),{language:s}=Kn(),r=Wn("timeRef"),c=y(()=>new Date(t.value.lastUpdated)),l=y(()=>c.value.toISOString()),h=nn("");return D(()=>{Z(()=>{const m=e.value.lastUpdated?.formatOptions?.forceLocale?o.value:s.value;h.value=new Intl.DateTimeFormat(m,e.value.lastUpdated?.formatOptions??{dateStyle:"medium",timeStyle:"medium"}).format(c.value),m&&o.value!==m?r.value?.setAttribute("lang",m):r.value?.removeAttribute("lang")})}),(m,$)=>(a(),u("p",Ue,[z(S(i(e).lastUpdated?.text||i(e).lastUpdatedText||"Last updated")+": ",1),d("time",{ref_key:"timeRef",ref:r,datetime:l.value},S(h.value),9,We)]))}}),qe=k(Ke,[["__scopeId","data-v-3c637f39"]]),Je={key:0,class:"VPDocFooter"},Qe={key:0,class:"edit-info"},Ye={key:0,class:"edit-link"},Xe={key:1,class:"last-updated"},Ze={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},nt={class:"pager"},et=["innerHTML"],tt=["innerHTML"],ot={class:"pager"},st=["innerHTML"],at=["innerHTML"],rt=_({__name:"VPDocFooter",setup(n){const{theme:e,page:t,frontmatter:o}=L(),s=Re(),r=ze(),c=y(()=>e.value.editLink&&o.value.editLink!==!1),l=y(()=>t.value.lastUpdated),h=y(()=>c.value||l.value||r.value.prev||r.value.next);return(m,$)=>h.value?(a(),u("footer",Je,[v(m.$slots,"doc-footer-before",{},void 0,!0),c.value||l.value?(a(),u("div",Qe,[c.value?(a(),u("div",Ye,[g(j,{class:"edit-link-button",href:i(s).url,"no-icon":!0},{default:f(()=>[$[0]||($[0]=d("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),z(" "+S(i(s).text),1)]),_:1},8,["href"])])):p("",!0),l.value?(a(),u("div",Xe,[g(qe)])):p("",!0)])):p("",!0),i(r).prev?.link||i(r).next?.link?(a(),u("nav",Ze,[$[1]||($[1]=d("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),d("div",nt,[i(r).prev?.link?(a(),b(j,{key:0,class:"pager-link prev",href:i(r).prev.link},{default:f(()=>[d("span",{class:"desc",innerHTML:i(e).docFooter?.prev||"Previous page"},null,8,et),d("span",{class:"title",innerHTML:i(r).prev.text},null,8,tt)]),_:1},8,["href"])):p("",!0)]),d("div",ot,[i(r).next?.link?(a(),b(j,{key:0,class:"pager-link next",href:i(r).next.link},{default:f(()=>[d("span",{class:"desc",innerHTML:i(e).docFooter?.next||"Next page"},null,8,st),d("span",{class:"title",innerHTML:i(r).next.text},null,8,at)]),_:1},8,["href"])):p("",!0)])])):p("",!0)])):p("",!0)}}),it=k(rt,[["__scopeId","data-v-e257564d"]]),lt={class:"container"},ct={class:"aside-container"},ut={class:"aside-content"},dt={class:"content"},vt={class:"content-container"},ft={class:"main"},ht=_({__name:"VPDoc",setup(n){const{theme:e}=L(),t=en(),{hasSidebar:o,hasAside:s,leftAside:r}=R(),c=y(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(l,h)=>{const m=U("Content");return a(),u("div",{class:N(["VPDoc",{"has-sidebar":i(o),"has-aside":i(s)}])},[v(l.$slots,"doc-top",{},void 0,!0),d("div",lt,[i(s)?(a(),u("div",{key:0,class:N(["aside",{"left-aside":i(r)}])},[h[0]||(h[0]=d("div",{class:"aside-curtain"},null,-1)),d("div",ct,[d("div",ut,[g(Fe,null,{"aside-top":f(()=>[v(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":f(()=>[v(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":f(()=>[v(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":f(()=>[v(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":f(()=>[v(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":f(()=>[v(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):p("",!0),d("div",dt,[d("div",vt,[v(l.$slots,"doc-before",{},void 0,!0),d("main",ft,[g(m,{class:N(["vp-doc",[c.value,i(e).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),g(it,null,{"doc-footer-before":f(()=>[v(l.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),v(l.$slots,"doc-after",{},void 0,!0)])])]),v(l.$slots,"doc-bottom",{},void 0,!0)],2)}}}),mt=k(ht,[["__scopeId","data-v-7011f0d8"]]),pt=_({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(n){const e=n,t=y(()=>e.href&&Nn.test(e.href)),o=y(()=>e.tag||(e.href?"a":"button"));return(s,r)=>(a(),b(E(o.value),{class:N(["VPButton",[n.size,n.theme]]),href:n.href?i(mn)(n.href):void 0,target:e.target??(t.value?"_blank":void 0),rel:e.rel??(t.value?"noreferrer":void 0)},{default:f(()=>[v(s.$slots,"default",{},()=>[z(S(n.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),_t=k(pt,[["__scopeId","data-v-01bff58b"]]),gt=["src","alt"],bt=_({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(n){return(e,t)=>{const o=U("VPImage",!0);return n.image?(a(),u(T,{key:0},[typeof n.image=="string"||"src"in n.image?(a(),u("img",F({key:0,class:"VPImage"},typeof n.image=="string"?e.$attrs:{...n.image,...e.$attrs},{src:i(vn)(typeof n.image=="string"?n.image:n.image.src),alt:n.alt??(typeof n.image=="string"?"":n.image.alt||"")}),null,16,gt)):(a(),u(T,{key:1},[g(o,F({class:"dark",image:n.image.dark,alt:n.image.alt},e.$attrs),null,16,["image","alt"]),g(o,F({class:"light",image:n.image.light,alt:n.image.alt},e.$attrs),null,16,["image","alt"])],64))],64)):p("",!0)}}}),X=k(bt,[["__scopeId","data-v-8426fc1a"]]),kt={class:"container"},$t={class:"main"},yt={class:"heading"},Pt=["innerHTML"],Lt=["innerHTML"],St=["innerHTML"],Vt={key:0,class:"actions"},Tt={key:0,class:"image"},Nt={class:"image-container"},Mt=_({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(n){const{heroImageSlotExists:e}=tn(On);return(t,o)=>(a(),u("div",{class:N(["VPHero",{"has-image":n.image||i(e)}])},[d("div",kt,[d("div",$t,[v(t.$slots,"home-hero-info-before",{},void 0,!0),v(t.$slots,"home-hero-info",{},()=>[d("h1",yt,[n.name?(a(),u("span",{key:0,innerHTML:n.name,class:"name clip"},null,8,Pt)):p("",!0),n.text?(a(),u("span",{key:1,innerHTML:n.text,class:"text"},null,8,Lt)):p("",!0)]),n.tagline?(a(),u("p",{key:0,innerHTML:n.tagline,class:"tagline"},null,8,St)):p("",!0)],!0),v(t.$slots,"home-hero-info-after",{},void 0,!0),n.actions?(a(),u("div",Vt,[(a(!0),u(T,null,C(n.actions,s=>(a(),u("div",{key:s.link,class:"action"},[g(_t,{tag:"a",size:"medium",theme:s.theme,text:s.text,href:s.link,target:s.target,rel:s.rel},null,8,["theme","text","href","target","rel"])]))),128))])):p("",!0),v(t.$slots,"home-hero-actions-after",{},void 0,!0)]),n.image||i(e)?(a(),u("div",Tt,[d("div",Nt,[o[0]||(o[0]=d("div",{class:"image-bg"},null,-1)),v(t.$slots,"home-hero-image",{},()=>[n.image?(a(),b(X,{key:0,class:"image-src",image:n.image},null,8,["image"])):p("",!0)],!0)])])):p("",!0)])],2))}}),Bt=k(Mt,[["__scopeId","data-v-1e96e9e8"]]),At=_({__name:"VPHomeHero",setup(n){const{frontmatter:e}=L();return(t,o)=>i(e).hero?(a(),b(Bt,{key:0,class:"VPHomeHero",name:i(e).hero.name,text:i(e).hero.text,tagline:i(e).hero.tagline,image:i(e).hero.image,actions:i(e).hero.actions},{"home-hero-info-before":f(()=>[v(t.$slots,"home-hero-info-before")]),"home-hero-info":f(()=>[v(t.$slots,"home-hero-info")]),"home-hero-info-after":f(()=>[v(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":f(()=>[v(t.$slots,"home-hero-actions-after")]),"home-hero-image":f(()=>[v(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):p("",!0)}}),wt={class:"box"},xt={key:0,class:"icon"},It=["innerHTML"],Ct=["innerHTML"],Ot=["innerHTML"],Ht={key:4,class:"link-text"},Et={class:"link-text-value"},jt=_({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(n){return(e,t)=>(a(),b(j,{class:"VPFeature",href:n.link,rel:n.rel,target:n.target,"no-icon":!0,tag:n.link?"a":"div"},{default:f(()=>[d("article",wt,[typeof n.icon=="object"&&n.icon.wrap?(a(),u("div",xt,[g(X,{image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])])):typeof n.icon=="object"?(a(),b(X,{key:1,image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])):n.icon?(a(),u("div",{key:2,class:"icon",innerHTML:n.icon},null,8,It)):p("",!0),d("h2",{class:"title",innerHTML:n.title},null,8,Ct),n.details?(a(),u("p",{key:3,class:"details",innerHTML:n.details},null,8,Ot)):p("",!0),n.linkText?(a(),u("div",Ht,[d("p",Et,[z(S(n.linkText)+" ",1),t[0]||(t[0]=d("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):p("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Dt=k(jt,[["__scopeId","data-v-5219619b"]]),Ft={key:0,class:"VPFeatures"},Rt={class:"container"},zt={class:"items"},Gt=_({__name:"VPFeatures",props:{features:{}},setup(n){const e=n,t=y(()=>{const o=e.features.length;if(o){if(o===2)return"grid-2";if(o===3)return"grid-3";if(o%3===0)return"grid-6";if(o>3)return"grid-4"}else return});return(o,s)=>n.features?(a(),u("div",Ft,[d("div",Rt,[d("div",zt,[(a(!0),u(T,null,C(n.features,r=>(a(),u("div",{key:r.title,class:N(["item",[t.value]])},[g(Dt,{icon:r.icon,title:r.title,details:r.details,link:r.link,"link-text":r.linkText,rel:r.rel,target:r.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):p("",!0)}}),Ut=k(Gt,[["__scopeId","data-v-a6181336"]]),Wt=_({__name:"VPHomeFeatures",setup(n){const{frontmatter:e}=L();return(t,o)=>i(e).features?(a(),b(Ut,{key:0,class:"VPHomeFeatures",features:i(e).features},null,8,["features"])):p("",!0)}}),Kt=_({__name:"VPHomeContent",setup(n){const{width:e}=qn({initialWidth:0,includeScrollbar:!1});return(t,o)=>(a(),u("div",{class:"vp-doc container",style:Mn(i(e)?{"--vp-offset":`calc(50% - ${i(e)/2}px)`}:{})},[v(t.$slots,"default",{},void 0,!0)],4))}}),qt=k(Kt,[["__scopeId","data-v-8e2d4988"]]),Jt=_({__name:"VPHome",setup(n){const{frontmatter:e,theme:t}=L();return(o,s)=>{const r=U("Content");return a(),u("div",{class:N(["VPHome",{"external-link-icon-enabled":i(t).externalLinkIcon}])},[v(o.$slots,"home-hero-before",{},void 0,!0),g(At,null,{"home-hero-info-before":f(()=>[v(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":f(()=>[v(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":f(()=>[v(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":f(()=>[v(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":f(()=>[v(o.$slots,"home-hero-image",{},void 0,!0)]),_:3}),v(o.$slots,"home-hero-after",{},void 0,!0),v(o.$slots,"home-features-before",{},void 0,!0),g(Wt),v(o.$slots,"home-features-after",{},void 0,!0),i(e).markdownStyles!==!1?(a(),b(qt,{key:0},{default:f(()=>[g(r)]),_:1})):(a(),b(r,{key:1}))],2)}}}),Qt=k(Jt,[["__scopeId","data-v-8b561e3d"]]),Yt={},Xt={class:"VPPage"};function Zt(n,e){const t=U("Content");return a(),u("div",Xt,[v(n.$slots,"page-top"),g(t),v(n.$slots,"page-bottom")])}const no=k(Yt,[["render",Zt]]),eo=_({__name:"VPContent",setup(n){const{page:e,frontmatter:t}=L(),{isHome:o,hasSidebar:s}=R();return(r,c)=>(a(),u("div",{class:N(["VPContent",{"has-sidebar":i(s),"is-home":i(o)}]),id:"VPContent"},[i(e).isNotFound?v(r.$slots,"not-found",{key:0},()=>[g(pe)],!0):i(t).layout==="page"?(a(),b(no,{key:1},{"page-top":f(()=>[v(r.$slots,"page-top",{},void 0,!0)]),"page-bottom":f(()=>[v(r.$slots,"page-bottom",{},void 0,!0)]),_:3})):i(t).layout==="home"?(a(),b(Qt,{key:2},{"home-hero-before":f(()=>[v(r.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":f(()=>[v(r.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":f(()=>[v(r.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":f(()=>[v(r.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":f(()=>[v(r.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":f(()=>[v(r.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":f(()=>[v(r.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":f(()=>[v(r.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":f(()=>[v(r.$slots,"home-features-after",{},void 0,!0)]),_:3})):i(t).layout&&i(t).layout!=="doc"?(a(),b(E(i(t).layout),{key:3})):(a(),b(mt,{key:4},{"doc-top":f(()=>[v(r.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":f(()=>[v(r.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":f(()=>[v(r.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":f(()=>[v(r.$slots,"doc-before",{},void 0,!0)]),"doc-after":f(()=>[v(r.$slots,"doc-after",{},void 0,!0)]),"aside-top":f(()=>[v(r.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":f(()=>[v(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":f(()=>[v(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":f(()=>[v(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":f(()=>[v(r.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":f(()=>[v(r.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),to=k(eo,[["__scopeId","data-v-c87f25bf"]]),oo={class:"container"},so=["innerHTML"],ao=["innerHTML"],ro=_({__name:"VPFooter",setup(n){const{theme:e,frontmatter:t}=L(),{hasSidebar:o}=R();return(s,r)=>i(e).footer&&i(t).footer!==!1?(a(),u("footer",{key:0,class:N(["VPFooter",{"has-sidebar":i(o)}])},[d("div",oo,[i(e).footer.message?(a(),u("p",{key:0,class:"message",innerHTML:i(e).footer.message},null,8,so)):p("",!0),i(e).footer.copyright?(a(),u("p",{key:1,class:"copyright",innerHTML:i(e).footer.copyright},null,8,ao)):p("",!0)])],2)):p("",!0)}}),io=k(ro,[["__scopeId","data-v-c3855bb3"]]),lo={class:"menu-text"},co={class:"header"},uo={class:"outline"},vo=_({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(n){const e=n,{theme:t}=L(),o=V(!1),s=V(0),r=V(),c=V();function l(P){r.value?.contains(P.target)||(o.value=!1)}H(o,P=>{if(P){document.addEventListener("click",l);return}document.removeEventListener("click",l)}),Jn("Escape",()=>{o.value=!1}),Tn(()=>{o.value=!1});function h(){o.value=!o.value,s.value=window.innerHeight+Math.min(window.scrollY-e.navHeight,0)}function m(P){P.target.classList.contains("outline-link")&&(c.value&&(c.value.style.transition="none"),Y(()=>{o.value=!1}))}function $(){o.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(P,B)=>(a(),u("div",{class:"VPLocalNavOutlineDropdown",style:Mn({"--vp-vh":s.value+"px"}),ref_key:"main",ref:r},[n.headers.length>0?(a(),u("button",{key:0,onClick:h,class:N({open:o.value})},[d("span",lo,S(i(Cn)(i(t))),1),B[0]||(B[0]=d("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(a(),u("button",{key:1,onClick:$},S(i(t).returnToTopLabel||"Return to top"),1)),g(dn,{name:"flyout"},{default:f(()=>[o.value?(a(),u("div",{key:0,ref_key:"items",ref:c,class:"items",onClick:m},[d("div",co,[d("a",{class:"top-link",href:"#",onClick:$},S(i(t).returnToTopLabel||"Return to top"),1)]),d("div",uo,[g(Hn,{headers:n.headers},null,8,["headers"])])],512)):p("",!0)]),_:1})],4))}}),fo=k(vo,[["__scopeId","data-v-0bf0e06f"]]),ho={class:"container"},mo=["aria-expanded"],po={class:"menu-text"},_o=_({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(n){const{theme:e}=L(),{isHome:t,hasSidebar:o,headers:s,hasLocalNav:r}=R(),{y:c}=Bn(),l=V(0);D(()=>{l.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const h=y(()=>({VPLocalNav:!0,"has-sidebar":o.value,empty:!r.value,fixed:!r.value&&!o.value}));return(m,$)=>!i(t)&&(i(r)||i(o)||i(c)>=l.value)?(a(),u("div",{key:0,class:N(h.value)},[d("div",ho,[i(o)?(a(),u("button",{key:0,class:"menu","aria-expanded":n.open,"aria-controls":"VPSidebarNav",onClick:$[0]||($[0]=P=>m.$emit("open-menu"))},[$[1]||($[1]=d("span",{class:"vpi-align-left menu-icon"},null,-1)),d("span",po,S(i(e).sidebarMenuLabel||"Menu"),1)],8,mo)):p("",!0),g(fo,{headers:i(s),navHeight:l.value},null,8,["headers","navHeight"])])],2)):p("",!0)}}),go=k(_o,[["__scopeId","data-v-db738f89"]]);function bo(){const n=V(!1);function e(){n.value=!0,window.addEventListener("resize",s)}function t(){n.value=!1,window.removeEventListener("resize",s)}function o(){n.value?t():e()}function s(){window.outerWidth>=768&&t()}const r=en();return H(()=>r.path,t),{isScreenOpen:n,openScreen:e,closeScreen:t,toggleScreen:o}}const pn=Symbol("nav"),ko={},$o={class:"VPSwitch",type:"button",role:"switch"},yo={class:"check"},Po={key:0,class:"icon"};function Lo(n,e){return a(),u("button",$o,[d("span",yo,[n.$slots.default?(a(),u("span",Po,[v(n.$slots,"default",{},void 0,!0)])):p("",!0)])])}const So=k(ko,[["render",Lo],["__scopeId","data-v-1d5665e3"]]),Vo=_({__name:"VPSwitchAppearance",setup(n){const{isDark:e,theme:t}=L(),o=tn("toggle-appearance",()=>{e.value=!e.value}),s=V("");return hn(()=>{s.value=e.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(r,c)=>(a(),b(So,{title:s.value,class:"VPSwitchAppearance","aria-checked":i(e),onClick:i(o)},{default:f(()=>[...c[0]||(c[0]=[d("span",{class:"vpi-sun sun"},null,-1),d("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),_n=k(Vo,[["__scopeId","data-v-5337faa4"]]),To={key:0,class:"VPNavBarAppearance"},No=_({__name:"VPNavBarAppearance",setup(n){const{site:e}=L();return(t,o)=>i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),u("div",To,[g(_n)])):p("",!0)}}),Mo=k(No,[["__scopeId","data-v-6c893767"]]),gn=V();let En=!1,sn=0;function Bo(n){const e=V(!1);if(q){!En&&Ao(),sn++;const t=H(gn,o=>{o===n.el.value||n.el.value?.contains(o)?(e.value=!0,n.onFocus?.()):(e.value=!1,n.onBlur?.())});fn(()=>{t(),sn--,sn||wo()})}return Qn(e)}function Ao(){document.addEventListener("focusin",jn),En=!0,gn.value=document.activeElement}function wo(){document.removeEventListener("focusin",jn)}function jn(){gn.value=document.activeElement}const xo={class:"VPMenuLink"},Io=["innerHTML"],Co=_({inheritAttrs:!1,__name:"VPMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=L(),o=y(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link);return(s,r)=>(a(),u("div",xo,[g(j,F(s.$attrs,{class:{active:i(G)(i(t).relativePath,n.item.activeMatch||o.value,!!n.item.activeMatch)},href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon}),{default:f(()=>[d("span",{innerHTML:n.item.text},null,8,Io)]),_:1},16,["class","href","target","rel","no-icon"])]))}}),on=k(Co,[["__scopeId","data-v-faf5b206"]]),Oo={class:"VPMenuGroup"},Ho={key:0,class:"title"},Eo=_({__name:"VPMenuGroup",props:{text:{},items:{}},setup(n){return(e,t)=>(a(),u("div",Oo,[n.text?(a(),u("p",Ho,S(n.text),1)):p("",!0),(a(!0),u(T,null,C(n.items,o=>(a(),u(T,{key:JSON.stringify(o)},["link"in o?(a(),b(on,{key:0,item:o},null,8,["item"])):p("",!0)],64))),128))]))}}),jo=k(Eo,[["__scopeId","data-v-1963e1bb"]]),Do={class:"VPMenu"},Fo={key:0,class:"items"},Ro=_({__name:"VPMenu",props:{items:{}},setup(n){return(e,t)=>(a(),u("div",Do,[n.items?(a(),u("div",Fo,[(a(!0),u(T,null,C(n.items,o=>(a(),u(T,{key:JSON.stringify(o)},["link"in o?(a(),b(on,{key:0,item:o},null,8,["item"])):"component"in o?(a(),b(E(o.component),F({key:1,ref_for:!0},o.props),null,16)):(a(),b(jo,{key:2,text:o.text,items:o.items},null,8,["text","items"]))],64))),128))])):p("",!0),v(e.$slots,"default",{},void 0,!0)]))}}),zo=k(Ro,[["__scopeId","data-v-25a6cce8"]]),Go=["aria-expanded","aria-label"],Uo={key:0,class:"text"},Wo=["innerHTML"],Ko={key:1,class:"vpi-more-horizontal icon"},qo={class:"menu"},Jo=_({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(n){const e=V(!1),t=V();Bo({el:t,onBlur:o});function o(){e.value=!1}return(s,r)=>(a(),u("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:r[1]||(r[1]=c=>e.value=!0),onMouseleave:r[2]||(r[2]=c=>e.value=!1)},[d("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":e.value,"aria-label":n.label,onClick:r[0]||(r[0]=c=>e.value=!e.value)},[n.button||n.icon?(a(),u("span",Uo,[n.icon?(a(),u("span",{key:0,class:N([n.icon,"option-icon"])},null,2)):p("",!0),n.button?(a(),u("span",{key:1,innerHTML:n.button},null,8,Wo)):p("",!0),r[3]||(r[3]=d("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(a(),u("span",Ko))],8,Go),d("div",qo,[g(zo,{items:n.items},{default:f(()=>[v(s.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),bn=k(Jo,[["__scopeId","data-v-42cb505d"]]),Qo=["href","aria-label","rel","innerHTML"],Yo=_({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(n){const e=n,t=V();D(async()=>{await Y();const s=t.value?.children[0];s instanceof HTMLElement&&s.className.startsWith("vpi-social-")&&(getComputedStyle(s).maskImage||getComputedStyle(s).webkitMaskImage)==="none"&&s.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${e.icon}.svg')`)});const o=y(()=>typeof e.icon=="object"?e.icon.svg:`<span class="vpi-social-${e.icon}"></span>`);return(s,r)=>(a(),u("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:n.link,"aria-label":n.ariaLabel??(typeof n.icon=="string"?n.icon:""),target:"_blank",rel:n.me?"me noopener":"noopener",innerHTML:o.value},null,8,Qo))}}),Xo=k(Yo,[["__scopeId","data-v-591a6b30"]]),Zo={class:"VPSocialLinks"},ns=_({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(n){return(e,t)=>(a(),u("div",Zo,[(a(!0),u(T,null,C(n.links,({link:o,icon:s,ariaLabel:r})=>(a(),b(Xo,{key:o,icon:s,link:o,ariaLabel:r,me:n.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),kn=k(ns,[["__scopeId","data-v-d07f11e6"]]),es={key:0,class:"group translations"},ts={class:"trans-title"},os={key:1,class:"group"},ss={class:"item appearance"},as={class:"label"},rs={class:"appearance-action"},is={key:2,class:"group"},ls={class:"item social-links"},cs=_({__name:"VPNavBarExtra",setup(n){const{site:e,theme:t}=L(),{localeLinks:o,currentLang:s}=J({correspondingLink:!0}),r=y(()=>o.value.length&&s.value.label||e.value.appearance||t.value.socialLinks);return(c,l)=>r.value?(a(),b(bn,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:f(()=>[i(o).length&&i(s).label?(a(),u("div",es,[d("p",ts,S(i(s).label),1),(a(!0),u(T,null,C(i(o),h=>(a(),b(on,{key:h.link,item:h,lang:h.lang,dir:h.dir},null,8,["item","lang","dir"]))),128))])):p("",!0),i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),u("div",os,[d("div",ss,[d("p",as,S(i(t).darkModeSwitchLabel||"Appearance"),1),d("div",rs,[g(_n)])])])):p("",!0),i(t).socialLinks?(a(),u("div",is,[d("div",ls,[g(kn,{class:"social-links-list",links:i(t).socialLinks},null,8,["links"])])])):p("",!0)]),_:1})):p("",!0)}}),us=k(cs,[["__scopeId","data-v-bf2fac68"]]),ds=["aria-expanded"],vs=_({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(n){return(e,t)=>(a(),u("button",{type:"button",class:N(["VPNavBarHamburger",{active:n.active}]),"aria-label":"mobile navigation","aria-expanded":n.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=o=>e.$emit("click"))},[...t[1]||(t[1]=[d("span",{class:"container"},[d("span",{class:"top"}),d("span",{class:"middle"}),d("span",{class:"bottom"})],-1)])],10,ds))}}),fs=k(vs,[["__scopeId","data-v-e5dd9c1c"]]),hs=["innerHTML"],ms=_({__name:"VPNavBarMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=L(),o=y(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link);return(s,r)=>(a(),b(j,{class:N({VPNavBarMenuLink:!0,active:i(G)(i(t).relativePath,n.item.activeMatch||o.value,!!n.item.activeMatch)}),href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,tabindex:"0"},{default:f(()=>[d("span",{innerHTML:n.item.text},null,8,hs)]),_:1},8,["class","href","target","rel","no-icon"]))}}),ps=k(ms,[["__scopeId","data-v-52a1d768"]]),_s=_({__name:"VPNavBarMenuGroup",props:{item:{}},setup(n){const e=n,{page:t}=L(),o=r=>"component"in r?!1:"link"in r?G(t.value.relativePath,typeof r.link=="function"?r.link(t.value):r.link,!!e.item.activeMatch):r.items.some(o),s=y(()=>o(e.item));return(r,c)=>(a(),b(bn,{class:N({VPNavBarMenuGroup:!0,active:i(G)(i(t).relativePath,n.item.activeMatch,!!n.item.activeMatch)||s.value}),button:n.item.text,items:n.item.items},null,8,["class","button","items"]))}}),gs={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},bs=_({__name:"VPNavBarMenu",setup(n){const{theme:e}=L();return(t,o)=>i(e).nav?(a(),u("nav",gs,[o[0]||(o[0]=d("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(a(!0),u(T,null,C(i(e).nav,s=>(a(),u(T,{key:JSON.stringify(s)},["link"in s?(a(),b(ps,{key:0,item:s},null,8,["item"])):"component"in s?(a(),b(E(s.component),F({key:1,ref_for:!0},s.props),null,16)):(a(),b(_s,{key:2,item:s},null,8,["item"]))],64))),128))])):p("",!0)}}),ks=k(bs,[["__scopeId","data-v-39714824"]]);function $s(n){const{localeIndex:e,theme:t}=L();function o(s){const r=s.split("."),c=t.value.search?.options,l=c&&typeof c=="object",h=l&&c.locales?.[e.value]?.translations||null,m=l&&c.translations||null;let $=h,P=m,B=n;const A=r.pop();for(const M of r){let w=null;const x=B?.[M];x&&(w=B=x);const I=P?.[M];I&&(w=P=I);const O=$?.[M];O&&(w=$=O),x||(B=w),I||(P=w),O||($=w)}return $?.[A]??P?.[A]??B?.[A]??""}return o}const ys=["aria-label"],Ps={class:"DocSearch-Button-Container"},Ls={class:"DocSearch-Button-Placeholder"},Ln=_({__name:"VPNavBarSearchButton",setup(n){const t=$s({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(o,s)=>(a(),u("button",{type:"button","aria-label":i(t)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[d("span",Ps,[s[0]||(s[0]=d("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),d("span",Ls,S(i(t)("button.buttonText")),1)]),s[1]||(s[1]=d("span",{class:"DocSearch-Button-Keys"},[d("kbd",{class:"DocSearch-Button-Key"}),d("kbd",{class:"DocSearch-Button-Key"})],-1))],8,ys))}}),Ss={class:"VPNavBarSearch"},Vs={id:"local-search"},Ts={key:1,id:"docsearch"},Ns=_({__name:"VPNavBarSearch",setup(n){const e=()=>null,t=()=>null,{theme:o}=L(),s=V(!1),r=V(!1);D(()=>{});function c(){s.value||(s.value=!0,setTimeout(l,16))}function l(){const $=new Event("keydown");$.key="k",$.metaKey=!0,window.dispatchEvent($),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||l()},16)}const h=V(!1),m="";return($,P)=>(a(),u("div",Ss,[i(m)==="local"?(a(),u(T,{key:0},[h.value?(a(),b(i(e),{key:0,onClose:P[0]||(P[0]=B=>h.value=!1)})):p("",!0),d("div",Vs,[g(Ln,{onClick:P[1]||(P[1]=B=>h.value=!0)})])],64)):i(m)==="algolia"?(a(),u(T,{key:1},[s.value?(a(),b(i(t),{key:0,algolia:i(o).search?.options??i(o).algolia,onVnodeBeforeMount:P[2]||(P[2]=B=>r.value=!0)},null,8,["algolia"])):p("",!0),r.value?p("",!0):(a(),u("div",Ts,[g(Ln,{onClick:c})]))],64)):p("",!0)]))}}),Ms=_({__name:"VPNavBarSocialLinks",setup(n){const{theme:e}=L();return(t,o)=>i(e).socialLinks?(a(),b(kn,{key:0,class:"VPNavBarSocialLinks",links:i(e).socialLinks},null,8,["links"])):p("",!0)}}),Bs=k(Ms,[["__scopeId","data-v-0394ad82"]]),As=["href","rel","target"],ws=["innerHTML"],xs={key:2},Is=_({__name:"VPNavBarTitle",setup(n){const{site:e,theme:t}=L(),{hasSidebar:o}=R(),{currentLang:s}=J(),r=y(()=>typeof t.value.logoLink=="string"?t.value.logoLink:t.value.logoLink?.link),c=y(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.rel),l=y(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.target);return(h,m)=>(a(),u("div",{class:N(["VPNavBarTitle",{"has-sidebar":i(o)}])},[d("a",{class:"title",href:r.value??i(mn)(i(s).link),rel:c.value,target:l.value},[v(h.$slots,"nav-bar-title-before",{},void 0,!0),i(t).logo?(a(),b(X,{key:0,class:"logo",image:i(t).logo},null,8,["image"])):p("",!0),i(t).siteTitle?(a(),u("span",{key:1,innerHTML:i(t).siteTitle},null,8,ws)):i(t).siteTitle===void 0?(a(),u("span",xs,S(i(e).title),1)):p("",!0),v(h.$slots,"nav-bar-title-after",{},void 0,!0)],8,As)],2))}}),Cs=k(Is,[["__scopeId","data-v-1e38c6bc"]]),Os={class:"items"},Hs={class:"title"},Es=_({__name:"VPNavBarTranslations",setup(n){const{theme:e}=L(),{localeLinks:t,currentLang:o}=J({correspondingLink:!0});return(s,r)=>i(t).length&&i(o).label?(a(),b(bn,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:i(e).langMenuLabel||"Change language"},{default:f(()=>[d("div",Os,[d("p",Hs,S(i(o).label),1),(a(!0),u(T,null,C(i(t),c=>(a(),b(on,{key:c.link,item:c,lang:c.lang,dir:c.dir},null,8,["item","lang","dir"]))),128))])]),_:1},8,["label"])):p("",!0)}}),js=k(Es,[["__scopeId","data-v-4c1766e2"]]),Ds={class:"wrapper"},Fs={class:"container"},Rs={class:"title"},zs={class:"content"},Gs={class:"content-body"},Us=_({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(n){const e=n,{y:t}=Bn(),{isHome:o,hasSidebar:s}=R(),r=V({});return hn(()=>{r.value={"has-sidebar":s.value,home:o.value,top:t.value===0,"screen-open":e.isScreenOpen}}),(c,l)=>(a(),u("div",{class:N(["VPNavBar",r.value])},[d("div",Ds,[d("div",Fs,[d("div",Rs,[g(Cs,null,{"nav-bar-title-before":f(()=>[v(c.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":f(()=>[v(c.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),d("div",zs,[d("div",Gs,[v(c.$slots,"nav-bar-content-before",{},void 0,!0),g(Ns,{class:"search"}),g(ks,{class:"menu"}),g(js,{class:"translations"}),g(Mo,{class:"appearance"}),g(Bs,{class:"social-links"}),g(us,{class:"extra"}),v(c.$slots,"nav-bar-content-after",{},void 0,!0),g(fs,{class:"hamburger",active:n.isScreenOpen,onClick:l[0]||(l[0]=h=>c.$emit("toggle-screen"))},null,8,["active"])])])])]),l[1]||(l[1]=d("div",{class:"divider"},[d("div",{class:"divider-line"})],-1))],2))}}),Ws=k(Us,[["__scopeId","data-v-70946a35"]]),Ks={key:0,class:"VPNavScreenAppearance"},qs={class:"text"},Js=_({__name:"VPNavScreenAppearance",setup(n){const{site:e,theme:t}=L();return(o,s)=>i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),u("div",Ks,[d("p",qs,S(i(t).darkModeSwitchLabel||"Appearance"),1),g(_n)])):p("",!0)}}),Qs=k(Js,[["__scopeId","data-v-b44890b2"]]),Ys=["innerHTML"],Xs=_({__name:"VPNavScreenMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=L(),o=y(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link),{closeScreen:s}=tn(pn);return(r,c)=>(a(),b(j,{class:"VPNavScreenMenuLink",href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:i(s)},{default:f(()=>[d("span",{innerHTML:n.item.text},null,8,Ys)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Zs=k(Xs,[["__scopeId","data-v-7d55a1c1"]]),na=["innerHTML"],ea=_({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(n){const e=n,{page:t}=L(),o=y(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link),{closeScreen:s}=tn(pn);return(r,c)=>(a(),b(j,{class:"VPNavScreenMenuGroupLink",href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:i(s)},{default:f(()=>[d("span",{innerHTML:n.item.text},null,8,na)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Dn=k(ea,[["__scopeId","data-v-49e5ec9f"]]),ta={class:"VPNavScreenMenuGroupSection"},oa={key:0,class:"title"},sa=_({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(n){return(e,t)=>(a(),u("div",ta,[n.text?(a(),u("p",oa,S(n.text),1)):p("",!0),(a(!0),u(T,null,C(n.items,o=>(a(),b(Dn,{key:o.text,item:o},null,8,["item"]))),128))]))}}),aa=k(sa,[["__scopeId","data-v-4b7a798b"]]),ra=["aria-controls","aria-expanded"],ia=["innerHTML"],la=["id"],ca={key:0,class:"item"},ua={key:1,class:"item"},da={key:2,class:"group"},va=_({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(n){const e=n,t=V(!1),o=y(()=>`NavScreenGroup-${e.text.replace(" ","-").toLowerCase()}`);function s(){t.value=!t.value}return(r,c)=>(a(),u("div",{class:N(["VPNavScreenMenuGroup",{open:t.value}])},[d("button",{class:"button","aria-controls":o.value,"aria-expanded":t.value,onClick:s},[d("span",{class:"button-text",innerHTML:n.text},null,8,ia),c[0]||(c[0]=d("span",{class:"vpi-plus button-icon"},null,-1))],8,ra),d("div",{id:o.value,class:"items"},[(a(!0),u(T,null,C(n.items,l=>(a(),u(T,{key:JSON.stringify(l)},["link"in l?(a(),u("div",ca,[g(Dn,{item:l},null,8,["item"])])):"component"in l?(a(),u("div",ua,[(a(),b(E(l.component),F({ref_for:!0},l.props,{"screen-menu":""}),null,16))])):(a(),u("div",da,[g(aa,{text:l.text,items:l.items},null,8,["text","items"])]))],64))),128))],8,la)],2))}}),fa=k(va,[["__scopeId","data-v-956364f9"]]),ha={key:0,class:"VPNavScreenMenu"},ma=_({__name:"VPNavScreenMenu",setup(n){const{theme:e}=L();return(t,o)=>i(e).nav?(a(),u("nav",ha,[(a(!0),u(T,null,C(i(e).nav,s=>(a(),u(T,{key:JSON.stringify(s)},["link"in s?(a(),b(Zs,{key:0,item:s},null,8,["item"])):"component"in s?(a(),b(E(s.component),F({key:1,ref_for:!0},s.props,{"screen-menu":""}),null,16)):(a(),b(fa,{key:2,text:s.text||"",items:s.items},null,8,["text","items"]))],64))),128))])):p("",!0)}}),pa=_({__name:"VPNavScreenSocialLinks",setup(n){const{theme:e}=L();return(t,o)=>i(e).socialLinks?(a(),b(kn,{key:0,class:"VPNavScreenSocialLinks",links:i(e).socialLinks},null,8,["links"])):p("",!0)}}),_a={class:"list"},ga=_({__name:"VPNavScreenTranslations",setup(n){const{localeLinks:e,currentLang:t}=J({correspondingLink:!0}),o=V(!1);function s(){o.value=!o.value}return(r,c)=>i(e).length&&i(t).label?(a(),u("div",{key:0,class:N(["VPNavScreenTranslations",{open:o.value}])},[d("button",{class:"title",onClick:s},[c[0]||(c[0]=d("span",{class:"vpi-languages icon lang"},null,-1)),z(" "+S(i(t).label)+" ",1),c[1]||(c[1]=d("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),d("ul",_a,[(a(!0),u(T,null,C(i(e),l=>(a(),u("li",{key:l.link,class:"item"},[g(j,{class:"link",href:l.link,lang:l.lang,dir:l.dir},{default:f(()=>[z(S(l.text),1)]),_:2},1032,["href","lang","dir"])]))),128))])],2)):p("",!0)}}),ba=k(ga,[["__scopeId","data-v-a4d9b172"]]),ka={class:"container"},$a=_({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(n){const e=V(null),t=An(q?document.body:null);return(o,s)=>(a(),b(dn,{name:"fade",onEnter:s[0]||(s[0]=r=>t.value=!0),onAfterLeave:s[1]||(s[1]=r=>t.value=!1)},{default:f(()=>[n.open?(a(),u("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:e,id:"VPNavScreen"},[d("div",ka,[v(o.$slots,"nav-screen-content-before",{},void 0,!0),g(ma,{class:"menu"}),g(ba,{class:"translations"}),g(Qs,{class:"appearance"}),g(pa,{class:"social-links"}),v(o.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):p("",!0)]),_:3}))}}),ya=k($a,[["__scopeId","data-v-f2779853"]]),Pa={key:0,class:"VPNav"},La=_({__name:"VPNav",setup(n){const{isScreenOpen:e,closeScreen:t,toggleScreen:o}=bo(),{frontmatter:s}=L(),r=y(()=>s.value.navbar!==!1);return wn(pn,{closeScreen:t}),Z(()=>{q&&document.documentElement.classList.toggle("hide-nav",!r.value)}),(c,l)=>r.value?(a(),u("header",Pa,[g(Ws,{"is-screen-open":i(e),onToggleScreen:i(o)},{"nav-bar-title-before":f(()=>[v(c.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":f(()=>[v(c.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":f(()=>[v(c.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":f(()=>[v(c.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),g(ya,{open:i(e)},{"nav-screen-content-before":f(()=>[v(c.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":f(()=>[v(c.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):p("",!0)}}),Sa=k(La,[["__scopeId","data-v-da52a441"]]),Va=["role","tabindex"],Ta={key:1,class:"items"},Na=_({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(n){const e=n,{collapsed:t,collapsible:o,isLink:s,isActiveLink:r,hasActiveLink:c,hasChildren:l,toggle:h}=Me(y(()=>e.item)),m=y(()=>l.value?"section":"div"),$=y(()=>s.value?"a":"div"),P=y(()=>l.value?e.depth+2===7?"p":`h${e.depth+2}`:"p"),B=y(()=>s.value?void 0:"button"),A=y(()=>[[`level-${e.depth}`],{collapsible:o.value},{collapsed:t.value},{"is-link":s.value},{"is-active":r.value},{"has-active":c.value}]);function M(x){"key"in x&&x.key!=="Enter"||!e.item.link&&h()}function w(){e.item.link&&h()}return(x,I)=>{const O=U("VPSidebarItem",!0);return a(),b(E(m.value),{class:N(["VPSidebarItem",A.value])},{default:f(()=>[n.item.text?(a(),u("div",F({key:0,class:"item",role:B.value},Yn(n.item.items?{click:M,keydown:M}:{},!0),{tabindex:n.item.items&&0}),[I[1]||(I[1]=d("div",{class:"indicator"},null,-1)),n.item.link?(a(),b(j,{key:0,tag:$.value,class:"link",href:n.item.link,rel:n.item.rel,target:n.item.target},{default:f(()=>[(a(),b(E(P.value),{class:"text",innerHTML:n.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(a(),b(E(P.value),{key:1,class:"text",innerHTML:n.item.text},null,8,["innerHTML"])),n.item.collapsed!=null&&n.item.items&&n.item.items.length?(a(),u("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:w,onKeydown:Xn(w,["enter"]),tabindex:"0"},[...I[0]||(I[0]=[d("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):p("",!0)],16,Va)):p("",!0),n.item.items&&n.item.items.length?(a(),u("div",Ta,[n.depth<5?(a(!0),u(T,{key:0},C(n.item.items,$n=>(a(),b(O,{key:$n.text,item:$n,depth:n.depth+1},null,8,["item","depth"]))),128)):p("",!0)])):p("",!0)]),_:1},8,["class"])}}}),Ma=k(Na,[["__scopeId","data-v-d81de50c"]]),Ba=_({__name:"VPSidebarGroup",props:{items:{}},setup(n){const e=V(!0);let t=null;return D(()=>{t=setTimeout(()=>{t=null,e.value=!1},300)}),Zn(()=>{t!=null&&(clearTimeout(t),t=null)}),(o,s)=>(a(!0),u(T,null,C(n.items,r=>(a(),u("div",{key:r.text,class:N(["group",{"no-transition":e.value}])},[g(Ma,{item:r,depth:0},null,8,["item"])],2))),128))}}),Aa=k(Ba,[["__scopeId","data-v-8d50c081"]]),wa={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},xa=_({__name:"VPSidebar",props:{open:{type:Boolean}},setup(n){const{sidebarGroups:e,hasSidebar:t}=R(),o=n,s=V(null),r=An(q?document.body:null);H([o,s],()=>{o.open?(r.value=!0,s.value?.focus()):r.value=!1},{immediate:!0,flush:"post"});const c=V(0);return H(e,()=>{c.value+=1},{deep:!0}),(l,h)=>i(t)?(a(),u("aside",{key:0,class:N(["VPSidebar",{open:n.open}]),ref_key:"navEl",ref:s,onClick:h[0]||(h[0]=ne(()=>{},["stop"]))},[h[2]||(h[2]=d("div",{class:"curtain"},null,-1)),d("nav",wa,[h[1]||(h[1]=d("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),v(l.$slots,"sidebar-nav-before",{},void 0,!0),(a(),b(Aa,{items:i(e),key:c.value},null,8,["items"])),v(l.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):p("",!0)}}),Ia=k(xa,[["__scopeId","data-v-af661f50"]]),Ca={href:"#VPContent",class:"VPSkipLink visually-hidden"},Oa=_({__name:"VPSkipLink",setup(n){const{theme:e}=L(),t=en(),o=V();return H(()=>t.path,()=>o.value.focus()),(s,r)=>(a(),u(T,null,[d("span",{ref_key:"backToTop",ref:o,tabindex:"-1"},null,512),d("a",Ca,S(i(e).skipToContentLabel||"Skip to content"),1)],64))}}),Ha=k(Oa,[["__scopeId","data-v-331ec75c"]]),Ea=_({__name:"Layout",setup(n){const{isOpen:e,open:t,close:o}=Ne();Be({closeSidebar:o});const{frontmatter:s}=L(),r=ee(),c=y(()=>!!r["home-hero-image"]);return wn(On,{heroImageSlotExists:c}),(l,h)=>{const m=U("Content");return i(s).layout!==!1?(a(),u("div",{key:0,class:N(["Layout",i(s).pageClass])},[v(l.$slots,"layout-top",{},void 0,!0),g(Ha),g(re,{class:"backdrop",show:i(e),onClick:i(o)},null,8,["show","onClick"]),g(Sa,null,{"nav-bar-title-before":f(()=>[v(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":f(()=>[v(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":f(()=>[v(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":f(()=>[v(l.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":f(()=>[v(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":f(()=>[v(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),g(go,{open:i(e),onOpenMenu:i(t)},null,8,["open","onOpenMenu"]),g(Ia,{open:i(e)},{"sidebar-nav-before":f(()=>[v(l.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":f(()=>[v(l.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),g(to,null,{"page-top":f(()=>[v(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":f(()=>[v(l.$slots,"page-bottom",{},void 0,!0)]),"not-found":f(()=>[v(l.$slots,"not-found",{},void 0,!0)]),"home-hero-before":f(()=>[v(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":f(()=>[v(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":f(()=>[v(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":f(()=>[v(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":f(()=>[v(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":f(()=>[v(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":f(()=>[v(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":f(()=>[v(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":f(()=>[v(l.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":f(()=>[v(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":f(()=>[v(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":f(()=>[v(l.$slots,"doc-after",{},void 0,!0)]),"doc-top":f(()=>[v(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":f(()=>[v(l.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":f(()=>[v(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":f(()=>[v(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":f(()=>[v(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":f(()=>[v(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":f(()=>[v(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":f(()=>[v(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),g(io),v(l.$slots,"layout-bottom",{},void 0,!0)],2)):(a(),b(m,{key:1}))}}}),ja=k(Ea,[["__scopeId","data-v-1df9f90f"]]),Fn={Layout:ja,enhanceApp:({app:n})=>{n.component("Badge",oe)}},Da={key:0,class:"age-warning-overlay"},Sn="age_verified",Fa=365,Ra=_({__name:"AgeWarning",setup(n){const e=V(!1);function t(c,l,h){const m=new Date;m.setTime(m.getTime()+h*24*60*60*1e3);const $=`expires=${m.toUTCString()}`;document.cookie=`${c}=${l};${$};path=/;SameSite=Strict`}function o(c){const l=c+"=",h=document.cookie.split(";");for(let m=0;m<h.length;m++){let $=h[m];for(;$.charAt(0)===" ";)$=$.substring(1,$.length);if($.indexOf(l)===0)return $.substring(l.length,$.length)}return null}function s(){t(Sn,"true",Fa),e.value=!1}function r(){window.location.href="https://tv.cctv.com/2013/09/02/VIDE1378113141436780.shtml"}return D(()=>{o(Sn)||(e.value=!0)}),(c,l)=>(a(),b(te,{to:"body"},[e.value?(a(),u("div",Da,[d("div",{class:"age-warning-modal"},[l[0]||(l[0]=d("div",{class:"warning-icon"},"🔞",-1)),l[1]||(l[1]=d("h2",null,"未成年人禁止入内",-1)),l[2]||(l[2]=d("p",null,"本站包含成人内容，仅限18岁及以上人士访问。",-1)),l[3]||(l[3]=d("p",{class:"warning-detail"}," 继续访问即表示您已年满18周岁，并同意浏览成人内容。 ",-1)),d("div",{class:"warning-buttons"},[d("button",{onClick:s,class:"btn-confirm"}," 是，我已年满18岁 "),d("button",{onClick:r,class:"btn-reject"}," 否，我未满18岁 ")])])])):p("",!0)]))}}),za=k(Ra,[["__scopeId","data-v-b11830fb"]]),Ga=_({__name:"Layout",setup(n){const{Layout:e}=Fn,{isDark:t}=Vn(),o=xn(),s=c=>{document.querySelector("iframe.giscus-frame")?.contentWindow?.postMessage({giscus:{setConfig:{theme:c}}},"https://giscus.app")},r=()=>{const c=document.querySelector(".giscus-wrapper");if(!c)return;const l=c.querySelector("iframe.giscus-frame"),h=t.value?"dark":"light";if(l){s(h);return}const m=document.createElement("script");m.src="https://giscus.app/client.js",m.setAttribute("data-repo","NatsumiXD/novel-comment"),m.setAttribute("data-repo-id","R_kgDOQshs6w"),m.setAttribute("data-category","Announcements"),m.setAttribute("data-category-id","DIC_kwDOQshs684C0EPb"),m.setAttribute("data-mapping","pathname"),m.setAttribute("data-strict","1"),m.setAttribute("data-reactions-enabled","1"),m.setAttribute("data-emit-metadata","0"),m.setAttribute("data-input-position","bottom"),m.setAttribute("data-theme",h),m.setAttribute("data-lang","zh-CN"),m.setAttribute("crossorigin","anonymous"),m.async=!0,m.onload=()=>s(h),c.appendChild(m)};return D(()=>{Y(()=>setTimeout(r,50))}),H(t,c=>{s(c?"dark":"light")},{flush:"post"}),H(()=>o.route.path,()=>{Y(()=>setTimeout(r,50))},{flush:"post"}),(c,l)=>(a(),b(i(e),null,{"layout-top":f(()=>[g(za)]),"doc-after":f(()=>[...l[0]||(l[0]=[d("div",{class:"giscus-wrapper"},null,-1)])]),_:1}))}}),Ua=k(Ga,[["__scopeId","data-v-bce2e75a"]]),Wa={},Ka={class:"not-found"};function qa(n,e){return a(),u("div",Ka,[...e[0]||(e[0]=[d("div",{class:"not-found__bubble"},[d("p",{class:"not-found__code"},"404"),d("h1",null,"迷路啦！"),d("p",null,"这里是次元夹缝，路标被史莱姆吃掉了。"),d("p",null,"别慌，跟着导航猫娘回去就好喵！"),d("a",{class:"not-found__button",href:"/"},"喵呜~ 带我回首页"),d("p",{class:"not-found__tip"},"一直往前会抵达未来，但换个方向更快找到想要的世界。")],-1)])])}const Ja=k(Wa,[["render",qa],["__scopeId","data-v-2020f3db"]]),Qa=`---
order: 1
---
...
`,Ya=Object.freeze(Object.defineProperty({__proto__:null,default:Qa},Symbol.toStringTag,{value:"Module"})),Xa=`---
order: 1
---
...
而床上，两个被禁忌的欲望和温暖的体温缠绕在一起的灵魂，才刚刚开始面对他们崭新、混乱、而又无法分割的未来。`,Za=Object.freeze(Object.defineProperty({__proto__:null,default:Xa},Symbol.toStringTag,{value:"Module"})),nr=`---
order: 2
---
...
⚠️ **警告**: 本作品包含成人内容，仅限18岁以上读者阅读。
`,er=Object.freeze(Object.defineProperty({__proto__:null,default:nr},Symbol.toStringTag,{value:"Module"})),tr={key:0,class:"chapter-list"},or=["href"],sr=_({__name:"ChapterList",props:{novel:{},novelPath:{default:()=>""}},setup(n){const e=n;xn();const t=y(()=>e.novelPath||e.novel),o=y(()=>{const s=Object.assign({"/articles/ark/index.md":Ya,"/articles/tsandsis/chapter1.md":Za,"/articles/tsandsis/index.md":er}),r=h=>{if(typeof h=="string")return h;if(h&&typeof h=="object"){const m=h.__content;if(typeof m=="string")return m;const $=h.default;if(typeof $=="string")return $}return""},c=[],l=t.value;return Object.entries(s).forEach(([h,m])=>{const $=h.match(new RegExp(`/articles/${l}/(.+?)\\.md$`));if(!$)return;const P=$[1];if(P==="index")return;const B=r(m),A=B.match(/^---\s*\n([\s\S]*?)\n---/);let M=999,w=P;if(A){const I=A[1].match(/order:\s*(\d+)/);I&&(M=parseInt(I[1],10))}const x=B.match(/^#\s+(.+)$/m);x&&(w=x[1]),c.push({order:M,title:w,path:`/articles/${l}/${P}`})}),c.sort((h,m)=>h.order-m.order)});return(s,r)=>o.value.length>0?(a(),u("div",tr,[r[0]||(r[0]=d("h2",null,"章节列表",-1)),d("ul",null,[(a(!0),u(T,null,C(o.value,c=>(a(),u("li",{key:c.path},[d("a",{href:c.path},S(c.title),9,or)]))),128))])])):p("",!0)}}),ar=k(sr,[["__scopeId","data-v-2681bc47"]]),rr=`---
order: 2
---
...
雪原的风裹挟着冰冷的雪花涌入洞口，试图冷却她们滚烫的肌肤和仍在分泌情动液体的隐秘地带，却徒劳无功。一前一后的身影，在苍茫雪地上投下扭曲纠缠、仿佛永生永世无法分离的影子。她们没有结合，没有亲吻，但空气中弥漫的、那混合着纯粹生殖渴望与原始情欲的、浓烈到令人窒息的张力，比任何身体的交合都更加惊心动魄，更加蚀骨销魂。这份在血与火、冰与欲、生与死的边缘淬炼出的生殖吸引，是灵魂与肉体的双重献祭，是征服与臣服的永恒悖论，是毁灭与重生的极致轮回。它如同一个未完成的、充满致命诱惑的生殖仪式，在寂静的雪原上、在她们每一次心跳的间隙里，无声地呼唤着下一次更加炽热、更加彻底的沉沦。直到她们在彼此的爱欲之火中，完成生命本能最原始、最澎湃的终极召唤——在极致的生殖结合中找到那唯一的、永恒的归宿，或在创造与毁灭的顶点化为灰烬。`,ir=Object.freeze(Object.defineProperty({__proto__:null,default:rr},Symbol.toStringTag,{value:"Module"})),lr=`---
order: 1
---
...
`,cr=Object.freeze(Object.defineProperty({__proto__:null,default:lr},Symbol.toStringTag,{value:"Module"})),ur=`---
order: 2
---
...
只有小屋“主人们”和能天使知道真相。羞涩优雅音乐家没病。她只是被彻底心甘情愿重塑成只为欲望存在沉迷轮奸快感时刻需要填满的——性奴。堕落的乐章已然奏响永不停歇。每个白天是在跳蛋嗡鸣中煎熬等待夜晚降临前奏。每个夜晚小屋都成为她彻底沉沦献祭自我的祭坛。直到虚脱直到意识只剩色欲直到美丽躯壳被彻底开发使用殆尽。（完）`,fr=Object.freeze(Object.defineProperty({__proto__:null,default:vr},Symbol.toStringTag,{value:"Module"})),hr=`---
order: 2
title: 阿尔图罗的派对(?)
---
...
`,Mr=Object.freeze(Object.defineProperty({__proto__:null,default:Nr},Symbol.toStringTag,{value:"Module"})),Br=`---
order: 1
title: 变成泡芙的能天使~
---
...
这是N系列的简介。
`,Ar=Object.freeze(Object.defineProperty({__proto__:null,default:Br},Symbol.toStringTag,{value:"Module"})),wr={class:"ark-chapter-list"},xr={key:0,class:"section-a"},Ir=["href"],Cr={key:1,class:"section-b"},Or={key:0},Hr=["href"],Er=_({__name:"ARKChapterList",setup(n){const e=y(()=>{const t=h=>typeof h=="string"?h:h&&typeof h.default=="string"?h.default:h&&typeof h.__content=="string"?h.__content:"",o=Object.assign({"/articles/ark/A/A.1.md":ir}),s=[];Object.entries(o).forEach(([h,m])=>{const $=h.match(/\/articles\/ark\/A\/(.+?)\.md$/);if(!$)return;const P=$[1],B=t(m),A=B.match(/^---\s*\n([\s\S]*?)\n---/);let M=999,w=P;if(A){const I=A[1].match(/order:\s*(\d+)/);I&&(M=parseInt(I[1],10))}const x=B.match(/^#\s+(.+)$/m);x&&(w=x[1]),s.push({order:M,title:w,path:`/articles/ark/A/${P}`})}),s.sort((h,m)=>h.order-m.order);const r=Object.assign({"/articles/ark/B/A/B.A.1and2.md":cr,"/articles/ark/B/A/B.A.3and4.md":dr,"/articles/ark/B/A/B.A.5and6.md":fr,"/articles/ark/B/A/index.md":mr,"/articles/ark/B/N/B.N.1.md":_r,"/articles/ark/B/N/B.N.2.md":br,"/articles/ark/B/N/B.N.3.md":$r,"/articles/ark/B/N/B.N.4.md":Pr,"/articles/ark/B/N/B.N.5.1.md":Sr,"/articles/ark/B/N/B.N.5.2.md":Tr,"/articles/ark/B/N/B.N.6.md":Mr,"/articles/ark/B/N/index.md":Ar}),c=new Map;Object.entries(r).forEach(([h,m])=>{const $=h.match(/\/articles\/ark\/B\/(\w+)\/(.+?)\.md$/);if(!$)return;const[,P,B]=$,A=t(m);if(B==="index"){const M=A.match(/^---\s*\n([\s\S]*?)\n---/);let w=999,x=P;if(M){const O=M[1].match(/order:\s*(\d+)/);O&&(w=parseInt(O[1],10))}const I=A.match(/^#\s+(.+)$/m);if(I)x=I[1];else if(M){const O=M[1].match(/title:\s*(.+)/);O&&(x=O[1].trim())}if(!c.has(P))c.set(P,{name:P,order:w,title:x,chapters:[]});else{const O=c.get(P);O.order=w,O.title=x}}else{const M=A.match(/^---\s*\n([\s\S]*?)\n---/);let w=999,x=B;if(M){const O=M[1].match(/order:\s*(\d+)/);O&&(w=parseInt(O[1],10))}const I=A.match(/^#\s+(.+)$/m);I&&(x=I[1]),c.has(P)||c.set(P,{name:P,order:999,title:P,chapters:[]}),c.get(P).chapters.push({order:w,title:x,path:`/articles/ark/B/${P}/${B}`})}});const l=Array.from(c.values());return l.forEach(h=>{h.chapters.sort((m,$)=>m.order-$.order)}),l.sort((h,m)=>h.order-m.order),{aChapters:s,series:l}});return(t,o)=>(a(),u("div",wr,[e.value.aChapters.length>0?(a(),u("section",xr,[o[0]||(o[0]=d("h3",null,"A 系列（短篇）",-1)),d("ul",null,[(a(!0),u(T,null,C(e.value.aChapters,s=>(a(),u("li",{key:s.path},[d("a",{href:s.path},S(s.title),9,Ir)]))),128))])])):p("",!0),e.value.series.length>0?(a(),u("section",Cr,[o[1]||(o[1]=d("h3",null,"B 系列（系列连载）",-1)),(a(!0),u(T,null,C(e.value.series,s=>(a(),u("div",{key:s.name,class:"series"},[d("h4",null,S(s.title),1),s.chapters.length>0?(a(),u("ul",Or,[(a(!0),u(T,null,C(s.chapters,r=>(a(),u("li",{key:r.path},[d("a",{href:r.path},S(r.title),9,Hr)]))),128))])):p("",!0)]))),128))])):p("",!0)]))}}),jr=k(Er,[["__scopeId","data-v-e236f069"]]),Fr={extends:Fn,Layout:Ua,NotFound:Ja,enhanceApp({app:n}){n.component("ChapterList",ar),n.component("ARKChapterList",jr)}};export{Fr as R};
