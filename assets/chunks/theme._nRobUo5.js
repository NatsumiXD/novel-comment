const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.Daegrc2c.js","assets/chunks/framework.v-3SKfDB.js"])))=>i.map(i=>d[i]);
import{d as k,c as d,r as f,n as M,o as a,a as W,t as N,b as P,w as m,T as $n,e as g,_ as $,u as yn,i as Zn,f as ne,g as Pn,h as S,j as u,k as i,l as q,m as In,p as D,q as ee,s as Sn,v as te,x as L,y as rn,z as F,A as Ln,B as ln,C as nn,D as cn,E as Bn,F as Hn,G as A,H,I as J,J as b,K as R,L as Dn,M as oe,N as se,O as G,P as un,Q as Fn,R as ae,S as hn,U as sn,V as jn,W as re,X as ie,Y as le,Z as Rn,$ as zn,a0 as ce,a1 as ue,a2 as dn,a3 as de,a4 as ve,a5 as fe,a6 as Tn,a7 as me,a8 as he}from"./framework.v-3SKfDB.js";const pe=k({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(n){return(e,t)=>(a(),d("span",{class:M(["VPBadge",n.type])},[f(e.$slots,"default",{},()=>[W(N(n.text),1)])],2))}}),_e={key:0,class:"VPBackdrop"},ge=k({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(n){return(e,t)=>(a(),P($n,{name:"fade"},{default:m(()=>[n.show?(a(),d("div",_e)):g("",!0)]),_:1}))}}),ke=$(ge,[["__scopeId","data-v-c79a1216"]]),V=yn;function be(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),(o=!0)&&setTimeout(()=>o=!1,e))}}function pn(n){return n.startsWith("/")?n:`/${n}`}function Vn(n){const{pathname:e,search:t,hash:o,protocol:s}=new URL(n,"http://a.com");if(Zn(n)||n.startsWith("#")||!s.startsWith("http")||!ne(e))return n;const{site:r}=V(),c=e.endsWith("/")||e.endsWith(".html")?n:n.replace(/(?:(^\.+)\/)?.*$/,`$1${e.replace(/(\.md)?$/,r.value.cleanUrls?"":".html")}${t}${o}`);return Pn(c)}function en({correspondingLink:n=!1}={}){const{site:e,localeIndex:t,page:o,theme:s,hash:r}=V(),c=S(()=>({label:e.value.locales[t.value]?.label,link:e.value.locales[t.value]?.link||(t.value==="root"?"/":`/${t.value}/`)}));return{localeLinks:S(()=>Object.entries(e.value.locales).flatMap(([v,_])=>c.value.label===_.label?[]:{text:_.label,link:$e(_.link||(v==="root"?"/":`/${v}/`),s.value.i18nRouting!==!1&&n,o.value.relativePath.slice(c.value.link.length-1),!e.value.cleanUrls)+r.value,lang:_.lang,dir:_.dir})),currentLang:c}}function $e(n,e,t,o){return e?n.replace(/\/$/,"")+pn(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,o?".html":"")):n}const ye={class:"NotFound"},Pe={class:"code"},Se={class:"title"},Le={class:"quote"},Te={class:"action"},Ve=["href","aria-label"],we=k({__name:"NotFound",setup(n){const{theme:e}=V(),{currentLang:t}=en();return(o,s)=>(a(),d("div",ye,[u("p",Pe,N(i(e).notFound?.code??"404"),1),u("h1",Se,N(i(e).notFound?.title??"PAGE NOT FOUND"),1),s[0]||(s[0]=u("div",{class:"divider"},null,-1)),u("blockquote",Le,N(i(e).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),u("div",Te,[u("a",{class:"link",href:i(Pn)(i(e).notFound?.link??i(t).link),"aria-label":i(e).notFound?.linkLabel??"go to home"},N(i(e).notFound?.linkText??"Take me home"),9,Ve)])]))}}),Ne=$(we,[["__scopeId","data-v-829df670"]]);function Gn(n,e){if(Array.isArray(n))return on(n);if(n==null)return[];e=pn(e);const t=Object.keys(n).sort((s,r)=>r.split("/").length-s.split("/").length).find(s=>e.startsWith(pn(s))),o=t?n[t]:[];return Array.isArray(o)?on(o):on(o.items,o.base)}function Me(n){const e=[];let t=0;for(const o in n){const s=n[o];if(s.items){t=e.push(s);continue}e[t]||e.push({items:[]}),e[t].items.push(s)}return e}function Ce(n){const e=[];function t(o){for(const s of o)s.text&&s.link&&e.push({text:s.text,link:s.link,docFooterText:s.docFooterText}),s.items&&t(s.items)}return t(n),e}function _n(n,e){return Array.isArray(e)?e.some(t=>_n(n,t)):q(n,e.link)?!0:e.items?_n(n,e.items):!1}function on(n,e){return[...n].map(t=>{const o={...t},s=o.base||e;return s&&o.link&&(o.link=s+o.link.replace(/^\//,s.endsWith("/")?"":"/")),o.items&&(o.items=on(o.items,s)),o})}function Ae(){const{hasSidebar:n}=U(),e=In("(min-width: 960px)"),t=In("(min-width: 1280px)");return{isAsideEnabled:S(()=>!t.value&&!e.value?!1:n.value?t.value:e.value)}}const Ie=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,gn=[];function Un(n){return typeof n.outline=="object"&&!Array.isArray(n.outline)&&n.outline.label||n.outlineTitle||"On this page"}function Be(n){const e=[...document.querySelectorAll(".VPDoc h1, .VPDoc h2, .VPDoc h3, .VPDoc h4, .VPDoc h5, .VPDoc h6")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const o=Number(t.tagName[1]);return{element:t,title:xe(t),link:"#"+t.id,level:o}});return Ee(e,n)}function xe(n){let e="";for(const t of n.childNodes)if(t.nodeType===1){if(Ie.test(t.className))continue;e+=t.textContent}else t.nodeType===3&&(e+=t.textContent);return e.trim()}function Ee(n,e){if(e===!1)return[];const t=(typeof e=="object"&&!Array.isArray(e)?e.level:e)||2,[o,s]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return De(n,o,s)}function Oe(n,e){const{isAsideEnabled:t}=Ae(),o=be(r,100);let s=null;D(()=>{requestAnimationFrame(r),window.addEventListener("scroll",o)}),ee(()=>{c(location.hash)}),Sn(()=>{window.removeEventListener("scroll",o)});function r(){if(!t.value)return;const l=window.scrollY,v=window.innerHeight,_=document.body.offsetHeight,p=Math.abs(l+v-_)<1,h=gn.map(({element:y,link:w})=>({link:w,top:He(y)})).filter(({top:y})=>!Number.isNaN(y)).sort((y,w)=>y.top-w.top);if(!h.length){c(null);return}if(l<1){c(null);return}if(p){c(h[h.length-1].link);return}let T=null;for(const{link:y,top:w}of h){if(w>l+te()+4)break;T=y}c(T)}function c(l){s&&s.classList.remove("active"),l==null?s=null:s=n.value.querySelector(`a[href="${decodeURIComponent(l)}"]`);const v=s;v?(v.classList.add("active"),e.value.style.top=v.offsetTop+39+"px",e.value.style.opacity="1"):(e.value.style.top="33px",e.value.style.opacity="0")}}function He(n){let e=0;for(;n!==document.body;){if(n===null)return NaN;e+=n.offsetTop,n=n.offsetParent}return e}function De(n,e,t){gn.length=0;const o=[],s=[];return n.forEach(r=>{const c={...r,children:[]};let l=s[s.length-1];for(;l&&l.level>=c.level;)s.pop(),l=s[s.length-1];if(c.element.classList.contains("ignore-header")||l&&"shouldIgnore"in l){s.push({level:c.level,shouldIgnore:!0});return}c.level>t||c.level<e||(gn.push({element:c.element,link:c.link}),l?l.children.push(c):o.push(c),s.push(c))}),o}const Q=L(!1);function Fe(n){let e;rn(()=>{e=Q.value?document.activeElement:void 0}),D(()=>{window.addEventListener("keyup",t)}),Sn(()=>{window.removeEventListener("keyup",t)});function t(o){o.key==="Escape"&&Q.value&&(n(),e?.focus())}}function je(){function n(){Q.value=!0}function e(){Q.value=!1}function t(){Q.value?e():n()}return{isOpen:Q,open:n,close:e,toggle:t}}function Re(n){const{page:e,hash:t}=V(),o=L(!1),s=S(()=>n.value.collapsed!=null),r=S(()=>!!n.value.link),c=L(!1),l=()=>{c.value=q(e.value.relativePath,n.value.link)};F([e,n,t],l),D(l);const v=S(()=>c.value?!0:n.value.items?_n(e.value.relativePath,n.value.items):!1),_=S(()=>!!(n.value.items&&n.value.items.length));rn(()=>{o.value=!!(s.value&&n.value.collapsed)}),Ln(()=>{(c.value||v.value)&&(o.value=!1)});function p(){s.value&&(o.value=!o.value)}return{collapsed:o,collapsible:s,isLink:r,isActiveLink:c,hasActiveLink:v,hasChildren:_,toggle:p}}const kn=ln([]),Z=ln([]),bn=ln(!1);function U(){const{frontmatter:n,theme:e}=V(),t=S(()=>!!(n.value.isHome??n.value.layout==="home")),o=S(()=>n.value.sidebar!==!1&&Z.value.length>0&&!t.value),s=S(()=>o.value&&bn.value),r=S(()=>o.value?Me(Z.value):[]),c=S(()=>t.value?!1:n.value.aside!=null?!!n.value.aside:e.value.aside!==!1),l=S(()=>c.value?n.value.aside==null?e.value.aside==="left":n.value.aside==="left":!1),v=S(()=>kn.value.length>0);return{isHome:t,sidebar:Bn(Z),sidebarGroups:r,hasSidebar:o,isSidebarEnabled:s,hasAside:c,leftAside:l,headers:Bn(kn),hasLocalNav:v}}function ze({closeSidebar:n}){const{frontmatter:e,page:t,theme:o}=V();F(()=>[t.value.relativePath,o.value.sidebar],([r,c])=>{const l=c?Gn(c,r):[];JSON.stringify(l)!==JSON.stringify(Z.value)&&(Z.value=l)},{immediate:!0,deep:!0,flush:"sync"}),Hn(()=>{kn.value=Be(e.value.outline??o.value.outline)}),nn&&(bn.value=window.innerWidth>=960,window.addEventListener("resize",()=>{bn.value=window.innerWidth>=960},{passive:!0}));const s=cn();F(()=>s.path,n),Fe(n)}const Kn=Symbol("layout-info"),Ge=["href","title"],Ue=k({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(n){return(e,t)=>{const o=J("VPDocOutlineItem",!0);return a(),d("ul",{class:M(["VPDocOutlineItem",n.root?"root":"nested"])},[(a(!0),d(A,null,H(n.headers,({children:s,link:r,title:c})=>(a(),d("li",null,[u("a",{class:"outline-link",href:r,title:c},N(c),9,Ge),s?.length?(a(),P(o,{key:0,headers:s},null,8,["headers"])):g("",!0)]))),256))],2)}}}),Wn=$(Ue,[["__scopeId","data-v-1ce71065"]]),Ke={class:"content"},We={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},qe=k({__name:"VPDocAsideOutline",setup(n){const{theme:e}=V(),t=L(),o=L(),{headers:s,hasLocalNav:r}=U();return Oe(t,o),(c,l)=>(a(),d("nav",{"aria-labelledby":"doc-outline-aria-label",class:M(["VPDocAsideOutline",{"has-outline":i(r)}]),ref_key:"container",ref:t},[u("div",Ke,[u("div",{class:"outline-marker",ref_key:"marker",ref:o},null,512),u("div",We,N(i(Un)(i(e))),1),b(Wn,{headers:i(s),root:!0},null,8,["headers"])])],2))}}),Je=$(qe,[["__scopeId","data-v-60d5052e"]]),Ye={class:"VPDocAsideCarbonAds"},Qe=k({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(n){const e=()=>null;return(t,o)=>(a(),d("div",Ye,[b(i(e),{"carbon-ads":n.carbonAds},null,8,["carbon-ads"])]))}}),Xe={class:"VPDocAside"},Ze=k({__name:"VPDocAside",setup(n){const{theme:e}=V();return(t,o)=>(a(),d("div",Xe,[f(t.$slots,"aside-top",{},void 0,!0),f(t.$slots,"aside-outline-before",{},void 0,!0),b(Je),f(t.$slots,"aside-outline-after",{},void 0,!0),o[0]||(o[0]=u("div",{class:"spacer"},null,-1)),f(t.$slots,"aside-ads-before",{},void 0,!0),i(e).carbonAds?(a(),P(Qe,{key:0,"carbon-ads":i(e).carbonAds},null,8,["carbon-ads"])):g("",!0),f(t.$slots,"aside-ads-after",{},void 0,!0),f(t.$slots,"aside-bottom",{},void 0,!0)]))}}),nt=$(Ze,[["__scopeId","data-v-3f215769"]]);function et(){const{theme:n,page:e}=V();return S(()=>{const{text:t="Edit this page",pattern:o=""}=n.value.editLink||{};let s;return typeof o=="function"?s=o(e.value):s=o.replace(/:path/g,e.value.filePath),{url:s,text:t}})}function tt(){const{page:n,theme:e,frontmatter:t}=V();return S(()=>{const o=Gn(e.value.sidebar,n.value.relativePath),s=Ce(o),r=ot(s,_=>_.link.replace(/[?#].*$/,"")),c=r.findIndex(_=>q(n.value.relativePath,_.link)),l=e.value.docFooter?.prev===!1&&!t.value.prev||t.value.prev===!1,v=e.value.docFooter?.next===!1&&!t.value.next||t.value.next===!1;return{prev:l?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??r[c-1]?.docFooterText??r[c-1]?.text,link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??r[c-1]?.link},next:v?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??r[c+1]?.docFooterText??r[c+1]?.text,link:(typeof t.value.next=="object"?t.value.next.link:void 0)??r[c+1]?.link}}})}function ot(n,e){const t=new Set;return n.filter(o=>{const s=e(o);return t.has(s)?!1:t.add(s)})}const z=k({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(n){const e=n,t=S(()=>e.tag??(e.href?"a":"span")),o=S(()=>e.href&&Dn.test(e.href)||e.target==="_blank");return(s,r)=>(a(),P(R(t.value),{class:M(["VPLink",{link:n.href,"vp-external-link-icon":o.value,"no-icon":n.noIcon}]),href:n.href?i(Vn)(n.href):void 0,target:n.target??(o.value?"_blank":void 0),rel:n.rel??(o.value?"noreferrer":void 0)},{default:m(()=>[f(s.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),st={class:"VPLastUpdated"},at=["datetime"],rt=k({__name:"VPDocFooterLastUpdated",setup(n){const{theme:e,page:t,lang:o}=V(),{language:s}=se(),r=oe("timeRef"),c=S(()=>new Date(t.value.lastUpdated)),l=S(()=>c.value.toISOString()),v=ln("");return D(()=>{rn(()=>{const _=e.value.lastUpdated?.formatOptions?.forceLocale?o.value:s.value;v.value=new Intl.DateTimeFormat(_,e.value.lastUpdated?.formatOptions??{dateStyle:"medium",timeStyle:"medium"}).format(c.value),_&&o.value!==_?r.value?.setAttribute("lang",_):r.value?.removeAttribute("lang")})}),(_,p)=>(a(),d("p",st,[W(N(i(e).lastUpdated?.text||i(e).lastUpdatedText||"Last updated")+": ",1),u("time",{ref_key:"timeRef",ref:r,datetime:l.value},N(v.value),9,at)]))}}),it=$(rt,[["__scopeId","data-v-3c637f39"]]),lt={key:0,class:"VPDocFooter"},ct={key:0,class:"edit-info"},ut={key:0,class:"edit-link"},dt={key:1,class:"last-updated"},vt={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},ft={class:"pager"},mt=["innerHTML"],ht=["innerHTML"],pt={class:"pager"},_t=["innerHTML"],gt=["innerHTML"],kt=k({__name:"VPDocFooter",setup(n){const{theme:e,page:t,frontmatter:o}=V(),s=et(),r=tt(),c=S(()=>e.value.editLink&&o.value.editLink!==!1),l=S(()=>t.value.lastUpdated),v=S(()=>c.value||l.value||r.value.prev||r.value.next);return(_,p)=>v.value?(a(),d("footer",lt,[f(_.$slots,"doc-footer-before",{},void 0,!0),c.value||l.value?(a(),d("div",ct,[c.value?(a(),d("div",ut,[b(z,{class:"edit-link-button",href:i(s).url,"no-icon":!0},{default:m(()=>[p[0]||(p[0]=u("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),W(" "+N(i(s).text),1)]),_:1},8,["href"])])):g("",!0),l.value?(a(),d("div",dt,[b(it)])):g("",!0)])):g("",!0),i(r).prev?.link||i(r).next?.link?(a(),d("nav",vt,[p[1]||(p[1]=u("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),u("div",ft,[i(r).prev?.link?(a(),P(z,{key:0,class:"pager-link prev",href:i(r).prev.link},{default:m(()=>[u("span",{class:"desc",innerHTML:i(e).docFooter?.prev||"Previous page"},null,8,mt),u("span",{class:"title",innerHTML:i(r).prev.text},null,8,ht)]),_:1},8,["href"])):g("",!0)]),u("div",pt,[i(r).next?.link?(a(),P(z,{key:0,class:"pager-link next",href:i(r).next.link},{default:m(()=>[u("span",{class:"desc",innerHTML:i(e).docFooter?.next||"Next page"},null,8,_t),u("span",{class:"title",innerHTML:i(r).next.text},null,8,gt)]),_:1},8,["href"])):g("",!0)])])):g("",!0)])):g("",!0)}}),bt=$(kt,[["__scopeId","data-v-e257564d"]]),$t={class:"container"},yt={class:"aside-container"},Pt={class:"aside-content"},St={class:"content"},Lt={class:"content-container"},Tt={class:"main"},Vt=k({__name:"VPDoc",setup(n){const{theme:e}=V(),t=cn(),{hasSidebar:o,hasAside:s,leftAside:r}=U(),c=S(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(l,v)=>{const _=J("Content");return a(),d("div",{class:M(["VPDoc",{"has-sidebar":i(o),"has-aside":i(s)}])},[f(l.$slots,"doc-top",{},void 0,!0),u("div",$t,[i(s)?(a(),d("div",{key:0,class:M(["aside",{"left-aside":i(r)}])},[v[0]||(v[0]=u("div",{class:"aside-curtain"},null,-1)),u("div",yt,[u("div",Pt,[b(nt,null,{"aside-top":m(()=>[f(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[f(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[f(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[f(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[f(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[f(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):g("",!0),u("div",St,[u("div",Lt,[f(l.$slots,"doc-before",{},void 0,!0),u("main",Tt,[b(_,{class:M(["vp-doc",[c.value,i(e).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),b(bt,null,{"doc-footer-before":m(()=>[f(l.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),f(l.$slots,"doc-after",{},void 0,!0)])])]),f(l.$slots,"doc-bottom",{},void 0,!0)],2)}}}),wt=$(Vt,[["__scopeId","data-v-7011f0d8"]]),Nt=k({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(n){const e=n,t=S(()=>e.href&&Dn.test(e.href)),o=S(()=>e.tag||(e.href?"a":"button"));return(s,r)=>(a(),P(R(o.value),{class:M(["VPButton",[n.size,n.theme]]),href:n.href?i(Vn)(n.href):void 0,target:e.target??(t.value?"_blank":void 0),rel:e.rel??(t.value?"noreferrer":void 0)},{default:m(()=>[f(s.$slots,"default",{},()=>[W(N(n.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),Mt=$(Nt,[["__scopeId","data-v-01bff58b"]]),Ct=["src","alt"],At=k({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(n){return(e,t)=>{const o=J("VPImage",!0);return n.image?(a(),d(A,{key:0},[typeof n.image=="string"||"src"in n.image?(a(),d("img",G({key:0,class:"VPImage"},typeof n.image=="string"?e.$attrs:{...n.image,...e.$attrs},{src:i(Pn)(typeof n.image=="string"?n.image:n.image.src),alt:n.alt??(typeof n.image=="string"?"":n.image.alt||"")}),null,16,Ct)):(a(),d(A,{key:1},[b(o,G({class:"dark",image:n.image.dark,alt:n.image.alt},e.$attrs),null,16,["image","alt"]),b(o,G({class:"light",image:n.image.light,alt:n.image.alt},e.$attrs),null,16,["image","alt"])],64))],64)):g("",!0)}}}),an=$(At,[["__scopeId","data-v-8426fc1a"]]),It={class:"container"},Bt={class:"main"},xt={class:"heading"},Et=["innerHTML"],Ot=["innerHTML"],Ht=["innerHTML"],Dt={key:0,class:"actions"},Ft={key:0,class:"image"},jt={class:"image-container"},Rt=k({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(n){const{heroImageSlotExists:e}=un(Kn);return(t,o)=>(a(),d("div",{class:M(["VPHero",{"has-image":n.image||i(e)}])},[u("div",It,[u("div",Bt,[f(t.$slots,"home-hero-info-before",{},void 0,!0),f(t.$slots,"home-hero-info",{},()=>[u("h1",xt,[n.name?(a(),d("span",{key:0,innerHTML:n.name,class:"name clip"},null,8,Et)):g("",!0),n.text?(a(),d("span",{key:1,innerHTML:n.text,class:"text"},null,8,Ot)):g("",!0)]),n.tagline?(a(),d("p",{key:0,innerHTML:n.tagline,class:"tagline"},null,8,Ht)):g("",!0)],!0),f(t.$slots,"home-hero-info-after",{},void 0,!0),n.actions?(a(),d("div",Dt,[(a(!0),d(A,null,H(n.actions,s=>(a(),d("div",{key:s.link,class:"action"},[b(Mt,{tag:"a",size:"medium",theme:s.theme,text:s.text,href:s.link,target:s.target,rel:s.rel},null,8,["theme","text","href","target","rel"])]))),128))])):g("",!0),f(t.$slots,"home-hero-actions-after",{},void 0,!0)]),n.image||i(e)?(a(),d("div",Ft,[u("div",jt,[o[0]||(o[0]=u("div",{class:"image-bg"},null,-1)),f(t.$slots,"home-hero-image",{},()=>[n.image?(a(),P(an,{key:0,class:"image-src",image:n.image},null,8,["image"])):g("",!0)],!0)])])):g("",!0)])],2))}}),zt=$(Rt,[["__scopeId","data-v-1e96e9e8"]]),Gt=k({__name:"VPHomeHero",setup(n){const{frontmatter:e}=V();return(t,o)=>i(e).hero?(a(),P(zt,{key:0,class:"VPHomeHero",name:i(e).hero.name,text:i(e).hero.text,tagline:i(e).hero.tagline,image:i(e).hero.image,actions:i(e).hero.actions},{"home-hero-info-before":m(()=>[f(t.$slots,"home-hero-info-before")]),"home-hero-info":m(()=>[f(t.$slots,"home-hero-info")]),"home-hero-info-after":m(()=>[f(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":m(()=>[f(t.$slots,"home-hero-actions-after")]),"home-hero-image":m(()=>[f(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):g("",!0)}}),Ut={class:"box"},Kt={key:0,class:"icon"},Wt=["innerHTML"],qt=["innerHTML"],Jt=["innerHTML"],Yt={key:4,class:"link-text"},Qt={class:"link-text-value"},Xt=k({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(n){return(e,t)=>(a(),P(z,{class:"VPFeature",href:n.link,rel:n.rel,target:n.target,"no-icon":!0,tag:n.link?"a":"div"},{default:m(()=>[u("article",Ut,[typeof n.icon=="object"&&n.icon.wrap?(a(),d("div",Kt,[b(an,{image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])])):typeof n.icon=="object"?(a(),P(an,{key:1,image:n.icon,alt:n.icon.alt,height:n.icon.height||48,width:n.icon.width||48},null,8,["image","alt","height","width"])):n.icon?(a(),d("div",{key:2,class:"icon",innerHTML:n.icon},null,8,Wt)):g("",!0),u("h2",{class:"title",innerHTML:n.title},null,8,qt),n.details?(a(),d("p",{key:3,class:"details",innerHTML:n.details},null,8,Jt)):g("",!0),n.linkText?(a(),d("div",Yt,[u("p",Qt,[W(N(n.linkText)+" ",1),t[0]||(t[0]=u("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):g("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Zt=$(Xt,[["__scopeId","data-v-5219619b"]]),no={key:0,class:"VPFeatures"},eo={class:"container"},to={class:"items"},oo=k({__name:"VPFeatures",props:{features:{}},setup(n){const e=n,t=S(()=>{const o=e.features.length;if(o){if(o===2)return"grid-2";if(o===3)return"grid-3";if(o%3===0)return"grid-6";if(o>3)return"grid-4"}else return});return(o,s)=>n.features?(a(),d("div",no,[u("div",eo,[u("div",to,[(a(!0),d(A,null,H(n.features,r=>(a(),d("div",{key:r.title,class:M(["item",[t.value]])},[b(Zt,{icon:r.icon,title:r.title,details:r.details,link:r.link,"link-text":r.linkText,rel:r.rel,target:r.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):g("",!0)}}),so=$(oo,[["__scopeId","data-v-a6181336"]]),ao=k({__name:"VPHomeFeatures",setup(n){const{frontmatter:e}=V();return(t,o)=>i(e).features?(a(),P(so,{key:0,class:"VPHomeFeatures",features:i(e).features},null,8,["features"])):g("",!0)}}),ro=k({__name:"VPHomeContent",setup(n){const{width:e}=ae({initialWidth:0,includeScrollbar:!1});return(t,o)=>(a(),d("div",{class:"vp-doc container",style:Fn(i(e)?{"--vp-offset":`calc(50% - ${i(e)/2}px)`}:{})},[f(t.$slots,"default",{},void 0,!0)],4))}}),io=$(ro,[["__scopeId","data-v-8e2d4988"]]),lo=k({__name:"VPHome",setup(n){const{frontmatter:e,theme:t}=V();return(o,s)=>{const r=J("Content");return a(),d("div",{class:M(["VPHome",{"external-link-icon-enabled":i(t).externalLinkIcon}])},[f(o.$slots,"home-hero-before",{},void 0,!0),b(Gt,null,{"home-hero-info-before":m(()=>[f(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[f(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[f(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[f(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[f(o.$slots,"home-hero-image",{},void 0,!0)]),_:3}),f(o.$slots,"home-hero-after",{},void 0,!0),f(o.$slots,"home-features-before",{},void 0,!0),b(ao),f(o.$slots,"home-features-after",{},void 0,!0),i(e).markdownStyles!==!1?(a(),P(io,{key:0},{default:m(()=>[b(r)]),_:1})):(a(),P(r,{key:1}))],2)}}}),co=$(lo,[["__scopeId","data-v-8b561e3d"]]),uo={},vo={class:"VPPage"};function fo(n,e){const t=J("Content");return a(),d("div",vo,[f(n.$slots,"page-top"),b(t),f(n.$slots,"page-bottom")])}const mo=$(uo,[["render",fo]]),ho=k({__name:"VPContent",setup(n){const{page:e,frontmatter:t}=V(),{isHome:o,hasSidebar:s}=U();return(r,c)=>(a(),d("div",{class:M(["VPContent",{"has-sidebar":i(s),"is-home":i(o)}]),id:"VPContent"},[i(e).isNotFound?f(r.$slots,"not-found",{key:0},()=>[b(Ne)],!0):i(t).layout==="page"?(a(),P(mo,{key:1},{"page-top":m(()=>[f(r.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[f(r.$slots,"page-bottom",{},void 0,!0)]),_:3})):i(t).layout==="home"?(a(),P(co,{key:2},{"home-hero-before":m(()=>[f(r.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[f(r.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[f(r.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[f(r.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[f(r.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[f(r.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[f(r.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[f(r.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[f(r.$slots,"home-features-after",{},void 0,!0)]),_:3})):i(t).layout&&i(t).layout!=="doc"?(a(),P(R(i(t).layout),{key:3})):(a(),P(wt,{key:4},{"doc-top":m(()=>[f(r.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[f(r.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":m(()=>[f(r.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[f(r.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[f(r.$slots,"doc-after",{},void 0,!0)]),"aside-top":m(()=>[f(r.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":m(()=>[f(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[f(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[f(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[f(r.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":m(()=>[f(r.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),po=$(ho,[["__scopeId","data-v-c87f25bf"]]),_o={class:"container"},go=["innerHTML"],ko=["innerHTML"],bo=k({__name:"VPFooter",setup(n){const{theme:e,frontmatter:t}=V(),{hasSidebar:o}=U();return(s,r)=>i(e).footer&&i(t).footer!==!1?(a(),d("footer",{key:0,class:M(["VPFooter",{"has-sidebar":i(o)}])},[u("div",_o,[i(e).footer.message?(a(),d("p",{key:0,class:"message",innerHTML:i(e).footer.message},null,8,go)):g("",!0),i(e).footer.copyright?(a(),d("p",{key:1,class:"copyright",innerHTML:i(e).footer.copyright},null,8,ko)):g("",!0)])],2)):g("",!0)}}),$o=$(bo,[["__scopeId","data-v-c3855bb3"]]),yo={class:"menu-text"},Po={class:"header"},So={class:"outline"},Lo=k({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(n){const e=n,{theme:t}=V(),o=L(!1),s=L(0),r=L(),c=L();function l(h){r.value?.contains(h.target)||(o.value=!1)}F(o,h=>{if(h){document.addEventListener("click",l);return}document.removeEventListener("click",l)}),hn("Escape",()=>{o.value=!1}),Hn(()=>{o.value=!1});function v(){o.value=!o.value,s.value=window.innerHeight+Math.min(window.scrollY-e.navHeight,0)}function _(h){h.target.classList.contains("outline-link")&&(c.value&&(c.value.style.transition="none"),sn(()=>{o.value=!1}))}function p(){o.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(h,T)=>(a(),d("div",{class:"VPLocalNavOutlineDropdown",style:Fn({"--vp-vh":s.value+"px"}),ref_key:"main",ref:r},[n.headers.length>0?(a(),d("button",{key:0,onClick:v,class:M({open:o.value})},[u("span",yo,N(i(Un)(i(t))),1),T[0]||(T[0]=u("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(a(),d("button",{key:1,onClick:p},N(i(t).returnToTopLabel||"Return to top"),1)),b($n,{name:"flyout"},{default:m(()=>[o.value?(a(),d("div",{key:0,ref_key:"items",ref:c,class:"items",onClick:_},[u("div",Po,[u("a",{class:"top-link",href:"#",onClick:p},N(i(t).returnToTopLabel||"Return to top"),1)]),u("div",So,[b(Wn,{headers:n.headers},null,8,["headers"])])],512)):g("",!0)]),_:1})],4))}}),To=$(Lo,[["__scopeId","data-v-0bf0e06f"]]),Vo={class:"container"},wo=["aria-expanded"],No={class:"menu-text"},Mo=k({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(n){const{theme:e}=V(),{isHome:t,hasSidebar:o,headers:s,hasLocalNav:r}=U(),{y:c}=jn(),l=L(0);D(()=>{l.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const v=S(()=>({VPLocalNav:!0,"has-sidebar":o.value,empty:!r.value,fixed:!r.value&&!o.value}));return(_,p)=>!i(t)&&(i(r)||i(o)||i(c)>=l.value)?(a(),d("div",{key:0,class:M(v.value)},[u("div",Vo,[i(o)?(a(),d("button",{key:0,class:"menu","aria-expanded":n.open,"aria-controls":"VPSidebarNav",onClick:p[0]||(p[0]=h=>_.$emit("open-menu"))},[p[1]||(p[1]=u("span",{class:"vpi-align-left menu-icon"},null,-1)),u("span",No,N(i(e).sidebarMenuLabel||"Menu"),1)],8,wo)):g("",!0),b(To,{headers:i(s),navHeight:l.value},null,8,["headers","navHeight"])])],2)):g("",!0)}}),Co=$(Mo,[["__scopeId","data-v-db738f89"]]);function Ao(){const n=L(!1);function e(){n.value=!0,window.addEventListener("resize",s)}function t(){n.value=!1,window.removeEventListener("resize",s)}function o(){n.value?t():e()}function s(){window.outerWidth>=768&&t()}const r=cn();return F(()=>r.path,t),{isScreenOpen:n,openScreen:e,closeScreen:t,toggleScreen:o}}const wn=Symbol("nav"),Io={},Bo={class:"VPSwitch",type:"button",role:"switch"},xo={class:"check"},Eo={key:0,class:"icon"};function Oo(n,e){return a(),d("button",Bo,[u("span",xo,[n.$slots.default?(a(),d("span",Eo,[f(n.$slots,"default",{},void 0,!0)])):g("",!0)])])}const Ho=$(Io,[["render",Oo],["__scopeId","data-v-1d5665e3"]]),Do=k({__name:"VPSwitchAppearance",setup(n){const{isDark:e,theme:t}=V(),o=un("toggle-appearance",()=>{e.value=!e.value}),s=L("");return Ln(()=>{s.value=e.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(r,c)=>(a(),P(Ho,{title:s.value,class:"VPSwitchAppearance","aria-checked":i(e),onClick:i(o)},{default:m(()=>[...c[0]||(c[0]=[u("span",{class:"vpi-sun sun"},null,-1),u("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Nn=$(Do,[["__scopeId","data-v-5337faa4"]]),Fo={key:0,class:"VPNavBarAppearance"},jo=k({__name:"VPNavBarAppearance",setup(n){const{site:e}=V();return(t,o)=>i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),d("div",Fo,[b(Nn)])):g("",!0)}}),Ro=$(jo,[["__scopeId","data-v-6c893767"]]),Mn=L();let qn=!1,mn=0;function zo(n){const e=L(!1);if(nn){!qn&&Go(),mn++;const t=F(Mn,o=>{o===n.el.value||n.el.value?.contains(o)?(e.value=!0,n.onFocus?.()):(e.value=!1,n.onBlur?.())});Sn(()=>{t(),mn--,mn||Uo()})}return re(e)}function Go(){document.addEventListener("focusin",Jn),qn=!0,Mn.value=document.activeElement}function Uo(){document.removeEventListener("focusin",Jn)}function Jn(){Mn.value=document.activeElement}const Ko={class:"VPMenuLink"},Wo=["innerHTML"],qo=k({inheritAttrs:!1,__name:"VPMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=V(),o=S(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link);return(s,r)=>(a(),d("div",Ko,[b(z,G(s.$attrs,{class:{active:i(q)(i(t).relativePath,n.item.activeMatch||o.value,!!n.item.activeMatch)},href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon}),{default:m(()=>[u("span",{innerHTML:n.item.text},null,8,Wo)]),_:1},16,["class","href","target","rel","no-icon"])]))}}),vn=$(qo,[["__scopeId","data-v-faf5b206"]]),Jo={class:"VPMenuGroup"},Yo={key:0,class:"title"},Qo=k({__name:"VPMenuGroup",props:{text:{},items:{}},setup(n){return(e,t)=>(a(),d("div",Jo,[n.text?(a(),d("p",Yo,N(n.text),1)):g("",!0),(a(!0),d(A,null,H(n.items,o=>(a(),d(A,{key:JSON.stringify(o)},["link"in o?(a(),P(vn,{key:0,item:o},null,8,["item"])):g("",!0)],64))),128))]))}}),Xo=$(Qo,[["__scopeId","data-v-1963e1bb"]]),Zo={class:"VPMenu"},ns={key:0,class:"items"},es=k({__name:"VPMenu",props:{items:{}},setup(n){return(e,t)=>(a(),d("div",Zo,[n.items?(a(),d("div",ns,[(a(!0),d(A,null,H(n.items,o=>(a(),d(A,{key:JSON.stringify(o)},["link"in o?(a(),P(vn,{key:0,item:o},null,8,["item"])):"component"in o?(a(),P(R(o.component),G({key:1,ref_for:!0},o.props),null,16)):(a(),P(Xo,{key:2,text:o.text,items:o.items},null,8,["text","items"]))],64))),128))])):g("",!0),f(e.$slots,"default",{},void 0,!0)]))}}),ts=$(es,[["__scopeId","data-v-25a6cce8"]]),os=["aria-expanded","aria-label"],ss={key:0,class:"text"},as=["innerHTML"],rs={key:1,class:"vpi-more-horizontal icon"},is={class:"menu"},ls=k({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(n){const e=L(!1),t=L();zo({el:t,onBlur:o});function o(){e.value=!1}return(s,r)=>(a(),d("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:r[1]||(r[1]=c=>e.value=!0),onMouseleave:r[2]||(r[2]=c=>e.value=!1)},[u("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":e.value,"aria-label":n.label,onClick:r[0]||(r[0]=c=>e.value=!e.value)},[n.button||n.icon?(a(),d("span",ss,[n.icon?(a(),d("span",{key:0,class:M([n.icon,"option-icon"])},null,2)):g("",!0),n.button?(a(),d("span",{key:1,innerHTML:n.button},null,8,as)):g("",!0),r[3]||(r[3]=u("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(a(),d("span",rs))],8,os),u("div",is,[b(ts,{items:n.items},{default:m(()=>[f(s.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Cn=$(ls,[["__scopeId","data-v-42cb505d"]]),cs=["href","aria-label","rel","innerHTML"],us=k({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(n){const e=n,t=L();D(async()=>{await sn();const s=t.value?.children[0];s instanceof HTMLElement&&s.className.startsWith("vpi-social-")&&(getComputedStyle(s).maskImage||getComputedStyle(s).webkitMaskImage)==="none"&&s.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${e.icon}.svg')`)});const o=S(()=>typeof e.icon=="object"?e.icon.svg:`<span class="vpi-social-${e.icon}"></span>`);return(s,r)=>(a(),d("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:n.link,"aria-label":n.ariaLabel??(typeof n.icon=="string"?n.icon:""),target:"_blank",rel:n.me?"me noopener":"noopener",innerHTML:o.value},null,8,cs))}}),ds=$(us,[["__scopeId","data-v-591a6b30"]]),vs={class:"VPSocialLinks"},fs=k({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(n){return(e,t)=>(a(),d("div",vs,[(a(!0),d(A,null,H(n.links,({link:o,icon:s,ariaLabel:r})=>(a(),P(ds,{key:o,icon:s,link:o,ariaLabel:r,me:n.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),An=$(fs,[["__scopeId","data-v-d07f11e6"]]),ms={key:0,class:"group translations"},hs={class:"trans-title"},ps={key:1,class:"group"},_s={class:"item appearance"},gs={class:"label"},ks={class:"appearance-action"},bs={key:2,class:"group"},$s={class:"item social-links"},ys=k({__name:"VPNavBarExtra",setup(n){const{site:e,theme:t}=V(),{localeLinks:o,currentLang:s}=en({correspondingLink:!0}),r=S(()=>o.value.length&&s.value.label||e.value.appearance||t.value.socialLinks);return(c,l)=>r.value?(a(),P(Cn,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:m(()=>[i(o).length&&i(s).label?(a(),d("div",ms,[u("p",hs,N(i(s).label),1),(a(!0),d(A,null,H(i(o),v=>(a(),P(vn,{key:v.link,item:v,lang:v.lang,dir:v.dir},null,8,["item","lang","dir"]))),128))])):g("",!0),i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),d("div",ps,[u("div",_s,[u("p",gs,N(i(t).darkModeSwitchLabel||"Appearance"),1),u("div",ks,[b(Nn)])])])):g("",!0),i(t).socialLinks?(a(),d("div",bs,[u("div",$s,[b(An,{class:"social-links-list",links:i(t).socialLinks},null,8,["links"])])])):g("",!0)]),_:1})):g("",!0)}}),Ps=$(ys,[["__scopeId","data-v-bf2fac68"]]),Ss=["aria-expanded"],Ls=k({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(n){return(e,t)=>(a(),d("button",{type:"button",class:M(["VPNavBarHamburger",{active:n.active}]),"aria-label":"mobile navigation","aria-expanded":n.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=o=>e.$emit("click"))},[...t[1]||(t[1]=[u("span",{class:"container"},[u("span",{class:"top"}),u("span",{class:"middle"}),u("span",{class:"bottom"})],-1)])],10,Ss))}}),Ts=$(Ls,[["__scopeId","data-v-e5dd9c1c"]]),Vs=["innerHTML"],ws=k({__name:"VPNavBarMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=V(),o=S(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link);return(s,r)=>(a(),P(z,{class:M({VPNavBarMenuLink:!0,active:i(q)(i(t).relativePath,n.item.activeMatch||o.value,!!n.item.activeMatch)}),href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,tabindex:"0"},{default:m(()=>[u("span",{innerHTML:n.item.text},null,8,Vs)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Ns=$(ws,[["__scopeId","data-v-52a1d768"]]),Ms=k({__name:"VPNavBarMenuGroup",props:{item:{}},setup(n){const e=n,{page:t}=V(),o=r=>"component"in r?!1:"link"in r?q(t.value.relativePath,typeof r.link=="function"?r.link(t.value):r.link,!!e.item.activeMatch):r.items.some(o),s=S(()=>o(e.item));return(r,c)=>(a(),P(Cn,{class:M({VPNavBarMenuGroup:!0,active:i(q)(i(t).relativePath,n.item.activeMatch,!!n.item.activeMatch)||s.value}),button:n.item.text,items:n.item.items},null,8,["class","button","items"]))}}),Cs={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},As=k({__name:"VPNavBarMenu",setup(n){const{theme:e}=V();return(t,o)=>i(e).nav?(a(),d("nav",Cs,[o[0]||(o[0]=u("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(a(!0),d(A,null,H(i(e).nav,s=>(a(),d(A,{key:JSON.stringify(s)},["link"in s?(a(),P(Ns,{key:0,item:s},null,8,["item"])):"component"in s?(a(),P(R(s.component),G({key:1,ref_for:!0},s.props),null,16)):(a(),P(Ms,{key:2,item:s},null,8,["item"]))],64))),128))])):g("",!0)}}),Is=$(As,[["__scopeId","data-v-39714824"]]);function Bs(n){const{localeIndex:e,theme:t}=V();function o(s){const r=s.split("."),c=t.value.search?.options,l=c&&typeof c=="object",v=l&&c.locales?.[e.value]?.translations||null,_=l&&c.translations||null;let p=v,h=_,T=n;const y=r.pop();for(const w of r){let C=null;const I=T?.[w];I&&(C=T=I);const B=h?.[w];B&&(C=h=B);const O=p?.[w];O&&(C=p=O),I||(T=C),B||(h=C),O||(p=C)}return p?.[y]??h?.[y]??T?.[y]??""}return o}const xs=["aria-label"],Es={class:"DocSearch-Button-Container"},Os={class:"DocSearch-Button-Placeholder"},xn=k({__name:"VPNavBarSearchButton",setup(n){const t=Bs({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(o,s)=>(a(),d("button",{type:"button","aria-label":i(t)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[u("span",Es,[s[0]||(s[0]=u("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),u("span",Os,N(i(t)("button.buttonText")),1)]),s[1]||(s[1]=u("span",{class:"DocSearch-Button-Keys"},[u("kbd",{class:"DocSearch-Button-Key"}),u("kbd",{class:"DocSearch-Button-Key"})],-1))],8,xs))}}),Hs={class:"VPNavBarSearch"},Ds={id:"local-search"},Fs={key:1,id:"docsearch"},js=k({__name:"VPNavBarSearch",setup(n){const e=ie(()=>le(()=>import("./VPLocalSearchBox.Daegrc2c.js"),__vite__mapDeps([0,1]))),t=()=>null,{theme:o}=V(),s=L(!1),r=L(!1);D(()=>{});function c(){s.value||(s.value=!0,setTimeout(l,16))}function l(){const h=new Event("keydown");h.key="k",h.metaKey=!0,window.dispatchEvent(h),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||l()},16)}function v(h){const T=h.target,y=T.tagName;return T.isContentEditable||y==="INPUT"||y==="SELECT"||y==="TEXTAREA"}const _=L(!1);hn("k",h=>{(h.ctrlKey||h.metaKey)&&(h.preventDefault(),_.value=!0)}),hn("/",h=>{v(h)||(h.preventDefault(),_.value=!0)});const p="local";return(h,T)=>(a(),d("div",Hs,[i(p)==="local"?(a(),d(A,{key:0},[_.value?(a(),P(i(e),{key:0,onClose:T[0]||(T[0]=y=>_.value=!1)})):g("",!0),u("div",Ds,[b(xn,{onClick:T[1]||(T[1]=y=>_.value=!0)})])],64)):i(p)==="algolia"?(a(),d(A,{key:1},[s.value?(a(),P(i(t),{key:0,algolia:i(o).search?.options??i(o).algolia,onVnodeBeforeMount:T[2]||(T[2]=y=>r.value=!0)},null,8,["algolia"])):g("",!0),r.value?g("",!0):(a(),d("div",Fs,[b(xn,{onClick:c})]))],64)):g("",!0)]))}}),Rs=k({__name:"VPNavBarSocialLinks",setup(n){const{theme:e}=V();return(t,o)=>i(e).socialLinks?(a(),P(An,{key:0,class:"VPNavBarSocialLinks",links:i(e).socialLinks},null,8,["links"])):g("",!0)}}),zs=$(Rs,[["__scopeId","data-v-0394ad82"]]),Gs=["href","rel","target"],Us=["innerHTML"],Ks={key:2},Ws=k({__name:"VPNavBarTitle",setup(n){const{site:e,theme:t}=V(),{hasSidebar:o}=U(),{currentLang:s}=en(),r=S(()=>typeof t.value.logoLink=="string"?t.value.logoLink:t.value.logoLink?.link),c=S(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.rel),l=S(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.target);return(v,_)=>(a(),d("div",{class:M(["VPNavBarTitle",{"has-sidebar":i(o)}])},[u("a",{class:"title",href:r.value??i(Vn)(i(s).link),rel:c.value,target:l.value},[f(v.$slots,"nav-bar-title-before",{},void 0,!0),i(t).logo?(a(),P(an,{key:0,class:"logo",image:i(t).logo},null,8,["image"])):g("",!0),i(t).siteTitle?(a(),d("span",{key:1,innerHTML:i(t).siteTitle},null,8,Us)):i(t).siteTitle===void 0?(a(),d("span",Ks,N(i(e).title),1)):g("",!0),f(v.$slots,"nav-bar-title-after",{},void 0,!0)],8,Gs)],2))}}),qs=$(Ws,[["__scopeId","data-v-1e38c6bc"]]),Js={class:"items"},Ys={class:"title"},Qs=k({__name:"VPNavBarTranslations",setup(n){const{theme:e}=V(),{localeLinks:t,currentLang:o}=en({correspondingLink:!0});return(s,r)=>i(t).length&&i(o).label?(a(),P(Cn,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:i(e).langMenuLabel||"Change language"},{default:m(()=>[u("div",Js,[u("p",Ys,N(i(o).label),1),(a(!0),d(A,null,H(i(t),c=>(a(),P(vn,{key:c.link,item:c,lang:c.lang,dir:c.dir},null,8,["item","lang","dir"]))),128))])]),_:1},8,["label"])):g("",!0)}}),Xs=$(Qs,[["__scopeId","data-v-4c1766e2"]]),Zs={class:"wrapper"},na={class:"container"},ea={class:"title"},ta={class:"content"},oa={class:"content-body"},sa=k({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(n){const e=n,{y:t}=jn(),{isHome:o,hasSidebar:s}=U(),r=L({});return Ln(()=>{r.value={"has-sidebar":s.value,home:o.value,top:t.value===0,"screen-open":e.isScreenOpen}}),(c,l)=>(a(),d("div",{class:M(["VPNavBar",r.value])},[u("div",Zs,[u("div",na,[u("div",ea,[b(qs,null,{"nav-bar-title-before":m(()=>[f(c.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[f(c.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),u("div",ta,[u("div",oa,[f(c.$slots,"nav-bar-content-before",{},void 0,!0),b(js,{class:"search"}),b(Is,{class:"menu"}),b(Xs,{class:"translations"}),b(Ro,{class:"appearance"}),b(zs,{class:"social-links"}),b(Ps,{class:"extra"}),f(c.$slots,"nav-bar-content-after",{},void 0,!0),b(Ts,{class:"hamburger",active:n.isScreenOpen,onClick:l[0]||(l[0]=v=>c.$emit("toggle-screen"))},null,8,["active"])])])])]),l[1]||(l[1]=u("div",{class:"divider"},[u("div",{class:"divider-line"})],-1))],2))}}),aa=$(sa,[["__scopeId","data-v-70946a35"]]),ra={key:0,class:"VPNavScreenAppearance"},ia={class:"text"},la=k({__name:"VPNavScreenAppearance",setup(n){const{site:e,theme:t}=V();return(o,s)=>i(e).appearance&&i(e).appearance!=="force-dark"&&i(e).appearance!=="force-auto"?(a(),d("div",ra,[u("p",ia,N(i(t).darkModeSwitchLabel||"Appearance"),1),b(Nn)])):g("",!0)}}),ca=$(la,[["__scopeId","data-v-b44890b2"]]),ua=["innerHTML"],da=k({__name:"VPNavScreenMenuLink",props:{item:{}},setup(n){const e=n,{page:t}=V(),o=S(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link),{closeScreen:s}=un(wn);return(r,c)=>(a(),P(z,{class:"VPNavScreenMenuLink",href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:i(s)},{default:m(()=>[u("span",{innerHTML:n.item.text},null,8,ua)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),va=$(da,[["__scopeId","data-v-7d55a1c1"]]),fa=["innerHTML"],ma=k({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(n){const e=n,{page:t}=V(),o=S(()=>typeof e.item.link=="function"?e.item.link(t.value):e.item.link),{closeScreen:s}=un(wn);return(r,c)=>(a(),P(z,{class:"VPNavScreenMenuGroupLink",href:o.value,target:n.item.target,rel:n.item.rel,"no-icon":n.item.noIcon,onClick:i(s)},{default:m(()=>[u("span",{innerHTML:n.item.text},null,8,fa)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Yn=$(ma,[["__scopeId","data-v-49e5ec9f"]]),ha={class:"VPNavScreenMenuGroupSection"},pa={key:0,class:"title"},_a=k({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(n){return(e,t)=>(a(),d("div",ha,[n.text?(a(),d("p",pa,N(n.text),1)):g("",!0),(a(!0),d(A,null,H(n.items,o=>(a(),P(Yn,{key:o.text,item:o},null,8,["item"]))),128))]))}}),ga=$(_a,[["__scopeId","data-v-4b7a798b"]]),ka=["aria-controls","aria-expanded"],ba=["innerHTML"],$a=["id"],ya={key:0,class:"item"},Pa={key:1,class:"item"},Sa={key:2,class:"group"},La=k({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(n){const e=n,t=L(!1),o=S(()=>`NavScreenGroup-${e.text.replace(" ","-").toLowerCase()}`);function s(){t.value=!t.value}return(r,c)=>(a(),d("div",{class:M(["VPNavScreenMenuGroup",{open:t.value}])},[u("button",{class:"button","aria-controls":o.value,"aria-expanded":t.value,onClick:s},[u("span",{class:"button-text",innerHTML:n.text},null,8,ba),c[0]||(c[0]=u("span",{class:"vpi-plus button-icon"},null,-1))],8,ka),u("div",{id:o.value,class:"items"},[(a(!0),d(A,null,H(n.items,l=>(a(),d(A,{key:JSON.stringify(l)},["link"in l?(a(),d("div",ya,[b(Yn,{item:l},null,8,["item"])])):"component"in l?(a(),d("div",Pa,[(a(),P(R(l.component),G({ref_for:!0},l.props,{"screen-menu":""}),null,16))])):(a(),d("div",Sa,[b(ga,{text:l.text,items:l.items},null,8,["text","items"])]))],64))),128))],8,$a)],2))}}),Ta=$(La,[["__scopeId","data-v-956364f9"]]),Va={key:0,class:"VPNavScreenMenu"},wa=k({__name:"VPNavScreenMenu",setup(n){const{theme:e}=V();return(t,o)=>i(e).nav?(a(),d("nav",Va,[(a(!0),d(A,null,H(i(e).nav,s=>(a(),d(A,{key:JSON.stringify(s)},["link"in s?(a(),P(va,{key:0,item:s},null,8,["item"])):"component"in s?(a(),P(R(s.component),G({key:1,ref_for:!0},s.props,{"screen-menu":""}),null,16)):(a(),P(Ta,{key:2,text:s.text||"",items:s.items},null,8,["text","items"]))],64))),128))])):g("",!0)}}),Na=k({__name:"VPNavScreenSocialLinks",setup(n){const{theme:e}=V();return(t,o)=>i(e).socialLinks?(a(),P(An,{key:0,class:"VPNavScreenSocialLinks",links:i(e).socialLinks},null,8,["links"])):g("",!0)}}),Ma={class:"list"},Ca=k({__name:"VPNavScreenTranslations",setup(n){const{localeLinks:e,currentLang:t}=en({correspondingLink:!0}),o=L(!1);function s(){o.value=!o.value}return(r,c)=>i(e).length&&i(t).label?(a(),d("div",{key:0,class:M(["VPNavScreenTranslations",{open:o.value}])},[u("button",{class:"title",onClick:s},[c[0]||(c[0]=u("span",{class:"vpi-languages icon lang"},null,-1)),W(" "+N(i(t).label)+" ",1),c[1]||(c[1]=u("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),u("ul",Ma,[(a(!0),d(A,null,H(i(e),l=>(a(),d("li",{key:l.link,class:"item"},[b(z,{class:"link",href:l.link,lang:l.lang,dir:l.dir},{default:m(()=>[W(N(l.text),1)]),_:2},1032,["href","lang","dir"])]))),128))])],2)):g("",!0)}}),Aa=$(Ca,[["__scopeId","data-v-a4d9b172"]]),Ia={class:"container"},Ba=k({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(n){const e=L(null),t=Rn(nn?document.body:null);return(o,s)=>(a(),P($n,{name:"fade",onEnter:s[0]||(s[0]=r=>t.value=!0),onAfterLeave:s[1]||(s[1]=r=>t.value=!1)},{default:m(()=>[n.open?(a(),d("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:e,id:"VPNavScreen"},[u("div",Ia,[f(o.$slots,"nav-screen-content-before",{},void 0,!0),b(wa,{class:"menu"}),b(Aa,{class:"translations"}),b(ca,{class:"appearance"}),b(Na,{class:"social-links"}),f(o.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):g("",!0)]),_:3}))}}),xa=$(Ba,[["__scopeId","data-v-f2779853"]]),Ea={key:0,class:"VPNav"},Oa=k({__name:"VPNav",setup(n){const{isScreenOpen:e,closeScreen:t,toggleScreen:o}=Ao(),{frontmatter:s}=V(),r=S(()=>s.value.navbar!==!1);return zn(wn,{closeScreen:t}),rn(()=>{nn&&document.documentElement.classList.toggle("hide-nav",!r.value)}),(c,l)=>r.value?(a(),d("header",Ea,[b(aa,{"is-screen-open":i(e),onToggleScreen:i(o)},{"nav-bar-title-before":m(()=>[f(c.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[f(c.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[f(c.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[f(c.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),b(xa,{open:i(e)},{"nav-screen-content-before":m(()=>[f(c.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[f(c.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):g("",!0)}}),Ha=$(Oa,[["__scopeId","data-v-da52a441"]]),Da=["role","tabindex"],Fa={key:1,class:"items"},ja=k({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(n){const e=n,{collapsed:t,collapsible:o,isLink:s,isActiveLink:r,hasActiveLink:c,hasChildren:l,toggle:v}=Re(S(()=>e.item)),_=S(()=>l.value?"section":"div"),p=S(()=>s.value?"a":"div"),h=S(()=>l.value?e.depth+2===7?"p":`h${e.depth+2}`:"p"),T=S(()=>s.value?void 0:"button"),y=S(()=>[[`level-${e.depth}`],{collapsible:o.value},{collapsed:t.value},{"is-link":s.value},{"is-active":r.value},{"has-active":c.value}]);function w(I){"key"in I&&I.key!=="Enter"||!e.item.link&&v()}function C(){e.item.link&&v()}return(I,B)=>{const O=J("VPSidebarItem",!0);return a(),P(R(_.value),{class:M(["VPSidebarItem",y.value])},{default:m(()=>[n.item.text?(a(),d("div",G({key:0,class:"item",role:T.value},ce(n.item.items?{click:w,keydown:w}:{},!0),{tabindex:n.item.items&&0}),[B[1]||(B[1]=u("div",{class:"indicator"},null,-1)),n.item.link?(a(),P(z,{key:0,tag:p.value,class:"link",href:n.item.link,rel:n.item.rel,target:n.item.target},{default:m(()=>[(a(),P(R(h.value),{class:"text",innerHTML:n.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(a(),P(R(h.value),{key:1,class:"text",innerHTML:n.item.text},null,8,["innerHTML"])),n.item.collapsed!=null&&n.item.items&&n.item.items.length?(a(),d("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:C,onKeydown:ue(C,["enter"]),tabindex:"0"},[...B[0]||(B[0]=[u("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):g("",!0)],16,Da)):g("",!0),n.item.items&&n.item.items.length?(a(),d("div",Fa,[n.depth<5?(a(!0),d(A,{key:0},H(n.item.items,Y=>(a(),P(O,{key:Y.text,item:Y,depth:n.depth+1},null,8,["item","depth"]))),128)):g("",!0)])):g("",!0)]),_:1},8,["class"])}}}),Ra=$(ja,[["__scopeId","data-v-d81de50c"]]),za=k({__name:"VPSidebarGroup",props:{items:{}},setup(n){const e=L(!0);let t=null;return D(()=>{t=setTimeout(()=>{t=null,e.value=!1},300)}),dn(()=>{t!=null&&(clearTimeout(t),t=null)}),(o,s)=>(a(!0),d(A,null,H(n.items,r=>(a(),d("div",{key:r.text,class:M(["group",{"no-transition":e.value}])},[b(Ra,{item:r,depth:0},null,8,["item"])],2))),128))}}),Ga=$(za,[["__scopeId","data-v-8d50c081"]]),Ua={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Ka=k({__name:"VPSidebar",props:{open:{type:Boolean}},setup(n){const{sidebarGroups:e,hasSidebar:t}=U(),o=n,s=L(null),r=Rn(nn?document.body:null);F([o,s],()=>{o.open?(r.value=!0,s.value?.focus()):r.value=!1},{immediate:!0,flush:"post"});const c=L(0);return F(e,()=>{c.value+=1},{deep:!0}),(l,v)=>i(t)?(a(),d("aside",{key:0,class:M(["VPSidebar",{open:n.open}]),ref_key:"navEl",ref:s,onClick:v[0]||(v[0]=de(()=>{},["stop"]))},[v[2]||(v[2]=u("div",{class:"curtain"},null,-1)),u("nav",Ua,[v[1]||(v[1]=u("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),f(l.$slots,"sidebar-nav-before",{},void 0,!0),(a(),P(Ga,{items:i(e),key:c.value},null,8,["items"])),f(l.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):g("",!0)}}),Wa=$(Ka,[["__scopeId","data-v-af661f50"]]),qa={href:"#VPContent",class:"VPSkipLink visually-hidden"},Ja=k({__name:"VPSkipLink",setup(n){const{theme:e}=V(),t=cn(),o=L();return F(()=>t.path,()=>o.value.focus()),(s,r)=>(a(),d(A,null,[u("span",{ref_key:"backToTop",ref:o,tabindex:"-1"},null,512),u("a",qa,N(i(e).skipToContentLabel||"Skip to content"),1)],64))}}),Ya=$(Ja,[["__scopeId","data-v-331ec75c"]]),Qa=k({__name:"Layout",setup(n){const{isOpen:e,open:t,close:o}=je();ze({closeSidebar:o});const{frontmatter:s}=V(),r=ve(),c=S(()=>!!r["home-hero-image"]);return zn(Kn,{heroImageSlotExists:c}),(l,v)=>{const _=J("Content");return i(s).layout!==!1?(a(),d("div",{key:0,class:M(["Layout",i(s).pageClass])},[f(l.$slots,"layout-top",{},void 0,!0),b(Ya),b(ke,{class:"backdrop",show:i(e),onClick:i(o)},null,8,["show","onClick"]),b(Ha,null,{"nav-bar-title-before":m(()=>[f(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":m(()=>[f(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":m(()=>[f(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":m(()=>[f(l.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":m(()=>[f(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":m(()=>[f(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),b(Co,{open:i(e),onOpenMenu:i(t)},null,8,["open","onOpenMenu"]),b(Wa,{open:i(e)},{"sidebar-nav-before":m(()=>[f(l.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":m(()=>[f(l.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),b(po,null,{"page-top":m(()=>[f(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":m(()=>[f(l.$slots,"page-bottom",{},void 0,!0)]),"not-found":m(()=>[f(l.$slots,"not-found",{},void 0,!0)]),"home-hero-before":m(()=>[f(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":m(()=>[f(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":m(()=>[f(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":m(()=>[f(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":m(()=>[f(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":m(()=>[f(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":m(()=>[f(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":m(()=>[f(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":m(()=>[f(l.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":m(()=>[f(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":m(()=>[f(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":m(()=>[f(l.$slots,"doc-after",{},void 0,!0)]),"doc-top":m(()=>[f(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":m(()=>[f(l.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":m(()=>[f(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":m(()=>[f(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":m(()=>[f(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":m(()=>[f(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":m(()=>[f(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":m(()=>[f(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),b($o),f(l.$slots,"layout-bottom",{},void 0,!0)],2)):(a(),P(_,{key:1}))}}}),Xa=$(Qa,[["__scopeId","data-v-1df9f90f"]]),Qn={Layout:Xa,enhanceApp:({app:n})=>{n.component("Badge",pe)}},En="age_verified",Za=365,nr=k({__name:"AgeWarning",setup(n){const e=L(!1),t=L(!1);function o(l,v,_){const p=new Date;p.setTime(p.getTime()+_*24*60*60*1e3);const h=`expires=${p.toUTCString()}`;document.cookie=`${l}=${v};${h};path=/;SameSite=Strict`}function s(l){const v=l+"=",_=document.cookie.split(";");for(let p=0;p<_.length;p++){let h=_[p];for(;h.charAt(0)===" ";)h=h.substring(1,h.length);if(h.indexOf(v)===0)return h.substring(v.length,h.length)}return null}function r(){t.value=!0,setTimeout(()=>{e.value=!1,t.value=!1},300),o(En,"true",Za)}function c(){window.location.href="https://tv.cctv.com/2013/09/02/VIDE1378113141436780.shtml"}return D(()=>{s(En)||(e.value=!0)}),(l,v)=>(a(),P(fe,{to:"body"},[e.value?(a(),d("div",{key:0,class:M(["age-warning-overlay",{"fade-out":t.value}])},[u("div",{class:"age-warning-modal"},[v[0]||(v[0]=u("div",{class:"warning-icon"},"🔞",-1)),v[1]||(v[1]=u("h2",null,"未成年人禁止入内",-1)),v[2]||(v[2]=u("p",null,"本站包含成人内容，仅限18岁及以上人士访问。",-1)),v[3]||(v[3]=u("p",{class:"warning-detail"}," 继续访问即表示您已年满18周岁，并同意浏览成人内容。 ",-1)),u("div",{class:"warning-buttons"},[u("button",{onClick:r,class:"btn-confirm"}," 是，我已年满18岁 "),u("button",{onClick:c,class:"btn-reject"}," 否，我未满18岁 ")])])],2)):g("",!0)]))}}),er=$(nr,[["__scopeId","data-v-3dbc0a41"]]),tr={key:0},or={class:"moon-icon"},sr=k({__name:"ThemeTransition",setup(n){const{isDark:e}=yn(),t=L(!1),o=L(!1),s=L(!1),r=L(!1),c=L(!1);let l,v,_;const p=()=>{l&&(clearTimeout(l),l=void 0),v&&(clearTimeout(v),v=void 0),_&&(clearTimeout(_),_=void 0)},h=()=>{c.value=!0,r.value=!1,s.value=!1,v=setTimeout(()=>{t.value=!1,c.value=!1},260)},T=w=>{const C=document.documentElement;w?C.classList.add("dark"):C.classList.remove("dark")},y=w=>{p(),o.value=w,document.documentElement.classList.add("theme-switching"),s.value=!0,t.value=!0,r.value=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{r.value=!0})}),_=setTimeout(()=>{T(w)},200),l=setTimeout(()=>{r.value=!1,s.value=!1,document.documentElement.classList.remove("theme-switching"),v=setTimeout(()=>{t.value=!1},400)},500)};return F(e,(w,C)=>{if(!(typeof window>"u")&&C!==void 0){if(t.value||r.value||s.value){p(),h(),setTimeout(()=>y(w),130);return}y(w)}}),(w,C)=>t.value?(a(),d("div",tr,[u("div",{class:M(["theme-backdrop",{"backdrop-dark":o.value,show:s.value,fast:c.value}])},null,2),u("div",{class:M(["theme-transition-mask",{"mask-dark":o.value,animating:r.value,fast:c.value}])},[u("div",or,N(o.value?"🌙":"☀️"),1)],2)])):g("",!0)}}),ar=$(sr,[["__scopeId","data-v-06473298"]]),rr=280,ir=k({__name:"BackToTop",setup(n){const e=L(!1),t=()=>{e.value=window.scrollY>rr},o=()=>{window.scrollTo({top:0,behavior:"smooth"})};return D(()=>{window.addEventListener("scroll",t,{passive:!0}),t()}),dn(()=>{window.removeEventListener("scroll",t)}),(s,r)=>e.value?(a(),d("button",{key:0,class:"back-top",type:"button",onClick:o,"aria-label":"返回顶部"}," ↑ ")):g("",!0)}}),lr=$(ir,[["__scopeId","data-v-df795d79"]]),X="last_read",cr="reading_prompt_enabled",ur=15e3,dr=900*1e3,vr=6e4,fr=k({__name:"ReadingReminder",setup(n){const e=Tn(),t=L(!1),o=L(!1),s=L(""),r=L(void 0),c=L(void 0),l=L(!0),v=x=>{const E=document.cookie.match(new RegExp("(?:^|; )"+x.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return E?decodeURIComponent(E[1]):""},_=(x,E,K=365)=>{const j=new Date;j.setTime(j.getTime()+K*24*60*60*1e3),document.cookie=`${x}=${encodeURIComponent(E)}; path=/; expires=${j.toUTCString()}`},p=()=>{r.value&&(clearTimeout(r.value),r.value=void 0)},h=()=>{c.value&&(clearTimeout(c.value),c.value=void 0)},T=()=>{const x=v(X);if(x)try{const E=JSON.parse(x),K=Date.now(),j={current:E.current,previous:E.current,tsCurrent:E.tsCurrent,tsPrevious:K};_(X,JSON.stringify(j))}catch{}},y=()=>{h(),c.value=setTimeout(()=>{l.value&&I(e.route.path)&&T()},vr)},w=()=>{o.value=!0,setTimeout(()=>{t.value=!1,o.value=!1},300),p()},C=()=>{p(),r.value=setTimeout(()=>w(),ur)},I=x=>!x.startsWith("/settings")&&!x.includes("/404"),B=x=>{if(!I(x))return;let E="",K=0;try{const fn=v(X);if(fn){const tn=JSON.parse(fn);tn.current&&(E=tn.current),tn.tsCurrent&&(K=tn.tsCurrent)}}catch{}const j=Date.now();_(X,JSON.stringify({current:x,previous:E,tsCurrent:j,tsPrevious:K}))},O=()=>{const x=localStorage.getItem(cr);return x===null?!0:x==="true"},Y=()=>{if(!O())return;const x=v(X);if(x)try{const E=JSON.parse(x),K=Date.now(),j=E.tsPrevious??0;E.previous&&j&&K-j>dr&&E.previous!==e.route.path&&(s.value=E.previous,t.value=!0,C())}catch{}},Xn=()=>{s.value&&(w(),e.go(s.value))};return D(()=>{F(()=>e.route.path,x=>{typeof document>"u"||(B(x),y())},{immediate:!0})}),D(()=>{Y(),y(),typeof window<"u"&&(window.addEventListener("visibilitychange",Y),window.addEventListener("focus",()=>{l.value=!0,y()}),window.addEventListener("blur",()=>{l.value=!1,h()}))}),dn(()=>{typeof window<"u"&&(window.removeEventListener("visibilitychange",Y),window.removeEventListener("focus",()=>{}),window.removeEventListener("blur",()=>{})),p(),h()}),(x,E)=>me((a(),d("div",{class:M(["reading-reminder",{"fade-out":o.value}])},[u("div",{class:"reading-reminder__content"},[E[0]||(E[0]=u("span",null,"是否跳转到上次阅读位置？",-1)),u("div",{class:"reading-reminder__actions"},[u("button",{class:"primary",onClick:Xn},"跳转"),u("button",{class:"ghost",onClick:w},"关闭")])])],2)),[[he,t.value]])}}),mr=$(fr,[["__scopeId","data-v-3d8c1068"]]),On="cookie_consent",hr="age_verified",pr=k({__name:"CookieConsent",setup(n){const e=L(!1),t=L(!1),o=L(!1),s=()=>{t.value=!0,setTimeout(()=>{localStorage.setItem(On,"true"),e.value=!1,t.value=!1},300)},r=()=>{window.location.href="https://www.pixiv.net/users/50811011"},c=()=>localStorage.getItem(On)==="true",l=()=>document.cookie.includes(`${hr}=true`),v=()=>{o.value=l(),o.value&&!c()&&(e.value=!0)};return D(()=>{v();const _=setInterval(()=>{l()&&!o.value&&v()},500);return()=>clearInterval(_)}),(_,p)=>e.value?(a(),d("div",{key:0,class:M(["cookie-consent",{"fade-out":t.value}])},[p[3]||(p[3]=u("div",{class:"cookie-backdrop"},null,-1)),u("div",{class:"cookie-modal"},[u("div",{class:"cookie-modal__content"},[p[0]||(p[0]=u("h2",null,"Cookie 政策",-1)),p[1]||(p[1]=u("p",null,"此网站使用 Cookie 来改进用户体验，包括记录您的阅读位置和偏好设置。",-1)),p[2]||(p[2]=u("p",null,'如果您不同意使用 Cookie，请点击"拒绝"按钮离开此网站。',-1)),u("div",{class:"cookie-modal__actions"},[u("button",{class:"accept",onClick:s},"同意并继续"),u("button",{class:"decline",onClick:r},"拒绝")])])])],2)):g("",!0)}}),_r=$(pr,[["__scopeId","data-v-1467ed82"]]),gr={style:{display:"none"}},kr=k({__name:"SearchModal",setup(n){let e=null,t=!1;const o=()=>{!e||t||(t=!0,e.classList.add("fade-out"),setTimeout(()=>{e&&(e.style.display="none",e.classList.remove("fade-out")),t=!1},300))};return D(()=>{const s=()=>{if(e=document.querySelector(".VPLocalSearchBox"),!e){setTimeout(s,50);return}const r=()=>{o()},c=v=>{v.key==="Escape"&&e&&window.getComputedStyle(e).display!=="none"&&(v.preventDefault(),o())},l=v=>{v.target.closest("a")&&o()};e.addEventListener("click",v=>{const _=v.target;_.closest(".back-button")?(v.stopPropagation(),r()):_.closest("a")&&l(v)}),document.addEventListener("keydown",c,!0),dn(()=>{document.removeEventListener("keydown",c,!0)})};s()}),(s,r)=>(a(),d("div",gr))}}),br="reader_font",$r="reader_font_size",yr=k({__name:"Layout",setup(n){const{Layout:e}=Qn,{isDark:t}=yn(),o=Tn(),s=p=>{if(typeof document>"u")return null;const h=document.cookie.match(new RegExp("(?:^|; )"+p.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return h?decodeURIComponent(h[1]):null},r=()=>{if(typeof window>"u")return;const p=s(br);p&&(document.documentElement.dataset.font=p);const h=s($r);h&&(document.documentElement.dataset.fontSize=h)},c=p=>{document.querySelector("iframe.giscus-frame")?.contentWindow?.postMessage({giscus:{setConfig:{theme:p}}},"https://giscus.app")},l=()=>{const p=document.querySelector(".giscus-wrapper");if(!p)return;const h=p.querySelector("iframe.giscus-frame"),T=t.value?"dark":"light";if(h){c(T);return}const y=document.createElement("script");y.src="https://giscus.app/client.js",y.setAttribute("data-repo","NatsumiXD/novel-comment"),y.setAttribute("data-repo-id","R_kgDOQshs6w"),y.setAttribute("data-category","Announcements"),y.setAttribute("data-category-id","DIC_kwDOQshs684C0EPb"),y.setAttribute("data-mapping","pathname"),y.setAttribute("data-strict","1"),y.setAttribute("data-reactions-enabled","1"),y.setAttribute("data-emit-metadata","0"),y.setAttribute("data-input-position","bottom"),y.setAttribute("data-theme",T),y.setAttribute("data-lang","zh-CN"),y.setAttribute("crossorigin","anonymous"),y.async=!0,y.onload=()=>c(T),p.appendChild(y)};D(()=>{r(),sn(()=>setTimeout(l,50))});const v=()=>{document.documentElement.classList.add("page-transitioning")},_=()=>{document.documentElement.classList.remove("page-transitioning")};return F(t,p=>{typeof window>"u"||c(p?"dark":"light")},{flush:"post"}),F(()=>o.route.path,()=>{v(),sn(()=>{setTimeout(()=>{l(),_()},200)})},{flush:"post"}),(p,h)=>(a(),P(i(e),null,{"layout-top":m(()=>[b(_r),b(er),b(ar),b(kr),b(mr)]),"doc-after":m(()=>[...h[0]||(h[0]=[u("div",{class:"giscus-wrapper"},null,-1)])]),"layout-bottom":m(()=>[b(lr)]),_:1}))}}),Pr=$(yr,[["__scopeId","data-v-01562b76"]]),Sr={},Lr={class:"not-found"};function Tr(n,e){return a(),d("div",Lr,[...e[0]||(e[0]=[u("div",{class:"not-found__bubble"},[u("p",{class:"not-found__code"},"404"),u("h1",null,"迷路啦！"),u("p",null,"这里是次元夹缝，路标被史莱姆吃掉了。"),u("p",null,"别慌，跟着导航猫娘回去就好喵！"),u("a",{class:"not-found__button",href:"/"},"喵呜~ 带我回首页"),u("p",{class:"not-found__tip"},"一直往前会抵达未来，但换个方向更快找到想要的世界。")],-1)])])}const Vr=$(Sr,[["render",Tr],["__scopeId","data-v-2020f3db"]]),wr=`---
order: 1
---
...
⚠️ **警告**: 本作品包含成人内容，仅限18岁以上读者阅读。
`,Ir=Object.freeze(Object.defineProperty({__proto__:null,default:Ar},Symbol.toStringTag,{value:"Module"})),Br={key:0,class:"chapter-list"},xr=["href"],Er=k({__name:"ChapterList",props:{novel:{},novelPath:{default:()=>""}},setup(n){const e=n;Tn();const t=S(()=>e.novelPath||e.novel),o=S(()=>{const s=Object.assign({"/articles/ark/index.md":Nr,"/articles/tsandsis/chapter1.md":Cr,"/articles/tsandsis/index.md":Ir}),r=v=>{if(typeof v=="string")return v;if(v&&typeof v=="object"){const _=v.__content;if(typeof _=="string")return _;const p=v.default;if(typeof p=="string")return p}return""},c=[],l=t.value;return Object.entries(s).forEach(([v,_])=>{const p=v.match(new RegExp(`/articles/${l}/(.+?)\\.md$`));if(!p)return;const h=p[1];if(h==="index")return;const T=r(_),y=T.match(/^---\s*\n([\s\S]*?)\n---/);let w=999,C=h;if(y){const B=y[1].match(/order:\s*(\d+)/);B&&(w=parseInt(B[1],10))}const I=T.match(/^#\s+(.+)$/m);I&&(C=I[1]),c.push({order:w,title:C,path:`/articles/${l}/${h}`})}),c.sort((v,_)=>v.order-_.order)});return(s,r)=>o.value.length>0?(a(),d("div",Br,[r[0]||(r[0]=u("h2",null,"章节列表",-1)),u("ul",null,[(a(!0),d(A,null,H(o.value,c=>(a(),d("li",{key:c.path},[u("a",{href:c.path},N(c.title),9,xr)]))),128))])])):g("",!0)}}),Or=$(Er,[["__scopeId","data-v-2681bc47"]]),Hr=`---
order: 2
---
...
这是N系列的简介。
`,ci=Object.freeze(Object.defineProperty({__proto__:null,default:li},Symbol.toStringTag,{value:"Module"})),ui={class:"ark-chapter-list"},di={key:0,class:"section-a"},vi=["href"],fi={key:1,class:"section-b"},mi={key:0},hi=["href"],pi=k({__name:"ARKChapterList",setup(n){const e=S(()=>{const t=v=>typeof v=="string"?v:v&&typeof v.default=="string"?v.default:v&&typeof v.__content=="string"?v.__content:"",o=Object.assign({"/articles/ark/A/A.1.md":Dr}),s=[];Object.entries(o).forEach(([v,_])=>{const p=v.match(/\/articles\/ark\/A\/(.+?)\.md$/);if(!p)return;const h=p[1],T=t(_),y=T.match(/^---\s*\n([\s\S]*?)\n---/);let w=999,C=h;if(y){const B=y[1].match(/order:\s*(\d+)/);B&&(w=parseInt(B[1],10))}const I=T.match(/^#\s+(.+)$/m);I&&(C=I[1]),s.push({order:w,title:C,path:`/articles/ark/A/${h}`})}),s.sort((v,_)=>v.order-_.order);const r=Object.assign({"/articles/ark/B/A/B.A.1and2.md":jr,"/articles/ark/B/A/B.A.3and4.md":zr,"/articles/ark/B/A/B.A.5and6.md":Ur,"/articles/ark/B/A/index.md":Wr,"/articles/ark/B/N/B.N.1.md":Jr,"/articles/ark/B/N/B.N.2.md":Qr,"/articles/ark/B/N/B.N.3.md":Zr,"/articles/ark/B/N/B.N.4.md":ei,"/articles/ark/B/N/B.N.5.1.md":oi,"/articles/ark/B/N/B.N.5.2.md":ai,"/articles/ark/B/N/B.N.6.md":ii,"/articles/ark/B/N/index.md":ci}),c=new Map;Object.entries(r).forEach(([v,_])=>{const p=v.match(/\/articles\/ark\/B\/(\w+)\/(.+?)\.md$/);if(!p)return;const[,h,T]=p,y=t(_);if(T==="index"){const w=y.match(/^---\s*\n([\s\S]*?)\n---/);let C=999,I=h;if(w){const O=w[1].match(/order:\s*(\d+)/);O&&(C=parseInt(O[1],10))}const B=y.match(/^#\s+(.+)$/m);if(B)I=B[1];else if(w){const O=w[1].match(/title:\s*(.+)/);O&&(I=O[1].trim())}if(!c.has(h))c.set(h,{name:h,order:C,title:I,chapters:[]});else{const O=c.get(h);O.order=C,O.title=I}}else{const w=y.match(/^---\s*\n([\s\S]*?)\n---/);let C=999,I=T;if(w){const O=w[1].match(/order:\s*(\d+)/);O&&(C=parseInt(O[1],10))}const B=y.match(/^#\s+(.+)$/m);B&&(I=B[1]),c.has(h)||c.set(h,{name:h,order:999,title:h,chapters:[]}),c.get(h).chapters.push({order:C,title:I,path:`/articles/ark/B/${h}/${T}`})}});const l=Array.from(c.values());return l.forEach(v=>{v.chapters.sort((_,p)=>_.order-p.order)}),l.sort((v,_)=>v.order-_.order),{aChapters:s,series:l}});return(t,o)=>(a(),d("div",ui,[e.value.aChapters.length>0?(a(),d("section",di,[o[0]||(o[0]=u("h3",null,"A 系列（短篇）",-1)),u("ul",null,[(a(!0),d(A,null,H(e.value.aChapters,s=>(a(),d("li",{key:s.path},[u("a",{href:s.path},N(s.title),9,vi)]))),128))])])):g("",!0),e.value.series.length>0?(a(),d("section",fi,[o[1]||(o[1]=u("h3",null,"B 系列（系列连载）",-1)),(a(!0),d(A,null,H(e.value.series,s=>(a(),d("div",{key:s.name,class:"series"},[u("h4",null,N(s.title),1),s.chapters.length>0?(a(),d("ul",mi,[(a(!0),d(A,null,H(s.chapters,r=>(a(),d("li",{key:r.path},[u("a",{href:r.path},N(r.title),9,hi)]))),128))])):g("",!0)]))),128))])):g("",!0)]))}}),_i=$(pi,[["__scopeId","data-v-e236f069"]]),bi={extends:Qn,Layout:Pr,NotFound:Vr,enhanceApp({app:n}){n.component("ChapterList",Or),n.component("ARKChapterList",_i)}};export{bi as R,Bs as c,V as u};
