const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.90ga2IdG.js","assets/chunks/framework.DHtr43LW.js"])))=>i.map(i=>d[i]);
import{d as P,c as r,r as f,n as C,o as a,a as E,t as V,b as y,w as v,T as ln,e as $,_,u as Tn,i as st,f as rt,g as yn,h as T,j as i,k as c,l as Y,m as Dn,p as R,q as it,s as An,v as lt,x as N,y as un,z as H,A as On,B as cn,C as tn,D as dn,E as Ln,F as Jn,G as I,H as z,I as J,J as S,K as F,L as Un,M as ut,N as ct,O as G,P as _n,Q as Fn,R as dt,S as vn,U as sn,V as Kn,W as _t,X as ft,Y as ht,Z as Gn,$ as Xn,a0 as mt,a1 as qt,a2 as Z,a3 as vt,a4 as bt,a5 as gt,a6 as Nn,a7 as $t,a8 as Pt,a9 as O}from"./chunks/framework.DHtr43LW.js";const kt=P({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(p){return(n,t)=>(a(),r("span",{class:C(["VPBadge",p.type])},[f(n.$slots,"default",{},()=>[E(V(p.text),1)])],2))}}),St={key:0,class:"VPBackdrop"},Tt=P({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(p){return(n,t)=>(a(),y(ln,{name:"fade"},{default:v(()=>[p.show?(a(),r("div",St)):$("",!0)]),_:1}))}}),yt=_(Tt,[["__scopeId","data-v-c79a1216"]]),x=Tn;function At(p,n){let t,e=!1;return()=>{t&&clearTimeout(t),e?t=setTimeout(p,n):(p(),(e=!0)&&setTimeout(()=>e=!1,n))}}function bn(p){return p.startsWith("/")?p:`/${p}`}function Bn(p){const{pathname:n,search:t,hash:e,protocol:o}=new URL(p,"http://a.com");if(st(p)||p.startsWith("#")||!o.startsWith("http")||!rt(n))return p;const{site:s}=x(),l=n.endsWith("/")||n.endsWith(".html")?p:p.replace(/(?:(^\.+)\/)?.*$/,`$1${n.replace(/(\.md)?$/,s.value.cleanUrls?"":".html")}${t}${e}`);return yn(l)}function en({correspondingLink:p=!1}={}){const{site:n,localeIndex:t,page:e,theme:o,hash:s}=x(),l=T(()=>({label:n.value.locales[t.value]?.label,link:n.value.locales[t.value]?.link||(t.value==="root"?"/":`/${t.value}/`)}));return{localeLinks:T(()=>Object.entries(n.value.locales).flatMap(([d,q])=>l.value.label===q.label?[]:{text:q.label,link:Ot(q.link||(d==="root"?"/":`/${d}/`),o.value.i18nRouting!==!1&&p,e.value.relativePath.slice(l.value.link.length-1),!n.value.cleanUrls)+s.value,lang:q.lang,dir:q.dir})),currentLang:l}}function Ot(p,n,t,e){return n?p.replace(/\/$/,"")+bn(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,e?".html":"")):p}const Nt={class:"NotFound"},Bt={class:"code"},xt={class:"title"},Vt={class:"quote"},Ct={class:"action"},It=["href","aria-label"],jt=P({__name:"NotFound",setup(p){const{theme:n}=x(),{currentLang:t}=en();return(e,o)=>(a(),r("div",Nt,[i("p",Bt,V(c(n).notFound?.code??"404"),1),i("h1",xt,V(c(n).notFound?.title??"PAGE NOT FOUND"),1),o[0]||(o[0]=i("div",{class:"divider"},null,-1)),i("blockquote",Vt,V(c(n).notFound?.quote??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),i("div",Ct,[i("a",{class:"link",href:c(yn)(c(n).notFound?.link??c(t).link),"aria-label":c(n).notFound?.linkLabel??"go to home"},V(c(n).notFound?.linkText??"Take me home"),9,It)])]))}}),Dt=_(jt,[["__scopeId","data-v-829df670"]]);function Wn(p,n){if(Array.isArray(p))return an(p);if(p==null)return[];n=bn(n);const t=Object.keys(p).sort((o,s)=>s.split("/").length-o.split("/").length).find(o=>n.startsWith(bn(o))),e=t?p[t]:[];return Array.isArray(e)?an(e):an(e.items,e.base)}function Lt(p){const n=[];let t=0;for(const e in p){const o=p[e];if(o.items){t=n.push(o);continue}n[t]||n.push({items:[]}),n[t].items.push(o)}return n}function Mt(p){const n=[];function t(e){for(const o of e)o.text&&o.link&&n.push({text:o.text,link:o.link,docFooterText:o.docFooterText}),o.items&&t(o.items)}return t(p),n}function gn(p,n){return Array.isArray(n)?n.some(t=>gn(p,t)):Y(p,n.link)?!0:n.items?gn(p,n.items):!1}function an(p,n){return[...p].map(t=>{const e={...t},o=e.base||n;return o&&e.link&&(e.link=o+e.link.replace(/^\//,o.endsWith("/")?"":"/")),e.items&&(e.items=an(e.items,o)),e})}function wt(){const{hasSidebar:p}=X(),n=Dn("(min-width: 960px)"),t=Dn("(min-width: 1280px)");return{isAsideEnabled:T(()=>!t.value&&!n.value?!1:p.value?t.value:n.value)}}const Et=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,$n=[];function Yn(p){return typeof p.outline=="object"&&!Array.isArray(p.outline)&&p.outline.label||p.outlineTitle||"On this page"}function zt(p){const n=[...document.querySelectorAll(".VPDoc h1, .VPDoc h2, .VPDoc h3, .VPDoc h4, .VPDoc h5, .VPDoc h6")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const e=Number(t.tagName[1]);return{element:t,title:Rt(t),link:"#"+t.id,level:e}});return Ht(n,p)}function Rt(p){let n="";for(const t of p.childNodes)if(t.nodeType===1){if(Et.test(t.className))continue;n+=t.textContent}else t.nodeType===3&&(n+=t.textContent);return n.trim()}function Ht(p,n){if(n===!1)return[];const t=(typeof n=="object"&&!Array.isArray(n)?n.level:n)||2,[e,o]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return Ft(p,e,o)}function Jt(p,n){const{isAsideEnabled:t}=wt(),e=At(s,100);let o=null;R(()=>{requestAnimationFrame(s),window.addEventListener("scroll",e)}),it(()=>{l(location.hash)}),An(()=>{window.removeEventListener("scroll",e)});function s(){if(!t.value)return;const u=window.scrollY,d=window.innerHeight,q=document.body.offsetHeight,m=Math.abs(u+d-q)<1,h=$n.map(({element:g,link:A})=>({link:A,top:Ut(g)})).filter(({top:g})=>!Number.isNaN(g)).sort((g,A)=>g.top-A.top);if(!h.length){l(null);return}if(u<1){l(null);return}if(m){l(h[h.length-1].link);return}let b=null;for(const{link:g,top:A}of h){if(A>u+lt()+4)break;b=g}l(b)}function l(u){o&&o.classList.remove("active"),u==null?o=null:o=p.value.querySelector(`a[href="${decodeURIComponent(u)}"]`);const d=o;d?(d.classList.add("active"),n.value.style.top=d.offsetTop+39+"px",n.value.style.opacity="1"):(n.value.style.top="33px",n.value.style.opacity="0")}}function Ut(p){let n=0;for(;p!==document.body;){if(p===null)return NaN;n+=p.offsetTop,p=p.offsetParent}return n}function Ft(p,n,t){$n.length=0;const e=[],o=[];return p.forEach(s=>{const l={...s,children:[]};let u=o[o.length-1];for(;u&&u.level>=l.level;)o.pop(),u=o[o.length-1];if(l.element.classList.contains("ignore-header")||u&&"shouldIgnore"in u){o.push({level:l.level,shouldIgnore:!0});return}l.level>t||l.level<n||($n.push({element:l.element,link:l.link}),u?u.children.push(l):e.push(l),o.push(l))}),e}const Q=N(!1);function Kt(p){let n;un(()=>{n=Q.value?document.activeElement:void 0}),R(()=>{window.addEventListener("keyup",t)}),An(()=>{window.removeEventListener("keyup",t)});function t(e){e.key==="Escape"&&Q.value&&(p(),n?.focus())}}function Gt(){function p(){Q.value=!0}function n(){Q.value=!1}function t(){Q.value?n():p()}return{isOpen:Q,open:p,close:n,toggle:t}}function Xt(p){const{page:n,hash:t}=x(),e=N(!1),o=T(()=>p.value.collapsed!=null),s=T(()=>!!p.value.link),l=N(!1),u=()=>{l.value=Y(n.value.relativePath,p.value.link)};H([n,p,t],u),R(u);const d=T(()=>l.value?!0:p.value.items?gn(n.value.relativePath,p.value.items):!1),q=T(()=>!!(p.value.items&&p.value.items.length));un(()=>{e.value=!!(o.value&&p.value.collapsed)}),On(()=>{(l.value||d.value)&&(e.value=!1)});function m(){o.value&&(e.value=!e.value)}return{collapsed:e,collapsible:o,isLink:s,isActiveLink:l,hasActiveLink:d,hasChildren:q,toggle:m}}const Pn=cn([]),pn=cn([]),kn=cn(!1);function X(){const{frontmatter:p,theme:n}=x(),t=T(()=>!!(p.value.isHome??p.value.layout==="home")),e=T(()=>p.value.sidebar!==!1&&pn.value.length>0&&!t.value),o=T(()=>e.value&&kn.value),s=T(()=>e.value?Lt(pn.value):[]),l=T(()=>t.value?!1:p.value.aside!=null?!!p.value.aside:n.value.aside!==!1),u=T(()=>l.value?p.value.aside==null?n.value.aside==="left":p.value.aside==="left":!1),d=T(()=>Pn.value.length>0);return{isHome:t,sidebar:Ln(pn),sidebarGroups:s,hasSidebar:e,isSidebarEnabled:o,hasAside:l,leftAside:u,headers:Ln(Pn),hasLocalNav:d}}function Wt({closeSidebar:p}){const{frontmatter:n,page:t,theme:e}=x();H(()=>[t.value.relativePath,e.value.sidebar],([s,l])=>{const u=l?Wn(l,s):[];JSON.stringify(u)!==JSON.stringify(pn.value)&&(pn.value=u)},{immediate:!0,deep:!0,flush:"sync"}),Jn(()=>{Pn.value=zt(n.value.outline??e.value.outline)}),tn&&(kn.value=window.innerWidth>=960,window.addEventListener("resize",()=>{kn.value=window.innerWidth>=960},{passive:!0}));const o=dn();H(()=>o.path,p),Kt(p)}const Qn=Symbol("layout-info"),Yt=["href","title"],Qt=P({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(p){return(n,t)=>{const e=J("VPDocOutlineItem",!0);return a(),r("ul",{class:C(["VPDocOutlineItem",p.root?"root":"nested"])},[(a(!0),r(I,null,z(p.headers,({children:o,link:s,title:l})=>(a(),r("li",null,[i("a",{class:"outline-link",href:s,title:l},V(l),9,Yt),o?.length?(a(),y(e,{key:0,headers:o},null,8,["headers"])):$("",!0)]))),256))],2)}}}),Zn=_(Qt,[["__scopeId","data-v-1ce71065"]]),Zt={class:"content"},ne={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},pe=P({__name:"VPDocAsideOutline",setup(p){const{theme:n}=x(),t=N(),e=N(),{headers:o,hasLocalNav:s}=X();return Jt(t,e),(l,u)=>(a(),r("nav",{"aria-labelledby":"doc-outline-aria-label",class:C(["VPDocAsideOutline",{"has-outline":c(s)}]),ref_key:"container",ref:t},[i("div",Zt,[i("div",{class:"outline-marker",ref_key:"marker",ref:e},null,512),i("div",ne,V(c(Yn)(c(n))),1),S(Zn,{headers:c(o),root:!0},null,8,["headers"])])],2))}}),te=_(pe,[["__scopeId","data-v-60d5052e"]]),ee={class:"VPDocAsideCarbonAds"},oe=P({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(p){const n=()=>null;return(t,e)=>(a(),r("div",ee,[S(c(n),{"carbon-ads":p.carbonAds},null,8,["carbon-ads"])]))}}),ae={class:"VPDocAside"},se=P({__name:"VPDocAside",setup(p){const{theme:n}=x();return(t,e)=>(a(),r("div",ae,[f(t.$slots,"aside-top",{},void 0,!0),f(t.$slots,"aside-outline-before",{},void 0,!0),S(te),f(t.$slots,"aside-outline-after",{},void 0,!0),e[0]||(e[0]=i("div",{class:"spacer"},null,-1)),f(t.$slots,"aside-ads-before",{},void 0,!0),c(n).carbonAds?(a(),y(oe,{key:0,"carbon-ads":c(n).carbonAds},null,8,["carbon-ads"])):$("",!0),f(t.$slots,"aside-ads-after",{},void 0,!0),f(t.$slots,"aside-bottom",{},void 0,!0)]))}}),re=_(se,[["__scopeId","data-v-3f215769"]]);function ie(){const{theme:p,page:n}=x();return T(()=>{const{text:t="Edit this page",pattern:e=""}=p.value.editLink||{};let o;return typeof e=="function"?o=e(n.value):o=e.replace(/:path/g,n.value.filePath),{url:o,text:t}})}function le(){const{page:p,theme:n,frontmatter:t}=x();return T(()=>{const e=Wn(n.value.sidebar,p.value.relativePath),o=Mt(e),s=ue(o,q=>q.link.replace(/[?#].*$/,"")),l=s.findIndex(q=>Y(p.value.relativePath,q.link)),u=n.value.docFooter?.prev===!1&&!t.value.prev||t.value.prev===!1,d=n.value.docFooter?.next===!1&&!t.value.next||t.value.next===!1;return{prev:u?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??s[l-1]?.docFooterText??s[l-1]?.text,link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??s[l-1]?.link},next:d?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??s[l+1]?.docFooterText??s[l+1]?.text,link:(typeof t.value.next=="object"?t.value.next.link:void 0)??s[l+1]?.link}}})}function ue(p,n){const t=new Set;return p.filter(e=>{const o=n(e);return t.has(o)?!1:t.add(o)})}const K=P({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(p){const n=p,t=T(()=>n.tag??(n.href?"a":"span")),e=T(()=>n.href&&Un.test(n.href)||n.target==="_blank");return(o,s)=>(a(),y(F(t.value),{class:C(["VPLink",{link:p.href,"vp-external-link-icon":e.value,"no-icon":p.noIcon}]),href:p.href?c(Bn)(p.href):void 0,target:p.target??(e.value?"_blank":void 0),rel:p.rel??(e.value?"noreferrer":void 0)},{default:v(()=>[f(o.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),ce={class:"VPLastUpdated"},de=["datetime"],_e=P({__name:"VPDocFooterLastUpdated",setup(p){const{theme:n,page:t,lang:e}=x(),{language:o}=ct(),s=ut("timeRef"),l=T(()=>new Date(t.value.lastUpdated)),u=T(()=>l.value.toISOString()),d=cn("");return R(()=>{un(()=>{const q=n.value.lastUpdated?.formatOptions?.forceLocale?e.value:o.value;d.value=new Intl.DateTimeFormat(q,n.value.lastUpdated?.formatOptions??{dateStyle:"medium",timeStyle:"medium"}).format(l.value),q&&e.value!==q?s.value?.setAttribute("lang",q):s.value?.removeAttribute("lang")})}),(q,m)=>(a(),r("p",ce,[E(V(c(n).lastUpdated?.text||c(n).lastUpdatedText||"Last updated")+": ",1),i("time",{ref_key:"timeRef",ref:s,datetime:u.value},V(d.value),9,de)]))}}),fe=_(_e,[["__scopeId","data-v-3c637f39"]]),he={key:0,class:"VPDocFooter"},me={key:0,class:"edit-info"},qe={key:0,class:"edit-link"},ve={key:1,class:"last-updated"},be={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},ge={class:"pager"},$e=["innerHTML"],Pe=["innerHTML"],ke={class:"pager"},Se=["innerHTML"],Te=["innerHTML"],ye=P({__name:"VPDocFooter",setup(p){const{theme:n,page:t,frontmatter:e}=x(),o=ie(),s=le(),l=T(()=>n.value.editLink&&e.value.editLink!==!1),u=T(()=>t.value.lastUpdated),d=T(()=>l.value||u.value||s.value.prev||s.value.next);return(q,m)=>d.value?(a(),r("footer",he,[f(q.$slots,"doc-footer-before",{},void 0,!0),l.value||u.value?(a(),r("div",me,[l.value?(a(),r("div",qe,[S(K,{class:"edit-link-button",href:c(o).url,"no-icon":!0},{default:v(()=>[m[0]||(m[0]=i("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),E(" "+V(c(o).text),1)]),_:1},8,["href"])])):$("",!0),u.value?(a(),r("div",ve,[S(fe)])):$("",!0)])):$("",!0),c(s).prev?.link||c(s).next?.link?(a(),r("nav",be,[m[1]||(m[1]=i("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),i("div",ge,[c(s).prev?.link?(a(),y(K,{key:0,class:"pager-link prev",href:c(s).prev.link},{default:v(()=>[i("span",{class:"desc",innerHTML:c(n).docFooter?.prev||"Previous page"},null,8,$e),i("span",{class:"title",innerHTML:c(s).prev.text},null,8,Pe)]),_:1},8,["href"])):$("",!0)]),i("div",ke,[c(s).next?.link?(a(),y(K,{key:0,class:"pager-link next",href:c(s).next.link},{default:v(()=>[i("span",{class:"desc",innerHTML:c(n).docFooter?.next||"Next page"},null,8,Se),i("span",{class:"title",innerHTML:c(s).next.text},null,8,Te)]),_:1},8,["href"])):$("",!0)])])):$("",!0)])):$("",!0)}}),Ae=_(ye,[["__scopeId","data-v-e257564d"]]),Oe={class:"container"},Ne={class:"aside-container"},Be={class:"aside-content"},xe={class:"content"},Ve={class:"content-container"},Ce={class:"main"},Ie=P({__name:"VPDoc",setup(p){const{theme:n}=x(),t=dn(),{hasSidebar:e,hasAside:o,leftAside:s}=X(),l=T(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(u,d)=>{const q=J("Content");return a(),r("div",{class:C(["VPDoc",{"has-sidebar":c(e),"has-aside":c(o)}])},[f(u.$slots,"doc-top",{},void 0,!0),i("div",Oe,[c(o)?(a(),r("div",{key:0,class:C(["aside",{"left-aside":c(s)}])},[d[0]||(d[0]=i("div",{class:"aside-curtain"},null,-1)),i("div",Ne,[i("div",Be,[S(re,null,{"aside-top":v(()=>[f(u.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":v(()=>[f(u.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":v(()=>[f(u.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":v(()=>[f(u.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":v(()=>[f(u.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":v(()=>[f(u.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):$("",!0),i("div",xe,[i("div",Ve,[f(u.$slots,"doc-before",{},void 0,!0),i("main",Ce,[S(q,{class:C(["vp-doc",[l.value,c(n).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),S(Ae,null,{"doc-footer-before":v(()=>[f(u.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),f(u.$slots,"doc-after",{},void 0,!0)])])]),f(u.$slots,"doc-bottom",{},void 0,!0)],2)}}}),je=_(Ie,[["__scopeId","data-v-7011f0d8"]]),De=P({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(p){const n=p,t=T(()=>n.href&&Un.test(n.href)),e=T(()=>n.tag||(n.href?"a":"button"));return(o,s)=>(a(),y(F(e.value),{class:C(["VPButton",[p.size,p.theme]]),href:p.href?c(Bn)(p.href):void 0,target:n.target??(t.value?"_blank":void 0),rel:n.rel??(t.value?"noreferrer":void 0)},{default:v(()=>[f(o.$slots,"default",{},()=>[E(V(p.text),1)],!0)]),_:3},8,["class","href","target","rel"]))}}),Le=_(De,[["__scopeId","data-v-01bff58b"]]),Me=["src","alt"],we=P({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(p){return(n,t)=>{const e=J("VPImage",!0);return p.image?(a(),r(I,{key:0},[typeof p.image=="string"||"src"in p.image?(a(),r("img",G({key:0,class:"VPImage"},typeof p.image=="string"?n.$attrs:{...p.image,...n.$attrs},{src:c(yn)(typeof p.image=="string"?p.image:p.image.src),alt:p.alt??(typeof p.image=="string"?"":p.image.alt||"")}),null,16,Me)):(a(),r(I,{key:1},[S(e,G({class:"dark",image:p.image.dark,alt:p.image.alt},n.$attrs),null,16,["image","alt"]),S(e,G({class:"light",image:p.image.light,alt:p.image.alt},n.$attrs),null,16,["image","alt"])],64))],64)):$("",!0)}}}),rn=_(we,[["__scopeId","data-v-8426fc1a"]]),Ee={class:"container"},ze={class:"main"},Re={class:"heading"},He=["innerHTML"],Je=["innerHTML"],Ue=["innerHTML"],Fe={key:0,class:"actions"},Ke={key:0,class:"image"},Ge={class:"image-container"},Xe=P({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(p){const{heroImageSlotExists:n}=_n(Qn);return(t,e)=>(a(),r("div",{class:C(["VPHero",{"has-image":p.image||c(n)}])},[i("div",Ee,[i("div",ze,[f(t.$slots,"home-hero-info-before",{},void 0,!0),f(t.$slots,"home-hero-info",{},()=>[i("h1",Re,[p.name?(a(),r("span",{key:0,innerHTML:p.name,class:"name clip"},null,8,He)):$("",!0),p.text?(a(),r("span",{key:1,innerHTML:p.text,class:"text"},null,8,Je)):$("",!0)]),p.tagline?(a(),r("p",{key:0,innerHTML:p.tagline,class:"tagline"},null,8,Ue)):$("",!0)],!0),f(t.$slots,"home-hero-info-after",{},void 0,!0),p.actions?(a(),r("div",Fe,[(a(!0),r(I,null,z(p.actions,o=>(a(),r("div",{key:o.link,class:"action"},[S(Le,{tag:"a",size:"medium",theme:o.theme,text:o.text,href:o.link,target:o.target,rel:o.rel},null,8,["theme","text","href","target","rel"])]))),128))])):$("",!0),f(t.$slots,"home-hero-actions-after",{},void 0,!0)]),p.image||c(n)?(a(),r("div",Ke,[i("div",Ge,[e[0]||(e[0]=i("div",{class:"image-bg"},null,-1)),f(t.$slots,"home-hero-image",{},()=>[p.image?(a(),y(rn,{key:0,class:"image-src",image:p.image},null,8,["image"])):$("",!0)],!0)])])):$("",!0)])],2))}}),We=_(Xe,[["__scopeId","data-v-1e96e9e8"]]),Ye=P({__name:"VPHomeHero",setup(p){const{frontmatter:n}=x();return(t,e)=>c(n).hero?(a(),y(We,{key:0,class:"VPHomeHero",name:c(n).hero.name,text:c(n).hero.text,tagline:c(n).hero.tagline,image:c(n).hero.image,actions:c(n).hero.actions},{"home-hero-info-before":v(()=>[f(t.$slots,"home-hero-info-before")]),"home-hero-info":v(()=>[f(t.$slots,"home-hero-info")]),"home-hero-info-after":v(()=>[f(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":v(()=>[f(t.$slots,"home-hero-actions-after")]),"home-hero-image":v(()=>[f(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):$("",!0)}}),Qe={class:"box"},Ze={key:0,class:"icon"},no=["innerHTML"],po=["innerHTML"],to=["innerHTML"],eo={key:4,class:"link-text"},oo={class:"link-text-value"},ao=P({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(p){return(n,t)=>(a(),y(K,{class:"VPFeature",href:p.link,rel:p.rel,target:p.target,"no-icon":!0,tag:p.link?"a":"div"},{default:v(()=>[i("article",Qe,[typeof p.icon=="object"&&p.icon.wrap?(a(),r("div",Ze,[S(rn,{image:p.icon,alt:p.icon.alt,height:p.icon.height||48,width:p.icon.width||48},null,8,["image","alt","height","width"])])):typeof p.icon=="object"?(a(),y(rn,{key:1,image:p.icon,alt:p.icon.alt,height:p.icon.height||48,width:p.icon.width||48},null,8,["image","alt","height","width"])):p.icon?(a(),r("div",{key:2,class:"icon",innerHTML:p.icon},null,8,no)):$("",!0),i("h2",{class:"title",innerHTML:p.title},null,8,po),p.details?(a(),r("p",{key:3,class:"details",innerHTML:p.details},null,8,to)):$("",!0),p.linkText?(a(),r("div",eo,[i("p",oo,[E(V(p.linkText)+" ",1),t[0]||(t[0]=i("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):$("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),so=_(ao,[["__scopeId","data-v-5219619b"]]),ro={key:0,class:"VPFeatures"},io={class:"container"},lo={class:"items"},uo=P({__name:"VPFeatures",props:{features:{}},setup(p){const n=p,t=T(()=>{const e=n.features.length;if(e){if(e===2)return"grid-2";if(e===3)return"grid-3";if(e%3===0)return"grid-6";if(e>3)return"grid-4"}else return});return(e,o)=>p.features?(a(),r("div",ro,[i("div",io,[i("div",lo,[(a(!0),r(I,null,z(p.features,s=>(a(),r("div",{key:s.title,class:C(["item",[t.value]])},[S(so,{icon:s.icon,title:s.title,details:s.details,link:s.link,"link-text":s.linkText,rel:s.rel,target:s.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):$("",!0)}}),co=_(uo,[["__scopeId","data-v-a6181336"]]),_o=P({__name:"VPHomeFeatures",setup(p){const{frontmatter:n}=x();return(t,e)=>c(n).features?(a(),y(co,{key:0,class:"VPHomeFeatures",features:c(n).features},null,8,["features"])):$("",!0)}}),fo=P({__name:"VPHomeContent",setup(p){const{width:n}=dt({initialWidth:0,includeScrollbar:!1});return(t,e)=>(a(),r("div",{class:"vp-doc container",style:Fn(c(n)?{"--vp-offset":`calc(50% - ${c(n)/2}px)`}:{})},[f(t.$slots,"default",{},void 0,!0)],4))}}),ho=_(fo,[["__scopeId","data-v-8e2d4988"]]),mo=P({__name:"VPHome",setup(p){const{frontmatter:n,theme:t}=x();return(e,o)=>{const s=J("Content");return a(),r("div",{class:C(["VPHome",{"external-link-icon-enabled":c(t).externalLinkIcon}])},[f(e.$slots,"home-hero-before",{},void 0,!0),S(Ye,null,{"home-hero-info-before":v(()=>[f(e.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":v(()=>[f(e.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":v(()=>[f(e.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":v(()=>[f(e.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":v(()=>[f(e.$slots,"home-hero-image",{},void 0,!0)]),_:3}),f(e.$slots,"home-hero-after",{},void 0,!0),f(e.$slots,"home-features-before",{},void 0,!0),S(_o),f(e.$slots,"home-features-after",{},void 0,!0),c(n).markdownStyles!==!1?(a(),y(ho,{key:0},{default:v(()=>[S(s)]),_:1})):(a(),y(s,{key:1}))],2)}}}),qo=_(mo,[["__scopeId","data-v-8b561e3d"]]),vo={},bo={class:"VPPage"};function go(p,n){const t=J("Content");return a(),r("div",bo,[f(p.$slots,"page-top"),S(t),f(p.$slots,"page-bottom")])}const $o=_(vo,[["render",go]]),Po=P({__name:"VPContent",setup(p){const{page:n,frontmatter:t}=x(),{isHome:e,hasSidebar:o}=X();return(s,l)=>(a(),r("div",{class:C(["VPContent",{"has-sidebar":c(o),"is-home":c(e)}]),id:"VPContent"},[c(n).isNotFound?f(s.$slots,"not-found",{key:0},()=>[S(Dt)],!0):c(t).layout==="page"?(a(),y($o,{key:1},{"page-top":v(()=>[f(s.$slots,"page-top",{},void 0,!0)]),"page-bottom":v(()=>[f(s.$slots,"page-bottom",{},void 0,!0)]),_:3})):c(t).layout==="home"?(a(),y(qo,{key:2},{"home-hero-before":v(()=>[f(s.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":v(()=>[f(s.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":v(()=>[f(s.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":v(()=>[f(s.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":v(()=>[f(s.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":v(()=>[f(s.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":v(()=>[f(s.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":v(()=>[f(s.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":v(()=>[f(s.$slots,"home-features-after",{},void 0,!0)]),_:3})):c(t).layout&&c(t).layout!=="doc"?(a(),y(F(c(t).layout),{key:3})):(a(),y(je,{key:4},{"doc-top":v(()=>[f(s.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":v(()=>[f(s.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":v(()=>[f(s.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":v(()=>[f(s.$slots,"doc-before",{},void 0,!0)]),"doc-after":v(()=>[f(s.$slots,"doc-after",{},void 0,!0)]),"aside-top":v(()=>[f(s.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":v(()=>[f(s.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":v(()=>[f(s.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":v(()=>[f(s.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":v(()=>[f(s.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":v(()=>[f(s.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),ko=_(Po,[["__scopeId","data-v-c87f25bf"]]),So={class:"container"},To=["innerHTML"],yo=["innerHTML"],Ao=P({__name:"VPFooter",setup(p){const{theme:n,frontmatter:t}=x(),{hasSidebar:e}=X();return(o,s)=>c(n).footer&&c(t).footer!==!1?(a(),r("footer",{key:0,class:C(["VPFooter",{"has-sidebar":c(e)}])},[i("div",So,[c(n).footer.message?(a(),r("p",{key:0,class:"message",innerHTML:c(n).footer.message},null,8,To)):$("",!0),c(n).footer.copyright?(a(),r("p",{key:1,class:"copyright",innerHTML:c(n).footer.copyright},null,8,yo)):$("",!0)])],2)):$("",!0)}}),Oo=_(Ao,[["__scopeId","data-v-c3855bb3"]]),No={class:"menu-text"},Bo={class:"header"},xo={class:"outline"},Vo=P({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(p){const n=p,{theme:t}=x(),e=N(!1),o=N(0),s=N(),l=N();function u(h){s.value?.contains(h.target)||(e.value=!1)}H(e,h=>{if(h){document.addEventListener("click",u);return}document.removeEventListener("click",u)}),vn("Escape",()=>{e.value=!1}),Jn(()=>{e.value=!1});function d(){e.value=!e.value,o.value=window.innerHeight+Math.min(window.scrollY-n.navHeight,0)}function q(h){h.target.classList.contains("outline-link")&&(l.value&&(l.value.style.transition="none"),sn(()=>{e.value=!1}))}function m(){e.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(h,b)=>(a(),r("div",{class:"VPLocalNavOutlineDropdown",style:Fn({"--vp-vh":o.value+"px"}),ref_key:"main",ref:s},[p.headers.length>0?(a(),r("button",{key:0,onClick:d,class:C({open:e.value})},[i("span",No,V(c(Yn)(c(t))),1),b[0]||(b[0]=i("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(a(),r("button",{key:1,onClick:m},V(c(t).returnToTopLabel||"Return to top"),1)),S(ln,{name:"flyout"},{default:v(()=>[e.value?(a(),r("div",{key:0,ref_key:"items",ref:l,class:"items",onClick:q},[i("div",Bo,[i("a",{class:"top-link",href:"#",onClick:m},V(c(t).returnToTopLabel||"Return to top"),1)]),i("div",xo,[S(Zn,{headers:p.headers},null,8,["headers"])])],512)):$("",!0)]),_:1})],4))}}),Co=_(Vo,[["__scopeId","data-v-0bf0e06f"]]),Io={class:"container"},jo=["aria-expanded"],Do={class:"menu-text"},Lo=P({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(p){const{theme:n}=x(),{isHome:t,hasSidebar:e,headers:o,hasLocalNav:s}=X(),{y:l}=Kn(),u=N(0);R(()=>{u.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))});const d=T(()=>({VPLocalNav:!0,"has-sidebar":e.value,empty:!s.value,fixed:!s.value&&!e.value}));return(q,m)=>!c(t)&&(c(s)||c(e)||c(l)>=u.value)?(a(),r("div",{key:0,class:C(d.value)},[i("div",Io,[c(e)?(a(),r("button",{key:0,class:"menu","aria-expanded":p.open,"aria-controls":"VPSidebarNav",onClick:m[0]||(m[0]=h=>q.$emit("open-menu"))},[m[1]||(m[1]=i("span",{class:"vpi-align-left menu-icon"},null,-1)),i("span",Do,V(c(n).sidebarMenuLabel||"Menu"),1)],8,jo)):$("",!0),S(Co,{headers:c(o),navHeight:u.value},null,8,["headers","navHeight"])])],2)):$("",!0)}}),Mo=_(Lo,[["__scopeId","data-v-db738f89"]]);function wo(){const p=N(!1);function n(){p.value=!0,window.addEventListener("resize",o)}function t(){p.value=!1,window.removeEventListener("resize",o)}function e(){p.value?t():n()}function o(){window.outerWidth>=768&&t()}const s=dn();return H(()=>s.path,t),{isScreenOpen:p,openScreen:n,closeScreen:t,toggleScreen:e}}const xn=Symbol("nav"),Eo={},zo={class:"VPSwitch",type:"button",role:"switch"},Ro={class:"check"},Ho={key:0,class:"icon"};function Jo(p,n){return a(),r("button",zo,[i("span",Ro,[p.$slots.default?(a(),r("span",Ho,[f(p.$slots,"default",{},void 0,!0)])):$("",!0)])])}const Uo=_(Eo,[["render",Jo],["__scopeId","data-v-1d5665e3"]]),Fo=P({__name:"VPSwitchAppearance",setup(p){const{isDark:n,theme:t}=x(),e=_n("toggle-appearance",()=>{n.value=!n.value}),o=N("");return On(()=>{o.value=n.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(s,l)=>(a(),y(Uo,{title:o.value,class:"VPSwitchAppearance","aria-checked":c(n),onClick:c(e)},{default:v(()=>[...l[0]||(l[0]=[i("span",{class:"vpi-sun sun"},null,-1),i("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Vn=_(Fo,[["__scopeId","data-v-5337faa4"]]),Ko={key:0,class:"VPNavBarAppearance"},Go=P({__name:"VPNavBarAppearance",setup(p){const{site:n}=x();return(t,e)=>c(n).appearance&&c(n).appearance!=="force-dark"&&c(n).appearance!=="force-auto"?(a(),r("div",Ko,[S(Vn)])):$("",!0)}}),Xo=_(Go,[["__scopeId","data-v-6c893767"]]),Cn=N();let np=!1,mn=0;function Wo(p){const n=N(!1);if(tn){!np&&Yo(),mn++;const t=H(Cn,e=>{e===p.el.value||p.el.value?.contains(e)?(n.value=!0,p.onFocus?.()):(n.value=!1,p.onBlur?.())});An(()=>{t(),mn--,mn||Qo()})}return _t(n)}function Yo(){document.addEventListener("focusin",pp),np=!0,Cn.value=document.activeElement}function Qo(){document.removeEventListener("focusin",pp)}function pp(){Cn.value=document.activeElement}const Zo={class:"VPMenuLink"},na=["innerHTML"],pa=P({inheritAttrs:!1,__name:"VPMenuLink",props:{item:{}},setup(p){const n=p,{page:t}=x(),e=T(()=>typeof n.item.link=="function"?n.item.link(t.value):n.item.link);return(o,s)=>(a(),r("div",Zo,[S(K,G(o.$attrs,{class:{active:c(Y)(c(t).relativePath,p.item.activeMatch||e.value,!!p.item.activeMatch)},href:e.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon}),{default:v(()=>[i("span",{innerHTML:p.item.text},null,8,na)]),_:1},16,["class","href","target","rel","no-icon"])]))}}),fn=_(pa,[["__scopeId","data-v-faf5b206"]]),ta={class:"VPMenuGroup"},ea={key:0,class:"title"},oa=P({__name:"VPMenuGroup",props:{text:{},items:{}},setup(p){return(n,t)=>(a(),r("div",ta,[p.text?(a(),r("p",ea,V(p.text),1)):$("",!0),(a(!0),r(I,null,z(p.items,e=>(a(),r(I,{key:JSON.stringify(e)},["link"in e?(a(),y(fn,{key:0,item:e},null,8,["item"])):$("",!0)],64))),128))]))}}),aa=_(oa,[["__scopeId","data-v-1963e1bb"]]),sa={class:"VPMenu"},ra={key:0,class:"items"},ia=P({__name:"VPMenu",props:{items:{}},setup(p){return(n,t)=>(a(),r("div",sa,[p.items?(a(),r("div",ra,[(a(!0),r(I,null,z(p.items,e=>(a(),r(I,{key:JSON.stringify(e)},["link"in e?(a(),y(fn,{key:0,item:e},null,8,["item"])):"component"in e?(a(),y(F(e.component),G({key:1,ref_for:!0},e.props),null,16)):(a(),y(aa,{key:2,text:e.text,items:e.items},null,8,["text","items"]))],64))),128))])):$("",!0),f(n.$slots,"default",{},void 0,!0)]))}}),la=_(ia,[["__scopeId","data-v-25a6cce8"]]),ua=["aria-expanded","aria-label"],ca={key:0,class:"text"},da=["innerHTML"],_a={key:1,class:"vpi-more-horizontal icon"},fa={class:"menu"},ha=P({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(p){const n=N(!1),t=N();Wo({el:t,onBlur:e});function e(){n.value=!1}return(o,s)=>(a(),r("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:s[1]||(s[1]=l=>n.value=!0),onMouseleave:s[2]||(s[2]=l=>n.value=!1)},[i("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":n.value,"aria-label":p.label,onClick:s[0]||(s[0]=l=>n.value=!n.value)},[p.button||p.icon?(a(),r("span",ca,[p.icon?(a(),r("span",{key:0,class:C([p.icon,"option-icon"])},null,2)):$("",!0),p.button?(a(),r("span",{key:1,innerHTML:p.button},null,8,da)):$("",!0),s[3]||(s[3]=i("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(a(),r("span",_a))],8,ua),i("div",fa,[S(la,{items:p.items},{default:v(()=>[f(o.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),In=_(ha,[["__scopeId","data-v-42cb505d"]]),ma=["href","aria-label","rel","innerHTML"],qa=P({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{},me:{type:Boolean}},setup(p){const n=p,t=N();R(async()=>{await sn();const o=t.value?.children[0];o instanceof HTMLElement&&o.className.startsWith("vpi-social-")&&(getComputedStyle(o).maskImage||getComputedStyle(o).webkitMaskImage)==="none"&&o.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${n.icon}.svg')`)});const e=T(()=>typeof n.icon=="object"?n.icon.svg:`<span class="vpi-social-${n.icon}"></span>`);return(o,s)=>(a(),r("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:p.link,"aria-label":p.ariaLabel??(typeof p.icon=="string"?p.icon:""),target:"_blank",rel:p.me?"me noopener":"noopener",innerHTML:e.value},null,8,ma))}}),va=_(qa,[["__scopeId","data-v-591a6b30"]]),ba={class:"VPSocialLinks"},ga=P({__name:"VPSocialLinks",props:{links:{},me:{type:Boolean,default:!0}},setup(p){return(n,t)=>(a(),r("div",ba,[(a(!0),r(I,null,z(p.links,({link:e,icon:o,ariaLabel:s})=>(a(),y(va,{key:e,icon:o,link:e,ariaLabel:s,me:p.me},null,8,["icon","link","ariaLabel","me"]))),128))]))}}),jn=_(ga,[["__scopeId","data-v-d07f11e6"]]),$a={key:0,class:"group translations"},Pa={class:"trans-title"},ka={key:1,class:"group"},Sa={class:"item appearance"},Ta={class:"label"},ya={class:"appearance-action"},Aa={key:2,class:"group"},Oa={class:"item social-links"},Na=P({__name:"VPNavBarExtra",setup(p){const{site:n,theme:t}=x(),{localeLinks:e,currentLang:o}=en({correspondingLink:!0}),s=T(()=>e.value.length&&o.value.label||n.value.appearance||t.value.socialLinks);return(l,u)=>s.value?(a(),y(In,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:v(()=>[c(e).length&&c(o).label?(a(),r("div",$a,[i("p",Pa,V(c(o).label),1),(a(!0),r(I,null,z(c(e),d=>(a(),y(fn,{key:d.link,item:d,lang:d.lang,dir:d.dir},null,8,["item","lang","dir"]))),128))])):$("",!0),c(n).appearance&&c(n).appearance!=="force-dark"&&c(n).appearance!=="force-auto"?(a(),r("div",ka,[i("div",Sa,[i("p",Ta,V(c(t).darkModeSwitchLabel||"Appearance"),1),i("div",ya,[S(Vn)])])])):$("",!0),c(t).socialLinks?(a(),r("div",Aa,[i("div",Oa,[S(jn,{class:"social-links-list",links:c(t).socialLinks},null,8,["links"])])])):$("",!0)]),_:1})):$("",!0)}}),Ba=_(Na,[["__scopeId","data-v-bf2fac68"]]),xa=["aria-expanded"],Va=P({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(p){return(n,t)=>(a(),r("button",{type:"button",class:C(["VPNavBarHamburger",{active:p.active}]),"aria-label":"mobile navigation","aria-expanded":p.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=e=>n.$emit("click"))},[...t[1]||(t[1]=[i("span",{class:"container"},[i("span",{class:"top"}),i("span",{class:"middle"}),i("span",{class:"bottom"})],-1)])],10,xa))}}),Ca=_(Va,[["__scopeId","data-v-e5dd9c1c"]]),Ia=["innerHTML"],ja=P({__name:"VPNavBarMenuLink",props:{item:{}},setup(p){const n=p,{page:t}=x(),e=T(()=>typeof n.item.link=="function"?n.item.link(t.value):n.item.link);return(o,s)=>(a(),y(K,{class:C({VPNavBarMenuLink:!0,active:c(Y)(c(t).relativePath,p.item.activeMatch||e.value,!!p.item.activeMatch)}),href:e.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,tabindex:"0"},{default:v(()=>[i("span",{innerHTML:p.item.text},null,8,Ia)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Da=_(ja,[["__scopeId","data-v-52a1d768"]]),La=P({__name:"VPNavBarMenuGroup",props:{item:{}},setup(p){const n=p,{page:t}=x(),e=s=>"component"in s?!1:"link"in s?Y(t.value.relativePath,typeof s.link=="function"?s.link(t.value):s.link,!!n.item.activeMatch):s.items.some(e),o=T(()=>e(n.item));return(s,l)=>(a(),y(In,{class:C({VPNavBarMenuGroup:!0,active:c(Y)(c(t).relativePath,p.item.activeMatch,!!p.item.activeMatch)||o.value}),button:p.item.text,items:p.item.items},null,8,["class","button","items"]))}}),Ma={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},wa=P({__name:"VPNavBarMenu",setup(p){const{theme:n}=x();return(t,e)=>c(n).nav?(a(),r("nav",Ma,[e[0]||(e[0]=i("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(a(!0),r(I,null,z(c(n).nav,o=>(a(),r(I,{key:JSON.stringify(o)},["link"in o?(a(),y(Da,{key:0,item:o},null,8,["item"])):"component"in o?(a(),y(F(o.component),G({key:1,ref_for:!0},o.props),null,16)):(a(),y(La,{key:2,item:o},null,8,["item"]))],64))),128))])):$("",!0)}}),Ea=_(wa,[["__scopeId","data-v-39714824"]]);function za(p){const{localeIndex:n,theme:t}=x();function e(o){const s=o.split("."),l=t.value.search?.options,u=l&&typeof l=="object",d=u&&l.locales?.[n.value]?.translations||null,q=u&&l.translations||null;let m=d,h=q,b=p;const g=s.pop();for(const A of s){let k=null;const B=b?.[A];B&&(k=b=B);const D=h?.[A];D&&(k=h=D);const j=m?.[A];j&&(k=m=j),B||(b=k),D||(h=k),j||(m=k)}return m?.[g]??h?.[g]??b?.[g]??""}return e}const Ra=["aria-label"],Ha={class:"DocSearch-Button-Container"},Ja={class:"DocSearch-Button-Placeholder"},Mn=P({__name:"VPNavBarSearchButton",setup(p){const t=za({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(e,o)=>(a(),r("button",{type:"button","aria-label":c(t)("button.buttonAriaLabel"),"aria-keyshortcuts":"/ control+k meta+k",class:"DocSearch DocSearch-Button"},[i("span",Ha,[o[0]||(o[0]=i("span",{class:"vpi-search DocSearch-Search-Icon"},null,-1)),i("span",Ja,V(c(t)("button.buttonText")),1)]),o[1]||(o[1]=i("span",{class:"DocSearch-Button-Keys"},[i("kbd",{class:"DocSearch-Button-Key"}),i("kbd",{class:"DocSearch-Button-Key"})],-1))],8,Ra))}}),Ua={class:"VPNavBarSearch"},Fa={id:"local-search"},Ka={key:1,id:"docsearch"},Ga=P({__name:"VPNavBarSearch",setup(p){const n=ft(()=>ht(()=>import("./chunks/VPLocalSearchBox.90ga2IdG.js"),__vite__mapDeps([0,1]))),t=()=>null,{theme:e}=x(),o=N(!1),s=N(!1);R(()=>{});function l(){o.value||(o.value=!0,setTimeout(u,16))}function u(){const h=new Event("keydown");h.key="k",h.metaKey=!0,window.dispatchEvent(h),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||u()},16)}function d(h){const b=h.target,g=b.tagName;return b.isContentEditable||g==="INPUT"||g==="SELECT"||g==="TEXTAREA"}const q=N(!1);vn("k",h=>{(h.ctrlKey||h.metaKey)&&(h.preventDefault(),q.value=!0)}),vn("/",h=>{d(h)||(h.preventDefault(),q.value=!0)});const m="local";return(h,b)=>(a(),r("div",Ua,[c(m)==="local"?(a(),r(I,{key:0},[q.value?(a(),y(c(n),{key:0,onClose:b[0]||(b[0]=g=>q.value=!1)})):$("",!0),i("div",Fa,[S(Mn,{onClick:b[1]||(b[1]=g=>q.value=!0)})])],64)):c(m)==="algolia"?(a(),r(I,{key:1},[o.value?(a(),y(c(t),{key:0,algolia:c(e).search?.options??c(e).algolia,onVnodeBeforeMount:b[2]||(b[2]=g=>s.value=!0)},null,8,["algolia"])):$("",!0),s.value?$("",!0):(a(),r("div",Ka,[S(Mn,{onClick:l})]))],64)):$("",!0)]))}}),Xa=P({__name:"VPNavBarSocialLinks",setup(p){const{theme:n}=x();return(t,e)=>c(n).socialLinks?(a(),y(jn,{key:0,class:"VPNavBarSocialLinks",links:c(n).socialLinks},null,8,["links"])):$("",!0)}}),Wa=_(Xa,[["__scopeId","data-v-0394ad82"]]),Ya=["href","rel","target"],Qa=["innerHTML"],Za={key:2},ns=P({__name:"VPNavBarTitle",setup(p){const{site:n,theme:t}=x(),{hasSidebar:e}=X(),{currentLang:o}=en(),s=T(()=>typeof t.value.logoLink=="string"?t.value.logoLink:t.value.logoLink?.link),l=T(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.rel),u=T(()=>typeof t.value.logoLink=="string"?void 0:t.value.logoLink?.target);return(d,q)=>(a(),r("div",{class:C(["VPNavBarTitle",{"has-sidebar":c(e)}])},[i("a",{class:"title",href:s.value??c(Bn)(c(o).link),rel:l.value,target:u.value},[f(d.$slots,"nav-bar-title-before",{},void 0,!0),c(t).logo?(a(),y(rn,{key:0,class:"logo",image:c(t).logo},null,8,["image"])):$("",!0),c(t).siteTitle?(a(),r("span",{key:1,innerHTML:c(t).siteTitle},null,8,Qa)):c(t).siteTitle===void 0?(a(),r("span",Za,V(c(n).title),1)):$("",!0),f(d.$slots,"nav-bar-title-after",{},void 0,!0)],8,Ya)],2))}}),ps=_(ns,[["__scopeId","data-v-1e38c6bc"]]),ts={class:"items"},es={class:"title"},os=P({__name:"VPNavBarTranslations",setup(p){const{theme:n}=x(),{localeLinks:t,currentLang:e}=en({correspondingLink:!0});return(o,s)=>c(t).length&&c(e).label?(a(),y(In,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:c(n).langMenuLabel||"Change language"},{default:v(()=>[i("div",ts,[i("p",es,V(c(e).label),1),(a(!0),r(I,null,z(c(t),l=>(a(),y(fn,{key:l.link,item:l,lang:l.lang,dir:l.dir},null,8,["item","lang","dir"]))),128))])]),_:1},8,["label"])):$("",!0)}}),as=_(os,[["__scopeId","data-v-4c1766e2"]]),ss={class:"wrapper"},rs={class:"container"},is={class:"title"},ls={class:"content"},us={class:"content-body"},cs=P({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(p){const n=p,{y:t}=Kn(),{isHome:e,hasSidebar:o}=X(),s=N({});return On(()=>{s.value={"has-sidebar":o.value,home:e.value,top:t.value===0,"screen-open":n.isScreenOpen}}),(l,u)=>(a(),r("div",{class:C(["VPNavBar",s.value])},[i("div",ss,[i("div",rs,[i("div",is,[S(ps,null,{"nav-bar-title-before":v(()=>[f(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":v(()=>[f(l.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),i("div",ls,[i("div",us,[f(l.$slots,"nav-bar-content-before",{},void 0,!0),S(Ga,{class:"search"}),S(Ea,{class:"menu"}),S(as,{class:"translations"}),S(Xo,{class:"appearance"}),S(Wa,{class:"social-links"}),S(Ba,{class:"extra"}),f(l.$slots,"nav-bar-content-after",{},void 0,!0),S(Ca,{class:"hamburger",active:p.isScreenOpen,onClick:u[0]||(u[0]=d=>l.$emit("toggle-screen"))},null,8,["active"])])])])]),u[1]||(u[1]=i("div",{class:"divider"},[i("div",{class:"divider-line"})],-1))],2))}}),ds=_(cs,[["__scopeId","data-v-70946a35"]]),_s={key:0,class:"VPNavScreenAppearance"},fs={class:"text"},hs=P({__name:"VPNavScreenAppearance",setup(p){const{site:n,theme:t}=x();return(e,o)=>c(n).appearance&&c(n).appearance!=="force-dark"&&c(n).appearance!=="force-auto"?(a(),r("div",_s,[i("p",fs,V(c(t).darkModeSwitchLabel||"Appearance"),1),S(Vn)])):$("",!0)}}),ms=_(hs,[["__scopeId","data-v-b44890b2"]]),qs=["innerHTML"],vs=P({__name:"VPNavScreenMenuLink",props:{item:{}},setup(p){const n=p,{page:t}=x(),e=T(()=>typeof n.item.link=="function"?n.item.link(t.value):n.item.link),{closeScreen:o}=_n(xn);return(s,l)=>(a(),y(K,{class:"VPNavScreenMenuLink",href:e.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,onClick:c(o)},{default:v(()=>[i("span",{innerHTML:p.item.text},null,8,qs)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),bs=_(vs,[["__scopeId","data-v-7d55a1c1"]]),gs=["innerHTML"],$s=P({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(p){const n=p,{page:t}=x(),e=T(()=>typeof n.item.link=="function"?n.item.link(t.value):n.item.link),{closeScreen:o}=_n(xn);return(s,l)=>(a(),y(K,{class:"VPNavScreenMenuGroupLink",href:e.value,target:p.item.target,rel:p.item.rel,"no-icon":p.item.noIcon,onClick:c(o)},{default:v(()=>[i("span",{innerHTML:p.item.text},null,8,gs)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),tp=_($s,[["__scopeId","data-v-49e5ec9f"]]),Ps={class:"VPNavScreenMenuGroupSection"},ks={key:0,class:"title"},Ss=P({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(p){return(n,t)=>(a(),r("div",Ps,[p.text?(a(),r("p",ks,V(p.text),1)):$("",!0),(a(!0),r(I,null,z(p.items,e=>(a(),y(tp,{key:e.text,item:e},null,8,["item"]))),128))]))}}),Ts=_(Ss,[["__scopeId","data-v-4b7a798b"]]),ys=["aria-controls","aria-expanded"],As=["innerHTML"],Os=["id"],Ns={key:0,class:"item"},Bs={key:1,class:"item"},xs={key:2,class:"group"},Vs=P({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(p){const n=p,t=N(!1),e=T(()=>`NavScreenGroup-${n.text.replace(" ","-").toLowerCase()}`);function o(){t.value=!t.value}return(s,l)=>(a(),r("div",{class:C(["VPNavScreenMenuGroup",{open:t.value}])},[i("button",{class:"button","aria-controls":e.value,"aria-expanded":t.value,onClick:o},[i("span",{class:"button-text",innerHTML:p.text},null,8,As),l[0]||(l[0]=i("span",{class:"vpi-plus button-icon"},null,-1))],8,ys),i("div",{id:e.value,class:"items"},[(a(!0),r(I,null,z(p.items,u=>(a(),r(I,{key:JSON.stringify(u)},["link"in u?(a(),r("div",Ns,[S(tp,{item:u},null,8,["item"])])):"component"in u?(a(),r("div",Bs,[(a(),y(F(u.component),G({ref_for:!0},u.props,{"screen-menu":""}),null,16))])):(a(),r("div",xs,[S(Ts,{text:u.text,items:u.items},null,8,["text","items"])]))],64))),128))],8,Os)],2))}}),Cs=_(Vs,[["__scopeId","data-v-956364f9"]]),Is={key:0,class:"VPNavScreenMenu"},js=P({__name:"VPNavScreenMenu",setup(p){const{theme:n}=x();return(t,e)=>c(n).nav?(a(),r("nav",Is,[(a(!0),r(I,null,z(c(n).nav,o=>(a(),r(I,{key:JSON.stringify(o)},["link"in o?(a(),y(bs,{key:0,item:o},null,8,["item"])):"component"in o?(a(),y(F(o.component),G({key:1,ref_for:!0},o.props,{"screen-menu":""}),null,16)):(a(),y(Cs,{key:2,text:o.text||"",items:o.items},null,8,["text","items"]))],64))),128))])):$("",!0)}}),Ds=P({__name:"VPNavScreenSocialLinks",setup(p){const{theme:n}=x();return(t,e)=>c(n).socialLinks?(a(),y(jn,{key:0,class:"VPNavScreenSocialLinks",links:c(n).socialLinks},null,8,["links"])):$("",!0)}}),Ls={class:"list"},Ms=P({__name:"VPNavScreenTranslations",setup(p){const{localeLinks:n,currentLang:t}=en({correspondingLink:!0}),e=N(!1);function o(){e.value=!e.value}return(s,l)=>c(n).length&&c(t).label?(a(),r("div",{key:0,class:C(["VPNavScreenTranslations",{open:e.value}])},[i("button",{class:"title",onClick:o},[l[0]||(l[0]=i("span",{class:"vpi-languages icon lang"},null,-1)),E(" "+V(c(t).label)+" ",1),l[1]||(l[1]=i("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),i("ul",Ls,[(a(!0),r(I,null,z(c(n),u=>(a(),r("li",{key:u.link,class:"item"},[S(K,{class:"link",href:u.link,lang:u.lang,dir:u.dir},{default:v(()=>[E(V(u.text),1)]),_:2},1032,["href","lang","dir"])]))),128))])],2)):$("",!0)}}),ws=_(Ms,[["__scopeId","data-v-a4d9b172"]]),Es={class:"container"},zs=P({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(p){const n=N(null),t=Gn(tn?document.body:null);return(e,o)=>(a(),y(ln,{name:"fade",onEnter:o[0]||(o[0]=s=>t.value=!0),onAfterLeave:o[1]||(o[1]=s=>t.value=!1)},{default:v(()=>[p.open?(a(),r("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:n,id:"VPNavScreen"},[i("div",Es,[f(e.$slots,"nav-screen-content-before",{},void 0,!0),S(js,{class:"menu"}),S(ws,{class:"translations"}),S(ms,{class:"appearance"}),S(Ds,{class:"social-links"}),f(e.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):$("",!0)]),_:3}))}}),Rs=_(zs,[["__scopeId","data-v-f2779853"]]),Hs={key:0,class:"VPNav"},Js=P({__name:"VPNav",setup(p){const{isScreenOpen:n,closeScreen:t,toggleScreen:e}=wo(),{frontmatter:o}=x(),s=T(()=>o.value.navbar!==!1);return Xn(xn,{closeScreen:t}),un(()=>{tn&&document.documentElement.classList.toggle("hide-nav",!s.value)}),(l,u)=>s.value?(a(),r("header",Hs,[S(ds,{"is-screen-open":c(n),onToggleScreen:c(e)},{"nav-bar-title-before":v(()=>[f(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":v(()=>[f(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":v(()=>[f(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":v(()=>[f(l.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),S(Rs,{open:c(n)},{"nav-screen-content-before":v(()=>[f(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":v(()=>[f(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):$("",!0)}}),Us=_(Js,[["__scopeId","data-v-da52a441"]]),Fs=["role","tabindex"],Ks={key:1,class:"items"},Gs=P({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(p){const n=p,{collapsed:t,collapsible:e,isLink:o,isActiveLink:s,hasActiveLink:l,hasChildren:u,toggle:d}=Xt(T(()=>n.item)),q=T(()=>u.value?"section":"div"),m=T(()=>o.value?"a":"div"),h=T(()=>u.value?n.depth+2===7?"p":`h${n.depth+2}`:"p"),b=T(()=>o.value?void 0:"button"),g=T(()=>[[`level-${n.depth}`],{collapsible:e.value},{collapsed:t.value},{"is-link":o.value},{"is-active":s.value},{"has-active":l.value}]);function A(B){"key"in B&&B.key!=="Enter"||!n.item.link&&d()}function k(){n.item.link&&d()}return(B,D)=>{const j=J("VPSidebarItem",!0);return a(),y(F(q.value),{class:C(["VPSidebarItem",g.value])},{default:v(()=>[p.item.text?(a(),r("div",G({key:0,class:"item",role:b.value},mt(p.item.items?{click:A,keydown:A}:{},!0),{tabindex:p.item.items&&0}),[D[1]||(D[1]=i("div",{class:"indicator"},null,-1)),p.item.link?(a(),y(K,{key:0,tag:m.value,class:"link",href:p.item.link,rel:p.item.rel,target:p.item.target},{default:v(()=>[(a(),y(F(h.value),{class:"text",innerHTML:p.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(a(),y(F(h.value),{key:1,class:"text",innerHTML:p.item.text},null,8,["innerHTML"])),p.item.collapsed!=null&&p.item.items&&p.item.items.length?(a(),r("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:k,onKeydown:qt(k,["enter"]),tabindex:"0"},[...D[0]||(D[0]=[i("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):$("",!0)],16,Fs)):$("",!0),p.item.items&&p.item.items.length?(a(),r("div",Ks,[p.depth<5?(a(!0),r(I,{key:0},z(p.item.items,L=>(a(),y(j,{key:L.text,item:L,depth:p.depth+1},null,8,["item","depth"]))),128)):$("",!0)])):$("",!0)]),_:1},8,["class"])}}}),Xs=_(Gs,[["__scopeId","data-v-d81de50c"]]),Ws=P({__name:"VPSidebarGroup",props:{items:{}},setup(p){const n=N(!0);let t=null;return R(()=>{t=setTimeout(()=>{t=null,n.value=!1},300)}),Z(()=>{t!=null&&(clearTimeout(t),t=null)}),(e,o)=>(a(!0),r(I,null,z(p.items,s=>(a(),r("div",{key:s.text,class:C(["group",{"no-transition":n.value}])},[S(Xs,{item:s,depth:0},null,8,["item"])],2))),128))}}),Ys=_(Ws,[["__scopeId","data-v-8d50c081"]]),Qs={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Zs=P({__name:"VPSidebar",props:{open:{type:Boolean}},setup(p){const{sidebarGroups:n,hasSidebar:t}=X(),e=p,o=N(null),s=Gn(tn?document.body:null);H([e,o],()=>{e.open?(s.value=!0,o.value?.focus()):s.value=!1},{immediate:!0,flush:"post"});const l=N(0);return H(n,()=>{l.value+=1},{deep:!0}),(u,d)=>c(t)?(a(),r("aside",{key:0,class:C(["VPSidebar",{open:p.open}]),ref_key:"navEl",ref:o,onClick:d[0]||(d[0]=vt(()=>{},["stop"]))},[d[2]||(d[2]=i("div",{class:"curtain"},null,-1)),i("nav",Qs,[d[1]||(d[1]=i("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),f(u.$slots,"sidebar-nav-before",{},void 0,!0),(a(),y(Ys,{items:c(n),key:l.value},null,8,["items"])),f(u.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):$("",!0)}}),nr=_(Zs,[["__scopeId","data-v-af661f50"]]),pr={href:"#VPContent",class:"VPSkipLink visually-hidden"},tr=P({__name:"VPSkipLink",setup(p){const{theme:n}=x(),t=dn(),e=N();return H(()=>t.path,()=>e.value.focus()),(o,s)=>(a(),r(I,null,[i("span",{ref_key:"backToTop",ref:e,tabindex:"-1"},null,512),i("a",pr,V(c(n).skipToContentLabel||"Skip to content"),1)],64))}}),er=_(tr,[["__scopeId","data-v-331ec75c"]]),or=P({__name:"Layout",setup(p){const{isOpen:n,open:t,close:e}=Gt();Wt({closeSidebar:e});const{frontmatter:o}=x(),s=bt(),l=T(()=>!!s["home-hero-image"]);return Xn(Qn,{heroImageSlotExists:l}),(u,d)=>{const q=J("Content");return c(o).layout!==!1?(a(),r("div",{key:0,class:C(["Layout",c(o).pageClass])},[f(u.$slots,"layout-top",{},void 0,!0),S(er),S(yt,{class:"backdrop",show:c(n),onClick:c(e)},null,8,["show","onClick"]),S(Us,null,{"nav-bar-title-before":v(()=>[f(u.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":v(()=>[f(u.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":v(()=>[f(u.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":v(()=>[f(u.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":v(()=>[f(u.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":v(()=>[f(u.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),S(Mo,{open:c(n),onOpenMenu:c(t)},null,8,["open","onOpenMenu"]),S(nr,{open:c(n)},{"sidebar-nav-before":v(()=>[f(u.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":v(()=>[f(u.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),S(ko,null,{"page-top":v(()=>[f(u.$slots,"page-top",{},void 0,!0)]),"page-bottom":v(()=>[f(u.$slots,"page-bottom",{},void 0,!0)]),"not-found":v(()=>[f(u.$slots,"not-found",{},void 0,!0)]),"home-hero-before":v(()=>[f(u.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":v(()=>[f(u.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":v(()=>[f(u.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":v(()=>[f(u.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":v(()=>[f(u.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":v(()=>[f(u.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":v(()=>[f(u.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":v(()=>[f(u.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":v(()=>[f(u.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":v(()=>[f(u.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":v(()=>[f(u.$slots,"doc-before",{},void 0,!0)]),"doc-after":v(()=>[f(u.$slots,"doc-after",{},void 0,!0)]),"doc-top":v(()=>[f(u.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":v(()=>[f(u.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":v(()=>[f(u.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":v(()=>[f(u.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":v(()=>[f(u.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":v(()=>[f(u.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":v(()=>[f(u.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":v(()=>[f(u.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),S(Oo),f(u.$slots,"layout-bottom",{},void 0,!0)],2)):(a(),y(q,{key:1}))}}}),ar=_(or,[["__scopeId","data-v-1df9f90f"]]),ep={Layout:ar,enhanceApp:({app:p})=>{p.component("Badge",kt)}},wn="age_verified",sr=365,rr=P({__name:"AgeWarning",setup(p){const n=N(!1),t=N(!1);function e(u,d,q){const m=new Date;m.setTime(m.getTime()+q*24*60*60*1e3);const h=`expires=${m.toUTCString()}`;document.cookie=`${u}=${d};${h};path=/;SameSite=Strict`}function o(u){const d=u+"=",q=document.cookie.split(";");for(let m=0;m<q.length;m++){let h=q[m];for(;h.charAt(0)===" ";)h=h.substring(1,h.length);if(h.indexOf(d)===0)return h.substring(d.length,h.length)}return null}function s(){t.value=!0,setTimeout(()=>{n.value=!1,t.value=!1},300),e(wn,"true",sr)}function l(){window.location.href="https://tv.cctv.com/2013/09/02/VIDE1378113141436780.shtml"}return R(()=>{o(wn)||(n.value=!0)}),(u,d)=>(a(),y(gt,{to:"body"},[n.value?(a(),r("div",{key:0,class:C(["age-warning-overlay",{"fade-out":t.value}])},[i("div",{class:"age-warning-modal"},[d[0]||(d[0]=i("div",{class:"warning-icon"},"🔞",-1)),d[1]||(d[1]=i("h2",null,"未成年人禁止入内",-1)),d[2]||(d[2]=i("p",null,"本站包含成人内容，仅限18岁及以上人士访问。",-1)),d[3]||(d[3]=i("p",{class:"warning-detail"}," 继续访问即表示您已年满18周岁，并同意浏览成人内容。 ",-1)),i("div",{class:"warning-buttons"},[i("button",{onClick:s,class:"btn-confirm"}," 是，我已年满18岁 "),i("button",{onClick:l,class:"btn-reject"}," 否，我未满18岁 ")])])],2)):$("",!0)]))}}),ir=_(rr,[["__scopeId","data-v-20130149"]]),lr={key:0},ur={class:"moon-icon"},cr=P({__name:"ThemeTransition",setup(p){const{isDark:n}=Tn(),t=N(!1),e=N(!1),o=N(!1),s=N(!1),l=N(!1);let u,d,q;const m=()=>{u&&(clearTimeout(u),u=void 0),d&&(clearTimeout(d),d=void 0),q&&(clearTimeout(q),q=void 0)},h=()=>{l.value=!0,s.value=!1,o.value=!1,d=setTimeout(()=>{t.value=!1,l.value=!1},260)},b=A=>{const k=document.documentElement;A?k.classList.add("dark"):k.classList.remove("dark")},g=A=>{m(),e.value=A,document.documentElement.classList.add("theme-switching"),o.value=!0,t.value=!0,s.value=!1,requestAnimationFrame(()=>{requestAnimationFrame(()=>{s.value=!0})}),q=setTimeout(()=>{b(A)},200),u=setTimeout(()=>{s.value=!1,o.value=!1,document.documentElement.classList.remove("theme-switching"),d=setTimeout(()=>{t.value=!1},400)},500)};return H(n,(A,k)=>{if(!(typeof window>"u")&&k!==void 0){if(t.value||s.value||o.value){m(),h(),setTimeout(()=>g(A),130);return}g(A)}}),(A,k)=>t.value?(a(),r("div",lr,[i("div",{class:C(["theme-backdrop",{"backdrop-dark":e.value,show:o.value,fast:l.value}])},null,2),i("div",{class:C(["theme-transition-mask",{"mask-dark":e.value,animating:s.value,fast:l.value}])},[i("div",ur,V(e.value?"🌙":"☀️"),1)],2)])):$("",!0)}}),dr=_(cr,[["__scopeId","data-v-06473298"]]),_r=280,fr=P({__name:"BackToTop",setup(p){const n=N(!1),t=()=>{n.value=window.scrollY>_r},e=()=>{window.scrollTo({top:0,behavior:"smooth"})};return R(()=>{window.addEventListener("scroll",t,{passive:!0}),t()}),Z(()=>{window.removeEventListener("scroll",t)}),(o,s)=>n.value?(a(),r("button",{key:0,class:"back-top",type:"button",onClick:e,"aria-label":"返回顶部"}," ↑ ")):$("",!0)}}),hr=_(fr,[["__scopeId","data-v-df795d79"]]),qn={allowedPrefixes:["/","/articles","/license","/settings"],excludedPrefixes:["/404"],excludedIncludes:[]},Sn=p=>{for(const n of qn.excludedPrefixes)if(p.startsWith(n))return!1;for(const n of qn.excludedIncludes)if(p.includes(n))return!1;for(const n of qn.allowedPrefixes)if(p.startsWith(n))return!0;return!1},nn="last_read",mr="reading_prompt_enabled",qr=15e3,vr=900*1e3,br=6e4,gr=P({__name:"ReadingReminder",setup(p){const n=Nn(),t=N(!1),e=N(!1),o=N(""),s=N(void 0),l=N(void 0),u=N(!0),d=M=>{const w=document.cookie.match(new RegExp("(?:^|; )"+M.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return w?decodeURIComponent(w[1]):""},q=(M,w,W=365)=>{const U=new Date;U.setTime(U.getTime()+W*24*60*60*1e3),document.cookie=`${M}=${encodeURIComponent(w)}; path=/; expires=${U.toUTCString()}`},m=()=>{s.value&&(clearTimeout(s.value),s.value=void 0)},h=()=>{l.value&&(clearTimeout(l.value),l.value=void 0)},b=()=>{const M=d(nn);if(M)try{const w=JSON.parse(M),W=Date.now(),U={current:w.current,previous:w.current,tsCurrent:w.tsCurrent,tsPrevious:W};q(nn,JSON.stringify(U))}catch{}},g=()=>{h(),l.value=setTimeout(()=>{u.value&&Sn(n.route.path)&&b()},br)},A=()=>{e.value=!0,setTimeout(()=>{t.value=!1,e.value=!1},300),m()},k=()=>{m(),s.value=setTimeout(()=>A(),qr)},B=M=>{if(!Sn(M))return;let w="",W=0;try{const hn=d(nn);if(hn){const on=JSON.parse(hn);on.current&&(w=on.current),on.tsCurrent&&(W=on.tsCurrent)}}catch{}const U=Date.now();q(nn,JSON.stringify({current:M,previous:w,tsCurrent:U,tsPrevious:W}))},D=()=>{const M=localStorage.getItem(mr);return M===null?!0:M==="true"},j=()=>{if(!D())return;const M=d(nn);if(M)try{const w=JSON.parse(M),W=Date.now(),U=w.tsPrevious??0;w.previous&&U&&W-U>vr&&w.previous!==n.route.path&&(o.value=w.previous,t.value=!0,k())}catch{}},L=()=>{o.value&&(A(),n.go(o.value))};return R(()=>{H(()=>n.route.path,M=>{typeof document>"u"||(B(M),g())},{immediate:!0})}),R(()=>{j(),g(),typeof window<"u"&&(window.addEventListener("visibilitychange",j),window.addEventListener("focus",()=>{u.value=!0,g()}),window.addEventListener("blur",()=>{u.value=!1,h()}))}),Z(()=>{typeof window<"u"&&(window.removeEventListener("visibilitychange",j),window.removeEventListener("focus",()=>{}),window.removeEventListener("blur",()=>{})),m(),h()}),(M,w)=>$t((a(),r("div",{class:C(["reading-reminder",{"fade-out":e.value}])},[i("div",{class:"reading-reminder__content"},[w[0]||(w[0]=i("span",null,"是否跳转到上次阅读位置？",-1)),i("div",{class:"reading-reminder__actions"},[i("button",{class:"primary",onClick:L},"跳转"),i("button",{class:"ghost",onClick:A},"关闭")])])],2)),[[Pt,t.value]])}}),$r=_(gr,[["__scopeId","data-v-62aa7ff8"]]),En="cookie_consent",Pr="age_verified",kr=P({__name:"CookieConsent",setup(p){const n=N(!1),t=N(!1),e=N(!1);let o;const s=()=>{t.value=!0,setTimeout(()=>{localStorage.setItem(En,"true"),n.value=!1,t.value=!1},300)},l=()=>{window.location.href="https://www.pixiv.net/users/50811011"},u=()=>localStorage.getItem(En)==="true",d=()=>document.cookie.includes(`${Pr}=true`),q=()=>{e.value=d(),e.value&&!u()&&(n.value=!0)};return R(()=>{q(),o=window.setInterval(()=>{d()&&!e.value&&q()},500)}),Z(()=>{o&&clearInterval(o)}),(m,h)=>n.value?(a(),r("div",{key:0,class:C(["cookie-consent",{"fade-out":t.value}])},[h[3]||(h[3]=i("div",{class:"cookie-backdrop"},null,-1)),i("div",{class:"cookie-modal"},[i("div",{class:"cookie-modal__content"},[h[0]||(h[0]=i("h2",null,"Cookie 政策",-1)),h[1]||(h[1]=i("p",null,"此网站使用 Cookie 来改进用户体验，包括记录您的阅读位置和偏好设置。",-1)),h[2]||(h[2]=i("p",null,"如果您不同意使用 Cookie，请点击“拒绝”按钮离开此网站。",-1)),i("div",{class:"cookie-modal__actions"},[i("button",{class:"accept",onClick:s},"同意并继续"),i("button",{class:"decline",onClick:l},"拒绝")])])])],2)):$("",!0)}}),Sr=_(kr,[["__scopeId","data-v-64f9ad39"]]),Tr={style:{display:"none"}},yr=P({__name:"SearchModal",setup(p){let n=null,t=!1;return R(()=>{const e=()=>{if(n=document.querySelector(".VPLocalSearchBox"),!n){setTimeout(e,50);return}const o=l=>{n&&(n.classList.add("fade-out"),setTimeout(()=>{n&&n.classList.remove("fade-out"),l()},200))},s=l=>{if(t)return;const u=l.target,d=u===n,q=u.closest("button"),m=u.closest("a"),h=l.type==="keydown"&&l.key==="Escape";(d||q||m||h)&&(l.preventDefault(),l.stopPropagation(),l.stopImmediatePropagation(),o(()=>{t=!0,h?window.dispatchEvent(new KeyboardEvent("keydown",{key:"Escape",code:"Escape",keyCode:27,bubbles:!0,cancelable:!0})):u instanceof HTMLElement&&u.click(),setTimeout(()=>{t=!1},0)}))};n.addEventListener("click",s,!0),window.addEventListener("keydown",s,!0),Z(()=>{n&&n.removeEventListener("click",s,!0),window.removeEventListener("keydown",s,!0)})};e()}),(e,o)=>(a(),r("div",Tr))}}),Ar=JSON.parse('{"title":"A.1 雪原与利刃的沉沦（拉普兰德1&德克萨斯0）","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/A/A.1.md","filePath":"articles/ark/A/A.1.md","lastUpdated":1766326350000}'),Or={name:"articles/ark/A/A.1.md"};function Nr(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",32)])])}const Br=_(Or,[["render",Nr]]),xr=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ar,default:Br},Symbol.toStringTag,{value:"Module"})),Vr=JSON.parse('{"title":"阿尔图罗的特别生日礼物~#1&#2","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/B/A/B.A.1and2.md","filePath":"articles/ark/B/A/B.A.1and2.md","lastUpdated":1766326350000}'),Cr={name:"articles/ark/B/A/B.A.1and2.md"};function Ir(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",81)])])}const jr=_(Cr,[["render",Ir]]),Dr=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Vr,default:jr},Symbol.toStringTag,{value:"Module"})),Lr=JSON.parse('{"title":"B.A.3&4 阿尔图罗的生日“派对”~#3&#4","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/B/A/B.A.3and4.md","filePath":"articles/ark/B/A/B.A.3and4.md","lastUpdated":1766326350000}'),Mr={name:"articles/ark/B/A/B.A.3and4.md"};function wr(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",136)])])}const Er=_(Mr,[["render",wr]]),zr=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Lr,default:Er},Symbol.toStringTag,{value:"Module"})),Rr=JSON.parse('{"title":"B.A.5&6 在音乐中堕落的阿尔图罗~#5&#6","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/ark/B/A/B.A.5and6.md","filePath":"articles/ark/B/A/B.A.5and6.md","lastUpdated":1766326350000}'),Hr={name:"articles/ark/B/A/B.A.5and6.md"};function Jr(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",113)])])}const Ur=_(Hr,[["render",Jr]]),Fr=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Rr,default:Ur},Symbol.toStringTag,{value:"Module"})),Kr=JSON.parse('{"title":"阿尔图罗的派对(?)","description":"","frontmatter":{"order":2,"title":"阿尔图罗的派对(?)"},"headers":[],"relativePath":"articles/ark/B/A/index.md","filePath":"articles/ark/B/A/index.md","lastUpdated":1766326350000}'),Gr={name:"articles/ark/B/A/index.md"};function Xr(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[i("h1",{id:"阿尔图罗的派对",tabindex:"-1"},[E("阿尔图罗的派对(?) "),i("a",{class:"header-anchor",href:"#阿尔图罗的派对","aria-label":"Permalink to “阿尔图罗的派对(?)”"},"​")],-1),i("p",null,"这是A系列的简介。",-1)])])}const Wr=_(Gr,[["render",Xr]]),Yr=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Kr,default:Wr},Symbol.toStringTag,{value:"Module"})),Qr=JSON.parse('{"title":"B.N.1 冰镇苹果汁💗~（能天使0&菲亚梅塔1）","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/B/N/B.N.1.md","filePath":"articles/ark/B/N/B.N.1.md","lastUpdated":1766326350000}'),Zr={name:"articles/ark/B/N/B.N.1.md"};function ni(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",92)])])}const pi=_(Zr,[["render",ni]]),ti=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Qr,default:pi},Symbol.toStringTag,{value:"Module"})),ei=JSON.parse('{"title":"B.N.2 坏姐姐！💗~（安乐）","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/ark/B/N/B.N.2.md","filePath":"articles/ark/B/N/B.N.2.md","lastUpdated":1766326350000}'),oi={name:"articles/ark/B/N/B.N.2.md"};function ai(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",87)])])}const si=_(oi,[["render",ai]]),ri=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ei,default:si},Symbol.toStringTag,{value:"Module"})),ii=JSON.parse('{"title":"B.N.3 泰拉的超市、可爱的能天使还有企鹅物流的各位💗~","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/ark/B/N/B.N.3.md","filePath":"articles/ark/B/N/B.N.3.md","lastUpdated":1766326350000}'),li={name:"articles/ark/B/N/B.N.3.md"};function ui(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",123)])])}const ci=_(li,[["render",ui]]),di=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ii,default:ci},Symbol.toStringTag,{value:"Module"})),_i=JSON.parse('{"title":"B.N.4 坏掉的小苹果~（乐徳）","description":"","frontmatter":{"order":4},"headers":[],"relativePath":"articles/ark/B/N/B.N.4.md","filePath":"articles/ark/B/N/B.N.4.md","lastUpdated":1766326350000}'),fi={name:"articles/ark/B/N/B.N.4.md"};function hi(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",77)])])}const mi=_(fi,[["render",hi]]),qi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:_i,default:mi},Symbol.toStringTag,{value:"Module"})),vi=JSON.parse('{"title":"B.N.5.1苹果派装不下再多了呜呜呜~！","description":"","frontmatter":{"order":5},"headers":[],"relativePath":"articles/ark/B/N/B.N.5.1.md","filePath":"articles/ark/B/N/B.N.5.1.md","lastUpdated":1766326350000}'),bi={name:"articles/ark/B/N/B.N.5.1.md"};function gi(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",94)])])}const $i=_(bi,[["render",gi]]),Pi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:vi,default:$i},Symbol.toStringTag,{value:"Module"})),ki=JSON.parse('{"title":"B.N.5.2 苹果派装不下再多了呜呜呜~！2","description":"","frontmatter":{"order":6},"headers":[],"relativePath":"articles/ark/B/N/B.N.5.2.md","filePath":"articles/ark/B/N/B.N.5.2.md","lastUpdated":1766326350000}'),Si={name:"articles/ark/B/N/B.N.5.2.md"};function Ti(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",64)])])}const yi=_(Si,[["render",Ti]]),Ai=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ki,default:yi},Symbol.toStringTag,{value:"Module"})),Oi=JSON.parse('{"title":"B.N.6 触手服以及能天使~","description":"","frontmatter":{"order":7},"headers":[],"relativePath":"articles/ark/B/N/B.N.6.md","filePath":"articles/ark/B/N/B.N.6.md","lastUpdated":1766326350000}'),Ni={name:"articles/ark/B/N/B.N.6.md"};function Bi(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",183)])])}const xi=_(Ni,[["render",Bi]]),Vi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Oi,default:xi},Symbol.toStringTag,{value:"Module"})),Ci=JSON.parse('{"title":"变成泡芙的能天使~","description":"","frontmatter":{"order":1,"title":"变成泡芙的能天使~"},"headers":[],"relativePath":"articles/ark/B/N/index.md","filePath":"articles/ark/B/N/index.md","lastUpdated":1766326350000}'),Ii={name:"articles/ark/B/N/index.md"};function ji(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[i("h1",{id:"变成泡芙的能天使",tabindex:"-1"},[E("变成泡芙的能天使~ "),i("a",{class:"header-anchor",href:"#变成泡芙的能天使","aria-label":"Permalink to “变成泡芙的能天使~”"},"​")],-1),i("p",null,"这是N系列的简介。",-1)])])}const Di=_(Ii,[["render",ji]]),Li=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ci,default:Di},Symbol.toStringTag,{value:"Module"})),Mi=JSON.parse('{"title":"淫乱的罗德岛","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/ark/index.md","filePath":"articles/ark/index.md","lastUpdated":1771914025000}'),wi={name:"articles/ark/index.md"};function Ei(p,n,t,e,o,s){const l=J("BookWordCount"),u=J("ARKChapterList");return a(),r("div",null,[n[0]||(n[0]=O("",10)),S(l,{novel:"ark"}),n[1]||(n[1]=i("h2",{id:"章节列表",tabindex:"-1"},[E("章节列表 "),i("a",{class:"header-anchor",href:"#章节列表","aria-label":"Permalink to “章节列表”"},"​")],-1)),S(u),n[2]||(n[2]=i("hr",null,null,-1)),n[3]||(n[3]=i("p",null,[E("⚠️ "),i("strong",null,"警告"),E(": 本作品包含成人内容，仅限18岁以上读者阅读。")],-1))])}const zi=_(wi,[["render",Ei]]),Ri=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Mi,default:zi},Symbol.toStringTag,{value:"Module"})),Hi=JSON.parse('{"title":"小说列表","description":"","frontmatter":{},"headers":[],"relativePath":"articles/index.md","filePath":"articles/index.md","lastUpdated":1766326350000}'),Ji={name:"articles/index.md"};function Ui(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[i("h1",{id:"小说列表",tabindex:"-1"},[E("小说列表 "),i("a",{class:"header-anchor",href:"#小说列表","aria-label":"Permalink to “小说列表”"},"​")],-1),i("p",null,[E("这里都是Naiii的小说！与"),i("a",{href:"https://www.pixiv.net/users/50811011",target:"_blank",rel:"noreferrer"},"Pixiv"),E("同步更新哦")],-1)])])}const Fi=_(Ji,[["render",Ui]]),Ki=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Hi,default:Fi},Symbol.toStringTag,{value:"Module"})),Gi=JSON.parse('{"title":"#1 共犯的初响","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"articles/tsandsis/chapter1.md","filePath":"articles/tsandsis/chapter1.md","lastUpdated":1766326350000}'),Xi={name:"articles/tsandsis/chapter1.md"};function Wi(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",95)])])}const Yi=_(Xi,[["render",Wi]]),Qi=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Gi,default:Yi},Symbol.toStringTag,{value:"Module"})),Zi=JSON.parse('{"title":"#10 湿透的伪装与荆棘的印记","description":"","frontmatter":{"order":10},"headers":[],"relativePath":"articles/tsandsis/chapter10.md","filePath":"articles/tsandsis/chapter10.md","lastUpdated":1766469247000}'),nl={name:"articles/tsandsis/chapter10.md"};function pl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",468)])])}const tl=_(nl,[["render",pl]]),el=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Zi,default:tl},Symbol.toStringTag,{value:"Module"})),ol=JSON.parse('{"title":"#11 同桌的指尖与白丝的秘密","description":"","frontmatter":{"order":11},"headers":[],"relativePath":"articles/tsandsis/chapter11.md","filePath":"articles/tsandsis/chapter11.md","lastUpdated":1768327787000}'),al={name:"articles/tsandsis/chapter11.md"};function sl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",221)])])}const rl=_(al,[["render",sl]]),il=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ol,default:rl},Symbol.toStringTag,{value:"Module"})),ll=JSON.parse('{"title":"#12 口红印与不道歉的占有","description":"","frontmatter":{"order":12},"headers":[],"relativePath":"articles/tsandsis/chapter12.md","filePath":"articles/tsandsis/chapter12.md","lastUpdated":1768327787000}'),ul={name:"articles/tsandsis/chapter12.md"};function cl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",171)])])}const dl=_(ul,[["render",cl]]),_l=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ll,default:dl},Symbol.toStringTag,{value:"Module"})),fl=JSON.parse('{"title":"#13 空教室中的观众与表演","description":"","frontmatter":{"order":13},"headers":[],"relativePath":"articles/tsandsis/chapter13.md","filePath":"articles/tsandsis/chapter13.md","lastUpdated":1768327787000}'),hl={name:"articles/tsandsis/chapter13.md"};function ml(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",120)])])}const ql=_(hl,[["render",ml]]),vl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:fl,default:ql},Symbol.toStringTag,{value:"Module"})),bl=JSON.parse('{"title":"#14 药水、校服与主动献祭","description":"","frontmatter":{"order":14},"headers":[],"relativePath":"articles/tsandsis/chapter14.md","filePath":"articles/tsandsis/chapter14.md","lastUpdated":1768327787000}'),gl={name:"articles/tsandsis/chapter14.md"};function $l(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",186)])])}const Pl=_(gl,[["render",$l]]),kl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:bl,default:Pl},Symbol.toStringTag,{value:"Module"})),Sl=JSON.parse('{"title":"#15 囚笼、盲眼与双倍的占有","description":"","frontmatter":{"order":15},"headers":[],"relativePath":"articles/tsandsis/chapter15.md","filePath":"articles/tsandsis/chapter15.md","lastUpdated":1768327787000}'),Tl={name:"articles/tsandsis/chapter15.md"};function yl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",284)])])}const Al=_(Tl,[["render",yl]]),Ol=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Sl,default:Al},Symbol.toStringTag,{value:"Module"})),Nl=JSON.parse('{"title":"#16 项圈、四肢与“汪”","description":"","frontmatter":{"order":16},"headers":[],"relativePath":"articles/tsandsis/chapter16.md","filePath":"articles/tsandsis/chapter16.md","lastUpdated":1768327787000}'),Bl={name:"articles/tsandsis/chapter16.md"};function xl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",182)])])}const Vl=_(Bl,[["render",xl]]),Cl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Nl,default:Vl},Symbol.toStringTag,{value:"Module"})),Il=JSON.parse('{"title":"#17 水牢、净罪与暗涌的欲望","description":"","frontmatter":{"order":17},"headers":[],"relativePath":"articles/tsandsis/chapter17.md","filePath":"articles/tsandsis/chapter17.md","lastUpdated":1768327787000}'),jl={name:"articles/tsandsis/chapter17.md"};function Dl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",131)])])}const Ll=_(jl,[["render",Dl]]),Ml=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Il,default:Ll},Symbol.toStringTag,{value:"Module"})),wl=JSON.parse('{"title":"#18 晨露、项圈与并行的足迹","description":"","frontmatter":{"order":18},"headers":[],"relativePath":"articles/tsandsis/chapter18.md","filePath":"articles/tsandsis/chapter18.md","lastUpdated":1768327787000}'),El={name:"articles/tsandsis/chapter18.md"};function zl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",117)])])}const Rl=_(El,[["render",zl]]),Hl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:wl,default:Rl},Symbol.toStringTag,{value:"Module"})),Jl=JSON.parse('{"title":"#19 制服、课堂与融化于课桌下的春潮","description":"","frontmatter":{"order":19},"headers":[],"relativePath":"articles/tsandsis/chapter19.md","filePath":"articles/tsandsis/chapter19.md","lastUpdated":1768327787000}'),Ul={name:"articles/tsandsis/chapter19.md"};function Fl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",105)])])}const Kl=_(Ul,[["render",Fl]]),Gl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Jl,default:Kl},Symbol.toStringTag,{value:"Module"})),Xl=JSON.parse('{"title":"#2 公园的羞耻游戏","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/tsandsis/chapter2.md","filePath":"articles/tsandsis/chapter2.md","lastUpdated":1766329124000}'),Wl={name:"articles/tsandsis/chapter2.md"};function Yl(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",322)])])}const Ql=_(Wl,[["render",Yl]]),Zl=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Xl,default:Ql},Symbol.toStringTag,{value:"Module"})),nu=JSON.parse('{"title":"#20 正字、囚服与永夜的盛宴","description":"","frontmatter":{"order":20},"headers":[],"relativePath":"articles/tsandsis/chapter20.md","filePath":"articles/tsandsis/chapter20.md","lastUpdated":1768328362000}'),pu={name:"articles/tsandsis/chapter20.md"};function tu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",133)])])}const eu=_(pu,[["render",tu]]),ou=Object.freeze(Object.defineProperty({__proto__:null,__pageData:nu,default:eu},Symbol.toStringTag,{value:"Module"})),au=JSON.parse('{"title":"#21 正字烙印与永夜沉沦","description":"","frontmatter":{"order":21},"headers":[],"relativePath":"articles/tsandsis/chapter21.md","filePath":"articles/tsandsis/chapter21.md","lastUpdated":1768328362000}'),su={name:"articles/tsandsis/chapter21.md"};function ru(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",75)])])}const iu=_(su,[["render",ru]]),lu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:au,default:iu},Symbol.toStringTag,{value:"Module"})),uu=JSON.parse('{"title":"#22 双主轮舞与媚骨成刑","description":"","frontmatter":{"order":22},"headers":[],"relativePath":"articles/tsandsis/chapter22.md","filePath":"articles/tsandsis/chapter22.md","lastUpdated":1771696632000}'),cu={name:"articles/tsandsis/chapter22.md"};function du(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",83)])])}const _u=_(cu,[["render",du]]),fu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:uu,default:_u},Symbol.toStringTag,{value:"Module"})),hu=JSON.parse('{"title":"#23 忤逆初萌与惩戒深犁","description":"","frontmatter":{"order":23},"headers":[],"relativePath":"articles/tsandsis/chapter23.md","filePath":"articles/tsandsis/chapter23.md","lastUpdated":1771696632000}'),mu={name:"articles/tsandsis/chapter23.md"};function qu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",139)])])}const vu=_(mu,[["render",qu]]),bu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:hu,default:vu},Symbol.toStringTag,{value:"Module"})),gu=JSON.parse('{"title":"#24 双面镜城与午夜欢宴","description":"","frontmatter":{"order":24},"headers":[],"relativePath":"articles/tsandsis/chapter24.md","filePath":"articles/tsandsis/chapter24.md","lastUpdated":1771914025000}'),$u={name:"articles/tsandsis/chapter24.md"};function Pu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",231)])])}const ku=_($u,[["render",Pu]]),Su=Object.freeze(Object.defineProperty({__proto__:null,__pageData:gu,default:ku},Symbol.toStringTag,{value:"Module"})),Tu=JSON.parse('{"title":"#25 银幕下的暗潮与隔间内的盛宴","description":"","frontmatter":{"order":25},"headers":[],"relativePath":"articles/tsandsis/chapter25.md","filePath":"articles/tsandsis/chapter25.md","lastUpdated":1771914025000}'),yu={name:"articles/tsandsis/chapter25.md"};function Au(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",181)])])}const Ou=_(yu,[["render",Au]]),Nu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Tu,default:Ou},Symbol.toStringTag,{value:"Module"})),Bu=JSON.parse('{"title":"#26 潜意识烙印与疼痛圣礼","description":"","frontmatter":{"order":26},"headers":[],"relativePath":"articles/tsandsis/chapter26.md","filePath":"articles/tsandsis/chapter26.md","lastUpdated":1771914025000}'),xu={name:"articles/tsandsis/chapter26.md"};function Vu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",138)])])}const Cu=_(xu,[["render",Vu]]),Iu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Bu,default:Cu},Symbol.toStringTag,{value:"Module"})),ju=JSON.parse('{"title":"#27 贱犬的渴宴","description":"","frontmatter":{"order":27},"headers":[],"relativePath":"articles/tsandsis/chapter27.md","filePath":"articles/tsandsis/chapter27.md","lastUpdated":1771914025000}'),Du={name:"articles/tsandsis/chapter27.md"};function Lu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",128)])])}const Mu=_(Du,[["render",Lu]]),wu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:ju,default:Mu},Symbol.toStringTag,{value:"Module"})),Eu=JSON.parse('{"title":"#28 夜啼与晨礼","description":"","frontmatter":{"order":28},"headers":[],"relativePath":"articles/tsandsis/chapter28.md","filePath":"articles/tsandsis/chapter28.md","lastUpdated":1771914025000}'),zu={name:"articles/tsandsis/chapter28.md"};function Ru(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",98)])])}const Hu=_(zu,[["render",Ru]]),Ju=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Eu,default:Hu},Symbol.toStringTag,{value:"Module"})),Uu=JSON.parse('{"title":"#29 X直播间的白丝祭品","description":"","frontmatter":{"order":29},"headers":[],"relativePath":"articles/tsandsis/chapter29.md","filePath":"articles/tsandsis/chapter29.md","lastUpdated":1771914025000}'),Fu={name:"articles/tsandsis/chapter29.md"};function Ku(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",100)])])}const Gu=_(Fu,[["render",Ku]]),Xu=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Uu,default:Gu},Symbol.toStringTag,{value:"Module"})),Wu=JSON.parse('{"title":"#3 白瓷之印","description":"","frontmatter":{"order":3},"headers":[],"relativePath":"articles/tsandsis/chapter3.md","filePath":"articles/tsandsis/chapter3.md","lastUpdated":1766462880000}'),Yu={name:"articles/tsandsis/chapter3.md"};function Qu(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",305)])])}const Zu=_(Yu,[["render",Qu]]),nc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Wu,default:Zu},Symbol.toStringTag,{value:"Module"})),pc=JSON.parse('{"title":"#30 敏感囚笼与归巢之安","description":"","frontmatter":{"order":30},"headers":[],"relativePath":"articles/tsandsis/chapter30.md","filePath":"articles/tsandsis/chapter30.md","lastUpdated":1771914025000}'),tc={name:"articles/tsandsis/chapter30.md"};function ec(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",110)])])}const oc=_(tc,[["render",ec]]),ac=Object.freeze(Object.defineProperty({__proto__:null,__pageData:pc,default:oc},Symbol.toStringTag,{value:"Module"})),sc=JSON.parse('{"title":"#31 双主竞逐与泪雨迷途","description":"","frontmatter":{"order":31},"headers":[],"relativePath":"articles/tsandsis/chapter31.md","filePath":"articles/tsandsis/chapter31.md","lastUpdated":1771914025000}'),rc={name:"articles/tsandsis/chapter31.md"};function ic(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",107)])])}const lc=_(rc,[["render",ic]]),uc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:sc,default:lc},Symbol.toStringTag,{value:"Module"})),cc=JSON.parse('{"title":"#32 呼吸的赋权","description":"","frontmatter":{"order":32},"headers":[],"relativePath":"articles/tsandsis/chapter32.md","filePath":"articles/tsandsis/chapter32.md","lastUpdated":1771914025000}'),dc={name:"articles/tsandsis/chapter32.md"};function _c(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",227)])])}const fc=_(dc,[["render",_c]]),hc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:cc,default:fc},Symbol.toStringTag,{value:"Module"})),mc=JSON.parse('{"title":"#33催眠罂粟与黑丝献祭","description":"","frontmatter":{"order":33},"headers":[],"relativePath":"articles/tsandsis/chapter33.md","filePath":"articles/tsandsis/chapter33.md","lastUpdated":1771914025000}'),qc={name:"articles/tsandsis/chapter33.md"};function vc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",168)])])}const bc=_(qc,[["render",vc]]),gc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:mc,default:bc},Symbol.toStringTag,{value:"Module"})),$c=JSON.parse('{"title":"#34 门扉背后的无声淫宴","description":"","frontmatter":{"order":34},"headers":[],"relativePath":"articles/tsandsis/chapter34.md","filePath":"articles/tsandsis/chapter34.md","lastUpdated":1771914025000}'),Pc={name:"articles/tsandsis/chapter34.md"};function kc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",155)])])}const Sc=_(Pc,[["render",kc]]),Tc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:$c,default:Sc},Symbol.toStringTag,{value:"Module"})),yc=JSON.parse('{"title":"#35：月下犬饲与桥底的甘乳","description":"","frontmatter":{"order":35},"headers":[],"relativePath":"articles/tsandsis/chapter35.md","filePath":"articles/tsandsis/chapter35.md","lastUpdated":1777707608000}'),Ac={name:"articles/tsandsis/chapter35.md"};function Oc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",292)])])}const Nc=_(Ac,[["render",Oc]]),Bc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:yc,default:Nc},Symbol.toStringTag,{value:"Module"})),xc=JSON.parse('{"title":"#36内诊与哺育","description":"","frontmatter":{"order":36},"headers":[],"relativePath":"articles/tsandsis/chapter36.md","filePath":"articles/tsandsis/chapter36.md","lastUpdated":1777707608000}'),Vc={name:"articles/tsandsis/chapter36.md"};function Cc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",232)])])}const Ic=_(Vc,[["render",Cc]]),jc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:xc,default:Ic},Symbol.toStringTag,{value:"Module"})),Dc=JSON.parse('{"title":"#37 镜渊的淫祭","description":"","frontmatter":{"order":37},"headers":[],"relativePath":"articles/tsandsis/chapter37.md","filePath":"articles/tsandsis/chapter37.md","lastUpdated":1777707608000}'),Lc={name:"articles/tsandsis/chapter37.md"};function Mc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",215)])])}const wc=_(Lc,[["render",Mc]]),Ec=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Dc,default:wc},Symbol.toStringTag,{value:"Module"})),zc=JSON.parse('{"title":"#38 山径的裸兽","description":"","frontmatter":{"order":38},"headers":[],"relativePath":"articles/tsandsis/chapter38.md","filePath":"articles/tsandsis/chapter38.md","lastUpdated":1777707608000}'),Rc={name:"articles/tsandsis/chapter38.md"};function Hc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",150)])])}const Jc=_(Rc,[["render",Hc]]),Uc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:zc,default:Jc},Symbol.toStringTag,{value:"Module"})),Fc=JSON.parse('{"title":"#39 兄长的终末","description":"","frontmatter":{"order":39},"headers":[],"relativePath":"articles/tsandsis/chapter39.md","filePath":"articles/tsandsis/chapter39.md","lastUpdated":1777707608000}'),Kc={name:"articles/tsandsis/chapter39.md"};function Gc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",154)])])}const Xc=_(Kc,[["render",Gc]]),Wc=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Fc,default:Xc},Symbol.toStringTag,{value:"Module"})),Yc=JSON.parse('{"title":"#4 长发的白瓷铃铛","description":"","frontmatter":{"order":4},"headers":[],"relativePath":"articles/tsandsis/chapter4.md","filePath":"articles/tsandsis/chapter4.md","lastUpdated":1766462880000}'),Qc={name:"articles/tsandsis/chapter4.md"};function Zc(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",214)])])}const nd=_(Qc,[["render",Zc]]),pd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Yc,default:nd},Symbol.toStringTag,{value:"Module"})),td=JSON.parse('{"title":"#40 早川同学与妹妹与哥哥","description":"","frontmatter":{"order":40},"headers":[],"relativePath":"articles/tsandsis/chapter40.md","filePath":"articles/tsandsis/chapter40.md","lastUpdated":1777707608000}'),ed={name:"articles/tsandsis/chapter40.md"};function od(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",156)])])}const ad=_(ed,[["render",od]]),sd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:td,default:ad},Symbol.toStringTag,{value:"Module"})),rd=JSON.parse('{"title":"#41 共犯的终响","description":"","frontmatter":{"order":41},"headers":[],"relativePath":"articles/tsandsis/chapter41.md","filePath":"articles/tsandsis/chapter41.md","lastUpdated":1777707608000}'),id={name:"articles/tsandsis/chapter41.md"};function ld(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",139)])])}const ud=_(id,[["render",ld]]),cd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:rd,default:ud},Symbol.toStringTag,{value:"Module"})),dd=JSON.parse('{"title":"#5 黑丝、银锁与偏执的牙印","description":"","frontmatter":{"order":5},"headers":[],"relativePath":"articles/tsandsis/chapter5.md","filePath":"articles/tsandsis/chapter5.md","lastUpdated":1766462880000}'),_d={name:"articles/tsandsis/chapter5.md"};function fd(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",197)])])}const hd=_(_d,[["render",fd]]),md=Object.freeze(Object.defineProperty({__proto__:null,__pageData:dd,default:hd},Symbol.toStringTag,{value:"Module"})),qd=JSON.parse('{"title":"#6 白丝、药丸与空教室的惩罚","description":"","frontmatter":{"order":6},"headers":[],"relativePath":"articles/tsandsis/chapter6.md","filePath":"articles/tsandsis/chapter6.md","lastUpdated":1766462880000}'),vd={name:"articles/tsandsis/chapter6.md"};function bd(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",292)])])}const gd=_(vd,[["render",bd]]),$d=Object.freeze(Object.defineProperty({__proto__:null,__pageData:qd,default:gd},Symbol.toStringTag,{value:"Module"})),Pd=JSON.parse('{"title":"#7 铃音的小穴与温柔的引导","description":"","frontmatter":{"order":7},"headers":[],"relativePath":"articles/tsandsis/chapter7.md","filePath":"articles/tsandsis/chapter7.md","lastUpdated":1766462880000}'),kd={name:"articles/tsandsis/chapter7.md"};function Sd(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",166)])])}const Td=_(kd,[["render",Sd]]),yd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Pd,default:Td},Symbol.toStringTag,{value:"Module"})),Ad=JSON.parse('{"title":"#8 雪白的蛹与新生之穴","description":"","frontmatter":{"order":8},"headers":[],"relativePath":"articles/tsandsis/chapter8.md","filePath":"articles/tsandsis/chapter8.md","lastUpdated":1766463690000}'),Od={name:"articles/tsandsis/chapter8.md"};function Nd(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",262)])])}const Bd=_(Od,[["render",Nd]]),xd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ad,default:Bd},Symbol.toStringTag,{value:"Module"})),Vd=JSON.parse('{"title":"#9 谎言的茉莉香与惩罚的荆棘","description":"","frontmatter":{"order":9},"headers":[],"relativePath":"articles/tsandsis/chapter9.md","filePath":"articles/tsandsis/chapter9.md","lastUpdated":1766469247000}'),Cd={name:"articles/tsandsis/chapter9.md"};function Id(p,n,t,e,o,s){return a(),r("div",null,[...n[0]||(n[0]=[O("",355)])])}const jd=_(Cd,[["render",Id]]),Dd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Vd,default:jd},Symbol.toStringTag,{value:"Module"})),Ld=JSON.parse('{"title":"TS哥哥和扶她妹妹","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"articles/tsandsis/index.md","filePath":"articles/tsandsis/index.md","lastUpdated":1771914025000}'),Md={name:"articles/tsandsis/index.md"};function wd(p,n,t,e,o,s){const l=J("BookWordCount"),u=J("ChapterList");return a(),r("div",null,[n[0]||(n[0]=i("h1",{id:"ts哥哥和扶她妹妹",tabindex:"-1"},[E("TS哥哥和扶她妹妹 "),i("a",{class:"header-anchor",href:"#ts哥哥和扶她妹妹","aria-label":"Permalink to “TS哥哥和扶她妹妹”"},"​")],-1)),n[1]||(n[1]=i("p",null,"一个关于特殊兄妹关系的故事。",-1)),n[2]||(n[2]=i("h2",{id:"简介",tabindex:"-1"},[E("简介 "),i("a",{class:"header-anchor",href:"#简介","aria-label":"Permalink to “简介”"},"​")],-1)),n[3]||(n[3]=i("p",null,"就是骨科啦~",-1)),S(l,{novel:"tsandsis"}),S(u,{novel:"tsandsis"}),n[4]||(n[4]=i("hr",null,null,-1)),n[5]||(n[5]=i("p",null,[E("⚠️ "),i("strong",null,"警告"),E(": 本作品包含成人内容，仅限18岁以上读者阅读。")],-1))])}const Ed=_(Md,[["render",wd]]),zd=Object.freeze(Object.defineProperty({__proto__:null,__pageData:Ld,default:Ed},Symbol.toStringTag,{value:"Module"})),Rd={key:0,class:"latest-banner"},Hd={class:"latest-body"},Jd=["href"],Ud={key:0,class:"latest-date"},Fd={key:1,class:"latest-desc"},Kd="latest_update_banner",Gd=P({__name:"LatestUpdateBanner",setup(p){const n=Object.assign({"../../../articles/ark/A/A.1.md":xr,"../../../articles/ark/B/A/B.A.1and2.md":Dr,"../../../articles/ark/B/A/B.A.3and4.md":zr,"../../../articles/ark/B/A/B.A.5and6.md":Fr,"../../../articles/ark/B/A/index.md":Yr,"../../../articles/ark/B/N/B.N.1.md":ti,"../../../articles/ark/B/N/B.N.2.md":ri,"../../../articles/ark/B/N/B.N.3.md":di,"../../../articles/ark/B/N/B.N.4.md":qi,"../../../articles/ark/B/N/B.N.5.1.md":Pi,"../../../articles/ark/B/N/B.N.5.2.md":Ai,"../../../articles/ark/B/N/B.N.6.md":Vi,"../../../articles/ark/B/N/index.md":Li,"../../../articles/ark/index.md":Ri,"../../../articles/index.md":Ki,"../../../articles/tsandsis/chapter1.md":Qi,"../../../articles/tsandsis/chapter10.md":el,"../../../articles/tsandsis/chapter11.md":il,"../../../articles/tsandsis/chapter12.md":_l,"../../../articles/tsandsis/chapter13.md":vl,"../../../articles/tsandsis/chapter14.md":kl,"../../../articles/tsandsis/chapter15.md":Ol,"../../../articles/tsandsis/chapter16.md":Cl,"../../../articles/tsandsis/chapter17.md":Ml,"../../../articles/tsandsis/chapter18.md":Hl,"../../../articles/tsandsis/chapter19.md":Gl,"../../../articles/tsandsis/chapter2.md":Zl,"../../../articles/tsandsis/chapter20.md":ou,"../../../articles/tsandsis/chapter21.md":lu,"../../../articles/tsandsis/chapter22.md":fu,"../../../articles/tsandsis/chapter23.md":bu,"../../../articles/tsandsis/chapter24.md":Su,"../../../articles/tsandsis/chapter25.md":Nu,"../../../articles/tsandsis/chapter26.md":Iu,"../../../articles/tsandsis/chapter27.md":wu,"../../../articles/tsandsis/chapter28.md":Ju,"../../../articles/tsandsis/chapter29.md":Xu,"../../../articles/tsandsis/chapter3.md":nc,"../../../articles/tsandsis/chapter30.md":ac,"../../../articles/tsandsis/chapter31.md":uc,"../../../articles/tsandsis/chapter32.md":hc,"../../../articles/tsandsis/chapter33.md":gc,"../../../articles/tsandsis/chapter34.md":Tc,"../../../articles/tsandsis/chapter35.md":Bc,"../../../articles/tsandsis/chapter36.md":jc,"../../../articles/tsandsis/chapter37.md":Ec,"../../../articles/tsandsis/chapter38.md":Uc,"../../../articles/tsandsis/chapter39.md":Wc,"../../../articles/tsandsis/chapter4.md":pd,"../../../articles/tsandsis/chapter40.md":sd,"../../../articles/tsandsis/chapter41.md":cd,"../../../articles/tsandsis/chapter5.md":md,"../../../articles/tsandsis/chapter6.md":$d,"../../../articles/tsandsis/chapter7.md":yd,"../../../articles/tsandsis/chapter8.md":xd,"../../../articles/tsandsis/chapter9.md":Dd,"../../../articles/tsandsis/index.md":zd}),t=q=>{if(q==null)return null;if(typeof q=="number")return q<1e12?q*1e3:q;const m=Date.parse(String(q));return Number.isNaN(m)?null:m},e=T(()=>Object.values(n).map(q=>{const m=q?.__pageData??{},h=q?.frontmatter??{},b=m.relativePath;if(!b)return null;const g=b.replace(/\.md$/,""),A=g.endsWith("/index")?`/${g.slice(0,-6)}/`:`/${g}`,k=t(m.lastUpdated)??t(h.updated)??t(h.date);return{title:m.title||h.title||"未命名章节",description:m.description||h.description,path:A,lastUpdated:k??m.lastUpdated}}).filter(Boolean).filter(q=>q.path.startsWith("/articles")&&Sn(q.path)).sort((q,m)=>{const h=t(q.lastUpdated)??0,b=t(m.lastUpdated)??0;return h===b?m.path.localeCompare(q.path):b-h})),o=T(()=>e.value[0]),s=q=>{if(typeof document>"u")return null;const m=document.cookie.match(new RegExp("(?:^|; )"+q.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return m?decodeURIComponent(m[1]):null},l=N(!0);R(()=>{l.value=s(Kd)!=="1"});const u=()=>{l.value=!1},d=T(()=>{const q=o.value?.lastUpdated;if(!q)return"";const m=typeof q=="number"?q:Date.parse(q),h=m<1e12?m*1e3:m,b=new Date(h),g=A=>String(A).padStart(2,"0");return`${b.getFullYear()}-${g(b.getMonth()+1)}-${g(b.getDate())}`});return(q,m)=>(a(),y(ln,{name:"banner-fade"},{default:v(()=>[o.value&&l.value?(a(),r("div",Rd,[m[0]||(m[0]=i("div",{class:"latest-label"},"最新更新",-1)),i("div",Hd,[i("a",{class:"latest-title",href:o.value.path},V(o.value.title),9,Jd),d.value?(a(),r("span",Ud,"更新于 "+V(d.value),1)):$("",!0),o.value.description?(a(),r("p",Fd,V(o.value.description),1)):$("",!0)]),i("div",{class:"latest-actions"},[i("button",{class:"btn",onClick:u},"关闭")])])):$("",!0)]),_:1}))}}),Xd=_(Gd,[["__scopeId","data-v-fb77de2f"]]),Wd="reader_font",Yd="reader_font_size",Qd=P({__name:"Layout",setup(p){const{Layout:n}=ep,{isDark:t}=Tn(),e=Nn(),o="20260502_161037",s=k=>{k.preventDefault(),window.__deferredPwaPrompt=k,window.dispatchEvent(new CustomEvent("pwa-install-available"))},l=()=>{window.__deferredPwaPrompt=null,window.dispatchEvent(new CustomEvent("pwa-installed"))},u=k=>{if(typeof document>"u")return null;const B=document.cookie.match(new RegExp("(?:^|; )"+k.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return B?decodeURIComponent(B[1]):null},d=()=>{if(typeof window>"u")return;const k=u(Wd);k&&(document.documentElement.dataset.font=k);const B=u(Yd);B&&(document.documentElement.dataset.fontSize=B)},q=k=>{document.querySelector("iframe.giscus-frame")?.contentWindow?.postMessage({giscus:{setConfig:{theme:k}}},"https://giscus.app")},m=()=>{const k=document.querySelector(".giscus-wrapper");k&&(k.innerHTML="",typeof window<"u"&&"giscus"in window&&delete window.giscus)},h=(k=5)=>{const B=document.querySelector(".giscus-wrapper");if(!B){k>0&&setTimeout(()=>h(k-1),100);return}const D=B.querySelector("iframe.giscus-frame"),j=t.value?"dark":"light";if(D){q(j);return}const L=document.createElement("script");L.src="https://giscus.app/client.js",L.setAttribute("data-repo","NatsumiXD/novel-comment"),L.setAttribute("data-repo-id","R_kgDOQshs6w"),L.setAttribute("data-category","Announcements"),L.setAttribute("data-category-id","DIC_kwDOQshs684C0EPb"),L.setAttribute("data-mapping","pathname"),L.setAttribute("data-strict","1"),L.setAttribute("data-reactions-enabled","1"),L.setAttribute("data-emit-metadata","0"),L.setAttribute("data-input-position","bottom"),L.setAttribute("data-theme",j),L.setAttribute("data-lang","zh-CN"),L.setAttribute("crossorigin","anonymous"),L.async=!0,B.appendChild(L)};R(()=>{d(),typeof window<"u"&&(window.addEventListener("beforeinstallprompt",s),window.addEventListener("appinstalled",l)),sn(()=>{setTimeout(h,300),setTimeout(A,300)})}),Z(()=>{typeof window>"u"||(window.removeEventListener("beforeinstallprompt",s),window.removeEventListener("appinstalled",l))});const b=()=>{document.documentElement.classList.add("page-transitioning")},g=()=>{document.documentElement.classList.remove("page-transitioning")};H(t,k=>{typeof window>"u"||q(k?"dark":"light")},{flush:"post"}),H(()=>e.route.path,()=>{m(),b(),sn(()=>{setTimeout(h,100),setTimeout(A,200),setTimeout(g,500)})},{flush:"post"});const A=()=>{if(typeof document>"u")return;const k=document.querySelector(".VPFooter .message");if(!k||k.querySelector(".build-time-inline"))return;const B=document.createElement("span");B.className="footer-item",B.textContent=`Build time ${o}`,k.appendChild(B)};return(k,B)=>(a(),y(c(n),null,{"layout-top":v(()=>[S(Sr),S(ir),S(dr),S(yr),S($r)]),"home-hero-before":v(()=>[S(Xd)]),"doc-after":v(()=>[...B[0]||(B[0]=[i("div",{class:"giscus-wrapper"},null,-1)])]),"layout-bottom":v(()=>[S(hr)]),_:1}))}}),Zd=_(Qd,[["__scopeId","data-v-29cdc6cd"]]),n_={},p_={class:"not-found"};function t_(p,n){return a(),r("div",p_,[...n[0]||(n[0]=[i("div",{class:"not-found__bubble"},[i("p",{class:"not-found__code"},"404"),i("h1",null,"迷路啦！"),i("p",null,"这里是次元夹缝，路标被史莱姆吃掉了。"),i("p",null,"别慌，跟着导航猫娘回去就好喵！"),i("a",{class:"not-found__button",href:"/"},"喵呜~ 带我回首页"),i("p",{class:"not-found__tip"},"一直往前会抵达未来，但换个方向更快找到想要的世界。")],-1)])])}const e_=_(n_,[["render",t_],["__scopeId","data-v-2020f3db"]]),o_=`---
order: 1
---
...
`,op=Object.freeze(Object.defineProperty({__proto__:null,default:o_},Symbol.toStringTag,{value:"Module"})),a_=`---
order: 1
---
...
而床上，两个被禁忌的欲望和温暖的体温缠绕在一起的灵魂，才刚刚开始面对他们崭新、混乱、而又无法分割的未来。`,ap=Object.freeze(Object.defineProperty({__proto__:null,default:a_},Symbol.toStringTag,{value:"Module"})),s_=`---
order: 10
---
...
而这个牢笼，她甘愿被困在其中`,sp=Object.freeze(Object.defineProperty({__proto__:null,default:s_},Symbol.toStringTag,{value:"Module"})),r_=`---
order: 11
---
...
慢慢窒息。`,rp=Object.freeze(Object.defineProperty({__proto__:null,default:r_},Symbol.toStringTag,{value:"Module"})),i_=`---
order: 12
---
...
而这个囚笼，她早已放弃了逃离的念头。`,ip=Object.freeze(Object.defineProperty({__proto__:null,default:i_},Symbol.toStringTag,{value:"Module"})),l_=`---
order: 13
---
...
不知能否燎原。
`,lp=Object.freeze(Object.defineProperty({__proto__:null,default:l_},Symbol.toStringTag,{value:"Module"})),u_=`---
order: 14
---
...
`,up=Object.freeze(Object.defineProperty({__proto__:null,default:u_},Symbol.toStringTag,{value:"Module"})),c_=`---
order: 15
---
...
夜还很长。
而游戏，似乎才刚刚升级。
`,cp=Object.freeze(Object.defineProperty({__proto__:null,default:c_},Symbol.toStringTag,{value:"Module"})),d_=`---
order: 16
---
...
夜晚还很长。
而明天，新的课程即将开始。
`,dp=Object.freeze(Object.defineProperty({__proto__:null,default:d_},Symbol.toStringTag,{value:"Module"})),__=`---
order: 17
---
...
夜还长。
水汽未散。
锁链与项圈，在月光照不到的角落，泛着冷硬的光。`,_p=Object.freeze(Object.defineProperty({__proto__:null,default:__},Symbol.toStringTag,{value:"Module"})),f_=`---
order: 18
---
...
而庭院之外，天光正一寸寸变得明亮，照常升起。`,fp=Object.freeze(Object.defineProperty({__proto__:null,default:f_},Symbol.toStringTag,{value:"Module"})),h_=`---
order: 19
---
# #19 制服、课堂与融化于课桌下的春潮
...
而车厢内，属于“小白”的、被彻底掌控和宠爱的夜晚，才刚刚开始。`,hp=Object.freeze(Object.defineProperty({__proto__:null,default:h_},Symbol.toStringTag,{value:"Module"})),m_=`---
order: 2
---
...
而他们的夜晚，才刚刚开始。`,mp=Object.freeze(Object.defineProperty({__proto__:null,default:m_},Symbol.toStringTag,{value:"Module"})),q_=`---
order: 20
---
# #20 正字、囚服与永夜的盛宴
...
而对于被囚禁在房间内、身上刻写着欲望印记的“小白”来说，时间只是用来等待下一次盛宴的、缓慢流动的沙漏。`,qp=Object.freeze(Object.defineProperty({__proto__:null,default:q_},Symbol.toStringTag,{value:"Module"})),v_=`---
order: 21
---
# #21 正字烙印与永夜沉沦
...
夜色深沉。
盐灯的光晕柔和。
腿间的黑色图腾，在昏暗光线下，宛如活物，静静诉说着永不餍足的欲望，与永无止境的沉沦。`,vp=Object.freeze(Object.defineProperty({__proto__:null,default:v_},Symbol.toStringTag,{value:"Module"})),b_=`---
order: 22
---
# #22 双主轮舞与媚骨成刑
...
只有明日的阳光（如果还能照进这间屋子），才会揭晓。`,bp=Object.freeze(Object.defineProperty({__proto__:null,default:b_},Symbol.toStringTag,{value:"Module"})),g_=`---
order: 23
---
# #23 忤逆初萌与惩戒深犁
...
房间重归寂静。
只有熏香清冷的气息，在无声流淌。
而一场更深的沉沦，或许才刚刚揭开序幕。`,gp=Object.freeze(Object.defineProperty({__proto__:null,default:g_},Symbol.toStringTag,{value:"Module"})),$_=`---
order: 24
---
# #24 双面镜城与午夜欢宴
...
盐灯的光，温柔地笼罩着床上相拥的两人，仿佛在默许这一切的荒诞与必然。`,$p=Object.freeze(Object.defineProperty({__proto__:null,default:$_},Symbol.toStringTag,{value:"Module"})),P_=`---
order: 25
---
# #25 银幕下的暗潮与隔间内的盛宴
...
窗外，城市的夜晚依旧喧嚣。
而镜城之中，那面映照出“媚骨天成”的镜子，似乎被打磨得更加光亮，也映照出更加深邃、无法回头的欲望深渊。`,Pp=Object.freeze(Object.defineProperty({__proto__:null,default:P_},Symbol.toStringTag,{value:"Module"})),k_=`---
order: 26
---
# #26 潜意识烙印与疼痛圣礼
...
夜，如期而至。
而某些改变，已经悄然发生，并且不可逆转。`,kp=Object.freeze(Object.defineProperty({__proto__:null,default:k_},Symbol.toStringTag,{value:"Module"})),S_=`---
order: 27
---
# #27 贱犬的渴宴
...
渴求被满足，欲望被填满。
贱犬的盛宴，或许每日都在上演，并且，永无餍足。`,Sp=Object.freeze(Object.defineProperty({__proto__:null,default:S_},Symbol.toStringTag,{value:"Module"})),T_=`---
order: 28
---
# #28 夜啼与晨礼
...
而渴求，永远不会真正止息。
它只会在一次次被填满后，蛰伏，然后孕育出下一次，更加强烈、更加贪婪的索求。`,Tp=Object.freeze(Object.defineProperty({__proto__:null,default:T_},Symbol.toStringTag,{value:"Module"})),y_=`---
order: 29
---
# #29 X直播间的白丝祭品
...
直播结束了。
但欲望的余烬，仍在黑暗中无声地燃烧。
而这场被无数人见证的堕落，或许早已将某些东西，刻入了更深的、无法磨灭的维度。`,yp=Object.freeze(Object.defineProperty({__proto__:null,default:y_},Symbol.toStringTag,{value:"Module"})),A_=`---
order: 3
---
...
而游戏，才刚刚开始。`,Ap=Object.freeze(Object.defineProperty({__proto__:null,default:A_},Symbol.toStringTag,{value:"Module"})),O_=`---
order: 30
---
# #30 敏感囚笼与归巢之安
...
她再也无法离开。
也从未如此渴望停留。`,Op=Object.freeze(Object.defineProperty({__proto__:null,default:O_},Symbol.toStringTag,{value:"Module"})),N_=`---
order: 31
---
# #31 双主竞逐与泪雨迷途
...
泪雨已歇，但迷途更深。
在双主永不餍足的征服欲中，她这只可怜又可爱的小狗，除了将身心全部奉上，供其争夺、品评、享用之外，早已别无他路可走。`,Np=Object.freeze(Object.defineProperty({__proto__:null,default:N_},Symbol.toStringTag,{value:"Module"})),B_=`---
order: 32
---
# #32 呼吸的赋权
...
还有什么不能给的呢？`,Bp=Object.freeze(Object.defineProperty({__proto__:null,default:B_},Symbol.toStringTag,{value:"Module"})),x_=`---
order: 33
---
# #33催眠罂粟与黑丝献祭
...
黑丝是祭品，包裹着献祭给主人的肉体。
在理性沉睡的夜晚，本能接管了一切。
而她，终于彻底地、毫无保留地，堕落成了主人最淫荡、最忠诚、最美丽的——所有物。`,xp=Object.freeze(Object.defineProperty({__proto__:null,default:x_},Symbol.toStringTag,{value:"Module"})),V_=`---
order: 34
---
# #34 门扉背后的无声淫宴
...
门外的世界，依旧正常运转。
门内的世界，是只属于她们的、永恒的淫宴。
而小白，终于在她的“妈妈”们怀中，找到了最扭曲、也最真实的安宁。`,Vp=Object.freeze(Object.defineProperty({__proto__:null,default:V_},Symbol.toStringTag,{value:"Module"})),C_=`---
order: 35
---
# #35：月下犬饲与桥底的甘乳
...
（未完待续）`,Cp=Object.freeze(Object.defineProperty({__proto__:null,default:C_},Symbol.toStringTag,{value:"Module"})),I_=`---
order: 36
---
# #36内诊与哺育
...
（未完待续）
`,Ip=Object.freeze(Object.defineProperty({__proto__:null,default:I_},Symbol.toStringTag,{value:"Module"})),j_=`---
order: 37
---
...
（未完待续）
`,jp=Object.freeze(Object.defineProperty({__proto__:null,default:j_},Symbol.toStringTag,{value:"Module"})),D_=`---
order: 38
---
...
（未完待续）
`,Dp=Object.freeze(Object.defineProperty({__proto__:null,default:D_},Symbol.toStringTag,{value:"Module"})),L_=`---
order: 39
---
...
（未完待续）
`,Lp=Object.freeze(Object.defineProperty({__proto__:null,default:L_},Symbol.toStringTag,{value:"Module"})),M_=`---
order: 4
---
...
那是只属于他们的，秘密的旋律。`,Mp=Object.freeze(Object.defineProperty({__proto__:null,default:M_},Symbol.toStringTag,{value:"Module"})),w_=`---
order: 40
---
...
（未完待续）
`,wp=Object.freeze(Object.defineProperty({__proto__:null,default:w_},Symbol.toStringTag,{value:"Module"})),E_=`---
order: 41
---
...
（全文完）
`,Ep=Object.freeze(Object.defineProperty({__proto__:null,default:E_},Symbol.toStringTag,{value:"Module"})),z_=`---
order: 5
---
...
然后，他睡着了。`,zp=Object.freeze(Object.defineProperty({__proto__:null,default:z_},Symbol.toStringTag,{value:"Module"})),R_=`---
order: 6
---
...
夜晚，还很长。`,Rp=Object.freeze(Object.defineProperty({__proto__:null,default:R_},Symbol.toStringTag,{value:"Module"})),H_=`---
order: 7
---
...
窗外，阳光正好。`,Hp=Object.freeze(Object.defineProperty({__proto__:null,default:H_},Symbol.toStringTag,{value:"Module"})),J_=`---
order: 8
---
...
新生，才刚刚开始。`,Jp=Object.freeze(Object.defineProperty({__proto__:null,default:J_},Symbol.toStringTag,{value:"Module"})),U_=`---
order: 9
---
...
而明天，还会有新的风暴。`,Up=Object.freeze(Object.defineProperty({__proto__:null,default:U_},Symbol.toStringTag,{value:"Module"})),F_=`---
order: 2
---
...
⚠️ **警告**: 本作品包含成人内容，仅限18岁以上读者阅读。
`,Fp=Object.freeze(Object.defineProperty({__proto__:null,default:F_},Symbol.toStringTag,{value:"Module"})),K_={key:0,class:"chapter-list"},G_=["href"],X_=P({__name:"ChapterList",props:{novel:{},novelPath:{default:()=>""}},setup(p){const n=p;Nn();const t=T(()=>n.novelPath||n.novel),e=T(()=>{const o=Object.assign({"/articles/ark/index.md":op,"/articles/tsandsis/chapter1.md":ap,"/articles/tsandsis/chapter10.md":sp,"/articles/tsandsis/chapter11.md":rp,"/articles/tsandsis/chapter12.md":ip,"/articles/tsandsis/chapter13.md":lp,"/articles/tsandsis/chapter14.md":up,"/articles/tsandsis/chapter15.md":cp,"/articles/tsandsis/chapter16.md":dp,"/articles/tsandsis/chapter17.md":_p,"/articles/tsandsis/chapter18.md":fp,"/articles/tsandsis/chapter19.md":hp,"/articles/tsandsis/chapter2.md":mp,"/articles/tsandsis/chapter20.md":qp,"/articles/tsandsis/chapter21.md":vp,"/articles/tsandsis/chapter22.md":bp,"/articles/tsandsis/chapter23.md":gp,"/articles/tsandsis/chapter24.md":$p,"/articles/tsandsis/chapter25.md":Pp,"/articles/tsandsis/chapter26.md":kp,"/articles/tsandsis/chapter27.md":Sp,"/articles/tsandsis/chapter28.md":Tp,"/articles/tsandsis/chapter29.md":yp,"/articles/tsandsis/chapter3.md":Ap,"/articles/tsandsis/chapter30.md":Op,"/articles/tsandsis/chapter31.md":Np,"/articles/tsandsis/chapter32.md":Bp,"/articles/tsandsis/chapter33.md":xp,"/articles/tsandsis/chapter34.md":Vp,"/articles/tsandsis/chapter35.md":Cp,"/articles/tsandsis/chapter36.md":Ip,"/articles/tsandsis/chapter37.md":jp,"/articles/tsandsis/chapter38.md":Dp,"/articles/tsandsis/chapter39.md":Lp,"/articles/tsandsis/chapter4.md":Mp,"/articles/tsandsis/chapter40.md":wp,"/articles/tsandsis/chapter41.md":Ep,"/articles/tsandsis/chapter5.md":zp,"/articles/tsandsis/chapter6.md":Rp,"/articles/tsandsis/chapter7.md":Hp,"/articles/tsandsis/chapter8.md":Jp,"/articles/tsandsis/chapter9.md":Up,"/articles/tsandsis/index.md":Fp}),s=d=>{if(typeof d=="string")return d;if(d&&typeof d=="object"){const q=d.__content;if(typeof q=="string")return q;const m=d.default;if(typeof m=="string")return m}return""},l=[],u=t.value;return Object.entries(o).forEach(([d,q])=>{const m=d.match(new RegExp(`/articles/${u}/(.+?)\\.md$`));if(!m)return;const h=m[1];if(h==="index")return;const b=s(q),g=b.match(/^---\s*\n([\s\S]*?)\n---/);let A=999,k=h;if(g){const D=g[1].match(/order:\s*(\d+)/);D&&(A=parseInt(D[1],10))}const B=b.match(/^#\s+(.+)$/m);B&&(k=B[1]),l.push({order:A,title:k,path:`/articles/${u}/${h}`})}),l.sort((d,q)=>d.order-q.order)});return(o,s)=>e.value.length>0?(a(),r("div",K_,[s[0]||(s[0]=i("h2",null,"章节列表",-1)),i("ul",null,[(a(!0),r(I,null,z(e.value,l=>(a(),r("li",{key:l.path},[i("a",{href:l.path},V(l.title),9,G_)]))),128))])])):$("",!0)}}),W_=_(X_,[["__scopeId","data-v-2681bc47"]]),Y_=`---
order: 2
---
...
雪原的风裹挟着冰冷的雪花涌入洞口，试图冷却她们滚烫的肌肤和仍在分泌情动液体的隐秘地带，却徒劳无功。一前一后的身影，在苍茫雪地上投下扭曲纠缠、仿佛永生永世无法分离的影子。她们没有结合，没有亲吻，但空气中弥漫的、那混合着纯粹生殖渴望与原始情欲的、浓烈到令人窒息的张力，比任何身体的交合都更加惊心动魄，更加蚀骨销魂。这份在血与火、冰与欲、生与死的边缘淬炼出的生殖吸引，是灵魂与肉体的双重献祭，是征服与臣服的永恒悖论，是毁灭与重生的极致轮回。它如同一个未完成的、充满致命诱惑的生殖仪式，在寂静的雪原上、在她们每一次心跳的间隙里，无声地呼唤着下一次更加炽热、更加彻底的沉沦。直到她们在彼此的爱欲之火中，完成生命本能最原始、最澎湃的终极召唤——在极致的生殖结合中找到那唯一的、永恒的归宿，或在创造与毁灭的顶点化为灰烬。`,Kp=Object.freeze(Object.defineProperty({__proto__:null,default:Y_},Symbol.toStringTag,{value:"Module"})),Q_=`---
order: 1
---
...
`,Gp=Object.freeze(Object.defineProperty({__proto__:null,default:Q_},Symbol.toStringTag,{value:"Module"})),Z_=`---
order: 2
---
...
`,Xp=Object.freeze(Object.defineProperty({__proto__:null,default:Z_},Symbol.toStringTag,{value:"Module"})),nf=`---
order: 3
---
...
只有小屋“主人们”和能天使知道真相。羞涩优雅音乐家没病。她只是被彻底心甘情愿重塑成只为欲望存在沉迷轮奸快感时刻需要填满的——性奴。堕落的乐章已然奏响永不停歇。每个白天是在跳蛋嗡鸣中煎熬等待夜晚降临前奏。每个夜晚小屋都成为她彻底沉沦献祭自我的祭坛。直到虚脱直到意识只剩色欲直到美丽躯壳被彻底开发使用殆尽。（完）`,Wp=Object.freeze(Object.defineProperty({__proto__:null,default:nf},Symbol.toStringTag,{value:"Module"})),pf=`---
order: 2
title: 阿尔图罗的派对(?)
---
...
这是A系列的简介。
`,Yp=Object.freeze(Object.defineProperty({__proto__:null,default:pf},Symbol.toStringTag,{value:"Module"})),tf=`---
order: 1
---
...
`,Zp=Object.freeze(Object.defineProperty({__proto__:null,default:ef},Symbol.toStringTag,{value:"Module"})),of=`---
order: 3
---
...
`,nt=Object.freeze(Object.defineProperty({__proto__:null,default:of},Symbol.toStringTag,{value:"Module"})),af=`---
order: 4
---
# B.N.4 坏掉的小苹果~（乐徳）
...
`,pt=Object.freeze(Object.defineProperty({__proto__:null,default:af},Symbol.toStringTag,{value:"Module"})),sf=`---
order: 5
---
# B.N.5.1苹果派装不下再多了呜呜呜~！
...
`,tt=Object.freeze(Object.defineProperty({__proto__:null,default:sf},Symbol.toStringTag,{value:"Module"})),rf=`---
order: 6
---
...
`,et=Object.freeze(Object.defineProperty({__proto__:null,default:rf},Symbol.toStringTag,{value:"Module"})),lf=`---
order: 7
---
# B.N.6 触手服以及能天使~
...
`,ot=Object.freeze(Object.defineProperty({__proto__:null,default:lf},Symbol.toStringTag,{value:"Module"})),uf=`---
order: 1
title: 变成泡芙的能天使~
---
...
这是N系列的简介。
`,at=Object.freeze(Object.defineProperty({__proto__:null,default:uf},Symbol.toStringTag,{value:"Module"})),cf={class:"ark-chapter-list"},df={key:0,class:"section-a"},_f=["href"],ff={key:1,class:"section-b"},hf={key:0},mf=["href"],qf=P({__name:"ARKChapterList",setup(p){const n=T(()=>{const t=d=>typeof d=="string"?d:d&&typeof d.default=="string"?d.default:d&&typeof d.__content=="string"?d.__content:"",e=Object.assign({"/articles/ark/A/A.1.md":Kp}),o=[];Object.entries(e).forEach(([d,q])=>{const m=d.match(/\/articles\/ark\/A\/(.+?)\.md$/);if(!m)return;const h=m[1],b=t(q),g=b.match(/^---\s*\n([\s\S]*?)\n---/);let A=999,k=h;if(g){const D=g[1].match(/order:\s*(\d+)/);D&&(A=parseInt(D[1],10))}const B=b.match(/^#\s+(.+)$/m);B&&(k=B[1]),o.push({order:A,title:k,path:`/articles/ark/A/${h}`})}),o.sort((d,q)=>d.order-q.order);const s=Object.assign({"/articles/ark/B/A/B.A.1and2.md":Gp,"/articles/ark/B/A/B.A.3and4.md":Xp,"/articles/ark/B/A/B.A.5and6.md":Wp,"/articles/ark/B/A/index.md":Yp,"/articles/ark/B/N/B.N.1.md":Qp,"/articles/ark/B/N/B.N.2.md":Zp,"/articles/ark/B/N/B.N.3.md":nt,"/articles/ark/B/N/B.N.4.md":pt,"/articles/ark/B/N/B.N.5.1.md":tt,"/articles/ark/B/N/B.N.5.2.md":et,"/articles/ark/B/N/B.N.6.md":ot,"/articles/ark/B/N/index.md":at}),l=new Map;Object.entries(s).forEach(([d,q])=>{const m=d.match(/\/articles\/ark\/B\/(\w+)\/(.+?)\.md$/);if(!m)return;const[,h,b]=m,g=t(q);if(b==="index"){const A=g.match(/^---\s*\n([\s\S]*?)\n---/);let k=999,B=h;if(A){const j=A[1].match(/order:\s*(\d+)/);j&&(k=parseInt(j[1],10))}const D=g.match(/^#\s+(.+)$/m);if(D)B=D[1];else if(A){const j=A[1].match(/title:\s*(.+)/);j&&(B=j[1].trim())}if(!l.has(h))l.set(h,{name:h,order:k,title:B,chapters:[]});else{const j=l.get(h);j.order=k,j.title=B}}else{const A=g.match(/^---\s*\n([\s\S]*?)\n---/);let k=999,B=b;if(A){const j=A[1].match(/order:\s*(\d+)/);j&&(k=parseInt(j[1],10))}const D=g.match(/^#\s+(.+)$/m);D&&(B=D[1]),l.has(h)||l.set(h,{name:h,order:999,title:h,chapters:[]}),l.get(h).chapters.push({order:k,title:B,path:`/articles/ark/B/${h}/${b}`})}});const u=Array.from(l.values());return u.forEach(d=>{d.chapters.sort((q,m)=>q.order-m.order)}),u.sort((d,q)=>d.order-q.order),{aChapters:o,series:u}});return(t,e)=>(a(),r("div",cf,[n.value.aChapters.length>0?(a(),r("section",df,[e[0]||(e[0]=i("h3",null,"A 系列（短篇）",-1)),i("ul",null,[(a(!0),r(I,null,z(n.value.aChapters,o=>(a(),r("li",{key:o.path},[i("a",{href:o.path},V(o.title),9,_f)]))),128))])])):$("",!0),n.value.series.length>0?(a(),r("section",ff,[e[1]||(e[1]=i("h3",null,"B 系列（系列连载）",-1)),(a(!0),r(I,null,z(n.value.series,o=>(a(),r("div",{key:o.name,class:"series"},[i("h4",null,V(o.title),1),o.chapters.length>0?(a(),r("ul",hf,[(a(!0),r(I,null,z(o.chapters,s=>(a(),r("li",{key:s.path},[i("a",{href:s.path},V(s.title),9,mf)]))),128))])):$("",!0)]))),128))])):$("",!0)]))}}),vf=_(qf,[["__scopeId","data-v-e236f069"]]),bf=`# 小说列表
这里都是Naiii的小说！与[Pixiv](https://www.pixiv.net/users/50811011)同步更新哦`,gf=Object.freeze(Object.defineProperty({__proto__:null,default:bf},Symbol.toStringTag,{value:"Module"})),$f={class:"book-word-count"},Pf=P({__name:"BookWordCount",props:{novel:{},novelPath:{default:()=>""}},setup(p){const n=p,t=T(()=>n.novelPath||n.novel),e=Object.assign({"/articles/ark/A/A.1.md":Kp,"/articles/ark/B/A/B.A.1and2.md":Gp,"/articles/ark/B/A/B.A.3and4.md":Xp,"/articles/ark/B/A/B.A.5and6.md":Wp,"/articles/ark/B/A/index.md":Yp,"/articles/ark/B/N/B.N.1.md":Qp,"/articles/ark/B/N/B.N.2.md":Zp,"/articles/ark/B/N/B.N.3.md":nt,"/articles/ark/B/N/B.N.4.md":pt,"/articles/ark/B/N/B.N.5.1.md":tt,"/articles/ark/B/N/B.N.5.2.md":et,"/articles/ark/B/N/B.N.6.md":ot,"/articles/ark/B/N/index.md":at,"/articles/ark/index.md":op,"/articles/index.md":gf,"/articles/tsandsis/chapter1.md":ap,"/articles/tsandsis/chapter10.md":sp,"/articles/tsandsis/chapter11.md":rp,"/articles/tsandsis/chapter12.md":ip,"/articles/tsandsis/chapter13.md":lp,"/articles/tsandsis/chapter14.md":up,"/articles/tsandsis/chapter15.md":cp,"/articles/tsandsis/chapter16.md":dp,"/articles/tsandsis/chapter17.md":_p,"/articles/tsandsis/chapter18.md":fp,"/articles/tsandsis/chapter19.md":hp,"/articles/tsandsis/chapter2.md":mp,"/articles/tsandsis/chapter20.md":qp,"/articles/tsandsis/chapter21.md":vp,"/articles/tsandsis/chapter22.md":bp,"/articles/tsandsis/chapter23.md":gp,"/articles/tsandsis/chapter24.md":$p,"/articles/tsandsis/chapter25.md":Pp,"/articles/tsandsis/chapter26.md":kp,"/articles/tsandsis/chapter27.md":Sp,"/articles/tsandsis/chapter28.md":Tp,"/articles/tsandsis/chapter29.md":yp,"/articles/tsandsis/chapter3.md":Ap,"/articles/tsandsis/chapter30.md":Op,"/articles/tsandsis/chapter31.md":Np,"/articles/tsandsis/chapter32.md":Bp,"/articles/tsandsis/chapter33.md":xp,"/articles/tsandsis/chapter34.md":Vp,"/articles/tsandsis/chapter35.md":Cp,"/articles/tsandsis/chapter36.md":Ip,"/articles/tsandsis/chapter37.md":jp,"/articles/tsandsis/chapter38.md":Dp,"/articles/tsandsis/chapter39.md":Lp,"/articles/tsandsis/chapter4.md":Mp,"/articles/tsandsis/chapter40.md":wp,"/articles/tsandsis/chapter41.md":Ep,"/articles/tsandsis/chapter5.md":zp,"/articles/tsandsis/chapter6.md":Rp,"/articles/tsandsis/chapter7.md":Hp,"/articles/tsandsis/chapter8.md":Jp,"/articles/tsandsis/chapter9.md":Up,"/articles/tsandsis/index.md":Fp});function o(m){if(typeof m=="string")return m;if(m&&typeof m=="object"){const h=m.__content;if(typeof h=="string")return h;const b=m.default;if(typeof b=="string")return b}return""}function s(m){return m.replace(/^---\s*\n[\s\S]*?\n---\s*\n?/,"")}function l(m){return s(m).replace(/```[\s\S]*?```/g,"").replace(/`[^`]*`/g,"").replace(/!\[[^\]]*\]\([^)]*\)/g,"").replace(/\[([^\]]+)\]\(([^)]+)\)/g,"$1").replace(/^#{1,6}\s+/gm,"").replace(/^>\s?/gm,"").replace(/^\s*[-*+]\s+/gm,"").replace(/^\s*\d+\.\s+/gm,"").replace(/[*_~#>-]/g,"").replace(/<[^>]*>/g,"")}function u(m){return l(m).replace(/\s+/g,"").length}const d=T(()=>Object.keys(e).filter(m=>{const h=m.match(/^\/articles\/([^/]+)\/(.+)\.md$/);if(!h)return!1;const[,b,g]=h;return b!==t.value?!1:!g.endsWith("/index")&&g!=="index"}).length),q=T(()=>Object.entries(e).reduce((m,[h,b])=>{const g=h.match(/^\/articles\/([^/]+)\/(.+)\.md$/);if(!g)return m;const[,A,k]=g;return A!==t.value||k.endsWith("/index")||k==="index"?m:m+u(o(b))},0));return(m,h)=>(a(),r("div",$f,[h[0]||(h[0]=i("strong",null,"全书字数：",-1)),E(V(q.value.toLocaleString("zh-CN"))+" 字（共 "+V(d.value)+" 章） ",1)]))}}),kf=_(Pf,[["__scopeId","data-v-f4b43d41"]]),Sf={class:"settings-page"},Tf="reading_prompt_enabled",yf="last_read",zn="reader_font",Rn="reader_font_size",Hn="latest_update_banner",Af=P({__name:"SettingsPanel",setup(p){const n=(b,g,A=-1)=>{const k=new Date;k.setTime(k.getTime()+A*24*60*60*1e3),document.cookie=`${b}=${encodeURIComponent(g)}; path=/; expires=${k.toUTCString()}`},t=b=>{const g=document.cookie.match(new RegExp("(?:^|; )"+b.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return g?decodeURIComponent(g[1]):null},e=()=>document.cookie.split(";").map(b=>b.trim().split("=")[0]),o=b=>{document.documentElement.dataset.font=b,n(zn,b,365)},s=b=>{document.documentElement.dataset.fontSize=b,n(Rn,b,365)},l=()=>{const b=t(zn)||"sans",g=t(Rn)||"medium";document.documentElement.dataset.font=b,document.documentElement.dataset.fontSize=g;const A=document.getElementById("font-select"),k=document.getElementById("font-size-select");A&&(A.value=b),k&&(k.value=g)},u=b=>{localStorage.setItem(Tf,String(b)),alert(b?"已开启提示":"已关闭提示")},d=b=>{const g=new Date;g.setTime(g.getTime()+31536e6),b?(document.cookie=`${Hn}=0; path=/; expires=${g.toUTCString()}`,alert("已显示最新更新横幅")):(document.cookie=`${Hn}=1; path=/; expires=${g.toUTCString()}`,alert("已隐藏最新更新横幅（刷新页面生效）"))},q=()=>{n(yf,"",-1),alert("已清除上次阅读记录")},m=()=>{e().forEach(g=>{n(g,"",-1)}),alert("已清除所有 Cookie")};return typeof window<"u"&&setTimeout(()=>{const b=document.getElementById("enable-prompt"),g=document.getElementById("disable-prompt"),A=document.getElementById("clear-history"),k=document.getElementById("enable-banner"),B=document.getElementById("disable-banner"),D=document.getElementById("clear-all-cookies"),j=document.getElementById("font-select"),L=document.getElementById("font-size-select");b?.addEventListener("click",()=>u(!0)),g?.addEventListener("click",()=>u(!1)),A?.addEventListener("click",()=>q()),k?.addEventListener("click",()=>d(!0)),B?.addEventListener("click",()=>d(!1)),D?.addEventListener("click",()=>m()),j?.addEventListener("change",()=>{const M=j.value;o(M)}),L?.addEventListener("change",()=>{const M=L.value;s(M)}),l()},0),(b,g)=>(a(),r("div",Sf,[...g[0]||(g[0]=[O("",4)])]))}}),Of=_(Af,[["__scopeId","data-v-22dea74c"]]),xf={extends:ep,Layout:Zd,NotFound:e_,enhanceApp({app:p}){p.component("ChapterList",W_),p.component("ARKChapterList",vf),p.component("BookWordCount",kf),p.component("SettingsPanel",Of)}};export{Xl as $,Hi as A,jr as B,Fi as C,Gi as D,Yi as E,Zi as F,tl as G,ol as H,rl as I,ll as J,dl as K,fl as L,ql as M,bl as N,Pl as O,Sl as P,Al as Q,xf as R,Nl as S,Vl as T,Il as U,Ll as V,wl as W,Rl as X,Jl as Y,Kl as Z,Vr as _,Ar as __pageData,Lr as a,Ql as a0,nu as a1,eu as a2,au as a3,iu as a4,uu as a5,_u as a6,hu as a7,vu as a8,gu as a9,Ic as aA,Dc as aB,wc as aC,zc as aD,Jc as aE,Fc as aF,Xc as aG,Yc as aH,nd as aI,td as aJ,ad as aK,rd as aL,ud as aM,dd as aN,hd as aO,qd as aP,gd as aQ,Pd as aR,Td as aS,Ad as aT,Bd as aU,Vd as aV,jd as aW,Ld as aX,Ed as aY,ku as aa,Tu as ab,Ou as ac,Bu as ad,Cu as ae,ju as af,Mu as ag,Eu as ah,Hu as ai,Uu as aj,Gu as ak,Wu as al,Zu as am,pc as an,oc as ao,sc as ap,lc as aq,cc as ar,fc as as,mc as at,bc as au,$c as av,Sc as aw,yc as ax,Nc as ay,xc as az,Er as b,za as c,Rr as d,Br as default,Ur as e,Kr as f,Qr as g,pi as h,Wr as i,ei as j,si as k,ii as l,ci as m,_i as n,mi as o,vi as p,$i as q,ki as r,yi as s,Oi as t,x as u,xi as v,Ci as w,Di as x,Mi as y,zi as z};
