...
`,xc=Object.freeze(Object.defineProperty({__proto__:null,default:Vc},Symbol.toStringTag,{value:"Module"})),Cc=`---
order: 1
---
...
而床上，两个被禁忌的欲望和温暖的体温缠绕在一起的灵魂，才刚刚开始面对他们崭新、混乱、而又无法分割的未来。`,Lc=Object.freeze(Object.defineProperty({__proto__:null,default:Cc},Symbol.toStringTag,{value:"Module"})),Ic=`---
order: 10
---
...
而这个牢笼，她甘愿被困在其中`,Mc=Object.freeze(Object.defineProperty({__proto__:null,default:Ic},Symbol.toStringTag,{value:"Module"})),wc=`---
order: 11
---
...
慢慢窒息。`,Dc=Object.freeze(Object.defineProperty({__proto__:null,default:wc},Symbol.toStringTag,{value:"Module"})),Ec=`---
order: 12
---
...
雪原的风裹挟着冰冷的雪花涌入洞口，试图冷却她们滚烫的肌肤和仍在分泌情动液体的隐秘地带，却徒劳无功。一前一后的身影，在苍茫雪地上投下扭曲纠缠、仿佛永生永世无法分离的影子。她们没有结合，没有亲吻，但空气中弥漫的、那混合着纯粹生殖渴望与原始情欲的、浓烈到令人窒息的张力，比任何身体的交合都更加惊心动魄，更加蚀骨销魂。这份在血与火、冰与欲、生与死的边缘淬炼出的生殖吸引，是灵魂与肉体的双重献祭，是征服与臣服的永恒悖论，是毁灭与重生的极致轮回。它如同一个未完成的、充满致命诱惑的生殖仪式，在寂静的雪原上、在她们每一次心跳的间隙里，无声地呼唤着下一次更加炽热、更加彻底的沉沦。直到她们在彼此的爱欲之火中，完成生命本能最原始、最澎湃的终极召唤——在极致的生殖结合中找到那唯一的、永恒的归宿，或在创造与毁灭的顶点化为灰烬。`,Md=Object.freeze(Object.defineProperty({__proto__:null,default:Id},Symbol.toStringTag,{value:"Module"})),wd=`---
order: 1
---
...
`,Dd=Object.freeze(Object.defineProperty({__proto__:null,default:wd},Symbol.toStringTag,{value:"Module"})),Ed=`---
order: 2
---
...
这是N系列的简介。
`,su=Object.freeze(Object.defineProperty({__proto__:null,default:au},Symbol.toStringTag,{value:"Module"})),ou={class:"ark-chapter-list"},ru={key:0,class:"section-a"},iu=["href"],lu={key:1,class:"section-b"},cu={key:0},du=["href"],uu=P({__name:"ARKChapterList",setup(p){const n=A(()=>{const e=u=>typeof u=="string"?u:u&&typeof u.default=="string"?u.default:u&&typeof u.__content=="string"?u.__content:"",t=Object.assign({"/articles/ark/A/A.1.md":Md}),a=[];Object.entries(t).forEach(([u,f])=>{const b=u.match(/\/articles\/ark\/A\/(.+?)\.md$/);if(!b)return;const v=b[1],$=e(f),g=$.match(/^---\s*\n([\s\S]*?)\n---/);let T=999,O=v;if(g){const B=g[1].match(/order:\s*(\d+)/);B&&(T=parseInt(B[1],10))}const M=$.match(/^#\s+(.+)$/m);M&&(O=M[1]),a.push({order:T,title:O,path:`/articles/ark/A/${v}`})}),a.sort((u,f)=>u.order-f.order);const o=Object.assign({"/articles/ark/B/A/B.A.1and2.md":Dd,"/articles/ark/B/A/B.A.3and4.md":jd,"/articles/ark/B/A/B.A.5and6.md":Rd,"/articles/ark/B/A/index.md":Ud,"/articles/ark/B/N/B.N.1.md":Jd,"/articles/ark/B/N/B.N.2.md":Gd,"/articles/ark/B/N/B.N.3.md":Wd,"/articles/ark/B/N/B.N.4.md":Qd,"/articles/ark/B/N/B.N.5.1.md":Zd,"/articles/ark/B/N/B.N.5.2.md":pu,"/articles/ark/B/N/B.N.6.md":tu,"/articles/ark/B/N/index.md":su}),l=new Map;Object.entries(o).forEach(([u,f])=>{const b=u.match(/\/articles\/ark\/B\/(\w+)\/(.+?)\.md$/);if(!b)return;const[,v,$]=b,g=e(f);if($==="index"){const T=g.match(/^---\s*\n([\s\S]*?)\n---/);let O=999,M=v;if(T){const w=T[1].match(/order:\s*(\d+)/);w&&(O=parseInt(w[1],10))}const B=g.match(/^#\s+(.+)$/m);if(B)M=B[1];else if(T){const w=T[1].match(/title:\s*(.+)/);w&&(M=w[1].trim())}if(!l.has(v))l.set(v,{name:v,order:O,title:M,chapters:[]});else{const w=l.get(v);w.order=O,w.title=M}}else{const T=g.match(/^---\s*\n([\s\S]*?)\n---/);let O=999,M=$;if(T){const w=T[1].match(/order:\s*(\d+)/);w&&(O=parseInt(w[1],10))}const B=g.match(/^#\s+(.+)$/m);B&&(M=B[1]),l.has(v)||l.set(v,{name:v,order:999,title:v,chapters:[]}),l.get(v).chapters.push({order:O,title:M,path:`/articles/ark/B/${v}/${$}`})}});const c=Array.from(l.values());return c.forEach(u=>{u.chapters.sort((f,b)=>f.order-b.order)}),c.sort((u,f)=>u.order-f.order),{aChapters:a,series:c}});return(e,t)=>(s(),r("div",ou,[n.value.aChapters.length>0?(s(),r("section",ru,[t[0]||(t[0]=i("h3",null,"A 系列（短篇）",-1)),i("ul",null,[(s(!0),r(I,null,j(n.value.aChapters,a=>(s(),r("li",{key:a.path},[i("a",{href:a.path},C(a.title),9,iu)]))),128))])])):k("",!0),n.value.series.length>0?(s(),r("section",lu,[t[1]||(t[1]=i("h3",null,"B 系列（系列连载）",-1)),(s(!0),r(I,null,j(n.value.series,a=>(s(),r("div",{key:a.name,class:"series"},[i("h4",null,C(a.title),1),a.chapters.length>0?(s(),r("ul",cu,[(s(!0),r(I,null,j(a.chapters,o=>(s(),r("li",{key:o.path},[i("a",{href:o.path},C(o.title),9,du)]))),128))])):k("",!0)]))),128))])):k("",!0)]))}}),_u=h(uu,[["__scopeId","data-v-e236f069"]]),fu={class:"settings-page"},mu="reading_prompt_enabled",hu="last_read",Rn="reader_font",Hn="reader_font_size",Un="latest_update_banner",vu=P({__name:"SettingsPanel",setup(p){const n=($,g,T=-1)=>{const O=new Date;O.setTime(O.getTime()+T*24*60*60*1e3),document.cookie=`${$}=${encodeURIComponent(g)}; path=/; expires=${O.toUTCString()}`},e=$=>{const g=document.cookie.match(new RegExp("(?:^|; )"+$.replace(/([.$?*|{}()\[\]\\\/\+^])/g,"\\$1")+"=([^;]*)"));return g?decodeURIComponent(g[1]):null},t=()=>document.cookie.split(";").map($=>$.trim().split("=")[0]),a=$=>{document.documentElement.dataset.font=$,n(Rn,$,365)},o=$=>{document.documentElement.dataset.fontSize=$,n(Hn,$,365)},l=()=>{const $=e(Rn)||"sans",g=e(Hn)||"medium";document.documentElement.dataset.font=$,document.documentElement.dataset.fontSize=g;const T=document.getElementById("font-select"),O=document.getElementById("font-size-select");T&&(T.value=$),O&&(O.value=g)},c=$=>{localStorage.setItem(mu,String($)),alert($?"已开启提示":"已关闭提示")},u=$=>{const g=new Date;g.setTime(g.getTime()+31536e6),$?(document.cookie=`${Un}=0; path=/; expires=${g.toUTCString()}`,alert("已显示最新更新横幅")):(document.cookie=`${Un}=1; path=/; expires=${g.toUTCString()}`,alert("已隐藏最新更新横幅（刷新页面生效）"))},f=()=>{n(hu,"",-1),alert("已清除上次阅读记录")},b=()=>{t().forEach(g=>{n(g,"",-1)}),alert("已清除所有 Cookie")};return typeof window<"u"&&setTimeout(()=>{const $=document.getElementById("enable-prompt"),g=document.getElementById("disable-prompt"),T=document.getElementById("clear-history"),O=document.getElementById("enable-banner"),M=document.getElementById("disable-banner"),B=document.getElementById("clear-all-cookies"),w=document.getElementById("font-select"),Y=document.getElementById("font-size-select");$?.addEventListener("click",()=>c(!0)),g?.addEventListener("click",()=>c(!1)),T?.addEventListener("click",()=>f()),O?.addEventListener("click",()=>u(!0)),M?.addEventListener("click",()=>u(!1)),B?.addEventListener("click",()=>b()),w?.addEventListener("change",()=>{const D=w.value;a(D)}),Y?.addEventListener("change",()=>{const D=Y.value;o(D)}),l()},0),($,g)=>(s(),r("div",fu,[...g[0]||(g[0]=[x('<section class="settings-card" data-v-22dea74c><h2 data-v-22dea74c>阅读外观</h2><p class="settings-desc" data-v-22dea74c>调整全局字体与字号，立即生效。</p><div class="settings-field" data-v-22dea74c><label for="font-select" data-v-22dea74c>全局字体</label><select id="font-select" data-v-22dea74c><option value="sans" data-v-22dea74c>鸿蒙 Sans（默认）</option><option value="serif" data-v-22dea74c>衬线</option><option value="mono" data-v-22dea74c>等宽</option><option value="song" data-v-22dea74c>宋体</option><option value="kai" data-v-22dea74c>楷体</option></select></div><div class="settings-field" data-v-22dea74c><label for="font-size-select" data-v-22dea74c>正文字号</label><select id="font-size-select" data-v-22dea74c><option value="small" data-v-22dea74c>小</option><option value="medium" data-v-22dea74c>中（默认）</option><option value="large" data-v-22dea74c>大</option></select></div></section><section class="settings-card" data-v-22dea74c><h2 data-v-22dea74c>阅读提示</h2><p class="settings-desc" data-v-22dea74c>默认开启「上次阅读位置」提示。</p><div class="settings-actions" data-v-22dea74c><button id="enable-prompt" data-v-22dea74c>开启提示</button><button id="disable-prompt" data-v-22dea74c>关闭提示</button><button id="clear-history" data-v-22dea74c>清除上次阅读记录</button></div></section><section class="settings-card" data-v-22dea74c><h2 data-v-22dea74c>页面显示</h2><p class="settings-desc" data-v-22dea74c>控制首页最新更新横幅的显示状态。</p><div class="settings-actions" data-v-22dea74c><button id="enable-banner" data-v-22dea74c>显示最新更新横幅</button><button id="disable-banner" data-v-22dea74c>隐藏最新更新横幅</button></div></section><section class="settings-card danger-card" data-v-22dea74c><h2 data-v-22dea74c>数据清理</h2><p class="settings-desc" data-v-22dea74c>会清除站点 Cookie（含阅读记录与偏好）。</p><div class="settings-actions" data-v-22dea74c><button id="clear-all-cookies" class="danger-btn" data-v-22dea74c>清除所有 Cookie</button></div></section>',4)])]))}}),bu=h(vu,[["__scopeId","data-v-22dea74c"]]),ku={extends:tp,Layout:Sc,NotFound:Bc,enhanceApp({app:p}){p.component("ChapterList",Ld),p.component("ARKChapterList",_u),p.component("SettingsPanel",bu)}};export{Gi as $,Rr as A,Lo as B,Fr as C,Kr as D,Wr as E,Qr as F,ni as G,ei as H,si as I,ri as J,ci as K,ui as L,mi as M,vi as N,$i as O,Pi as P,Si as Q,ku as R,Ni as S,Vi as T,Ci as U,Mi as V,Di as W,zi as X,Hi as Y,Ji as Z,Vo as _,So as __pageData,Mo as a,Yi as a0,Xi as a1,pl as a2,tl as a3,ol as a4,il as a5,dl as a6,_l as a7,hl as a8,bl as a9,kl as aa,Tl as ab,Al as ac,Ol as ad,xl as ae,Ll as af,wl as ag,El as ah,Rl as ai,Ul as aj,Kl as ak,ql as al,Ql as am,Zl as an,ec as ao,ac as ap,rc as aq,lc as ar,uc as as,Eo as b,Ea as c,zo as d,Oo as default,Uo as e,Jo as f,Yo as g,Zo as h,qo as i,pr as j,ar as k,or as l,lr as m,dr as n,fr as o,hr as p,gr as q,kr as r,yr as s,Ar as t,V as u,Br as v,xr as w,Ir as x,wr as y,jr as z};
